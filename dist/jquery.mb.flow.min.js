...
import{FlowApp}from"./Classes/FlowApp.js";import{Util}from"./Classes/Util.js";import{UI}from"./Classes/UI.js";import{ClassName,ContextualMenu,Menu}from"./Classes/Menu.js";import{KeyboardListener,KeyType}from"./Classes/KeyboardListener.js";import{Events,EventType}from"./Classes/Events.js";import{Type}from"./Classes/Node.js";import{Connection}from"./Classes/Connection.js";import{ActorsDrawer}from"./Classes/ActorsDrawer.js";import{AvatarDrawer}from"./Classes/AvatarDrawer.js";import{Drawer}from"./Classes/Drawer.js";!function(r,s,c){r(()=>{r.flow.init()}),r.flow={metaKeys:[],draggable:[],areaSize:{},selectedNodes:[],latMousePosition:{},contextualMenu:{boardListElement:e=>{let t=[{name:"Rename",fn:function(e){e=r(e).parent().data("board-id");r.flow.editBoardName(e)}},{name:"Duplicate",fn:function(e){e=r(e).parent().data("board-id");r.flow.duplicateBoard(e)}},{name:"Export",fn:function(e){flowApp.exportToFile()}}],a=r(e).parent().data("board-id"),i=flowApp.flow.getBoardById(a),n=flowApp.flow.getBoardsGroupsList();return 1<n.length&&(t.push({}),t.push({name:"Move to: ",className:ClassName.listTitle})),n.forEach(n=>{var e;n!==i._group&&(e={name:n,className:"listElement",fn:function(e){r.flow.moveBoardToGroup(a,n);var t=flowApp.flow.selectedBoardGroup;flowApp.drawer.drawBoardList(),r.flow.showBoardsByGroup(t)}},t.push(e))}),t.push({}),t.push({name:"Delete",className:ClassName.alert,fn:function(e){var t=r(e).parent().data("board-id");r.flow.deleteBoard(t,e)}}),t},flows:[{name:"Rename",fn:function(e){var t=r(e).parent().data("flow-id");console.debug(e,t),r.flow.editFlowName(t)}},{name:"Duplicate",fn:function(e){console.log("Duplicate",r(e).parent().data("flow-id"))}},{name:"New",fn:function(e){r.flow.addFlow()}},{},{name:"Options",icon:"icon-cog",fn:function(e){}},{name:"Flows List",icon:"icon-list-ul",fn:function(e){}},{},{name:"Export",className:ClassName.highlight,icon:"icon-download",fn:function(e){flowApp.exportToFile()}},{name:"Import",icon:"icon-upload",className:ClassName.highlight,fn:function(e){FlowApp.ImportFromFile()}},{},{name:"Delete",className:ClassName.alert,fn:function(e){var t=r(e).parent().data("flow-id");r.flow.deleteFlow(t,e)}}],boardsGroups:e=>{let n=[];n.push({name:"Show All",fn:function(e){flowApp.flow.selectedBoardGroup="all",r.flow.showBoardsByGroup("all")}}),n.push({});let t=flowApp.flow.getBoardsGroupsList();t.forEach(t=>{var e={name:t,className:ClassName.listElement,fn:function(e){flowApp.flow.selectedBoardGroup=t,r.flow.showBoardsByGroup(t)}};n.push(e)}),n.push({});var a={name:"Rename Group",fn:function(e){let t=r(e).parent().find(".name");t.attr({contentEditable:!0}),t.focus();let n=t.text();Util.selectElementContents(t.get(0)),t.one("blur",()=>{flowApp.flow.updateGroupName(n,t.text()),t.attr({contentEditable:!1})})}};"all"!==flowApp.flow.selectedBoardGroup&&n.push(a);a={name:"New Group",className:ClassName.highlight,fn:function(e){var t={title:"Add a new Group for <br><b>"+flowApp.flow._name+"</b>",text:null,inputId:"groupName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:e=>{flowApp.flow.addGroup(e),r.flow.showBoardsByGroup(e)},className:""};UI.dialogue(t)}};return n.push(a),n},nodeMenu:e=>{let n=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let i=n.getNodeById(e),t=[{name:"Add Line",fn:function(e){e=r(e).parents(".node").data("node-id"),e=n.getNodeById(e);Events.register(EventType.addNodeElement,e)}},{},{name:"Clone",fn:function(e){e=r(e).parents(".node").data("node-id"),n.getNodeById(e);console.debug("Clone")}},{name:"Delete",className:ClassName.alert,fn:function(t,e){t=r(t).parents(".node").data("node-id");if(null!=t){let e=r.flow.selectedBoard();e.deleteNodeById(t)}}}];if(i._connections.length&&(t.push({}),t.push({name:"Remove Connections",className:ClassName.listTitle})),null!=e){let e=0;i._connections.forEach(a=>{t.push({name:"Connection "+ ++e,className:ClassName.alert,fn:function(e,t){a._connectionLine.remove(),i._connections.delete(a),n._connections.delete(a),Events.register(EventType.updateBoard,n)},hoverFn:function(e,t){a._connectionLine.setOptions({color:"red"})},outFn:function(e,t){var n=a._type||0,n=Drawer.getConnectionColorByConnectionType(n);a._connectionLine.setOptions({color:n})}})})}return t},cycleMenu:e=>{let t=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let n=t.getNodeById(e);return[{name:"List",icon:"icon-list-ol",className:"List"===n._cycleType?ClassName.highlight:null,fn:function(e){n._cycleType="List",r(e).attr("class","icon icon-list-ol"),Events.register(EventType.updateBoard,t)}},{name:"Loop",icon:"icon-repeat",className:"Repeat"===n._cycleType?ClassName.highlight:null,fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType="Repeat",r(e).attr("class","icon icon-repeat"),Events.register(EventType.updateBoard,t)}},{name:"Random",icon:"icon-random",className:"Random"===n._cycleType?ClassName.highlight:null,fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType="Random",r(e).attr("class","icon icon-random"),Events.register(EventType.updateBoard,t)}}]},actorMenu:e=>{let t=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let n=t.getNodeById(e),a=[];return a.push({name:"Actors",className:ClassName.listTitle}),a.push({}),flowApp.flow._actors.forEach(t=>{a.push({name:t._name,className:t._id===n._actorId?ClassName.highlight:null,fn:function(e){n._actorId=t._id,flowApp.drawer.drawBoard()}})}),a},board:[{name:"New Text Node",icon:"icon-commenting",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.text,{_x:t.clientX,_y:t.clientY})}},{name:"New Choice Node",icon:"icon-th-list",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.choices,{_x:t.clientX,_y:t.clientY})}},{name:"New Conditional Node",icon:"icon-sitemap",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.condition,{_x:t.clientX,_y:t.clientY})}},{name:"New Sequence Node",icon:"icon-tasks",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.sequence,{_x:t.clientX,_y:t.clientY})}},{name:"New Note node",icon:"icon-thumb-tack",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.note,{_x:t.clientX,_y:t.clientY})}},{name:"New Variables node",icon:"icon-code",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.variables,{_x:t.clientX,_y:t.clientY})}},{name:"New Random Node",icon:"icon-random",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.random,{_x:t.clientX,_y:t.clientY})}}],node:e=>{e=r(e).parents(".node").data("node-id");let a=r.flow.selectedBoard(),i=a.getNodeById(e),t=[{name:"Clone",fn:function(e){console.debug("Clone")}},{name:"Delete",className:ClassName.alert,fn:function(t,e){t=r(t).parents(".node").data("node-id");if(null!=t){let e=r.flow.selectedBoard();e.deleteNodeById(t)}}}];if(i._connections.length&&(t.push({}),t.push({name:"Remove Connections",className:ClassName.listTitle})),null!=e){let e=0;i._connections.forEach(n=>{t.push({name:"Connection "+ ++e,className:ClassName.alert,fn:function(e,t){console.debug(n),n._connectionLine.remove(),i._connections.delete(n),a._connections.delete(n),Events.register(EventType.updateBoard,a)},hoverFn:function(e,t){n._connectionLine.setOptions({color:"red"})},outFn:function(e,t){n._connectionLine.setOptions({color:Drawer.getConnectionColorByConnectionType(n._type)})}})})}return t},nodeElement:e=>{let a=r(e).is(".node-text")?r(e):r(e).find(".node-text"),i=a.caret(),t=[{name:"Delete Line",icon:"icon-remove",className:ClassName.alert,fn:function(e,t){let n=r(e).is(".node-content-line")?r(e):r(e).parents(".node-content-line");var a=n.data("node-id"),e=n.data("node-element-id");Events.register(EventType.deletetNodeElement,{nodeId:a,nodeElementId:e})}}];return a.is("[contenteditable]")&&(t.push({}),t.push({name:"Add variables",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n=" <span id='variable_"+Util.setUID()+"' class='variables' contenteditable='false'>{"+t+"}</span> ";a.caret(i),function(e){var t,n;if(c.getSelection&&(t=c.getSelection()).getRangeAt&&t.rangeCount){(n=t.getRangeAt(0)).deleteContents();var a=s.createElement("div");a.innerHTML=e;for(var i,l,o=s.createDocumentFragment();i=a.firstChild;)l=o.appendChild(i);n.insertNode(o),l&&((n=n.cloneRange()).setStartAfter(l),n.collapse(!0),t.removeAllRanges(),t.addRange(n))}}(n),Util.addVariables("{"+t+"}")},className:null};UI.dialogue(n)}})),t},variablesMenu:e=>{let a=r(e).is(".variables")?r(e):r(e).parents(".variables"),i=r(e).parents(".node-text"),t=[];return e._variables=flowApp.flow._variables,t.push({name:"Edit variables",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:a.text().replace(/{/g,"").replace(/}/g,""),okLabel:"Update",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n="{"+t+"}";Util.addVariables(n),i.find("#"+a.attr("id")).html(n),i.focus()},className:null};UI.dialogue(n)}}),t}},flowApp:()=>flowApp,selectedBoard:()=>flowApp.flow.getBoardById(flowApp.flow._selectedBoardId),init:()=>{c.Avataaars=Avataaars,c.KeyListener=new KeyboardListener,c.flowApp=new FlowApp;var e=r.mbStorage.get("lastFlow");null!=e?flowApp.load(e):r.flow.addFlow(),c.flows_menu=new Menu(".flows-menu",r.flow.contextualMenu.flows,!0),c.board_list_element_menu=new Menu(".board-list-element-menu",r.flow.contextualMenu.boardListElement,!0),c.boards_groups=new Menu(".boards-group-menu",r.flow.contextualMenu.boardsGroups,!0),c.node_menu=new Menu('[data-menu="node"]',r.flow.contextualMenu.nodeMenu,!0),c.cycle_menu=new Menu('[data-menu="cycle"]',r.flow.contextualMenu.cycleMenu,!0),c.actor_menu=new Menu('[data-menu="actor"]',r.flow.contextualMenu.actorMenu,!0),c.board_contextual_menu=new ContextualMenu(flowApp.ui.placeholders.drawingArea,r.flow.contextualMenu.board,!0),c.node_contextual_menu=new ContextualMenu(".node",r.flow.contextualMenu.node,!1),c.variables_contextual_menu=new ContextualMenu(".variables",r.flow.contextualMenu.variablesMenu,!0),c.nodeElement_contextual_menu=new ContextualMenu(".node-content-line",r.flow.contextualMenu.nodeElement,!0),r(s).on("paste","[contenteditable]",e=>{e.preventDefault();e=(e.originalEvent||e).clipboardData.getData("text/plain");s.execCommand("insertHTML",!1,e)}),r(s).on("keypress","[contenteditable]",e=>{var t=r(e.target).parents(".node");switch(0<t.length&&(r(e.target)[0].caretPos=r(e.target).caret()),e.key){case KeyType.enter:if(0<t.length)return void(0<=r.flow.metaKeys.indexOf(KeyType.shift)&&(e.preventDefault(),r(e.target).blur()));break;case KeyType.backspace:if(0<r(e.target).parents(".node").length)return;break;default:if(0<=r.flow.metaKeys.indexOf(KeyType.meta))return e.preventDefault(),!1}}),r(s).on("keyup","[contenteditable]",e=>{e=r(e.target).parents(".node");0<e.length&&(r.flow.autoShiftNodes(e),r.flow.updateConnections())}),r(s).on("keydown",e=>{let t=r.flow.selectedBoard();if(0<=r.flow.metaKeys.indexOf(KeyType.meta))switch(r(".node").draggable("disable"),e.stopPropagation(),e.key){case"0":case"-":case"+":e.preventDefault();break;case"Backspace":e.preventDefault(),r.flow.selectedNodes.forEach(e=>{t.deleteNodeById(e)}),r.flow.selectedNodes=[]}if(0<=r.flow.metaKeys.indexOf(KeyType.control))switch(e.stopPropagation(),e.key){case"t":e.preventDefault(),t.addNode(Type.text,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"n":e.preventDefault(),t.addNode(Type.note,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"c":e.preventDefault(),t.addNode(Type.choices,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"v":e.preventDefault(),t.addNode(Type.variables,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"r":e.preventDefault(),t.addNode(Type.random,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"s":e.preventDefault(),t.addNode(Type.sequence,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"x":e.preventDefault(),t.addNode(Type.condition,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y})}}),r(s).on("keyup",()=>{r(".node").draggable("enable")}),r(c).on("resize",()=>{flowApp.drawer.drawGrid()});let a=r(flowApp.ui.placeholders.board);a[0].style.zoom=1;let i={};r(s).on("mousedown.drag",e=>{0<=r.flow.metaKeys.indexOf(KeyType.meta)?(e.preventDefault(),r("body").css("cursor","grab"),i={left:a.offset().left,top:a.offset().top,x:e.pageX,y:e.pageY,hasMove:!0}):0<=r.flow.metaKeys.indexOf(KeyType.shift)&&flowApp.drawer.drawSelection(e),r(s).on("mousemove.drag",e=>{var t,n;r.flow.latMousePosition={x:e.clientX,y:e.clientY},0<=r.flow.metaKeys.indexOf(KeyType.meta)?(e.preventDefault(),r("body").css("cursor","grabbing"),i.hasMove&&(t=i.left+Math.round((e.pageX-i.x)/flowApp._grid)*flowApp._grid,n=i.top+Math.round((e.pageY-i.y)/flowApp._grid)*flowApp._grid,a.css({left:t,top:n})),r.flow.updateConnections()):0<=r.flow.metaKeys.indexOf(KeyType.shift)&&flowApp.drawer.drawSelection(e)}).one("mouseup.drag",e=>{if(flowApp.drawer.drawSelection(e),i.hasMove=!1,r(s).off("mousemove.drag"),0<=r.flow.metaKeys.indexOf(KeyType.meta)){r.flow.updateConnections(),r("body").css("cursor","default");let e=r.flow.getSelectedBoard();e._x=parseFloat(a.css("left")),e._y=parseFloat(a.css("top")),Events.register(EventType.updateBoard,e)}})})},makeNodeDraggableAndLinkable:e=>{let i=r("#node_"+e),n=i.get(0),a=r.flow.getSelectedBoard(),l=a.getNodeById(e);i.draggable({handle:i.find(".menu").length?".menu":null,cursor:"grabbing",opacity:.7,snap:".vline, .hline",zIndex:100,start:()=>{n.startX=i.position().left,n.startY=i.position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=r("#node_"+n),t=e.get(0);t.startX=parseFloat(e.css("left")),t.startY=parseFloat(e.css("top"))}})},drag:()=>{n.distanceX=i.position().left-n.startX,n.distanceY=i.position().top-n.startY,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(t=>{if(t!==e){let e=r("#node_"+t);e[0].style.left=e[0].startX+n.distanceX+"px",e[0].style.top=e[0].startY+n.distanceY+"px"}}),r.flow.updateConnections()},stop:()=>{l._x=r(n).position().left,l._y=r(n).position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=a.getNodeById(n),t=r("#node_"+n);e._x=t.position().left,e._y=t.position().top}}),Events.register(EventType.updateNode,l)}});let t=i.is(".anchorOut")?i:i.find(".anchorOut");t.each(function(){r(this).on("mousedown",function(e){if(0<=r.flow.metaKeys.indexOf(KeyType.meta)&&0<=r.flow.metaKeys.indexOf(KeyType.alt)){e.stopPropagation(),e.preventDefault();let t=r(flowApp.ui.placeholders.board),n=i.is(".anchorOut")?i:r(this);0<=r.flow.metaKeys.indexOf(KeyType.shift)&&l._type===Type.condition&&(n=i);let a=r("<div id='fakeEl'>").css({position:"absolute",width:10,height:10,background:"transparent",zIndex:-100,left:e.clientX-t.position().left,top:e.clientY-t.position().top});a.appendTo(flowApp.ui.placeholders.board);e=0<=r.flow.metaKeys.indexOf(KeyType.shift)&&l._type===Type.condition?"red":"orange";r(this).get(0).line=r.flow.LeaderLine(n.is(".anchorOut")||0<=r.flow.metaKeys.indexOf(KeyType.alt)&&l._type===Type.condition?n:n.find(".anchor"),a,{color:e,size:3}),r(s).on("mousemove.line",e=>{a.css({left:e.clientX-t.position().left,top:e.clientY-t.position().top}),r(this).get(0).line.position()}).one("mouseup.line",e=>{r(s).off("mousemove.line"),a.remove(),r(this).get(0).line.remove();let t=r(e.target).parents(".node");t.length&&t.data("node-id")!==n.data("node-id")&&t.data("node-id")!==n.parents(".node").data("node-id")&&(e=r.flow.getConnectionTypeByNodeType(l,n),e=new Connection(null,n.data("node-id"),n.data("node-element-id"),t.data("node-id"),e),Events.register(EventType.addConnection,e))})}})})},getConnectionTypeByNodeType(e,t=null){let n=0;switch(e._type){case Type.choices:n=1;break;case Type.condition:n=t&&null!=t.data("node-element-id")?2:3;break;case Type.random:n=4;break;case Type.start:n=5;break;case Type.sequence:n=6}return n},addFlow:()=>{var e={title:"Add a new Flow",text:null,inputId:"flowName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.addFlow(e),r.mbStorage.set("lastFlow",flowApp.flow.id);e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:null};UI.dialogue(e)},openFlow:()=>{},editFlowName:()=>{let e=r(flowApp.ui.placeholders.flowName).find("h1");e.attr({contentEditable:!0}),e.focus(),Util.selectElementContents(e.get(0)),e.one("blur",()=>{flowApp.flow.updateName(e.text()),e.attr({contentEditable:!1})})},deleteFlow:(t,e)=>{e={title:"Delete Flow",text:"Are you sure you want to delete<br><b>"+r(e).parent().find(".name").text()+"</b>?",inputId:null,inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.deleteFlow(t);var e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:"alert"};UI.dialogue(e)},getSelectedBoard:()=>flowApp.flow.getBoardById(flowApp.flow.selectedBoardId),addBoard:()=>{var e={title:"Add a new Board",text:null,inputId:"boardName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.flow.addBoard(e,flowApp.flow.selectedBoardGroup)},className:null};UI.dialogue(e)},duplicateBoard:e=>{flowApp.flow.duplicateBoard(e)},moveBoardToGroup:(e,t)=>{flowApp.flow.moveBoardToGroup(e,t);t=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,t)},editBoardName:t=>{let n=r(flowApp.ui.placeholders.boardList).find("#board_"+t+" .name");n.attr({contentEditable:!0}),n.focus(),Util.selectElementContents(n.get(0)),n.one("blur",()=>{let e=flowApp.flow.getBoardById(t);e._name=n.text(),flowApp.drawer.drawBoardList()})},deleteBoard:(e,t)=>{t={title:"Delete Board",text:"Are you sure you want to delete<br><b>"+r(t).parent().find(".name").text()+"</b>?",inputId:null,inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.flow.deleteBoard(e),flowApp.drawer.drawBoardList()},className:"alert"};UI.dialogue(t)},showBoardsByGroup:e=>{r(flowApp.ui.placeholders.boardList).find("li").hide(),("all"!==e?r(flowApp.ui.placeholders.boardList).find('[data-board-group="'+e+'"]'):r(flowApp.ui.placeholders.boardList).find("li")).show(),r(flowApp.ui.placeholders.boardGroupName).html("all"!==e?e:"All Boards")},LeaderLine:(e,t,n)=>new LeaderLine(e.get(0),t.get(0),n),updateConnections:()=>{let n=r.flow.getSelectedBoard()._connections;n.forEach(e=>{let t=e._connectionLine;t?"function"==typeof t.position&&t.position():n.delete(e)})},autoShiftNodes:i=>{let e=r.flow.getSelectedBoard()._nodes,l=parseFloat(i.css("left")),o=parseFloat(i.css("top"));i.get(0).h&&i.height()===i.get(0).h||(e.forEach(e=>{let t=r(flowApp.ui.placeholders.board).find("#node_"+e._id);var n=parseFloat(t.css("left")),a=parseFloat(t.css("top"));n>=l&&n<l+i.width()&&a>o&&(n=i.height()-i.get(0).h,t.css({top:a+n}),e._x=t.position().left,e._y=t.position().top)}),i.get(0).h=i.height())},getNodeById:e=>{let t=r.flow.getSelectedBoard();return t.getNodeById(e)},addToSelectedNodes:function(e,t=!1){t?r.flow.selectedNodes.indexOf(e)<0&&r.flow.selectedNodes.unshift(e):(r.flow.selectedNodes=[],r.flow.selectedNodes.unshift(e)),Events.register(EventType.selectNode,{selectedNodeId:e})},removeFromSelectedNodes:function(e=null){e?r.flow.selectedNodes.delete(e):r.flow.selectedNodes=[]},drawActorsWindow:()=>{ActorsDrawer.openWindow()},drawAvatarWindow:e=>{AvatarDrawer.openWindow(e)}},Array.prototype.delete=function(t){for(let e=0;e<this.length;e++)this[e]===t&&(this.splice(e,1),e--)},Number.prototype.module=function(e){return(this%e+e)%e}}(jQuery,document,window);const Avataaars={defaultOptions:{style:"circle"},create(e){return this._createAvataaar({...this.defaultOptions,...e})},setDefaultAvatar(e){this.defaultOptions=e},getEditableTypes(){return Object.keys(this.paths).filter(e=>1<Object.keys(this.paths[e]).length)},_getChildOrDefault(e,t,n){return void 0!==e[t][n]?e[t][n]:["facialHair","accessories"].includes(t)&&null==n?()=>"":e[t].default||e[t][Object.keys(e[t])[0]]},_getShape(e,t){return this._getChildOrDefault(this.paths,e,t)},_getColor(e,t){return this._getChildOrDefault(this.colors,e,t)},_createAvataaar(e){let t=this.paths.nose.default,n=this.paths.skin.default;var a=this._getColor("skin",e.skin);let[i,,l]=this._getTopType(e.top),o=this._getShape("facialHair",e.facialHair);var r=this._getColor("hair",e.facialHairColor);let s=this._getShape("clothing",e.clothing),c=this._getShape("clothingGraphic",e.clothingGraphic);var u=this._getColor("palette",e.clothingColor);let d=this._getShape("eyes",e.eyes),p=this._getShape("eyebrows",e.eyebrows),h=this._getShape("mouth",e.mouth),f=this._getShape("accessories",e.accessories);var m=this._getColor("palette",e.accessoriesColor),y=this._getColor("palette",e.hatColor),v=this._getColor("hair",e.hairColor),g=(e,t,n)=>0<e.length?`<g transform="translate(${t}, ${n})">${e}</g>`:"",v=g(i(y,v),7,0);let S=`
      ${g(n(a),40,36)}
      ${g(s(u,c()),8,170)}
      ${g(h(),86,134)}
      ${g(t(),112,122)}
  ...
  `},_getTopType(e){switch(e){case"bigHair":return[this.paths.top.bigHair,!1,0];case"bob":return[this.paths.top.bob,!1,0];case"bun":return[this.paths.top.bun,!1,1];case"curly":return[this.paths.top.curly,!1,0];case"curvy":return[this.paths.top.curvy,!1,0];case"dreads":return[this.paths.top.dreads,!1,0];case"frida":return[this.paths.top.frida,!1,0];case"fro":return[this.paths.top.fro,!1,0];case"froAndBand":return[this.paths.top.froAndBand,!1,0];case"miaWallace":return[this.paths.top.miaWallace,!1,0];case"longButNotTooLong":return[this.paths.top.longButNotTooLong,!1,0];case"shavedSides":return[this.paths.top.shavedSides,!1,0];case"straight01":return[this.paths.top.straight01,!1,0];case"straight02":return[this.paths.top.straight02,!1,0];case"straightAndStrand":return[this.paths.top.straightAndStrand,!1,0];case"dreads01":return[this.paths.top.dreads01,!1,1];case"dreads02":return[this.paths.top.dreads02,!1,1];case"frizzle":return[this.paths.top.frizzle,!1,1];case"shaggy":return[this.paths.top.shaggy,!1,2];case"shaggyMullet":return[this.paths.top.shaggyMullet,!1,0];case"shortCurly":return[this.paths.top.shortCurly,!1,1];case"shortFlat":return[this.paths.top.shortFlat,!1,1];case"shortRound":return[this.paths.top.shortRound,!1,1];case"shortWaved":return[this.paths.top.shortWaved,!1,1];case"sides":return[this.paths.top.sides,!1,1];case"theCaesar":return[this.paths.top.theCaesar,!1,1];case"theCaesarAndSidePart":return[this.paths.top.theCaesarAndSidePart,!1,1];case"hat":return[this.paths.top.hat,!0,0];case"winterHat01":return[this.paths.top.winterHat01,!0,2];case"winterHat02":return[this.paths.top.winterHat02,!0,2];case"winterHat03":return[this.paths.top.winterHat03,!0,2];case"winterHat04":return[this.paths.top.winterHat04,!0,2];case"hijab":return[this.paths.top.hijab,!0,1];case"turban":return[this.paths.top.turban,!0,1];case"eyepatch":return[this.paths.top.eyepatch,!1,1];default:return[this.paths.top.shortWaved,!1,1]}},colors:{hair:{auburn:"#A55728",black:"#2C1B18",blonde:"#B58143",blondeGolden:"#D6B370",brown:"#724133",brownDark:"#4A312C",pastelPink:"#F59797",platinum:"#ECDCBF",red:"#C93305",silverGray:"#E8E1E1"},palette:{black:"#262E33",blue01:"#65C9FF",blue02:"#5199E4",blue03:"#25557C",gray01:"#E5E5E5",gray02:"#929598",heather:"#3C4F5C",pastelBlue:"#B1E2FF",pastelGreen:"#A7FFC4",pastelOrange:"#FFDEB5",pastelRed:"#FFAFB9",pastelYellow:"#FFFFB1",pink:"#FF488E",red:"#FF5C5C",white:"#FFFFFF"},skin:{tanned:"#FD9841",yellow:"#F9D562",pale:"#FFDBB4",light:"#EDB98A",brown:"#D08B5B",darkBrown:"#AE5D29",black:"#614335"}},paths:{accessories:{none:e=>"",kurt:e=>`
      ...
      `}}};var nAgt=navigator.userAgent;function isTouchSupported(){var e=nAgt.msMaxTouchPoints,t="ontouchstart"in document.createElement("div");return!(!e&&!t)}jQuery.browser=jQuery.browser||{},jQuery.browser.mozilla=!1,jQuery.browser.webkit=!1,jQuery.browser.opera=!1,jQuery.browser.safari=!1,jQuery.browser.chrome=!1,jQuery.browser.androidStock=!1,jQuery.browser.msie=!1,jQuery.browser.edge=!1,jQuery.browser.ua=nAgt;var nameOffset,verOffset,ix,start,end,getOS=function(){var e={version:"Unknown version",name:"Unknown OS"};return-1!=navigator.appVersion.indexOf("Win")&&(e.name="Windows"),-1!=navigator.appVersion.indexOf("Mac")&&navigator.appVersion.indexOf("Mobile")<0&&(e.name="Mac"),-1!=navigator.appVersion.indexOf("Linux")&&(e.name="Linux"),/Mac OS X/.test(nAgt)&&!/Mobile/.test(nAgt)&&(e.version=/Mac OS X ([\._\d]+)/.exec(nAgt)[1],e.version=e.version.replace(/_/g,".").substring(0,5)),/Windows/.test(nAgt)&&(e.version="Unknown.Unknown"),/Windows NT 5.1/.test(nAgt)&&(e.version="5.1"),/Windows NT 6.0/.test(nAgt)&&(e.version="6.0"),/Windows NT 6.1/.test(nAgt)&&(e.version="6.1"),/Windows NT 6.2/.test(nAgt)&&(e.version="6.2"),/Windows NT 10.0/.test(nAgt)&&(e.version="10.0"),/Linux/.test(nAgt)&&/Linux/.test(nAgt)&&(e.version="Unknown.Unknown"),e.name=e.name.toLowerCase(),e.major_version="Unknown",e.minor_version="Unknown","Unknown.Unknown"!=e.version&&(e.major_version=parseFloat(e.version.split(".")[0]),e.minor_version=parseFloat(e.version.split(".")[1])),e};function uncamel(e){return e.replace(/([A-Z])/g,function(e){return"-"+e.toLowerCase()})}function setUnit(e,t){return"string"!=typeof e||e.match(/^[\-0-9\.]+jQuery/)?""+e+t:e}function setFilter(e,t,n){var a=uncamel(t),i=jQuery.mbBrowser.mozilla?"":jQuery.CSS.sfx;e[i+"filter"]=e[i+"filter"]||"",n=setUnit(n>jQuery.CSS.filters[t].max?jQuery.CSS.filters[t].max:n,jQuery.CSS.filters[t].unit),e[i+"filter"]+=a+"("+n+") ",delete e[t]}jQuery.browser.os=getOS(),jQuery.browser.hasTouch=isTouchSupported(),jQuery.browser.name=navigator.appName,jQuery.browser.fullVersion=""+parseFloat(navigator.appVersion),jQuery.browser.majorVersion=parseInt(navigator.appVersion,10),-1!=(verOffset=nAgt.indexOf("Opera"))?(jQuery.browser.opera=!0,jQuery.browser.name="Opera",jQuery.browser.fullVersion=nAgt.substring(verOffset+6),-1!=(verOffset=nAgt.indexOf("Version"))&&(jQuery.browser.fullVersion=nAgt.substring(verOffset+8))):-1!=(verOffset=nAgt.indexOf("OPR"))?(jQuery.browser.opera=!0,jQuery.browser.name="Opera",jQuery.browser.fullVersion=nAgt.substring(verOffset+4)):-1!=(verOffset=nAgt.indexOf("MSIE"))?(jQuery.browser.msie=!0,jQuery.browser.name="Microsoft Internet Explorer",jQuery.browser.fullVersion=nAgt.substring(verOffset+5)):-1!=nAgt.indexOf("Trident")?(jQuery.browser.msie=!0,jQuery.browser.name="Microsoft Internet Explorer",start=nAgt.indexOf("rv:")+3,jQuery.browser.fullVersion=nAgt.substring(start,end=start+4)):-1!=(verOffset=nAgt.indexOf("Edge"))?(jQuery.browser.edge=!0,jQuery.browser.name="Microsoft Edge",jQuery.browser.fullVersion=nAgt.substring(verOffset+5)):-1!=(verOffset=nAgt.indexOf("Chrome"))?(jQuery.browser.webkit=!0,jQuery.browser.chrome=!0,jQuery.browser.name="Chrome",jQuery.browser.fullVersion=nAgt.substring(verOffset+7)):-1<nAgt.indexOf("mozilla/5.0")&&-1<nAgt.indexOf("android ")&&-1<nAgt.indexOf("applewebkit")&&!(-1<nAgt.indexOf("chrome"))?(verOffset=nAgt.indexOf("Chrome"),jQuery.browser.webkit=!0,jQuery.browser.androidStock=!0,jQuery.browser.name="androidStock",jQuery.browser.fullVersion=nAgt.substring(verOffset+7)):-1!=(verOffset=nAgt.indexOf("Safari"))||-1!=(verOffset=nAgt.indexOf("AppleWebkit"))?(jQuery.browser.webkit=!0,jQuery.browser.safari=!0,jQuery.browser.name="Safari",jQuery.browser.fullVersion=nAgt.substring(verOffset+7),-1!=(verOffset=nAgt.indexOf("Version"))&&(jQuery.browser.fullVersion=nAgt.substring(verOffset+8))):-1!=(verOffset=nAgt.indexOf("Firefox"))?(jQuery.browser.mozilla=!0,jQuery.browser.name="Firefox",jQuery.browser.fullVersion=nAgt.substring(verOffset+8)):(nameOffset=nAgt.lastIndexOf(" ")+1)<(verOffset=nAgt.lastIndexOf("/"))&&(jQuery.browser.name=nAgt.substring(nameOffset,verOffset),jQuery.browser.fullVersion=nAgt.substring(verOffset+1),jQuery.browser.name.toLowerCase()==jQuery.browser.name.toUpperCase()&&(jQuery.browser.name=navigator.appName)),-1!=(ix=jQuery.browser.fullVersion.indexOf(";"))&&(jQuery.browser.fullVersion=jQuery.browser.fullVersion.substring(0,ix)),-1!=(ix=jQuery.browser.fullVersion.indexOf(" "))&&(jQuery.browser.fullVersion=jQuery.browser.fullVersion.substring(0,ix)),jQuery.browser.majorVersion=parseInt(""+jQuery.browser.fullVersion,10),isNaN(jQuery.browser.majorVersion)&&(jQuery.browser.fullVersion=""+parseFloat(navigator.appVersion),jQuery.browser.majorVersion=parseInt(navigator.appVersion,10)),jQuery.browser.version=jQuery.browser.majorVersion,jQuery.browser.android=/Android/i.test(nAgt),jQuery.browser.blackberry=/BlackBerry|BB|PlayBook/i.test(nAgt),jQuery.browser.ios=/iPhone|iPad|iPod|webOS/i.test(nAgt),jQuery.browser.operaMobile=/Opera Mini/i.test(nAgt),jQuery.browser.windowsMobile=/IEMobile|Windows Phone/i.test(nAgt),jQuery.browser.kindle=/Kindle|Silk/i.test(nAgt),jQuery.browser.mobile=jQuery.browser.android||jQuery.browser.blackberry||jQuery.browser.ios||jQuery.browser.windowsMobile||jQuery.browser.operaMobile||jQuery.browser.kindle,jQuery.isMobile=jQuery.browser.mobile,jQuery.isTablet=jQuery.browser.mobile&&765<jQuery(window).width(),jQuery.isAndroidDefault=jQuery.browser.android&&!/chrome/i.test(nAgt),jQuery.mbBrowser=jQuery.browser,jQuery.browser.versionCompare=function(e,t){if("stringstring"!=typeof e+typeof t)return!1;for(var n=e.split("."),a=t.split("."),i=0,l=Math.max(n.length,a.length);i<l;i++){if(n[i]&&!a[i]&&0<parseInt(n[i])||parseInt(n[i])>parseInt(a[i]))return 1;if(a[i]&&!n[i]&&0<parseInt(a[i])||parseInt(n[i])<parseInt(a[i]))return-1}return 0},jQuery.support.CSStransition=function(){var e=(document.body||document.documentElement).style;return void 0!==e.transition||void 0!==e.WebkitTransition||void 0!==e.MozTransition||void 0!==e.MsTransition||void 0!==e.OTransition}(),jQuery.CSS={name:"mb.CSSAnimate",author:"Matteo Bicocchi",version:"2.0.0",transitionEnd:"transitionEnd",sfx:"",filters:{blur:{min:0,max:100,unit:"px"},brightness:{min:0,max:400,unit:"%"},contrast:{min:0,max:400,unit:"%"},grayscale:{min:0,max:100,unit:"%"},hueRotate:{min:0,max:360,unit:"deg"},invert:{min:0,max:100,unit:"%"},saturate:{min:0,max:400,unit:"%"},sepia:{min:0,max:100,unit:"%"}},normalizeCss:function(e){var t,n,a=jQuery.extend(!0,{},e);for(t in jQuery.mbBrowser.webkit||jQuery.mbBrowser.opera?jQuery.CSS.sfx="-webkit-":jQuery.mbBrowser.mozilla?jQuery.CSS.sfx="-moz-":jQuery.mbBrowser.msie&&(jQuery.CSS.sfx="-ms-"),jQuery.CSS.sfx="",a)"transform"===t&&(a[jQuery.CSS.sfx+"transform"]=a[t],delete a[t]),"transform-origin"===t&&(a[jQuery.CSS.sfx+"transform-origin"]=e[t],delete a[t]),"filter"!==t||jQuery.mbBrowser.mozilla||(a[jQuery.CSS.sfx+"filter"]=e[t],delete a[t]),"blur"===t&&setFilter(a,"blur",e[t]),"brightness"===t&&setFilter(a,"brightness",e[t]),"contrast"===t&&setFilter(a,"contrast",e[t]),"grayscale"===t&&setFilter(a,"grayscale",e[t]),"hueRotate"===t&&setFilter(a,"hueRotate",e[t]),"invert"===t&&setFilter(a,"invert",e[t]),"saturate"===t&&setFilter(a,"saturate",e[t]),"sepia"===t&&setFilter(a,"sepia",e[t]),"x"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateX("+setUnit(e[t],"px")+")",delete a[t]),"y"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateY("+setUnit(e[t],"px")+")",delete a[t]),"z"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateZ("+setUnit(e[t],"px")+")",delete a[t]),"rotate"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotate("+setUnit(e[t],"deg")+")",delete a[t]),"rotateX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateX("+setUnit(e[t],"deg")+")",delete a[t]),"rotateY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateY("+setUnit(e[t],"deg")+")",delete a[t]),"rotateZ"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateZ("+setUnit(e[t],"deg")+")",delete a[t]),"scale"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scale("+setUnit(e[t],"")+")",delete a[t]),"scaleX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleX("+setUnit(e[t],"")+")",delete a[t]),"scaleY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleY("+setUnit(e[t],"")+")",delete a[t]),"scaleZ"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleZ("+setUnit(e[t],"")+")",delete a[t]),"skew"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skew("+setUnit(e[t],"deg")+")",delete a[t]),"skewX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skewX("+setUnit(e[t],"deg")+")",delete a[t]),"skewY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skewY("+setUnit(e[t],"deg")+")",delete a[t]),"perspective"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" perspective("+setUnit(e[t],"px")+")",delete a[t]);return a},getProp:function(e){var t,n=[];for(t in e)n.indexOf(t)<0&&n.push(uncamel(t));return n.join(",")},animate:function(r,s,c,u,d){return this.each(function(){function e(){t.called=!0,t.CSSAIsRunning=!1,n.off(jQuery.CSS.transitionEnd+"."+t.id),clearTimeout(t.timeout),n.css(jQuery.CSS.sfx+"transition",""),"function"==typeof d&&d.apply(t),"function"==typeof t.CSSqueue&&(t.CSSqueue(),t.CSSqueue=null)}var t=this,n=jQuery(this);t.id=t.id||"CSSA_"+(new Date).getTime();var a=a||{type:"noEvent"};if(t.CSSAIsRunning&&t.eventType==a.type&&!jQuery.mbBrowser.msie&&jQuery.mbBrowser.version<=9)t.CSSqueue=function(){n.CSSAnimate(r,s,c,u,d)};else if(t.CSSqueue=null,t.eventType=a.type,0!==n.length&&r){if(r=jQuery.normalizeCss(r),t.CSSAIsRunning=!0,"function"==typeof s&&(d=s,s=jQuery.fx.speeds._default),"function"==typeof c&&(u=c,c=0),"string"==typeof c&&(d=c,c=0),"function"==typeof u&&(d=u,u="cubic-bezier(0.65,0.03,0.36,0.72)"),"string"==typeof s)for(var i in jQuery.fx.speeds){if(s==i){s=jQuery.fx.speeds[i];break}s=jQuery.fx.speeds._default}if(s=s||jQuery.fx.speeds._default,"string"==typeof d&&(u=d,d=null),jQuery.support.CSStransition){(l={default:"ease",in:"ease-in",out:"ease-out","in-out":"ease-in-out",snap:"cubic-bezier(0,1,.5,1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"})[u]&&(u=l[u]),n.off(jQuery.CSS.transitionEnd+"."+t.id);var l=jQuery.CSS.getProp(r),o={};jQuery.extend(o,r),o[jQuery.CSS.sfx+"transition-property"]=l,o[jQuery.CSS.sfx+"transition-duration"]=s+"ms",o[jQuery.CSS.sfx+"transition-delay"]=c+"ms",o[jQuery.CSS.sfx+"transition-timing-function"]=u,setTimeout(function(){n.one(jQuery.CSS.transitionEnd+"."+t.id,e),n.css(o)},1),t.timeout=setTimeout(function(){t.called||!d?(t.called=!1,t.CSSAIsRunning=!1):(n.css(jQuery.CSS.sfx+"transition",""),d.apply(t),t.CSSAIsRunning=!1,"function"==typeof t.CSSqueue&&(t.CSSqueue(),t.CSSqueue=null))},s+c+10)}else{for(l in r)"transform"===l&&delete r[l],"filter"===l&&delete r[l],"transform-origin"===l&&delete r[l],"auto"===r[l]&&delete r[l],"x"===l&&(a=r[l],i="left",r[i]=a,delete r[l]),"y"===l&&(a=r[l],i="top",r[i]=a,delete r[l]),"-ms-transform"!==l&&"-ms-filter"!==l||delete r[l];n.delay(c).animate(r,s,d)}}})}},jQuery.fn.CSSAnimate=jQuery.CSS.animate,jQuery.normalizeCss=jQuery.CSS.normalizeCss,jQuery.fn.css3=function(n){return this.each(function(){var e=jQuery(this),t=jQuery.normalizeCss(n);e.css(t)})},function(i){i.simpleSlider={defaults:{initialval:0,maxval:100,orientation:"h",readonly:!1,callback:!1},events:{start:i.browser.mobile?"touchstart":"mousedown",end:i.browser.mobile?"touchend":"mouseup",move:i.browser.mobile?"touchmove":"mousemove"},init:function(a){return this.each(function(){var t=this,n=i(t);n.addClass("simpleSlider"),t.opt={},i.extend(t.opt,i.simpleSlider.defaults,a),i.extend(t.opt,n.data());var e="h"===t.opt.orientation?"horizontal":"vertical",e=i("<div/>").addClass("level").addClass(e);n.prepend(e),t.level=e,n.css({cursor:"default"}),"auto"==t.opt.maxval&&(t.opt.maxval=i(t).outerWidth()),n.updateSliderVal(),t.opt.readonly||(n.on(i.simpleSlider.events.start,function(e){i.browser.mobile&&(e=e.changedTouches[0]),t.canSlide=!0,n.updateSliderVal(e),"h"===t.opt.orientation?n.css({cursor:"col-resize"}):n.css({cursor:"row-resize"}),t.lastVal=t.val,i.browser.mobile||(e.preventDefault(),e.stopPropagation())}),i(document).on(i.simpleSlider.events.move,function(e){i.browser.mobile&&(e=e.changedTouches[0]),t.canSlide&&(i(document).css({cursor:"default"}),n.updateSliderVal(e),i.browser.mobile||(e.preventDefault(),e.stopPropagation()))}).on(i.simpleSlider.events.end,function(){i(document).css({cursor:"auto"}),t.canSlide=!1,n.css({cursor:"auto"})}))})},updateSliderVal:function(e){var t,n,a=this.get(0);a.opt&&(a.opt.initialval="number"==typeof a.opt.initialval?a.opt.initialval:a.opt.initialval(a),t=i(a).outerWidth(),n=i(a).outerHeight(),a.x="object"==typeof e?e.clientX+document.body.scrollLeft-this.offset().left:"number"==typeof e?e*t/a.opt.maxval:a.opt.initialval*t/a.opt.maxval,a.y="object"==typeof e?e.clientY+document.body.scrollTop-this.offset().top:"number"==typeof e?(a.opt.maxval-a.opt.initialval-e)*n/a.opt.maxval:a.opt.initialval*n/a.opt.maxval,a.y=this.outerHeight()-a.y,a.scaleX=a.x*a.opt.maxval/t,a.scaleY=a.y*a.opt.maxval/n,a.outOfRangeX=a.scaleX>a.opt.maxval?a.scaleX-a.opt.maxval:a.scaleX<0?a.scaleX:0,a.outOfRangeY=a.scaleY>a.opt.maxval?a.scaleY-a.opt.maxval:a.scaleY<0?a.scaleY:0,a.outOfRange="h"===a.opt.orientation?a.outOfRangeX:a.outOfRangeY,a.value=void 0!==e?"h"===a.opt.orientation?a.x>=this.outerWidth()?a.opt.maxval:a.x<=0?0:a.scaleX:a.y>=this.outerHeight()?a.opt.maxval:a.y<=0?0:a.scaleY:"h"===a.opt.orientation?a.scaleX:a.scaleY,"h"===a.opt.orientation?a.level.width(Math.floor(100*a.x/t)+"%"):a.level.height(Math.floor(100*a.y/n)),a.lastVal===a.value&&("h"===a.opt.orientation&&(a.x>=this.outerWidth()||a.x<=0)||"h"!==a.opt.orientation&&(a.y>=this.outerHeight()||a.y<=0))||("function"==typeof a.opt.callback&&a.opt.callback(a),a.lastVal=a.value))}},i.fn.simpleSlider=i.simpleSlider.init,i.fn.updateSliderVal=i.simpleSlider.updateSliderVal}(jQuery),function(t){t.mbCookie={set:function(e,t,n,a){"object"==typeof t&&(t=JSON.stringify(t)),a=a?"; domain="+a:"";var i=new Date,l="";0<n&&(i.setTime(i.getTime()+864e5*n),l="; expires="+i.toGMTString()),document.cookie=e+"="+t+l+"; path=/"+a},get:function(t){t+="=";for(var e=document.cookie.split(";"),n=0;n<e.length;n++){for(var a=e[n];" "==a.charAt(0);)a=a.substring(1,a.length);if(0==a.indexOf(t))try{return JSON.parse(a.substring(t.length,a.length))}catch(e){return a.substring(t.length,a.length)}}return null},remove:function(e){t.mbCookie.set(e,"",-1)}},t.mbStorage={set:function(e,t){"object"==typeof t&&(t=JSON.stringify(t)),localStorage.setItem(e,t)},get:function(t){if(!localStorage[t])return null;try{return JSON.parse(localStorage[t])}catch(e){return localStorage[t]}},remove:function(e){e?localStorage.removeItem(e):localStorage.clear()}}}(jQuery);var LeaderLine=function(){"use strict";var $,M,k,C,z,l,t,s,u,c,n,a,i,o,r,e,v,g,d,p,h,S,b,O="leader-line",_=1,x=2,E=3,A=4,I={top:_,right:x,bottom:E,left:A},V=1,N=2,L=3,T=4,B=5,j={straight:V,arc:N,fluid:L,magnet:T,grid:B},U="behind",f=O+"-defs",m='<svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="leader-line-defs"><style><![CDATA[.leader-line{position:absolute;overflow:visible!important;pointer-events:none!important;font-size:16px}#leader-line-defs{width:0;height:0;position:absolute;left:0;top:0}.leader-line-line-path{fill:none}.leader-line-mask-bg-rect{fill:#fff}.leader-line-caps-mask-anchor,.leader-line-caps-mask-marker-shape{fill:#000}.leader-line-caps-mask-anchor{stroke:#000}.leader-line-caps-mask-line,.leader-line-plugs-face{stroke:transparent}.leader-line-line-mask-shape{stroke:#fff}.leader-line-line-outline-mask-shape{stroke:#000}.leader-line-plug-mask-shape{fill:#fff;stroke:#000}.leader-line-plug-outline-mask-shape{fill:#000;stroke:#fff}.leader-line-areaAnchor{position:absolute;overflow:visible!important}]]></style><defs><circle id="leader-line-disc" cx="0" cy="0" r="5"/><rect id="leader-line-square" x="-5" y="-5" width="10" height="10"/><polygon id="leader-line-arrow1" points="-8,-8 8,0 -8,8 -5,0"/><polygon id="leader-line-arrow2" points="-4,-8 4,0 -4,8 -7,5 -2,0 -7,-5"/><polygon id="leader-line-arrow3" points="-4,-5 8,0 -4,5"/><g id="leader-line-hand"><path style="fill: #fcfcfc" d="M9.19 11.14h4.75c1.38 0 2.49-1.11 2.49-2.49 0-.51-.15-.98-.41-1.37h1.3c1.38 0 2.49-1.11 2.49-2.49s-1.11-2.53-2.49-2.53h1.02c1.38 0 2.49-1.11 2.49-2.49s-1.11-2.49-2.49-2.49h14.96c1.37 0 2.49-1.11 2.49-2.49s-1.11-2.49-2.49-2.49H16.58C16-9.86 14.28-11.14 9.7-11.14c-4.79 0-6.55 3.42-7.87 4.73H-2.14v13.23h3.68C3.29 9.97 5.47 11.14 9.19 11.14L9.19 11.14Z"/><path style="fill: black" d="M13.95 12c1.85 0 3.35-1.5 3.35-3.35 0-.17-.02-.34-.04-.51h.07c1.85 0 3.35-1.5 3.35-3.35 0-.79-.27-1.51-.72-2.08 1.03-.57 1.74-1.67 1.74-2.93 0-.59-.16-1.15-.43-1.63h12.04c1.85 0 3.35-1.5 3.35-3.35 0-1.85-1.5-3.35-3.35-3.35H17.2C16.26-10.93 13.91-12 9.7-12 5.36-12 3.22-9.4 1.94-7.84c0 0-.29.33-.5.57-.63 0-3.58 0-3.58 0C-2.61-7.27-3-6.88-3-6.41v13.23c0 .47.39.86.86.86 0 0 2.48 0 3.2 0C2.9 10.73 5.29 12 9.19 12L13.95 12ZM9.19 10.28c-3.46 0-5.33-1.05-6.9-3.87-.15-.27-.44-.44-.75-.44 0 0-1.81 0-2.82 0V-5.55c1.06 0 3.11 0 3.11 0 .25 0 .44-.06.61-.25l.83-.95c1.23-1.49 2.91-3.53 6.43-3.53 3.45 0 4.9.74 5.57 1.72h-4.3c-.48 0-.86.38-.86.86s.39.86.86.86h22.34c.9 0 1.63.73 1.63 1.63 0 .9-.73 1.63-1.63 1.63H15.83c-.48 0-.86.38-.86.86 0 .47.39.86.86.86h2.52c.9 0 1.63.73 1.63 1.63s-.73 1.63-1.63 1.63h-3.12c-.48 0-.86.38-.86.86 0 .47.39.86.86.86h2.11c.88 0 1.63.76 1.63 1.67 0 .9-.73 1.63-1.63 1.63h-3.2c-.48 0-.86.39-.86.86 0 .47.39.86.86.86h1.36c.05.16.09.34.09.51 0 .9-.73 1.63-1.63 1.63C13.95 10.28 9.19 10.28 9.19 10.28Z"/></g><g id="leader-line-crosshair"><path d="M0-78.97c-43.54 0-78.97 35.43-78.97 78.97 0 43.54 35.43 78.97 78.97 78.97s78.97-35.43 78.97-78.97C78.97-43.54 43.55-78.97 0-78.97ZM76.51-1.21h-9.91v-9.11h-2.43v9.11h-11.45c-.64-28.12-23.38-50.86-51.5-51.5V-64.17h9.11V-66.6h-9.11v-9.91C42.46-75.86 75.86-42.45 76.51-1.21ZM-1.21-30.76h-9.11v2.43h9.11V-4.2c-1.44.42-2.57 1.54-2.98 2.98H-28.33v-9.11h-2.43v9.11H-50.29C-49.65-28-27.99-49.65-1.21-50.29V-30.76ZM-30.76 1.21v9.11h2.43v-9.11H-4.2c.42 1.44 1.54 2.57 2.98 2.98v24.13h-9.11v2.43h9.11v19.53C-27.99 49.65-49.65 28-50.29 1.21H-30.76ZM1.22 30.75h9.11v-2.43h-9.11V4.2c1.44-.42 2.56-1.54 2.98-2.98h24.13v9.11h2.43v-9.11h19.53C49.65 28 28 49.65 1.22 50.29V30.75ZM30.76-1.21v-9.11h-2.43v9.11H4.2c-.42-1.44-1.54-2.56-2.98-2.98V-28.33h9.11v-2.43h-9.11V-50.29C28-49.65 49.65-28 50.29-1.21H30.76ZM-1.21-76.51v9.91h-9.11v2.43h9.11v11.45c-28.12.64-50.86 23.38-51.5 51.5H-64.17v-9.11H-66.6v9.11h-9.91C-75.86-42.45-42.45-75.86-1.21-76.51ZM-76.51 1.21h9.91v9.11h2.43v-9.11h11.45c.64 28.12 23.38 50.86 51.5 51.5v11.45h-9.11v2.43h9.11v9.91C-42.45 75.86-75.86 42.45-76.51 1.21ZM1.22 76.51v-9.91h9.11v-2.43h-9.11v-11.45c28.12-.64 50.86-23.38 51.5-51.5h11.45v9.11h2.43v-9.11h9.91C75.86 42.45 42.45 75.86 1.22 76.51Z"/><path d="M0 83.58-7.1 96 7.1 96Z"/><path d="M0-83.58 7.1-96-7.1-96"/><path d="M83.58 0 96 7.1 96-7.1Z"/><path d="M-83.58 0-96-7.1-96 7.1Z"/></g></defs></svg>',Y={disc:{elmId:"leader-line-disc",noRotate:!0,bBox:{left:-5,top:-5,width:10,height:10,right:5,bottom:5},widthR:2.5,heightR:2.5,bCircle:5,sideLen:5,backLen:5,overhead:0,outlineBase:1,outlineMax:4},square:{elmId:"leader-line-square",noRotate:!0,bBox:{left:-5,top:-5,width:10,height:10,right:5,bottom:5},widthR:2.5,heightR:2.5,bCircle:5,sideLen:5,backLen:5,overhead:0,outlineBase:1,outlineMax:4},arrow1:{elmId:"leader-line-arrow1",bBox:{left:-8,top:-8,width:16,height:16,right:8,bottom:8},widthR:4,heightR:4,bCircle:8,sideLen:8,backLen:8,overhead:8,outlineBase:2,outlineMax:1.5},arrow2:{elmId:"leader-line-arrow2",bBox:{left:-7,top:-8,width:11,height:16,right:4,bottom:8},widthR:2.75,heightR:4,bCircle:8,sideLen:8,backLen:7,overhead:4,outlineBase:1,outlineMax:1.75},arrow3:{elmId:"leader-line-arrow3",bBox:{left:-4,top:-5,width:12,height:10,right:8,bottom:5},widthR:3,heightR:2.5,bCircle:8,sideLen:5,backLen:4,overhead:8,outlineBase:1,outlineMax:2.5},hand:{elmId:"leader-line-hand",bBox:{left:-3,top:-12,width:40,height:24,right:37,bottom:12},widthR:10,heightR:6,bCircle:37,sideLen:12,backLen:3,overhead:37},crosshair:{elmId:"leader-line-crosshair",noRotate:!0,bBox:{left:-96,top:-96,width:192,height:192,right:96,bottom:96},widthR:48,heightR:48,bCircle:96,sideLen:96,backLen:96,overhead:0}},F={behind:U,disc:"disc",square:"square",arrow1:"arrow1",arrow2:"arrow2",arrow3:"arrow3",hand:"hand",crosshair:"crosshair"},X={disc:"disc",square:"square",arrow1:"arrow1",arrow2:"arrow2",arrow3:"arrow3",hand:"hand",crosshair:"crosshair"},P=[_,x,E,A],D="auto",q={x:"left",y:"top",width:"width",height:"height"},Q=80,W=4,R=5,H=120,G=8,K=3.75,Z=10,J=30,ee=.5522847,te=.25*Math.PI,y=/^\s*(\-?[\d\.]+)\s*(\%)?\s*$/,ne="http://www.w3.org/2000/svg",w="-ms-scroll-limit"in document.documentElement.style&&"-ms-ime-align"in document.documentElement.style&&!window.navigator.msPointerEnabled,ae=!w&&!!document.uniqueID,ie="MozAppearance"in document.documentElement.style,le=!(w||ie||!window.chrome||!window.CSS),oe=!w&&!ae&&!ie&&!le&&!window.chrome&&"WebkitAppearance"in document.documentElement.style,re=ae||w?.2:.1,se={path:L,lineColor:"coral",lineSize:4,plugSE:[U,"arrow1"],plugSizeSE:[1,1],lineOutlineEnabled:!1,lineOutlineColor:"indianred",lineOutlineSize:.25,plugOutlineEnabledSE:[!1,!1],plugOutlineSizeSE:[1,1]},ce=(n={}.toString,a={}.hasOwnProperty.toString,i=a.call(Object),function(e){return e&&"[object Object]"===n.call(e)&&(!(e=Object.getPrototypeOf(e))||(e=e.hasOwnProperty("constructor")&&e.constructor)&&"function"==typeof e&&a.call(e)===i)}),ue=Number.isFinite||function(e){return"number"==typeof e&&window.isFinite(e)},de=(v={ease:[.25,.1,.25,1],linear:[0,0,1,1],"ease-in":[.42,0,1,1],"ease-out":[0,0,.58,1],"ease-in-out":[.42,0,.58,1]},g=1e3/60/2,d=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||function(e){setTimeout(e,g)},p=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.msCancelAnimationFrame||function(e){clearTimeout(e)},h=Number.isFinite||function(e){return"number"==typeof e&&window.isFinite(e)},S=[],b=0,{add:function(n,e,t,a,i,l,o){var r,s,c,u,d,p,h,f,m=++b;function y(e,t){return{value:n(t),timeRatio:e,outputRatio:t}}if("string"==typeof i&&(i=v[i]),n=n||function(){},t<g)r=[y(0,0),y(1,1)];else{if(s=g/t,r=[y(0,0)],0===i[0]&&0===i[1]&&1===i[2]&&1===i[3])for(u=s;u<=1;u+=s)r.push(y(u,u));else for(d=c=(u=s)/10;d<=1;d+=c)p=(f=d*d)*d,f=3*(h=1-d)*f,u<=(p={x:(h=h*h*3*d)*i[0]+f*i[2]+p,y:h*i[1]+f*i[3]+p}).x&&(r.push(y(p.x,p.y)),u+=s);r.push(y(1,1))}return S.push(l={animId:m,frameCallback:e,duration:t,count:a,frames:r,reverse:!!l}),!1!==o&&_e(l,o),m},remove:function(n){var a;S.some(function(e,t){return e.animId===n&&(a=t,!(e.framesStart=null))})&&S.splice(a,1)},start:function(t,n,a){S.some(function(e){return e.animId===t&&(e.reverse=!!n,_e(e,a),!0)})},stop:function(t,n){var a;return S.some(function(e){return e.animId===t&&(n?null!=e.lastFrame&&(a=e.frames[e.lastFrame].timeRatio):(a=(Date.now()-e.framesStart)/e.duration,(a=e.reverse?1-a:a)<0?a=0:1<a&&(a=1)),!(e.framesStart=null))}),a},validTiming:function(t){return"string"==typeof t?v[t]:Array.isArray(t)&&[0,1,2,3].every(function(e){return h(t[e])&&0<=t[e]&&t[e]<=1})?[t[0],t[1],t[2],t[3]]:null}}),pe=function(e){e.SVGPathElement.prototype.getPathData&&e.SVGPathElement.prototype.setPathData||function(){function i(e){this._string=e,this._currentIndex=0,this._endIndex=this._string.length,this._prevCommand=null,this._skipOptionalSpaces()}var a={Z:"Z",M:"M",L:"L",C:"C",Q:"Q",A:"A",H:"H",V:"V",S:"S",T:"T",z:"Z",m:"m",l:"l",c:"c",q:"q",a:"a",h:"h",v:"v",s:"s",t:"t"},l=-1!==e.navigator.userAgent.indexOf("MSIE ");i.prototype={parseSegment:function(){var e=this._string[this._currentIndex],t=a[e]||null;if(null===t){if(null===this._prevCommand)return null;if(null===(t=("+"===e||"-"===e||"."===e||"0"<=e&&e<="9")&&"Z"!==this._prevCommand?"M"===this._prevCommand?"L":"m"===this._prevCommand?"l":this._prevCommand:null))return null}else this._currentIndex+=1;var n=null,e=(this._prevCommand=t).toUpperCase();return"H"===e||"V"===e?n=[this._parseNumber()]:"M"===e||"L"===e||"T"===e?n=[this._parseNumber(),this._parseNumber()]:"S"===e||"Q"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:"C"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:"A"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseArcFlag(),this._parseArcFlag(),this._parseNumber(),this._parseNumber()]:"Z"===e&&(this._skipOptionalSpaces(),n=[]),null===n||0<=n.indexOf(null)?null:{type:t,values:n}},hasMoreData:function(){return this._currentIndex<this._endIndex},peekSegmentType:function(){var e=this._string[this._currentIndex];return a[e]||null},initialCommandIsMoveTo:function(){if(!this.hasMoreData())return!0;var e=this.peekSegmentType();return"M"===e||"m"===e},_isCurrentSpace:function(){var e=this._string[this._currentIndex];return e<=" "&&(" "===e||"\n"===e||"\t"===e||"\r"===e||"\f"===e)},_skipOptionalSpaces:function(){for(;this._currentIndex<this._endIndex&&this._isCurrentSpace();)this._currentIndex+=1;return this._currentIndex<this._endIndex},_skipOptionalSpacesOrDelimiter:function(){return!(this._currentIndex<this._endIndex&&!this._isCurrentSpace()&&","!==this._string[this._currentIndex])&&(this._skipOptionalSpaces()&&this._currentIndex<this._endIndex&&","===this._string[this._currentIndex]&&(this._currentIndex+=1,this._skipOptionalSpaces()),this._currentIndex<this._endIndex)},_parseNumber:function(){var e=0,t=0,n=1,a=0,i=1,l=1,o=this._currentIndex;if(this._skipOptionalSpaces(),this._currentIndex<this._endIndex&&"+"===this._string[this._currentIndex]?this._currentIndex+=1:this._currentIndex<this._endIndex&&"-"===this._string[this._currentIndex]&&(this._currentIndex+=1,i=-1),this._currentIndex===this._endIndex||(this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])&&"."!==this._string[this._currentIndex])return null;for(var r=this._currentIndex;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)this._currentIndex+=1;if(this._currentIndex!==r)for(var s=this._currentIndex-1,c=1;r<=s;)t+=c*(this._string[s]-"0"),--s,c*=10;if(this._currentIndex<this._endIndex&&"."===this._string[this._currentIndex]){if(this._currentIndex+=1,this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])return null;for(;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)n*=10,a+=(this._string.charAt(this._currentIndex)-"0")/n,this._currentIndex+=1}if(this._currentIndex!==o&&this._currentIndex+1<this._endIndex&&("e"===this._string[this._currentIndex]||"E"===this._string[this._currentIndex])&&"x"!==this._string[this._currentIndex+1]&&"m"!==this._string[this._currentIndex+1]){if(this._currentIndex+=1,"+"===this._string[this._currentIndex]?this._currentIndex+=1:"-"===this._string[this._currentIndex]&&(this._currentIndex+=1,l=-1),this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])return null;for(;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)e*=10,e+=this._string[this._currentIndex]-"0",this._currentIndex+=1}var u=t+a;return u*=i,e&&(u*=Math.pow(10,l*e)),o===this._currentIndex?null:(this._skipOptionalSpacesOrDelimiter(),u)},_parseArcFlag:function(){if(this._currentIndex>=this._endIndex)return null;var e=null,t=this._string[this._currentIndex];if(this._currentIndex+=1,"0"===t)e=0;else{if("1"!==t)return null;e=1}return this._skipOptionalSpacesOrDelimiter(),e}};function n(e){if(!e||0===e.length)return[];var t=new i(e),n=[];if(t.initialCommandIsMoveTo())for(;t.hasMoreData();){var a=t.parseSegment();if(null===a)break;n.push(a)}return n}function o(e){return e.map(function(e){return{type:e.type,values:Array.prototype.slice.call(e.values)}})}function r(e){var c=[],u=null,d=null,p=null,h=null,f=null,m=null,y=null;return e.forEach(function(e){var t,n,a,i,l,o,r,s;"M"===e.type?(n=e.values[0],a=e.values[1],c.push({type:"M",values:[n,a]}),h=m=n,f=y=a):"C"===e.type?(r=e.values[0],s=e.values[1],t=e.values[2],i=e.values[3],n=e.values[4],a=e.values[5],c.push({type:"C",values:[r,s,t,i,n,a]}),d=t,p=i,h=n,f=a):"L"===e.type?(n=e.values[0],a=e.values[1],c.push({type:"L",values:[n,a]}),h=n,f=a):"H"===e.type?(n=e.values[0],c.push({type:"L",values:[n,f]}),h=n):"V"===e.type?(a=e.values[0],c.push({type:"L",values:[h,a]}),f=a):"S"===e.type?(t=e.values[0],i=e.values[1],n=e.values[2],a=e.values[3],o="C"===u||"S"===u?(l=h+(h-d),f+(f-p)):(l=h,f),c.push({type:"C",values:[l,o,t,i,n,a]}),d=t,p=i,h=n,f=a):"T"===e.type?(n=e.values[0],a=e.values[1],s="Q"===u||"T"===u?(r=h+(h-d),f+(f-p)):(r=h,f),c.push({type:"C",values:[l=h+2*(r-h)/3,o=f+2*(s-f)/3,n+2*(r-n)/3,a+2*(s-a)/3,n,a]}),d=r,p=s,h=n,f=a):"Q"===e.type?(r=e.values[0],s=e.values[1],n=e.values[2],a=e.values[3],c.push({type:"C",values:[l=h+2*(r-h)/3,o=f+2*(s-f)/3,n+2*(r-n)/3,a+2*(s-a)/3,n,a]}),d=r,p=s,h=n,f=a):"A"===e.type?(i=e.values[0],l=e.values[1],o=e.values[2],r=e.values[3],s=e.values[4],n=e.values[5],a=e.values[6],0===i||0===l?(c.push({type:"C",values:[h,f,n,a,n,a]}),h=n,f=a):h===n&&f===a||x(h,f,n,a,i,l,o,r,s).forEach(function(e){c.push({type:"C",values:e}),h=n,f=a})):"Z"===e.type&&(c.push(e),h=m,f=y),u=e.type}),c}var s=e.SVGPathElement.prototype.setAttribute,c=e.SVGPathElement.prototype.removeAttribute,h=e.Symbol?e.Symbol():"__cachedPathData",f=e.Symbol?e.Symbol():"__cachedNormalizedPathData",x=function(e,t,n,a,i,l,o,r,s,c){function u(e,t,n){return{x:e*Math.cos(n)-t*Math.sin(n),y:e*Math.sin(n)+t*Math.cos(n)}}var d=Math.PI*o/180,p=[];c?(S=c[0],b=c[1],v=c[2],g=c[3]):(e=(y=u(e,t,-d)).x,t=y.y,1<(y=(m=(e-(n=(f=u(n,a,-d)).x))/2)*m/(i*i)+(h=(t-(a=f.y))/2)*h/(l*l))&&(i*=y=Math.sqrt(y),l*=y),f=i*i,y=l*l,v=(f=(r===s?-1:1)*Math.sqrt(Math.abs((f*y-f*h*h-y*m*m)/(f*h*h+y*m*m))))*i*h/l+(e+n)/2,g=f*-l*m/i+(t+a)/2,S=Math.asin(parseFloat(((t-g)/l).toFixed(9))),b=Math.asin(parseFloat(((a-g)/l).toFixed(9))),e<v&&(S=Math.PI-S),n<v&&(b=Math.PI-b),S<0&&(S=2*Math.PI+S),b<0&&(b=2*Math.PI+b),s&&b<S&&(S-=2*Math.PI),!s&&S<b&&(b-=2*Math.PI));var h,f,m,y=b-S;Math.abs(y)>120*Math.PI/180&&(h=b,f=n,m=a,b=s&&S<b?S+120*Math.PI/180*1:S+120*Math.PI/180*-1,n=v+i*Math.cos(b),a=g+l*Math.sin(b),p=x(n,a,f,m,i,l,o,0,s,[b,h,v,g]));var y=b-S,v=Math.cos(S),g=Math.sin(S),S=Math.cos(b),b=Math.sin(b),y=Math.tan(y/4),i=4/3*i*y,l=4/3*l*y,y=[e,t],v=[e+i*g,t-l*v],S=[n+i*b,a-l*S],a=[n,a];if(v[0]=2*y[0]-v[0],v[1]=2*y[1]-v[1],c)return[v,S,a].concat(p);var p=[v,S,a].concat(p).join().split(","),w=[],_=[];return p.forEach(function(e,t){t%2?_.push(u(p[t-1],p[t],d).y):_.push(u(p[t],p[t+1],d).x),6===_.length&&(w.push(_),_=[])}),w};e.SVGPathElement.prototype.setAttribute=function(e,t){"d"===e&&(this[h]=null,this[f]=null),s.call(this,e,t)},e.SVGPathElement.prototype.removeAttribute=function(e,t){"d"===e&&(this[h]=null,this[f]=null),c.call(this,e)},e.SVGPathElement.prototype.getPathData=function(e){if(e&&e.normalize){if(this[f])return o(this[f]);this[h]?t=o(this[h]):(t=n(this.getAttribute("d")||""),this[h]=o(t));e=r((s=[],p=d=u=c=null,t.forEach(function(e){var t,n,a,i,l,o,r=e.type;"M"===r?(l=e.values[0],o=e.values[1],s.push({type:"M",values:[l,o]}),c=d=l,u=p=o):"m"===r?(l=c+e.values[0],o=u+e.values[1],s.push({type:"M",values:[l,o]}),c=d=l,u=p=o):"L"===r?(l=e.values[0],o=e.values[1],s.push({type:"L",values:[l,o]}),c=l,u=o):"l"===r?(l=c+e.values[0],o=u+e.values[1],s.push({type:"L",values:[l,o]}),c=l,u=o):"C"===r?(t=e.values[0],n=e.values[1],a=e.values[2],i=e.values[3],l=e.values[4],o=e.values[5],s.push({type:"C",values:[t,n,a,i,l,o]}),c=l,u=o):"c"===r?(t=c+e.values[0],n=u+e.values[1],a=c+e.values[2],i=u+e.values[3],l=c+e.values[4],o=u+e.values[5],s.push({type:"C",values:[t,n,a,i,l,o]}),c=l,u=o):"Q"===r?(t=e.values[0],n=e.values[1],l=e.values[2],o=e.values[3],s.push({type:"Q",values:[t,n,l,o]}),c=l,u=o):"q"===r?(t=c+e.values[0],n=u+e.values[1],l=c+e.values[2],o=u+e.values[3],s.push({type:"Q",values:[t,n,l,o]}),c=l,u=o):"A"===r?(l=e.values[5],o=e.values[6],s.push({type:"A",values:[e.values[0],e.values[1],e.values[2],e.values[3],e.values[4],l,o]}),c=l,u=o):"a"===r?(l=c+e.values[5],o=u+e.values[6],s.push({type:"A",values:[e.values[0],e.values[1],e.values[2],e.values[3],e.values[4],l,o]}),c=l,u=o):"H"===r?(l=e.values[0],s.push({type:"H",values:[l]}),c=l):"h"===r?(l=c+e.values[0],s.push({type:"H",values:[l]}),c=l):"V"===r?(o=e.values[0],s.push({type:"V",values:[o]}),u=o):"v"===r?(o=u+e.values[0],s.push({type:"V",values:[o]}),u=o):"S"===r?(a=e.values[0],i=e.values[1],l=e.values[2],o=e.values[3],s.push({type:"S",values:[a,i,l,o]}),c=l,u=o):"s"===r?(a=c+e.values[0],i=u+e.values[1],l=c+e.values[2],o=u+e.values[3],s.push({type:"S",values:[a,i,l,o]}),c=l,u=o):"T"===r?(l=e.values[0],o=e.values[1],s.push({type:"T",values:[l,o]}),c=l,u=o):"t"===r?(l=c+e.values[0],o=u+e.values[1],s.push({type:"T",values:[l,o]}),c=l,u=o):"Z"!==r&&"z"!==r||(s.push({type:"Z",values:[]}),c=d,u=p)}),s));return this[f]=o(e),e}if(this[h])return o(this[h]);var s,c,u,d,p,t=n(this.getAttribute("d")||"");return this[h]=o(t),t},e.SVGPathElement.prototype.setPathData=function(e){if(0===e.length)l?this.setAttribute("d",""):this.removeAttribute("d");else{for(var t="",n=0,a=e.length;n<a;n+=1){var i=e[n];0<n&&(t+=" "),t+=i.type,i.values&&0<i.values.length&&(t+=" "+i.values.join(" "))}this.setAttribute("d",t)}},e.SVGRectElement.prototype.getPathData=function(e){var t=this.x.baseVal.value,n=this.y.baseVal.value,a=this.width.baseVal.value,i=this.height.baseVal.value,l=(this.hasAttribute("rx")?this.rx:this.ry).baseVal.value,o=(this.hasAttribute("ry")?this.ry:this.rx).baseVal.value,n=(n=[{type:"M",values:[t+(l=a/2<l?a/2:l),n]},{type:"H",values:[t+a-l]},{type:"A",values:[l,o=i/2<o?i/2:o,0,0,1,t+a,n+o]},{type:"V",values:[n+i-o]},{type:"A",values:[l,o,0,0,1,t+a-l,n+i]},{type:"H",values:[t+l]},{type:"A",values:[l,o,0,0,1,t,n+i-o]},{type:"V",values:[n+o]},{type:"A",values:[l,o,0,0,1,t+l,n]},{type:"Z",values:[]}]).filter(function(e){return"A"!==e.type||0!==e.values[0]&&0!==e.values[1]});return n=e&&!0===e.normalize?r(n):n},e.SVGCircleElement.prototype.getPathData=function(e){var t=this.cx.baseVal.value,n=this.cy.baseVal.value,a=this.r.baseVal.value,n=[{type:"M",values:[t+a,n]},{type:"A",values:[a,a,0,0,1,t,n+a]},{type:"A",values:[a,a,0,0,1,t-a,n]},{type:"A",values:[a,a,0,0,1,t,n-a]},{type:"A",values:[a,a,0,0,1,t+a,n]},{type:"Z",values:[]}];return n=e&&!0===e.normalize?r(n):n},e.SVGEllipseElement.prototype.getPathData=function(e){var t=this.cx.baseVal.value,n=this.cy.baseVal.value,a=this.rx.baseVal.value,i=this.ry.baseVal.value,n=[{type:"M",values:[t+a,n]},{type:"A",values:[a,i,0,0,1,t,n+i]},{type:"A",values:[a,i,0,0,1,t-a,n]},{type:"A",values:[a,i,0,0,1,t,n-i]},{type:"A",values:[a,i,0,0,1,t+a,n]},{type:"Z",values:[]}];return n=e&&!0===e.normalize?r(n):n},e.SVGLineElement.prototype.getPathData=function(){return[{type:"M",values:[this.x1.baseVal.value,this.y1.baseVal.value]},{type:"L",values:[this.x2.baseVal.value,this.y2.baseVal.value]}]},e.SVGPolylineElement.prototype.getPathData=function(){for(var e=[],t=0;t<this.points.numberOfItems;t+=1){var n=this.points.getItem(t);e.push({type:0===t?"M":"L",values:[n.x,n.y]})}return e},e.SVGPolygonElement.prototype.getPathData=function(){for(var e=[],t=0;t<this.points.numberOfItems;t+=1){var n=this.points.getItem(t);e.push({type:0===t?"M":"L",values:[n.x,n.y]})}return e.push({type:"Z",values:[]}),e}}()},w=(r={},be.m=o=[function(e,t,n){n.r(t);var a=500,i=[],l=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||function(e){return setTimeout(e,1e3/60)},o=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.msCancelAnimationFrame||function(e){return clearTimeout(e)},r=void 0,s=Date.now();function c(){var t=void 0,e=void 0;r&&(o.call(window,r),r=null),i.forEach(function(e){e.event&&(e.listener(e.event),e.event=null,t=!0)}),t?(s=Date.now(),e=!0):Date.now()-s<a&&(e=!0),e&&(r=l.call(window,c))}function u(n){var a=-1;return i.some(function(e,t){return e.listener===n&&(a=t,!0)}),a}t.default={add:function(e){var t=void 0;return-1===u(e)?(i.push(t={listener:e}),function(e){t.event=e,r||c()}):null},remove:function(e){-1<(e=u(e))&&(i.splice(e,1),!i.length&&r&&(o.call(window,r),r=null))}}}],be.c=r,be.d=function(e,t,n){be.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:n})},be.r=function(e){Object.defineProperty(e,"__esModule",{value:!0})},be.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return be.d(t,"a",t),t},be.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},be.p="",be(be.s=0).default),he={line_altColor:{iniValue:!1},line_color:{},line_colorTra:{iniValue:!1},line_strokeWidth:{},plug_enabled:{iniValue:!1},plug_enabledSE:{hasSE:!0,iniValue:!1},plug_plugSE:{hasSE:!0,iniValue:U},plug_colorSE:{hasSE:!0},plug_colorTraSE:{hasSE:!0,iniValue:!1},plug_markerWidthSE:{hasSE:!0},plug_markerHeightSE:{hasSE:!0},lineOutline_enabled:{iniValue:!1},lineOutline_color:{},lineOutline_colorTra:{iniValue:!1},lineOutline_strokeWidth:{},lineOutline_inStrokeWidth:{},plugOutline_enabledSE:{hasSE:!0,iniValue:!1},plugOutline_plugSE:{hasSE:!0,iniValue:U},plugOutline_colorSE:{hasSE:!0},plugOutline_colorTraSE:{hasSE:!0,iniValue:!1},plugOutline_strokeWidthSE:{hasSE:!0},plugOutline_inStrokeWidthSE:{hasSE:!0},position_socketXYSE:{hasSE:!0,hasProps:!0},position_plugOverheadSE:{hasSE:!0},position_path:{},position_lineStrokeWidth:{},position_socketGravitySE:{hasSE:!0},path_pathData:{},path_edge:{hasProps:!0},viewBox_bBox:{hasProps:!0},viewBox_plugBCircleSE:{hasSE:!0},lineMask_enabled:{iniValue:!1},lineMask_outlineMode:{iniValue:!1},lineMask_x:{},lineMask_y:{},lineOutlineMask_x:{},lineOutlineMask_y:{},maskBGRect_x:{},maskBGRect_y:{},capsMaskAnchor_enabledSE:{hasSE:!0,iniValue:!1},capsMaskAnchor_pathDataSE:{hasSE:!0},capsMaskAnchor_strokeWidthSE:{hasSE:!0},capsMaskMarker_enabled:{iniValue:!1},capsMaskMarker_enabledSE:{hasSE:!0,iniValue:!1},capsMaskMarker_plugSE:{hasSE:!0,iniValue:U},capsMaskMarker_markerWidthSE:{hasSE:!0},capsMaskMarker_markerHeightSE:{hasSE:!0},caps_enabled:{iniValue:!1},attach_plugSideLenSE:{hasSE:!0},attach_plugBackLenSE:{hasSE:!0}},fe={show_on:{},show_effect:{},show_animOptions:{},show_animId:{},show_inAnim:{}},me=[],ye={},ve=0,ge={},Se=0;function be(e){if(r[e])return r[e].exports;var t=r[e]={i:e,l:!1,exports:{}};return o[e].call(t.exports,t,t.exports,be),t.l=!0,t.exports}function we(){var i=Date.now(),l=!1;e&&(p.call(window,e),e=null),S.forEach(function(e){var t,n,a;if(e.framesStart){if((t=i-e.framesStart)>=e.duration&&e.count&&e.loopsLeft<=1)return a=e.frames[e.lastFrame=e.reverse?0:e.frames.length-1],e.frameCallback(a.value,!0,a.timeRatio,a.outputRatio),void(e.framesStart=null);if(t>e.duration){if(n=Math.floor(t/e.duration),e.count){if(n>=e.loopsLeft)return a=e.frames[e.lastFrame=e.reverse?0:e.frames.length-1],e.frameCallback(a.value,!0,a.timeRatio,a.outputRatio),void(e.framesStart=null);e.loopsLeft-=n}e.framesStart+=e.duration*n,t=i-e.framesStart}e.reverse&&(t=e.duration-t),a=e.frames[e.lastFrame=Math.round(t/g)],!1!==e.frameCallback(a.value,!1,a.timeRatio,a.outputRatio)?l=!0:e.framesStart=null}}),l&&(e=d.call(window,we))}function _e(e,t){e.framesStart=Date.now(),null!=t&&(e.framesStart-=e.duration*(e.reverse?1-t:t)),e.loopsLeft=e.count,e.lastFrame=null,we()}function xe(t,n){var e,a;return typeof t!=typeof n||(e=ce(t)?"obj":Array.isArray(t)?"array":"")!=(ce(n)?"obj":Array.isArray(n)?"array":"")||("obj"===e?xe(a=Object.keys(t).sort(),Object.keys(n).sort())||a.some(function(e){return xe(t[e],n[e])}):"array"===e?t.length!==n.length||t.some(function(e,t){return xe(e,n[t])}):t!==n)}function Ee(n){return n&&(ce(n)?Object.keys(n).reduce(function(e,t){return e[t]=Ee(n[t]),e},{}):Array.isArray(n)?n.map(Ee):n)}function Me(e){var t,n,a,i=1,l=e=(e+"").trim();function o(e){var t=1,e=y.exec(e);return e&&(t=parseFloat(e[1]),e[2]?t=0<=t&&t<=100?t/100:1:(t<0||1<t)&&(t=1)),t}return(t=/^(rgba|hsla|hwb|gray|device\-cmyk)\s*\(([\s\S]+)\)$/i.exec(e))?(n=t[1].toLowerCase(),a=t[2].trim().split(/\s*,\s*/),"rgba"===n&&4===a.length?(i=o(a[3]),l="rgb("+a.slice(0,3).join(", ")+")"):"hsla"===n&&4===a.length?(i=o(a[3]),l="hsl("+a.slice(0,3).join(", ")+")"):"hwb"===n&&4===a.length?(i=o(a[3]),l="hwb("+a.slice(0,3).join(", ")+")"):"gray"===n&&2===a.length?(i=o(a[1]),l="gray("+a[0]+")"):"device-cmyk"===n&&5<=a.length&&(i=o(a[4]),l="device-cmyk("+a.slice(0,4).join(", ")+")")):(t=/^\#(?:([\da-f]{6})([\da-f]{2})|([\da-f]{3})([\da-f]))$/i.exec(e))?l=t[1]?(i=parseInt(t[2],16)/255,"#"+t[1]):(i=parseInt(t[4]+t[4],16)/255,"#"+t[3]):"transparent"===e.toLocaleLowerCase()&&(i=0),[i,l]}function ke(e){return!(!e||e.nodeType!==Node.ELEMENT_NODE||"function"!=typeof e.getBoundingClientRect)}function Ce(e,t){var n,a,i,l={};if(!(i=e.ownerDocument))return console.error("Cannot get document that contains the element."),null;if(e.compareDocumentPosition(i)&Node.DOCUMENT_POSITION_DISCONNECTED)return console.error("A disconnected element was passed."),null;for(a in n=e.getBoundingClientRect())l[a]=n[a];if(!t){if(!(i=i.defaultView))return console.error("Cannot get window that contains the element."),null;l.left+=i.pageXOffset,l.right+=i.pageXOffset,l.top+=i.pageYOffset,l.bottom+=i.pageYOffset}return l}function ze(e,t){var n,a=[],i=e;for(t=t||window;;){if(!(n=i.ownerDocument))return console.error("Cannot get document that contains the element."),null;if(!(n=n.defaultView))return console.error("Cannot get window that contains the element."),null;if(n===t)break;if(!(i=n.frameElement))return console.error("`baseWindow` was not found."),null;a.unshift(i)}return a}function Oe(e,t){var a=0,i=0;return(t=ze(e,t=t||window))?t.length?(t.forEach(function(e,t){var n=Ce(e,0<t);a+=n.left,i+=n.top,e=(t=e).ownerDocument.defaultView.getComputedStyle(t,""),n={left:t.clientLeft+parseFloat(e.paddingLeft),top:t.clientTop+parseFloat(e.paddingTop)},a+=n.left,i+=n.top}),(t=Ce(e,!0)).left+=a,t.right+=a,t.top+=i,t.bottom+=i,t):Ce(e):null}function Ae(e,t){var n=e.x-t.x,t=e.y-t.y;return Math.sqrt(n*n+t*t)}function Ie(e,t,n){var a=t.x-e.x,t=t.y-e.y;return{x:e.x+a*n,y:e.y+t*n,angle:Math.atan2(t,a)/(Math.PI/180)}}function Ve(e,t,n){e=Math.atan2(e.y-t.y,t.x-e.x);return{x:t.x+Math.cos(e)*n,y:t.y+Math.sin(e)*n*-1}}function Ne(e,t,n,a,i){var l=i*i,o=l*i,r=1-i,s=r*r,c=s*r,u=c*e.x+3*s*i*t.x+3*r*l*n.x+o*a.x,d=c*e.y+3*s*i*t.y+3*r*l*n.y+o*a.y,p=e.x+2*i*(t.x-e.x)+l*(n.x-2*t.x+e.x),c=e.y+2*i*(t.y-e.y)+l*(n.y-2*t.y+e.y),s=t.x+2*i*(n.x-t.x)+l*(a.x-2*n.x+t.x),o=t.y+2*i*(n.y-t.y)+l*(a.y-2*n.y+t.y),l=r*e.x+i*t.x,e=r*e.y+i*t.y,t=r*n.x+i*a.x,i=r*n.y+i*a.y,a=90-180*Math.atan2(p-s,c-o)/Math.PI;return{x:u,y:d,fromP2:{x:p,y:c},toP1:{x:s,y:o},fromP1:{x:l,y:e},toP2:{x:t,y:i},angle:a+=180<a?-180:180}}function Le(n,a,i,l,e){function o(e,t,n,a,i){return e*(e*(-3*t+9*n-9*a+3*i)+6*t-12*n+6*a)-3*t+3*n}var r,s,c=[.2491,.2491,.2335,.2335,.2032,.2032,.1601,.1601,.1069,.1069,.0472,.0472],u=0,d=(e=null==e||1<e?1:e<0?0:e)/2;return[-.1252,.1252,-.3678,.3678,-.5873,.5873,-.7699,.7699,-.9041,.9041,-.9816,.9816].forEach(function(e,t){r=o(s=d*e+d,n.x,a.x,i.x,l.x),s=o(s,n.y,a.y,i.y,l.y),s=r*r+s*s,u+=c[t]*Math.sqrt(s)}),d*u}function Te(e,t,n,a,i){for(var l,o,r=1-(o=.5);l=Le(e,t,n,a,r),!(Math.abs(l-i)<=.01);)r+=(l<i?1:-1)*(o/=2);return r}function Be(e,t){var n;return e.forEach(function(e){e=t?e.map(function(e){e={x:e.x,y:e.y};return t(e),e}):e;(n=n||[{type:"M",values:[e[0].x,e[0].y]}]).push(e.length?2===e.length?{type:"L",values:[e[1].x,e[1].y]}:{type:"C",values:[e[1].x,e[1].y,e[2].x,e[2].y,e[3].x,e[3].y]}:{type:"Z",values:[]})}),n}function je(e){var t=[],n=0;return e.forEach(function(e){e=(2===e.length?Ae:Le).apply(null,e);t.push(e),n+=e}),{segsLen:t,lenAll:n}}function Fe(e,a){return null==e||null==a||e.length!==a.length||e.some(function(e,t){var n=a[t];return e.type!==n.type||e.values.some(function(e,t){return e!==n.values[t]})})}function Pe(e,t,n){e.events[t]?e.events[t].indexOf(n)<0&&e.events[t].push(n):e.events[t]=[n]}function De(e,t,n){var a;e.events[t]&&-1<(a=e.events[t].indexOf(n))&&e.events[t].splice(a,1)}function Qe(e){t&&clearTimeout(t),me.push(e),t=setTimeout(function(){me.forEach(function(e){e()}),me=[]},0)}function We(e,t){e.reflowTargets.indexOf(t)<0&&e.reflowTargets.push(t)}function Re(e){e.reflowTargets.forEach(function(e){var n=e;setTimeout(function(){var e=n.parentNode,t=n.nextSibling;e.insertBefore(e.removeChild(n),t)},0)}),e.reflowTargets=[]}function He(e,t,n,a,i,l,o){var r;"auto-start-reverse"===n?("boolean"!=typeof s&&(t.setAttribute("orient","auto-start-reverse"),s=t.orientType.baseVal===SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN),s?t.setAttribute("orient",n):((r=i.createSVGTransform()).setRotate(180,0,0),l.transform.baseVal.appendItem(r),t.setAttribute("orient","auto"),r=!0)):(t.setAttribute("orient",n),!1===s&&l.transform.baseVal.clear()),t=t.viewBox.baseVal,r?(t.x=-a.right,t.y=-a.bottom):(t.x=a.left,t.y=a.top),t.width=a.width,t.height=a.height,ae&&We(e,o)}function Ge(e,t){return{prop:e?"markerEnd":"markerStart",orient:t?t.noRotate?"0":e?"auto":"auto-start-reverse":null}}function $e(n,a){Object.keys(a).forEach(function(e){var t=a[e];n[e]=null!=t.iniValue?t.hasSE?[t.iniValue,t.iniValue]:t.iniValue:t.hasSE?t.hasProps?[{},{}]:[]:t.hasProps?{}:null})}function Ue(t,e,n,a,i){return a!==e[n]&&(e[n]=a,i&&i.forEach(function(e){e(t,a,n)}),!0)}function Ye(e){function t(e,t){return e+parseFloat(t)}var n=e.document,a=e.getComputedStyle(n.documentElement,""),e=e.getComputedStyle(n.body,""),n={x:0,y:0};return"static"!==e.position?(n.x-=[a.marginLeft,a.borderLeftWidth,a.paddingLeft,e.marginLeft,e.borderLeftWidth].reduce(t,0),n.y-=[a.marginTop,a.borderTopWidth,a.paddingTop,e.marginTop,e.borderTopWidth].reduce(t,0)):"static"!==a.position&&(n.x-=[a.marginLeft,a.borderLeftWidth].reduce(t,0),n.y-=[a.marginTop,a.borderTopWidth].reduce(t,0)),n}function Xe(e){var t,n=e.document;n.getElementById(f)||(t=(new e.DOMParser).parseFromString(m,"image/svg+xml"),n.body.appendChild(t.documentElement),pe(e))}function qe(l){var g,p,S,e,n,a,i,h,o,r,s,t,c,u,d=l.options,f=l.curStats,m=l.aplStats,b=f.position_socketXYSE,y=!1;function v(e,t){e=t===_?{x:e.left+e.width/2,y:e.top}:t===x?{x:e.right,y:e.top+e.height/2}:t===E?{x:e.left+e.width/2,y:e.bottom}:{x:e.left,y:e.top+e.height/2};return e.socketId=t,e}function w(e){return{x:e.x,y:e.y}}if(f.position_path=d.path,f.position_lineStrokeWidth=f.line_strokeWidth,f.position_socketGravitySE=g=Ee(d.socketGravitySE),p=[0,1].map(function(e){var t=d.anchorSE[e],n=l.optionIsAttach.anchorSE[e],a=!1!==n?ge[t._id]:null,i=!1!==n&&a.conf.getStrokeWidth?a.conf.getStrokeWidth(a,l):0,t=!1!==n&&a.conf.getBBoxNest?a.conf.getBBoxNest(a,l,i):Oe(t,l.baseWindow);return f.capsMaskAnchor_pathDataSE[e]=!1!==n&&a.conf.getPathData?a.conf.getPathData(a,l,i):(n=null!=t.right?t.right:t.left+t.width,a=null!=t.bottom?t.bottom:t.top+t.height,[{type:"M",values:[t.left,t.top]},{type:"L",values:[n,t.top]},{type:"L",values:[n,a]},{type:"L",values:[t.left,a]},{type:"Z",values:[]}]),f.capsMaskAnchor_strokeWidthSE[e]=i,t}),i=-1,d.socketSE[0]&&d.socketSE[1]?(b[0]=v(p[0],d.socketSE[0]),b[1]=v(p[1],d.socketSE[1])):(d.socketSE[0]||d.socketSE[1]?(a=d.socketSE[0]?(n=0,1):(n=1,0),b[n]=v(p[n],d.socketSE[n]),(e=P.map(function(e){return v(p[a],e)})).forEach(function(e){var t=Ae(e,b[n]);(t<i||-1===i)&&(b[a]=e,i=t)})):(e=P.map(function(e){return v(p[1],e)}),P.map(function(e){return v(p[0],e)}).forEach(function(n){e.forEach(function(e){var t=Ae(n,e);(t<i||-1===i)&&(b[0]=n,b[1]=e,i=t)})})),[0,1].forEach(function(e){var t,n;d.socketSE[e]||(p[e].width||p[e].height?p[e].width||b[e].socketId!==A&&b[e].socketId!==x?p[e].height||b[e].socketId!==_&&b[e].socketId!==E||(b[e].socketId=0<=b[e?0:1].y-p[e].top?E:_):b[e].socketId=0<=b[e?0:1].x-p[e].left?x:A:(t=b[e?0:1].x-p[e].left,n=b[e?0:1].y-p[e].top,b[e].socketId=Math.abs(t)>=Math.abs(n)?0<=t?x:A:0<=n?E:_))})),f.position_path!==m.position_path||f.position_lineStrokeWidth!==m.position_lineStrokeWidth||[0,1].some(function(e){return f.position_plugOverheadSE[e]!==m.position_plugOverheadSE[e]||(t=b[e],n=m.position_socketXYSE[e],t.x!==n.x||t.y!==n.y||t.socketId!==n.socketId)||(t=g[e],n=m.position_socketGravitySE[e],(e=null==t?"auto":Array.isArray(t)?"array":"number")!=(null==n?"auto":Array.isArray(n)?"array":"number")||("array"==e?t[0]!==n[0]||t[1]!==n[1]:t!==n));var t,n})){switch(l.pathList.baseVal=S=[],l.pathList.animVal=null,f.position_path){case V:S.push([w(b[0]),w(b[1])]);break;case N:c="number"==typeof g[0]&&0<g[0]||"number"==typeof g[1]&&0<g[1],c=(u=te*(c?-1:1))-(t=Math.atan2(b[1].y-b[0].y,b[1].x-b[0].x)),t=Math.PI-t-u,u=Ae(b[0],b[1])/Math.sqrt(2)*ee,c={x:b[0].x+Math.cos(c)*u,y:b[0].y+Math.sin(c)*u*-1},u={x:b[1].x+Math.cos(t)*u,y:b[1].y+Math.sin(t)*u*-1},S.push([w(b[0]),c,u,w(b[1])]);break;case L:case T:o=[g[0],f.position_path===T?0:g[1]],r=[],s=[],b.forEach(function(e,t){var n,a=o[t],i=Array.isArray(a)?{x:a[0],y:a[1]}:"number"==typeof a?e.socketId===_?{x:0,y:-a}:e.socketId===x?{x:a,y:0}:e.socketId===E?{x:0,y:a}:{x:-a,y:0}:(n=b[t?0:1],a=0<(a=f.position_plugOverheadSE[t])?H+(G<a?(a-G)*K:0):Q+(f.position_lineStrokeWidth>W?(f.position_lineStrokeWidth-W)*R:0),e.socketId===_?{x:0,y:-(i=(i=(e.y-n.y)/2)<a?a:i)}:e.socketId===x?{x:i=(i=(n.x-e.x)/2)<a?a:i,y:0}:e.socketId===E?{x:0,y:i=(i=(n.y-e.y)/2)<a?a:i}:{x:-(i=(i=(e.x-n.x)/2)<a?a:i),y:0});r[t]=e.x+i.x,s[t]=e.y+i.y}),S.push([w(b[0]),{x:r[0],y:s[0]},{x:r[1],y:s[1]},w(b[1])]);break;case B:!function(){var n,i=1,o=2,r=3,l=4,s=[[],[]],c=[];function u(e){return e===i?r:e===o?l:e===r?i:o}function d(e){return e===o||e===l?"x":"y"}function p(e,t,n){var a={x:e.x,y:e.y};if(n){if(n===u(e.dirId))throw new Error("Invalid dirId: "+n);a.dirId=n}else a.dirId=e.dirId;return a.dirId===i?a.y-=t:a.dirId===o?a.x+=t:a.dirId===r?a.y+=t:a.x-=t,a}function h(e,t){return t.dirId===i?e.y<=t.y:t.dirId===o?e.x>=t.x:t.dirId===r?e.y>=t.y:e.x<=t.x}function f(e,t){return t.dirId===i||t.dirId===r?e.x===t.x:e.y===t.y}function m(e){return e[0]?{contain:0,notContain:1}:{contain:1,notContain:0}}function y(e,t,n){return Math.abs(t[n]-e[n])}function v(e,t,n){return"x"===n?e.x<t.x?o:l:e.y<t.y?r:i}for(b.forEach(function(e,t){var n=w(e),a=g[t],e=Array.isArray(a)?a[0]<0?[l,-a[0]]:0<a[0]?[o,a[0]]:a[1]<0?[i,-a[1]]:0<a[1]?[r,a[1]]:[e.socketId,0]:"number"!=typeof a?[e.socketId,J]:0<=a?[e.socketId,a]:[u(e.socketId),-a];n.dirId=e[0],a=e[1],s[t].push(n),c[t]=p(n,a)});function(){var e,t,a,i,n=[h(c[1],c[0]),h(c[0],c[1])],l=[d(c[0].dirId),d(c[1].dirId)];if(l[0]===l[1]){if(n[0]&&n[1])return f(c[1],c[0])||(c[0][l[0]]===c[1][l[1]]?(s[0].push(c[0]),s[1].push(c[1])):(e=c[0][l[0]]+(c[1][l[1]]-c[0][l[0]])/2,s[0].push(p(c[0],Math.abs(e-c[0][l[0]]))),s[1].push(p(c[1],Math.abs(e-c[1][l[1]]))))),0;n[0]!==n[1]?(t=m(n),(a=y(c[t.notContain],c[t.contain],l[t.notContain]))<J&&(c[t.notContain]=p(c[t.notContain],J-a)),s[t.notContain].push(c[t.notContain]),c[t.notContain]=p(c[t.notContain],J,f(c[t.contain],c[t.notContain])?"x"===l[t.notContain]?r:o:v(c[t.notContain],c[t.contain],"x"===l[t.notContain]?"y":"x"))):(a=y(c[0],c[1],"x"===l[0]?"y":"x"),s.forEach(function(e,t){var n=0===t?1:0;e.push(c[t]),c[t]=p(c[t],J,2*J<=a?v(c[t],c[n],"x"===l[t]?"y":"x"):"x"===l[t]?r:o)}))}else{if(n[0]&&n[1])return f(c[1],c[0])?s[1].push(c[1]):f(c[0],c[1])?s[0].push(c[0]):s[0].push("x"===l[0]?{x:c[1].x,y:c[0].y}:{x:c[0].x,y:c[1].y}),0;n[0]!==n[1]?(t=m(n),s[t.notContain].push(c[t.notContain]),c[t.notContain]=p(c[t.notContain],J,y(c[t.notContain],c[t.contain],l[t.contain])>=J?v(c[t.notContain],c[t.contain],l[t.contain]):c[t.contain].dirId)):(i=[{x:c[0].x,y:c[0].y},{x:c[1].x,y:c[1].y}],s.forEach(function(e,t){var n=0===t?1:0,a=y(i[t],i[n],l[t]);a<J&&(c[t]=p(c[t],J-a)),e.push(c[t]),c[t]=p(c[t],J,v(c[t],c[n],l[n]))}))}return 1}(););s[1].reverse(),s[0].concat(s[1]).forEach(function(e,t){e={x:e.x,y:e.y};0<t&&S.push([n,e]),n=e})}()}h=[],f.position_plugOverheadSE.forEach(function(e,t){var n,a,i,l,o,r,s,c,u,d=!t;0<e?2===(n=S[a=d?0:S.length-1]).length?(h[a]=h[a]||Ae.apply(null,n),h[a]>Z&&(h[a]-e<Z&&(e=h[a]-Z),s=Ie(n[0],n[1],(d?e:h[a]-e)/h[a]),S[a]=d?[s,n[1]]:[n[0],s],h[a]-=e)):(h[a]=h[a]||Le.apply(null,n),h[a]>Z&&(h[a]-e<Z&&(e=h[a]-Z),s=Ne(n[0],n[1],n[2],n[3],Te(n[0],n[1],n[2],n[3],d?e:h[a]-e)),l=d?(i=n[0],s.toP1):(i=n[3],s.fromP2),o=Math.atan2(i.y-s.y,s.x-i.x),r=Ae(s,l),s.x=i.x+Math.cos(o)*e,s.y=i.y+Math.sin(o)*e*-1,l.x=s.x+Math.cos(o)*r,l.y=s.y+Math.sin(o)*r*-1,S[a]=d?[s,s.toP1,s.toP2,n[3]]:[n[0],s.fromP1,s.fromP2,s],h[a]=null)):e<0&&(n=S[a=d?0:S.length-1],s=b[t].socketId,e<(t=-p[t]["x"==(c=s===A||s===x?"x":"y")?"width":"height"])&&(e=t),u=e*(s===A||s===_?-1:1),2===n.length?n[d?0:n.length-1][c]+=u:(d?[0,1]:[n.length-2,n.length-1]).forEach(function(e){n[e][c]+=u}),h[a]=null)}),m.position_socketXYSE=Ee(b),m.position_plugOverheadSE=Ee(f.position_plugOverheadSE),m.position_path=f.position_path,m.position_lineStrokeWidth=f.position_lineStrokeWidth,m.position_socketGravitySE=Ee(g),y=!0,l.events.apl_position&&l.events.apl_position.forEach(function(e){e(l,S)})}return y}function Ke(t,n){n!==t.isShown&&(!!n!=!!t.isShown&&(t.svg.style.visibility=n?"":"hidden"),t.isShown=n,t.events&&t.events.svgShow&&t.events.svgShow.forEach(function(e){e(t,n)}))}function Ze(e,t){var n,a,u,d,p,h,f,i,l,o,r,s,c,m,y,v,g,S,b,w,_,x,E,M,k,C,z,O,A,I,V,N,L,T,B,j,F,P,D,Q,W,R,H,G={};t.line&&(G.line=(i=(n=e).options,a=n.curStats,l=n.events,o=!1,o=Ue(n,a,"line_color",i.lineColor,l.cur_line_color)||o,o=Ue(n,a,"line_colorTra",Me(a.line_color)[0]<1)||o,o=Ue(n,a,"line_strokeWidth",i.lineSize,l.cur_line_strokeWidth)||o)),(t.plug||G.line)&&(G.plug=(d=(u=e).options,p=u.curStats,h=u.events,f=!1,[0,1].forEach(function(e){var t,n,a,i,l,o,r,s,c=d.plugSE[e];f=Ue(u,p.plug_enabledSE,e,c!==U)||f,f=Ue(u,p.plug_plugSE,e,c)||f,f=Ue(u,p.plug_colorSE,e,s=d.plugColorSE[e]||p.line_color,h.cur_plug_colorSE)||f,f=Ue(u,p.plug_colorTraSE,e,Me(s)[0]<1)||f,c!==U&&(i=n=(t=Y[X[c]]).widthR*d.plugSizeSE[e],l=a=t.heightR*d.plugSizeSE[e],oe&&(i*=p.line_strokeWidth,l*=p.line_strokeWidth),f=Ue(u,p.plug_markerWidthSE,e,i)||f,f=Ue(u,p.plug_markerHeightSE,e,l)||f,p.capsMaskMarker_markerWidthSE[e]=n,p.capsMaskMarker_markerHeightSE[e]=a),p.plugOutline_plugSE[e]=p.capsMaskMarker_plugSE[e]=c,p.plug_enabledSE[e]?(s=p.line_strokeWidth/se.lineSize*d.plugSizeSE[e],p.position_plugOverheadSE[e]=t.overhead*s,p.viewBox_plugBCircleSE[e]=t.bCircle*s,o=t.sideLen*s,r=t.backLen*s):(p.position_plugOverheadSE[e]=-p.line_strokeWidth/2,p.viewBox_plugBCircleSE[e]=o=r=0),Ue(u,p.attach_plugSideLenSE,e,o,h.cur_attach_plugSideLenSE),Ue(u,p.attach_plugBackLenSE,e,r,h.cur_attach_plugBackLenSE),p.capsMaskAnchor_enabledSE[e]=!p.plug_enabledSE[e]}),f=Ue(u,p,"plug_enabled",p.plug_enabledSE[0]||p.plug_enabledSE[1])||f)),(t.lineOutline||G.line)&&(G.lineOutline=(l=(i=e).options,E=!1,E=Ue(i,o=i.curStats,"lineOutline_enabled",l.lineOutlineEnabled)||E,E=Ue(i,o,"lineOutline_color",l.lineOutlineColor)||E,E=Ue(i,o,"lineOutline_colorTra",Me(o.lineOutline_color)[0]<1)||E,l=o.line_strokeWidth*l.lineOutlineSize,E=Ue(i,o,"lineOutline_strokeWidth",o.line_strokeWidth-2*l)||E,E=Ue(i,o,"lineOutline_inStrokeWidth",o.lineOutline_colorTra?o.lineOutline_strokeWidth+2*re:o.line_strokeWidth-l)||E)),(t.plugOutline||G.line||G.plug||G.lineOutline)&&(G.plugOutline=(s=(r=e).options,c=r.curStats,m=!1,[0,1].forEach(function(e){var t=c.plugOutline_plugSE[e],n=t!==U?Y[X[t]]:null;m=Ue(r,c.plugOutline_enabledSE,e,s.plugOutlineEnabledSE[e]&&c.plug_enabled&&c.plug_enabledSE[e]&&!!n&&!!n.outlineBase)||m,m=Ue(r,c.plugOutline_colorSE,e,t=s.plugOutlineColorSE[e]||c.lineOutline_color)||m,m=Ue(r,c.plugOutline_colorTraSE,e,Me(t)[0]<1)||m,n&&n.outlineBase&&((t=s.plugOutlineSizeSE[e])>n.outlineMax&&(t=n.outlineMax),t*=2*n.outlineBase,m=Ue(r,c.plugOutline_strokeWidthSE,e,t)||m,m=Ue(r,c.plugOutline_inStrokeWidthSE,e,c.plugOutline_colorTraSE[e]?t-re/(c.line_strokeWidth/se.lineSize)/s.plugSizeSE[e]*2:t/2)||m)}),m)),(t.faces||G.line||G.plug||G.lineOutline||G.plugOutline)&&(G.faces=(g=(y=e).curStats,S=y.aplStats,b=y.events,w=!1,!g.line_altColor&&Ue(y,S,"line_color",v=g.line_color,b.apl_line_color)&&(y.lineFace.style.stroke=v,w=!0),Ue(y,S,"line_strokeWidth",v=g.line_strokeWidth,b.apl_line_strokeWidth)&&(y.lineShape.style.strokeWidth=v+"px",w=!0,(ie||ae)&&(We(y,y.lineShape),ae&&(We(y,y.lineFace),We(y,y.lineMaskCaps)))),Ue(y,S,"lineOutline_enabled",v=g.lineOutline_enabled,b.apl_lineOutline_enabled)&&(y.lineOutlineFace.style.display=v?"inline":"none",w=!0),g.lineOutline_enabled&&(Ue(y,S,"lineOutline_color",v=g.lineOutline_color,b.apl_lineOutline_color)&&(y.lineOutlineFace.style.stroke=v,w=!0),Ue(y,S,"lineOutline_strokeWidth",v=g.lineOutline_strokeWidth,b.apl_lineOutline_strokeWidth)&&(y.lineOutlineMaskShape.style.strokeWidth=v+"px",w=!0,ae&&(We(y,y.lineOutlineMaskCaps),We(y,y.lineOutlineFace))),Ue(y,S,"lineOutline_inStrokeWidth",v=g.lineOutline_inStrokeWidth,b.apl_lineOutline_inStrokeWidth)&&(y.lineMaskShape.style.strokeWidth=v+"px",w=!0,ae&&(We(y,y.lineOutlineMaskCaps),We(y,y.lineOutlineFace)))),Ue(y,S,"plug_enabled",v=g.plug_enabled,b.apl_plug_enabled)&&(y.plugsFace.style.display=v?"inline":"none",w=!0),g.plug_enabled&&[0,1].forEach(function(n){var e=g.plug_plugSE[n],t=e!==U?Y[X[e]]:null,a=Ge(n,t);Ue(y,S.plug_enabledSE,n,v=g.plug_enabledSE[n],b.apl_plug_enabledSE)&&(y.plugsFace.style[a.prop]=v?"url(#"+y.plugMarkerIdSE[n]+")":"none",w=!0),g.plug_enabledSE[n]&&(Ue(y,S.plug_plugSE,n,e,b.apl_plug_plugSE)&&(y.plugFaceSE[n].href.baseVal="#"+t.elmId,He(y,y.plugMarkerSE[n],a.orient,t.bBox,y.svg,y.plugMarkerShapeSE[n],y.plugsFace),w=!0,ie&&We(y,y.plugsFace)),Ue(y,S.plug_colorSE,n,v=g.plug_colorSE[n],b.apl_plug_colorSE)&&(y.plugFaceSE[n].style.fill=v,w=!0,(le||oe||ae)&&!g.line_colorTra&&We(y,ae?y.lineMaskCaps:y.capsMaskLine)),["markerWidth","markerHeight"].forEach(function(e){var t="plug_"+e+"SE";Ue(y,S[t],n,v=g[t][n],b["apl_"+t])&&(y.plugMarkerSE[n][e].baseVal.value=v,w=!0)}),Ue(y,S.plugOutline_enabledSE,n,v=g.plugOutline_enabledSE[n],b.apl_plugOutline_enabledSE)&&(v?(y.plugFaceSE[n].style.mask="url(#"+y.plugMaskIdSE[n]+")",y.plugOutlineFaceSE[n].style.display="inline"):(y.plugFaceSE[n].style.mask="none",y.plugOutlineFaceSE[n].style.display="none"),w=!0),g.plugOutline_enabledSE[n]&&(Ue(y,S.plugOutline_plugSE,n,e,b.apl_plugOutline_plugSE)&&(y.plugOutlineFaceSE[n].href.baseVal=y.plugMaskShapeSE[n].href.baseVal=y.plugOutlineMaskShapeSE[n].href.baseVal="#"+t.elmId,[y.plugMaskSE[n],y.plugOutlineMaskSE[n]].forEach(function(e){e.x.baseVal.value=t.bBox.left,e.y.baseVal.value=t.bBox.top,e.width.baseVal.value=t.bBox.width,e.height.baseVal.value=t.bBox.height}),w=!0),Ue(y,S.plugOutline_colorSE,n,v=g.plugOutline_colorSE[n],b.apl_plugOutline_colorSE)&&(y.plugOutlineFaceSE[n].style.fill=v,w=!0,ae&&(We(y,y.lineMaskCaps),We(y,y.lineOutlineMaskCaps))),Ue(y,S.plugOutline_strokeWidthSE,n,v=g.plugOutline_strokeWidthSE[n],b.apl_plugOutline_strokeWidthSE)&&(y.plugOutlineMaskShapeSE[n].style.strokeWidth=v+"px",w=!0),Ue(y,S.plugOutline_inStrokeWidthSE,n,v=g.plugOutline_inStrokeWidthSE[n],b.apl_plugOutline_inStrokeWidthSE)&&(y.plugMaskShapeSE[n].style.strokeWidth=v+"px",w=!0)))}),w)),(t.position||G.line||G.plug)&&(G.position=qe(e)),(t.path||G.position)&&(G.path=(E=(_=e).curStats,O=_.aplStats,z=_.pathList.animVal||_.pathList.baseVal,M=E.path_edge,A=!1,z&&(M.x1=M.x2=z[0][0].x,M.y1=M.y2=z[0][0].y,E.path_pathData=x=Be(z,function(e){e.x<M.x1&&(M.x1=e.x),e.y<M.y1&&(M.y1=e.y),e.x>M.x2&&(M.x2=e.x),e.y>M.y2&&(M.y2=e.y)}),Fe(x,O.path_pathData)&&(_.linePath.setPathData(x),O.path_pathData=x,A=!0,ae?(We(_,_.plugsFace),We(_,_.lineMaskCaps)):ie&&We(_,_.linePath),_.events.apl_path&&_.events.apl_path.forEach(function(e){e(_,x)}))),A)),G.viewBox=(z=(k=e).curStats,O=k.aplStats,A=z.path_edge,I=z.viewBox_bBox,V=O.viewBox_bBox,N=k.svg.viewBox.baseVal,L=k.svg.style,T=!1,O=Math.max(z.line_strokeWidth/2,z.viewBox_plugBCircleSE[0]||0,z.viewBox_plugBCircleSE[1]||0),C={x1:A.x1-O,y1:A.y1-O,x2:A.x2+O,y2:A.y2+O},k.events.new_edge4viewBox&&k.events.new_edge4viewBox.forEach(function(e){e(k,C)}),I.x=z.lineMask_x=z.lineOutlineMask_x=z.maskBGRect_x=C.x1,I.y=z.lineMask_y=z.lineOutlineMask_y=z.maskBGRect_y=C.y1,I.width=C.x2-C.x1,I.height=C.y2-C.y1,["x","y","width","height"].forEach(function(e){var t;(t=I[e])!==V[e]&&(N[e]=V[e]=t,L[q[e]]=t+("x"===e||"y"===e?k.bodyOffset[e]:0)+"px",T=!0)}),T),G.mask=(F=(B=e).curStats,P=B.aplStats,D=!1,F.plug_enabled?[0,1].forEach(function(e){F.capsMaskMarker_enabledSE[e]=F.plug_enabledSE[e]&&F.plug_colorTraSE[e]||F.plugOutline_enabledSE[e]&&F.plugOutline_colorTraSE[e]}):F.capsMaskMarker_enabledSE[0]=F.capsMaskMarker_enabledSE[1]=!1,F.capsMaskMarker_enabled=F.capsMaskMarker_enabledSE[0]||F.capsMaskMarker_enabledSE[1],F.lineMask_outlineMode=F.lineOutline_enabled,F.caps_enabled=F.capsMaskMarker_enabled||F.capsMaskAnchor_enabledSE[0]||F.capsMaskAnchor_enabledSE[1],F.lineMask_enabled=F.caps_enabled||F.lineMask_outlineMode,(F.lineMask_enabled&&!F.lineMask_outlineMode||F.lineOutline_enabled)&&["x","y"].forEach(function(e){var t="maskBGRect_"+e;Ue(B,P,t,j=F[t])&&(B.maskBGRect[e].baseVal.value=j,D=!0)}),Ue(B,P,"lineMask_enabled",j=F.lineMask_enabled)&&(B.lineFace.style.mask=j?"url(#"+B.lineMaskId+")":"none",D=!0,oe&&We(B,B.lineMask)),F.lineMask_enabled&&(Ue(B,P,"lineMask_outlineMode",j=F.lineMask_outlineMode)&&(j?(B.lineMaskBG.style.display="none",B.lineMaskShape.style.display="inline"):(B.lineMaskBG.style.display="inline",B.lineMaskShape.style.display="none"),D=!0),["x","y"].forEach(function(e){var t="lineMask_"+e;Ue(B,P,t,j=F[t])&&(B.lineMask[e].baseVal.value=j,D=!0)}),Ue(B,P,"caps_enabled",j=F.caps_enabled)&&(B.lineMaskCaps.style.display=B.lineOutlineMaskCaps.style.display=j?"inline":"none",D=!0,oe&&We(B,B.capsMaskLine)),F.caps_enabled&&([0,1].forEach(function(e){var t;Ue(B,P.capsMaskAnchor_enabledSE,e,j=F.capsMaskAnchor_enabledSE[e])&&(B.capsMaskAnchorSE[e].style.display=j?"inline":"none",D=!0,oe&&We(B,B.lineMask)),F.capsMaskAnchor_enabledSE[e]&&(Fe(t=F.capsMaskAnchor_pathDataSE[e],P.capsMaskAnchor_pathDataSE[e])&&(B.capsMaskAnchorSE[e].setPathData(t),P.capsMaskAnchor_pathDataSE[e]=t,D=!0),Ue(B,P.capsMaskAnchor_strokeWidthSE,e,j=F.capsMaskAnchor_strokeWidthSE[e])&&(B.capsMaskAnchorSE[e].style.strokeWidth=j+"px",D=!0))}),Ue(B,P,"capsMaskMarker_enabled",j=F.capsMaskMarker_enabled)&&(B.capsMaskLine.style.display=j?"inline":"none",D=!0),F.capsMaskMarker_enabled&&[0,1].forEach(function(n){var e=F.capsMaskMarker_plugSE[n],t=e!==U?Y[X[e]]:null,a=Ge(n,t);Ue(B,P.capsMaskMarker_enabledSE,n,j=F.capsMaskMarker_enabledSE[n])&&(B.capsMaskLine.style[a.prop]=j?"url(#"+B.lineMaskMarkerIdSE[n]+")":"none",D=!0),F.capsMaskMarker_enabledSE[n]&&(Ue(B,P.capsMaskMarker_plugSE,n,e)&&(B.capsMaskMarkerShapeSE[n].href.baseVal="#"+t.elmId,He(B,B.capsMaskMarkerSE[n],a.orient,t.bBox,B.svg,B.capsMaskMarkerShapeSE[n],B.capsMaskLine),D=!0,ie&&(We(B,B.capsMaskLine),We(B,B.lineFace))),["markerWidth","markerHeight"].forEach(function(e){var t="capsMaskMarker_"+e+"SE";Ue(B,P[t],n,j=F[t][n])&&(B.capsMaskMarkerSE[n][e].baseVal.value=j,D=!0)}))}))),F.lineOutline_enabled&&["x","y"].forEach(function(e){var t="lineOutlineMask_"+e;Ue(B,P,t,j=F[t])&&(B.lineOutlineMask[e].baseVal.value=j,D=!0)}),D),t.effect&&(R=(Q=e).curStats,H=Q.aplStats,Object.keys($).forEach(function(e){var t=$[e],n=e+"_enabled",a=e+"_options",e=R[a];Ue(Q,H,n,W=R[n])?(W&&(H[a]=Ee(e)),t[W?"init":"remove"](Q)):W&&xe(e,H[a])&&(t.remove(Q),H[n]=!0,H[a]=Ee(e),t.init(Q))})),(le||oe)&&G.line&&!G.path&&We(e,e.lineShape),le&&G.plug&&!G.line&&We(e,e.plugsFace),Re(e)}function Je(e,t){return{duration:(ue(e.duration)&&0<e.duration?e:t).duration,timing:de.validTiming(e.timing)?e.timing:Ee(t.timing)}}function et(e,t,n,a){var i=e.curStats,l=e.aplStats,o={};function r(){["show_on","show_effect","show_animOptions"].forEach(function(e){l[e]=i[e]})}i.show_on=t,n&&M[n]&&(i.show_effect=n,i.show_animOptions=Je(ce(a)?a:{},M[n].defaultAnimOptions)),o.show_on=i.show_on!==l.show_on,o.show_effect=i.show_effect!==l.show_effect,o.show_animOptions=xe(i.show_animOptions,l.show_animOptions),o.show_effect||o.show_animOptions?i.show_inAnim?(n=o.show_effect?M[l.show_effect].stop(e,!0,!0):M[l.show_effect].stop(e),r(),M[l.show_effect].init(e,n)):o.show_on&&(l.show_effect&&o.show_effect&&M[l.show_effect].stop(e,!0,!0),r(),M[l.show_effect].init(e)):o.show_on&&(r(),M[l.show_effect].start(e))}function tt(e,t,n){n={props:e,optionName:n};return e.attachments.indexOf(t)<0&&(!t.conf.bind||t.conf.bind(t,n))&&(e.attachments.push(t),t.boundTargets.push(n),1)}function nt(n,a,e){var i=n.attachments.indexOf(a);-1<i&&n.attachments.splice(i,1),a.boundTargets.some(function(e,t){return e.props===n&&(a.conf.unbind&&a.conf.unbind(a,e),i=t,!0)})&&(a.boundTargets.splice(i,1),e||Qe(function(){a.boundTargets.length||l(a)}))}function at(s,c){var i,n,e,t,a,l,o,r,u,d,p,h,f,m,y,v=s.options,g={};function S(e,t,n,a,i){var l={};return n?null!=a?(l.container=e[n],l.key=a):(l.container=e,l.key=n):(l.container=e,l.key=t),l.default=i,l.acceptsAuto=null==l.default,l}function b(e,t,n,a,i,l,o){var r,s,c,o=S(e,n,i,l,o);return null!=t[n]&&(s=(t[n]+"").toLowerCase())&&(o.acceptsAuto&&s===D||(c=a[s]))&&c!==o.container[o.key]&&(o.container[o.key]=c,r=!0),null!=o.container[o.key]||o.acceptsAuto||(o.container[o.key]=o.default,r=!0),r}function w(e,t,n,a,i,l,o,r,s){var c,u,o=S(e,n,i,l,o);if(!a){if(null==o.default)throw new Error("Invalid `type`: "+n);a=typeof o.default}return null!=t[n]&&(o.acceptsAuto&&(t[n]+"").toLowerCase()===D||(t=u=t[n],("number"===(n=a)?ue(t):typeof t===n)&&(u=s&&"string"===a&&u?u.trim():u,1)&&(!r||r(u))))&&u!==o.container[o.key]&&(o.container[o.key]=u,c=!0),null!=o.container[o.key]||o.acceptsAuto||(o.container[o.key]=o.default,c=!0),c}if(c=c||{},["start","end"].forEach(function(e,t){var n=c[e],a=!1;if(n&&(ke(n)||(a=z(n,"anchor")))&&n!==v.anchorSE[t]){if(!1!==s.optionIsAttach.anchorSE[t]&&nt(s,ge[v.anchorSE[t]._id]),a&&!tt(s,ge[n._id],e))throw new Error("Can't bind attachment");v.anchorSE[t]=n,s.optionIsAttach.anchorSE[t]=a,i=g.position=!0}}),!v.anchorSE[0]||!v.anchorSE[1]||v.anchorSE[0]===v.anchorSE[1])throw new Error("`start` and `end` are required.");function _(e){var t=a.appendChild(m.createElementNS(ne,"mask"));return t.id=e,t.maskUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,[t.x,t.y,t.width,t.height].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0)}),t}function x(e){var t=a.appendChild(m.createElementNS(ne,"marker"));return t.id=e,t.markerUnits.baseVal=SVGMarkerElement.SVG_MARKERUNITS_STROKEWIDTH,t.viewBox.baseVal||t.setAttribute("viewBox","0 0 0 0"),t}function E(e){return[e.width,e.height].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100)}),e}i&&(p=function(e,t){var n,a;if(!(e=ze(e))||!(n=ze(t)))throw new Error("Cannot get frames.");return e.length&&n.length&&(e.reverse(),n.reverse(),e.some(function(t){return n.some(function(e){return e===t&&(a=e.contentWindow,!0)})})),a||window}(!1!==s.optionIsAttach.anchorSE[0]?ge[v.anchorSE[0]._id].element:v.anchorSE[0],!1!==s.optionIsAttach.anchorSE[1]?ge[v.anchorSE[1]._id].element:v.anchorSE[1]))!==s.baseWindow&&(e=p,f=(n=s).aplStats,m=e.document,y=O+"-"+n._id,n.pathList={},$e(f,he),Object.keys($).forEach(function(e){var t=e+"_enabled";f[t]&&($[e].remove(n),f[t]=!1)}),n.baseWindow&&n.svg&&n.baseWindow.document.body.removeChild(n.svg),Xe(n.baseWindow=e),n.bodyOffset=Ye(e),n.svg=t=m.createElementNS(ne,"svg"),t.className.baseVal=O,t.viewBox.baseVal||t.setAttribute("viewBox","0 0 0 0"),n.defs=a=t.appendChild(m.createElementNS(ne,"defs")),n.linePath=o=a.appendChild(m.createElementNS(ne,"path")),o.id=r=y+"-line-path",o.className.baseVal=O+"-line-path",oe&&(o.style.fill="none"),n.lineShape=o=a.appendChild(m.createElementNS(ne,"use")),o.id=u=y+"-line-shape",o.href.baseVal="#"+r,(l=a.appendChild(m.createElementNS(ne,"g"))).id=d=y+"-caps",n.capsMaskAnchorSE=[0,1].map(function(){var e=l.appendChild(m.createElementNS(ne,"path"));return e.className.baseVal=O+"-caps-mask-anchor",e}),n.lineMaskMarkerIdSE=[y+"-caps-mask-marker-0",y+"-caps-mask-marker-1"],n.capsMaskMarkerSE=[0,1].map(function(e){return x(n.lineMaskMarkerIdSE[e])}),n.capsMaskMarkerShapeSE=[0,1].map(function(e){e=n.capsMaskMarkerSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-caps-mask-marker-shape",e}),n.capsMaskLine=o=l.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-caps-mask-line",o.href.baseVal="#"+u,n.maskBGRect=o=E(a.appendChild(m.createElementNS(ne,"rect"))),o.id=p=y+"-mask-bg-rect",o.className.baseVal=O+"-mask-bg-rect",oe&&(o.style.fill="white"),n.lineMask=E(_(n.lineMaskId=y+"-line-mask")),n.lineMaskBG=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+p,n.lineMaskShape=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-line-mask-shape",o.href.baseVal="#"+r,o.style.display="none",n.lineMaskCaps=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+d,n.lineOutlineMask=E(_(e=y+"-line-outline-mask")),(o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use"))).href.baseVal="#"+p,n.lineOutlineMaskShape=o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-line-outline-mask-shape",o.href.baseVal="#"+r,n.lineOutlineMaskCaps=o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+d,n.face=t.appendChild(m.createElementNS(ne,"g")),n.lineFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+u,n.lineOutlineFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+u,o.style.mask="url(#"+e+")",o.style.display="none",n.plugMaskIdSE=[y+"-plug-mask-0",y+"-plug-mask-1"],n.plugMaskSE=[0,1].map(function(e){return _(n.plugMaskIdSE[e])}),n.plugMaskShapeSE=[0,1].map(function(e){e=n.plugMaskSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-plug-mask-shape",e}),h=[],n.plugOutlineMaskSE=[0,1].map(function(e){return _(h[e]=y+"-plug-outline-mask-"+e)}),n.plugOutlineMaskShapeSE=[0,1].map(function(e){e=n.plugOutlineMaskSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-plug-outline-mask-shape",e}),n.plugMarkerIdSE=[y+"-plug-marker-0",y+"-plug-marker-1"],n.plugMarkerSE=[0,1].map(function(e){e=x(n.plugMarkerIdSE[e]);return oe&&(e.markerUnits.baseVal=SVGMarkerElement.SVG_MARKERUNITS_USERSPACEONUSE),e}),n.plugMarkerShapeSE=[0,1].map(function(e){return n.plugMarkerSE[e].appendChild(m.createElementNS(ne,"g"))}),n.plugFaceSE=[0,1].map(function(e){return n.plugMarkerShapeSE[e].appendChild(m.createElementNS(ne,"use"))}),n.plugOutlineFaceSE=[0,1].map(function(e){var t=n.plugMarkerShapeSE[e].appendChild(m.createElementNS(ne,"use"));return t.style.mask="url(#"+h[e]+")",t.style.display="none",t}),n.plugsFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-plugs-face",o.href.baseVal="#"+u,o.style.display="none",n.curStats.show_inAnim?(n.isShown=1,M[f.show_effect].stop(n,!0)):n.isShown||(t.style.visibility="hidden"),m.body.appendChild(t),[0,1,2].forEach(function(e){var t,e=n.options.labelSEM[e];e&&z(e,"label")&&(t=ge[e._id]).conf.initSvg&&t.conf.initSvg(t,n)}),g.line=g.plug=g.lineOutline=g.plugOutline=g.faces=g.effect=!0),g.position=b(v,c,"path",j,null,null,se.path)||g.position,g.position=b(v,c,"startSocket",I,"socketSE",0)||g.position,g.position=b(v,c,"endSocket",I,"socketSE",1)||g.position,[c.startSocketGravity,c.endSocketGravity].forEach(function(e,t){var n,a=!1;null!=e&&(Array.isArray(e)?ue(e[0])&&ue(e[1])&&(a=[e[0],e[1]],Array.isArray(v.socketGravitySE[t])&&(n=v.socketGravitySE[t],a.length===n.length&&a.every(function(e,t){return e===n[t]}))&&(a=!1)):((e+"").toLowerCase()===D?a=null:ue(e)&&0<=e&&(a=e),a===v.socketGravitySE[t]&&(a=!1)),!1!==a&&(v.socketGravitySE[t]=a,g.position=!0))}),g.line=w(v,c,"color",null,"lineColor",null,se.lineColor,null,!0)||g.line,g.line=w(v,c,"size",null,"lineSize",null,se.lineSize,function(e){return 0<e})||g.line,["startPlug","endPlug"].forEach(function(e,t){g.plug=b(v,c,e,F,"plugSE",t,se.plugSE[t])||g.plug,g.plug=w(v,c,e+"Color","string","plugColorSE",t,null,null,!0)||g.plug,g.plug=w(v,c,e+"Size",null,"plugSizeSE",t,se.plugSizeSE[t],function(e){return 0<e})||g.plug}),g.lineOutline=w(v,c,"outline",null,"lineOutlineEnabled",null,se.lineOutlineEnabled)||g.lineOutline,g.lineOutline=w(v,c,"outlineColor",null,"lineOutlineColor",null,se.lineOutlineColor,null,!0)||g.lineOutline,g.lineOutline=w(v,c,"outlineSize",null,"lineOutlineSize",null,se.lineOutlineSize,function(e){return 0<e&&e<=.48})||g.lineOutline,["startPlugOutline","endPlugOutline"].forEach(function(e,t){g.plugOutline=w(v,c,e,null,"plugOutlineEnabledSE",t,se.plugOutlineEnabledSE[t])||g.plugOutline,g.plugOutline=w(v,c,e+"Color","string","plugOutlineColorSE",t,null,null,!0)||g.plugOutline,g.plugOutline=w(v,c,e+"Size",null,"plugOutlineSizeSE",t,se.plugOutlineSizeSE[t],function(e){return 1<=e})||g.plugOutline}),["startLabel","endLabel","middleLabel"].forEach(function(e,t){var n,a,i,l=c[e],o=v.labelSEM[t]&&!s.optionIsAttach.labelSEM[t]?ge[v.labelSEM[t]._id].text:v.labelSEM[t],r=!1;if((n="string"==typeof l)&&(l=l.trim()),(n||l&&(r=z(l,"label")))&&l!==o){if(v.labelSEM[t]&&(nt(s,ge[v.labelSEM[t]._id]),v.labelSEM[t]=""),l){if(r?(a=ge[(i=l)._id]).boundTargets.slice().forEach(function(e){a.conf.removeOption(a,e)}):i=new C(k.captionLabel,[l]),!tt(s,ge[i._id],e))throw new Error("Can't bind attachment");v.labelSEM[t]=i}s.optionIsAttach.labelSEM[t]=r}}),Object.keys($).forEach(function(a){var e,t,l=$[a],n=a+"_enabled",i=a+"_options";function o(a){var i={};return l.optionsConf.forEach(function(e){var t=e[0],n=e[3];null==e[4]||i[n]||(i[n]=[]),("function"==typeof t?t:"id"===t?b:w).apply(null,[i,a].concat(e.slice(1)))}),i}function r(e){var t,n=a+"_animOptions";return e.hasOwnProperty("animation")?ce(e.animation)?t=s.curStats[n]=Je(e.animation,l.defaultAnimOptions):(t=!!e.animation,s.curStats[n]=t?Je({},l.defaultAnimOptions):null):(t=!!l.defaultEnabled,s.curStats[n]=t?Je({},l.defaultAnimOptions):null),t}c.hasOwnProperty(a)&&(e=c[a],ce(e)?(s.curStats[n]=!0,t=s.curStats[i]=o(e),l.anim&&(s.curStats[i].animation=r(e))):(t=s.curStats[n]=!!e)&&(s.curStats[i]=o({}),l.anim&&(s.curStats[i].animation=r({}))),xe(t,v[a])&&(v[a]=t,g.effect=!0))}),Ze(s,g)}function it(e,t,n){var a={options:{anchorSE:[],socketSE:[],socketGravitySE:[],plugSE:[],plugColorSE:[],plugSizeSE:[],plugOutlineEnabledSE:[],plugOutlineColorSE:[],plugOutlineSizeSE:[],labelSEM:["","",""]},optionIsAttach:{anchorSE:[!1,!1],labelSEM:[!1,!1,!1]},curStats:{},aplStats:{},attachments:[],events:{},reflowTargets:[]};$e(a.curStats,he),$e(a.aplStats,he),Object.keys($).forEach(function(e){var t=$[e].stats;$e(a.curStats,t),$e(a.aplStats,t),a.options[e]=!1}),$e(a.curStats,fe),$e(a.aplStats,fe),a.curStats.show_effect="fade",a.curStats.show_animOptions=Ee(M.fade.defaultAnimOptions),Object.defineProperty(this,"_id",{value:++ve}),a._id=this._id,ye[this._id]=a,1===arguments.length&&(n=e,e=null),n=n||{},(e||t)&&(n=Ee(n),e&&(n.start=e),t&&(n.end=t)),a.isShown=a.aplStats.show_on=!n.hide,this.setOptions(n)}return $={dash:{stats:{dash_len:{},dash_gap:{},dash_maxOffset:{}},anim:!0,defaultAnimOptions:{duration:1e3,timing:"linear"},optionsConf:[["type","len","number",null,null,null,function(e){return 0<e}],["type","gap","number",null,null,null,function(e){return 0<e}]],init:function(e){Pe(e,"apl_line_strokeWidth",$.dash.update),e.lineFace.style.strokeDashoffset=0,$.dash.update(e)},remove:function(e){var t=e.curStats;De(e,"apl_line_strokeWidth",$.dash.update),t.dash_animId&&(de.remove(t.dash_animId),t.dash_animId=null),e.lineFace.style.strokeDasharray="none",e.lineFace.style.strokeDashoffset=0,$e(e.aplStats,$.dash.stats)},update:function(t){var e,n=t.curStats,a=t.aplStats,i=a.dash_options,l=!1;n.dash_len=i.len||2*a.line_strokeWidth,n.dash_gap=i.gap||a.line_strokeWidth,n.dash_maxOffset=n.dash_len+n.dash_gap,l=Ue(t,a,"dash_len",n.dash_len)||l,(l=Ue(t,a,"dash_gap",n.dash_gap)||l)&&(t.lineFace.style.strokeDasharray=a.dash_len+","+a.dash_gap),n.dash_animOptions?(l=Ue(t,a,"dash_maxOffset",n.dash_maxOffset),a.dash_animOptions&&(l||xe(n.dash_animOptions,a.dash_animOptions))&&(n.dash_animId&&(e=de.stop(n.dash_animId),de.remove(n.dash_animId)),a.dash_animOptions=null),a.dash_animOptions||(n.dash_animId=de.add(function(e){return(1-e)*a.dash_maxOffset+"px"},function(e){t.lineFace.style.strokeDashoffset=e},n.dash_animOptions.duration,0,n.dash_animOptions.timing,!1,e),a.dash_animOptions=Ee(n.dash_animOptions))):a.dash_animOptions&&(n.dash_animId&&(de.remove(n.dash_animId),n.dash_animId=null),t.lineFace.style.strokeDashoffset=0,a.dash_animOptions=null)}},gradient:{stats:{gradient_colorSE:{hasSE:!0},gradient_pointSE:{hasSE:!0,hasProps:!0}},optionsConf:[["type","startColor","string","colorSE",0,null,null,!0],["type","endColor","string","colorSE",1,null,null,!0]],init:function(e){var a=e.baseWindow.document,t=e.defs,n=O+"-"+e._id+"-gradient";e.efc_gradient_gradient=t=t.appendChild(a.createElementNS(ne,"linearGradient")),t.id=n,t.gradientUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,[t.x1,t.y1,t.x2,t.y2].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0)}),e.efc_gradient_stopSE=[0,1].map(function(t){var n=e.efc_gradient_gradient.appendChild(a.createElementNS(ne,"stop"));try{n.offset.baseVal=t}catch(e){if(e.code!==DOMException.NO_MODIFICATION_ALLOWED_ERR)throw e;n.setAttribute("offset",t)}return n}),Pe(e,"cur_plug_colorSE",$.gradient.update),Pe(e,"apl_path",$.gradient.update),e.curStats.line_altColor=!0,e.lineFace.style.stroke="url(#"+n+")",$.gradient.update(e)},remove:function(e){e.efc_gradient_gradient&&(e.defs.removeChild(e.efc_gradient_gradient),e.efc_gradient_gradient=e.efc_gradient_stopSE=null),De(e,"cur_plug_colorSE",$.gradient.update),De(e,"apl_path",$.gradient.update),e.curStats.line_altColor=!1,e.lineFace.style.stroke=e.curStats.line_color,$e(e.aplStats,$.gradient.stats)},update:function(a){var e,i=a.curStats,l=a.aplStats,t=l.gradient_options,n=a.pathList.animVal||a.pathList.baseVal;[0,1].forEach(function(e){i.gradient_colorSE[e]=t.colorSE[e]||i.plug_colorSE[e]}),e=n[0][0],i.gradient_pointSE[0]={x:e.x,y:e.y},e=(n=n[n.length-1])[n.length-1],i.gradient_pointSE[1]={x:e.x,y:e.y},[0,1].forEach(function(t){var n;Ue(a,l.gradient_colorSE,t,n=i.gradient_colorSE[t])&&(oe?(n=Me(n),a.efc_gradient_stopSE[t].style.stopColor=n[1],a.efc_gradient_stopSE[t].style.stopOpacity=n[0]):a.efc_gradient_stopSE[t].style.stopColor=n),["x","y"].forEach(function(e){(n=i.gradient_pointSE[t][e])!==l.gradient_pointSE[t][e]&&(a.efc_gradient_gradient[e+(t+1)].baseVal.value=l.gradient_pointSE[t][e]=n)})})}},dropShadow:{stats:{dropShadow_dx:{},dropShadow_dy:{},dropShadow_blur:{},dropShadow_color:{},dropShadow_opacity:{},dropShadow_x:{},dropShadow_y:{}},optionsConf:[["type","dx",null,null,null,2],["type","dy",null,null,null,4],["type","blur",null,null,null,3,function(e){return 0<=e}],["type","color",null,null,null,"#000",null,!0],["type","opacity",null,null,null,.8,function(e){return 0<=e&&e<=1}]],init:function(t){var e,n,a,i,l=t.baseWindow.document,o=t.defs,r=O+"-"+t._id+"-dropShadow",s=(e=l,n=r,i={},"boolean"!=typeof c&&(c=!!window.SVGFEDropShadowElement&&!oe),i.elmsAppend=[i.elmFilter=l=e.createElementNS(ne,"filter")],l.filterUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,l.x.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),l.y.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),l.width.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100),l.height.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100),l.id=n,c?(i.elmOffset=i.elmBlur=a=l.appendChild(e.createElementNS(ne,"feDropShadow")),i.styleFlood=a.style):(i.elmBlur=l.appendChild(e.createElementNS(ne,"feGaussianBlur")),i.elmOffset=a=l.appendChild(e.createElementNS(ne,"feOffset")),a.result.baseVal="offsetblur",a=l.appendChild(e.createElementNS(ne,"feFlood")),i.styleFlood=a.style,(a=l.appendChild(e.createElementNS(ne,"feComposite"))).in2.baseVal="offsetblur",a.operator.baseVal=SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN,(a=l.appendChild(e.createElementNS(ne,"feMerge"))).appendChild(e.createElementNS(ne,"feMergeNode")),a.appendChild(e.createElementNS(ne,"feMergeNode")).in1.baseVal="SourceGraphic"),i);["elmFilter","elmOffset","elmBlur","styleFlood","elmsAppend"].forEach(function(e){t["efc_dropShadow_"+e]=s[e]}),s.elmsAppend.forEach(function(e){o.appendChild(e)}),t.face.setAttribute("filter","url(#"+r+")"),Pe(t,"new_edge4viewBox",$.dropShadow.adjustEdge),$.dropShadow.update(t)},remove:function(e){var t=e.defs;e.efc_dropShadow_elmsAppend&&(e.efc_dropShadow_elmsAppend.forEach(function(e){t.removeChild(e)}),e.efc_dropShadow_elmFilter=e.efc_dropShadow_elmOffset=e.efc_dropShadow_elmBlur=e.efc_dropShadow_styleFlood=e.efc_dropShadow_elmsAppend=null),De(e,"new_edge4viewBox",$.dropShadow.adjustEdge),Ze(e,{}),e.face.removeAttribute("filter"),$e(e.aplStats,$.dropShadow.stats)},update:function(e){var t,n,a=e.curStats,i=e.aplStats,l=i.dropShadow_options;a.dropShadow_dx=t=l.dx,Ue(e,i,"dropShadow_dx",t)&&(e.efc_dropShadow_elmOffset.dx.baseVal=t,n=!0),a.dropShadow_dy=t=l.dy,Ue(e,i,"dropShadow_dy",t)&&(e.efc_dropShadow_elmOffset.dy.baseVal=t,n=!0),a.dropShadow_blur=t=l.blur,Ue(e,i,"dropShadow_blur",t)&&(e.efc_dropShadow_elmBlur.setStdDeviation(t,t),n=!0),n&&Ze(e,{}),a.dropShadow_color=t=l.color,Ue(e,i,"dropShadow_color",t)&&(e.efc_dropShadow_styleFlood.floodColor=t),a.dropShadow_opacity=t=l.opacity,Ue(e,i,"dropShadow_opacity",t)&&(e.efc_dropShadow_styleFlood.floodOpacity=t)},adjustEdge:function(a,i){var e,l=a.curStats,o=a.aplStats;null!=l.dropShadow_dx&&(e=3*l.dropShadow_blur,(e={x1:i.x1-e+l.dropShadow_dx,y1:i.y1-e+l.dropShadow_dy,x2:i.x2+e+l.dropShadow_dx,y2:i.y2+e+l.dropShadow_dy}).x1<i.x1&&(i.x1=e.x1),e.y1<i.y1&&(i.y1=e.y1),e.x2>i.x2&&(i.x2=e.x2),e.y2>i.y2&&(i.y2=e.y2),["x","y"].forEach(function(e){var t,n="dropShadow_"+e;l[n]=t=i[e+"1"],Ue(a,o,n,t)&&(a.efc_dropShadow_elmFilter[e].baseVal.value=t)}))}}},Object.keys($).forEach(function(e){var t=$[e],n=t.stats;n[e+"_enabled"]={iniValue:!1},n[e+"_options"]={hasProps:!0},t.anim&&(n[e+"_animOptions"]={},n[e+"_animId"]={})}),M={none:{defaultAnimOptions:{},init:function(e,t){var n=e.curStats;n.show_animId&&(de.remove(n.show_animId),n.show_animId=null),M.none.start(e,t)},start:function(e,t){M.none.stop(e,!0)},stop:function(e,t,n){var a=e.curStats;return n=null!=n?n:e.aplStats.show_on,a.show_inAnim=!1,t&&Ke(e,n),n?1:0}},fade:{defaultAnimOptions:{duration:300,timing:"linear"},init:function(n,e){var t=n.curStats,a=n.aplStats;t.show_animId&&de.remove(t.show_animId),t.show_animId=de.add(function(e){return e},function(e,t){t?M.fade.stop(n,!0):(n.svg.style.opacity=e+"",ae&&(We(n,n.svg),Re(n)))},a.show_animOptions.duration,1,a.show_animOptions.timing,null,!1),M.fade.start(n,e)},start:function(e,t){var n,a=e.curStats;a.show_inAnim&&(n=de.stop(a.show_animId)),Ke(e,1),a.show_inAnim=!0,de.start(a.show_animId,!e.aplStats.show_on,null!=t?t:n)},stop:function(e,t,n){var a,i=e.curStats;return n=null!=n?n:e.aplStats.show_on,a=i.show_inAnim?de.stop(i.show_animId):n?1:0,i.show_inAnim=!1,t&&(e.svg.style.opacity=n?"":"0",Ke(e,n)),a}},draw:{defaultAnimOptions:{duration:500,timing:[.58,0,.42,1]},init:function(n,e){var t=n.curStats,a=n.aplStats,l=n.pathList.baseVal,i=je(l),o=i.segsLen,r=i.lenAll;t.show_animId&&de.remove(t.show_animId),t.show_animId=de.add(function(e){var t,n,a,i=-1;if(0===e)n=[[l[0][0],l[0][0]]];else if(1===e)n=l;else{for(t=r*e,n=[];t>=o[++i];)n.push(l[i]),t-=o[i];t&&(2===(a=l[i]).length?n.push([a[0],Ie(a[0],a[1],t/o[i])]):(e=Ne(a[0],a[1],a[2],a[3],Te(a[0],a[1],a[2],a[3],t)),n.push([a[0],e.fromP1,e.fromP2,e])))}return n},function(e,t){t?M.draw.stop(n,!0):(n.pathList.animVal=e,Ze(n,{path:!0}))},a.show_animOptions.duration,1,a.show_animOptions.timing,null,!1),M.draw.start(n,e)},start:function(e,t){var n,a=e.curStats;a.show_inAnim&&(n=de.stop(a.show_animId)),Ke(e,1),a.show_inAnim=!0,Pe(e,"apl_position",M.draw.update),de.start(a.show_animId,!e.aplStats.show_on,null!=t?t:n)},stop:function(e,t,n){var a,i=e.curStats;return n=null!=n?n:e.aplStats.show_on,a=i.show_inAnim?de.stop(i.show_animId):n?1:0,i.show_inAnim=!1,t&&(e.pathList.animVal=n?null:[[e.pathList.baseVal[0][0],e.pathList.baseVal[0][0]]],Ze(e,{path:!0}),Ke(e,n)),a},update:function(e){De(e,"apl_position",M.draw.update),e.curStats.show_inAnim?M.draw.init(e,M.draw.stop(e)):e.aplStats.show_animOptions={}}}},[["start","anchorSE",0],["end","anchorSE",1],["color","lineColor"],["size","lineSize"],["startSocketGravity","socketGravitySE",0],["endSocketGravity","socketGravitySE",1],["startPlugColor","plugColorSE",0],["endPlugColor","plugColorSE",1],["startPlugSize","plugSizeSE",0],["endPlugSize","plugSizeSE",1],["outline","lineOutlineEnabled"],["outlineColor","lineOutlineColor"],["outlineSize","lineOutlineSize"],["startPlugOutline","plugOutlineEnabledSE",0],["endPlugOutline","plugOutlineEnabledSE",1],["startPlugOutlineColor","plugOutlineColorSE",0],["endPlugOutlineColor","plugOutlineColorSE",1],["startPlugOutlineSize","plugOutlineSizeSE",0],["endPlugOutlineSize","plugOutlineSizeSE",1]].forEach(function(e){var t=e[0],n=e[1],a=e[2];Object.defineProperty(it.prototype,t,{get:function(){var e=null!=a?ye[this._id].options[n][a]:n?ye[this._id].options[n]:ye[this._id].options[t];return null==e?D:Ee(e)},set:ot(t),enumerable:!0})}),[["path",j],["startSocket",I,"socketSE",0],["endSocket",I,"socketSE",1],["startPlug",F,"plugSE",0],["endPlug",F,"plugSE",1]].forEach(function(e){var a=e[0],i=e[1],l=e[2],o=e[3];Object.defineProperty(it.prototype,a,{get:function(){var t,n=null!=o?ye[this._id].options[l][o]:l?ye[this._id].options[l]:ye[this._id].options[a];return n?Object.keys(i).some(function(e){return i[e]===n&&(t=e,!0)})?t:new Error("It's broken"):D},set:ot(a),enumerable:!0})}),Object.keys($).forEach(function(n){var a=$[n];Object.defineProperty(it.prototype,n,{get:function(){var s,e,t=ye[this._id].options[n];return ce(t)?(s=t,e=a.optionsConf.reduce(function(e,t){var n,a=t[0],i=t[1],l=t[2],o=t[3],t=t[4],r=null!=t?s[o][t]:o?s[o]:s[i];return e[i]="id"===a?r?Object.keys(l).some(function(e){return l[e]===r&&(n=e,!0)})?n:new Error("It's broken"):D:null==r?D:Ee(r),e},{}),a.anim&&(e.animation=Ee(s.animation)),e):t},set:ot(n),enumerable:!0})}),["startLabel","endLabel","middleLabel"].forEach(function(e,n){Object.defineProperty(it.prototype,e,{get:function(){var e=ye[this._id],t=e.options;return t.labelSEM[n]&&!e.optionIsAttach.labelSEM[n]?ge[t.labelSEM[n]._id].text:t.labelSEM[n]||""},set:ot(e),enumerable:!0})}),it.prototype.setOptions=function(e){return at(ye[this._id],e),this},it.prototype.position=function(){return Ze(ye[this._id],{position:!0}),this},it.prototype.remove=function(){var t=ye[this._id],n=t.curStats;Object.keys($).forEach(function(e){e+="_animId";n[e]&&de.remove(n[e])}),n.show_animId&&de.remove(n.show_animId),t.attachments.slice().forEach(function(e){nt(t,e)}),t.baseWindow&&t.svg&&t.baseWindow.document.body.removeChild(t.svg),delete ye[this._id]},it.prototype.show=function(e,t){return et(ye[this._id],!0,e,t),this},it.prototype.hide=function(e,t){return et(ye[this._id],!1,e,t),this},l=function(t){t&&ge[t._id]&&(t.boundTargets.slice().forEach(function(e){nt(e.props,t,!0)}),t.conf.remove&&t.conf.remove(t),delete ge[t._id])},lt.prototype.remove=function(){var t=this,n=ge[t._id];n&&(n.boundTargets.slice().forEach(function(e){n.conf.removeOption(n,e)}),Qe(function(){var e=ge[t._id];e&&(console.error("LeaderLineAttachment was not removed by removeOption"),l(e))}))},C=lt,window.LeaderLineAttachment=C,z=function(e,t){return e instanceof C&&(!(e.isRemoved||t&&ge[e._id].conf.type!==t)||null)},k={pointAnchor:{type:"anchor",argOptions:[{optionName:"element",type:ke}],init:function(e,t){return e.element=k.pointAnchor.checkElement(t.element),e.x=k.pointAnchor.parsePercent(t.x,!0)||[.5,!0],e.y=k.pointAnchor.parsePercent(t.y,!0)||[.5,!0],!0},removeOption:function(e,t){var n=t.props,a={},i=e.element,e=n.options.anchorSE["start"===t.optionName?1:0];i===e&&(i=e===document.body?new C(k.pointAnchor,[i]):document.body),a[t.optionName]=i,at(n,a)},getBBoxNest:function(e,t){var n=Oe(e.element,t.baseWindow),a=n.width,t=n.height;return n.width=n.height=0,n.left=n.right=n.left+e.x[0]*(e.x[1]?a:1),n.top=n.bottom=n.top+e.y[0]*(e.y[1]?t:1),n},parsePercent:function(e,t){var n,a,i=!1;return ue(e)?a=e:"string"==typeof e&&(n=y.exec(e))&&n[2]&&(i=0!=(a=parseFloat(n[1])/100)),null!=a&&(t||0<=a)?[a,i]:null},checkElement:function(e){if(null==e)e=document.body;else if(!ke(e))throw new Error("`element` must be Element");return e}},areaAnchor:{type:"anchor",argOptions:[{optionName:"element",type:ke},{optionName:"shape",type:"string"}],stats:{color:{},strokeWidth:{},elementWidth:{},elementHeight:{},elementLeft:{},elementTop:{},pathListRel:{},bBoxRel:{},pathData:{},viewBoxBBox:{hasProps:!0},dashLen:{},dashGap:{}},init:function(a,e){var t,n=[];return a.element=k.pointAnchor.checkElement(e.element),"string"==typeof e.color&&(a.color=e.color.trim()),"string"==typeof e.fillColor&&(a.fill=e.fillColor.trim()),ue(e.size)&&0<=e.size&&(a.size=e.size),e.dash&&(a.dash=!0,ue(e.dash.len)&&0<e.dash.len&&(a.dashLen=e.dash.len),ue(e.dash.gap)&&0<e.dash.gap&&(a.dashGap=e.dash.gap)),"circle"===e.shape?a.shape=e.shape:"polygon"===e.shape&&Array.isArray(e.points)&&3<=e.points.length&&e.points.every(function(e){var t={};return!(!(t.x=k.pointAnchor.parsePercent(e[0],!0))||!(t.y=k.pointAnchor.parsePercent(e[1],!0))||(n.push(t),(t.x[1]||t.y[1])&&(a.hasRatio=!0),0))})?(a.shape=e.shape,a.points=n):(a.shape="rect",a.radius=ue(e.radius)&&0<=e.radius?e.radius:0),"rect"!==a.shape&&"circle"!==a.shape||(a.x=k.pointAnchor.parsePercent(e.x,!0)||[-.05,!0],a.y=k.pointAnchor.parsePercent(e.y,!0)||[-.05,!0],a.width=k.pointAnchor.parsePercent(e.width)||[1.1,!0],a.height=k.pointAnchor.parsePercent(e.height)||[1.1,!0],(a.x[1]||a.y[1]||a.width[1]||a.height[1])&&(a.hasRatio=!0)),t=a.element.ownerDocument,a.svg=e=t.createElementNS(ne,"svg"),e.className.baseVal=O+"-areaAnchor",e.viewBox.baseVal||e.setAttribute("viewBox","0 0 0 0"),a.path=e.appendChild(t.createElementNS(ne,"path")),a.path.style.fill=a.fill||"none",a.isShown=!1,e.style.visibility="hidden",t.body.appendChild(e),Xe(t=t.defaultView),a.bodyOffset=Ye(t),a.updateColor=function(){var e=a.curStats,t=a.aplStats,n=a.boundTargets.length?a.boundTargets[0].props.curStats:null;e.color=n=a.color||(n?n.line_color:se.lineColor),Ue(a,t,"color",n)&&(a.path.style.stroke=n)},a.updateShow=function(){Ke(a,a.boundTargets.some(function(e){return!0===e.props.isShown}))},!0},bind:function(e,t){t=t.props;return e.color||Pe(t,"cur_line_color",e.updateColor),Pe(t,"svgShow",e.updateShow),Qe(function(){e.updateColor(),e.updateShow()}),!0},unbind:function(e,t){t=t.props;e.color||De(t,"cur_line_color",e.updateColor),De(t,"svgShow",e.updateShow),1<e.boundTargets.length&&Qe(function(){e.updateColor(),e.updateShow(),k.areaAnchor.update(e)&&e.boundTargets.forEach(function(e){Ze(e.props,{position:!0})})})},removeOption:function(e,t){k.pointAnchor.removeOption(e,t)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){k.areaAnchor.unbind(t,e)})),t.svg.parentNode.removeChild(t.svg)},getStrokeWidth:function(e,t){return k.areaAnchor.update(e)&&1<e.boundTargets.length&&Qe(function(){e.boundTargets.forEach(function(e){e.props!==t&&Ze(e.props,{position:!0})})}),e.curStats.strokeWidth},getPathData:function(e,t){var n=Oe(e.element,t.baseWindow);return Be(e.curStats.pathListRel,function(e){e.x+=n.left,e.y+=n.top})},getBBoxNest:function(e,t){t=Oe(e.element,t.baseWindow),e=e.curStats.bBoxRel;return{left:e.left+t.left,top:e.top+t.top,right:e.right+t.left,bottom:e.bottom+t.top,width:e.width,height:e.height}},update:function(t){var n,a,i,l,e,o,r,s,c,u,d,p,h,f,m,y,v=t.curStats,g=t.aplStats,S=t.boundTargets.length?t.boundTargets[0].props.curStats:null,b={};if(b.strokeWidth=Ue(t,v,"strokeWidth",null!=t.size?t.size:S?S.line_strokeWidth:se.lineSize),n=Ce(t.element),b.elementWidth=Ue(t,v,"elementWidth",n.width),b.elementHeight=Ue(t,v,"elementHeight",n.height),b.elementLeft=Ue(t,v,"elementLeft",n.left),b.elementTop=Ue(t,v,"elementTop",n.top),b.strokeWidth||t.hasRatio&&(b.elementWidth||b.elementHeight)){switch(t.shape){case"rect":(o={left:t.x[0]*(t.x[1]?n.width:1),top:t.y[0]*(t.y[1]?n.height:1),width:t.width[0]*(t.width[1]?n.width:1),height:t.height[0]*(t.height[1]?n.height:1)}).right=o.left+o.width,o.bottom=o.top+o.height,s=v.strokeWidth/2,r=(r=Math.min(o.width,o.height))?r/2*Math.SQRT2+s:0,d=(r=t.radius?t.radius<=r?t.radius:r:0)?(u=r-(c=(r-s)/Math.SQRT2),d=[{x:o.left-u,y:o.top+c},{x:o.left+c,y:o.top-u},{x:o.right-c,y:o.top-u},{x:o.right+u,y:o.top+c},{x:o.right+u,y:o.bottom-c},{x:o.right-c,y:o.bottom+u},{x:o.left+c,y:o.bottom+u},{x:o.left-u,y:o.bottom-c}],v.pathListRel=[[d[0],{x:d[0].x,y:d[0].y-(p=r*ee)},{x:d[1].x-p,y:d[1].y},d[1]]],d[1].x!==d[2].x&&v.pathListRel.push([d[1],d[2]]),v.pathListRel.push([d[2],{x:d[2].x+p,y:d[2].y},{x:d[3].x,y:d[3].y-p},d[3]]),d[3].y!==d[4].y&&v.pathListRel.push([d[3],d[4]]),v.pathListRel.push([d[4],{x:d[4].x,y:d[4].y+p},{x:d[5].x+p,y:d[5].y},d[5]]),d[5].x!==d[6].x&&v.pathListRel.push([d[5],d[6]]),v.pathListRel.push([d[6],{x:d[6].x-p,y:d[6].y},{x:d[7].x,y:d[7].y+p},d[7]]),d[7].y!==d[0].y&&v.pathListRel.push([d[7],d[0]]),v.pathListRel.push([]),u=r-c+v.strokeWidth/2,[{x:o.left-u,y:o.top-u},{x:o.right+u,y:o.bottom+u}]):(u=v.strokeWidth/2,d=[{x:o.left-u,y:o.top-u},{x:o.right+u,y:o.bottom+u}],v.pathListRel=[[d[0],{x:d[1].x,y:d[0].y}],[{x:d[1].x,y:d[0].y},d[1]],[d[1],{x:d[0].x,y:d[1].y}],[]],[{x:o.left-v.strokeWidth,y:o.top-v.strokeWidth},{x:o.right+v.strokeWidth,y:o.bottom+v.strokeWidth}]),v.bBoxRel={left:d[0].x,top:d[0].y,right:d[1].x,bottom:d[1].y,width:d[1].x-d[0].x,height:d[1].y-d[0].y};break;case"circle":(s={left:t.x[0]*(t.x[1]?n.width:1),top:t.y[0]*(t.y[1]?n.height:1),width:t.width[0]*(t.width[1]?n.width:1),height:t.height[0]*(t.height[1]?n.height:1)}).width||s.height||(s.width=s.height=10),s.width||(s.width=s.height),s.height||(s.height=s.width),s.right=s.left+s.width,s.bottom=s.top+s.height,p=s.left+s.width/2,r=s.top+s.height/2,e=v.strokeWidth/2,c=s.width/2,u=s.height/2,o=c*Math.SQRT2+e,d=u*Math.SQRT2+e,v.pathListRel=[[(e=[{x:p-o,y:r},{x:p,y:r-d},{x:p+o,y:r},{x:p,y:r+d}])[0],{x:e[0].x,y:e[0].y-(p=d*ee)},{x:e[1].x-(r=o*ee),y:e[1].y},e[1]],[e[1],{x:e[1].x+r,y:e[1].y},{x:e[2].x,y:e[2].y-p},e[2]],[e[2],{x:e[2].x,y:e[2].y+p},{x:e[3].x+r,y:e[3].y},e[3]],[e[3],{x:e[3].x-r,y:e[3].y},{x:e[0].x,y:e[0].y+p},e[0]],[]],c=o-c+v.strokeWidth/2,u=d-u+v.strokeWidth/2,e=[{x:s.left-c,y:s.top-u},{x:s.right+c,y:s.bottom+u}],v.bBoxRel={left:e[0].x,top:e[0].y,right:e[1].x,bottom:e[1].y,width:e[1].x-e[0].x,height:e[1].y-e[0].y};break;case"polygon":t.points.forEach(function(e){var t=e.x[0]*(e.x[1]?n.width:1),e=e.y[0]*(e.y[1]?n.height:1);i?(t<i.left&&(i.left=t),t>i.right&&(i.right=t),e<i.top&&(i.top=e),e>i.bottom&&(i.bottom=e)):i={left:t,right:t,top:e,bottom:e},l?v.pathListRel.push([l,{x:t,y:e}]):v.pathListRel=[],l={x:t,y:e}}),v.pathListRel.push([]),e=v.strokeWidth/2,e=[{x:i.left-e,y:i.top-e},{x:i.right+e,y:i.bottom+e}],v.bBoxRel={left:e[0].x,top:e[0].y,right:e[1].x,bottom:e[1].y,width:e[1].x-e[0].x,height:e[1].y-e[0].y}}b.pathListRel=b.bBoxRel=!0}return(b.pathListRel||b.elementLeft||b.elementTop)&&(v.pathData=Be(v.pathListRel,function(e){e.x+=n.left,e.y+=n.top})),Ue(t,g,"strokeWidth",a=v.strokeWidth)&&(t.path.style.strokeWidth=a+"px"),Fe(a=v.pathData,g.pathData)&&(t.path.setPathData(a),g.pathData=a,b.pathData=!0),t.dash&&(!b.pathData&&(!b.strokeWidth||t.dashLen&&t.dashGap)||(v.dashLen=t.dashLen||2*v.strokeWidth,v.dashGap=t.dashGap||v.strokeWidth),b.dash=Ue(t,g,"dashLen",v.dashLen)||b.dash,b.dash=Ue(t,g,"dashGap",v.dashGap)||b.dash,b.dash&&(t.path.style.strokeDasharray=g.dashLen+","+g.dashGap)),h=v.viewBoxBBox,f=g.viewBoxBBox,m=t.svg.viewBox.baseVal,y=t.svg.style,h.x=v.bBoxRel.left+n.left,h.y=v.bBoxRel.top+n.top,h.width=v.bBoxRel.width,h.height=v.bBoxRel.height,["x","y","width","height"].forEach(function(e){(a=h[e])!==f[e]&&(m[e]=f[e]=a,y[q[e]]=a+("x"===e||"y"===e?t.bodyOffset[e]:0)+"px")}),b.strokeWidth||b.pathListRel||b.bBoxRel}},mouseHoverAnchor:{type:"anchor",argOptions:[{optionName:"element",type:ke},{optionName:"showEffectName",type:"string"}],style:{backgroundImage:"url('data:image/svg+xml;charset=utf-8;base64,PHN2ZyB2ZXJzaW9uPSIxLjEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgd2lkdGg9IjI0IiBoZWlnaHQ9IjI0Ij48cG9seWdvbiBwb2ludHM9IjI0LDAgMCw4IDgsMTEgMCwxOSA1LDI0IDEzLDE2IDE2LDI0IiBmaWxsPSJjb3JhbCIvPjwvc3ZnPg==')",backgroundSize:"",backgroundRepeat:"no-repeat",backgroundColor:"#f8f881",cursor:"default"},hoverStyle:{backgroundImage:"none",backgroundColor:"#fadf8f"},padding:{top:1,right:15,bottom:1,left:2},minHeight:15,backgroundPosition:{right:2,top:2},backgroundSize:{width:12,height:12},dirKeys:[["top","Top"],["right","Right"],["bottom","Bottom"],["left","Left"]],init:function(a,i){var n,t,e,l,o,r,s,c,u,d=k.mouseHoverAnchor,p={};if(a.element=k.pointAnchor.checkElement(i.element),!((c=(s=a.element).ownerDocument)&&(u=c.defaultView)&&u.HTMLElement&&s instanceof u.HTMLElement))throw new Error("`element` must be HTML element");return d.style.backgroundSize=d.backgroundSize.width+"px "+d.backgroundSize.height+"px",["style","hoverStyle"].forEach(function(e){var n=d[e];a[e]=Object.keys(n).reduce(function(e,t){return e[t]=n[t],e},{})}),"inline"===(n=a.element.ownerDocument.defaultView.getComputedStyle(a.element,"")).display?a.style.display="inline-block":"none"===n.display&&(a.style.display="block"),k.mouseHoverAnchor.dirKeys.forEach(function(e){var t=e[0],e="padding"+e[1];parseFloat(n[e])<d.padding[t]&&(a.style[e]=d.padding[t]+"px")}),a.style.display&&(e=a.element.style.display,a.element.style.display=a.style.display),k.mouseHoverAnchor.dirKeys.forEach(function(e){e="padding"+e[1];a.style[e]&&(p[e]=a.element.style[e],a.element.style[e]=a.style[e])}),(s=a.element.getBoundingClientRect()).height<d.minHeight&&(ae?(u=d.minHeight,"content-box"===n.boxSizing?u-=parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth)+parseFloat(n.paddingTop)+parseFloat(n.paddingBottom):"padding-box"===n.boxSizing&&(u-=parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth)),a.style.height=u+"px"):a.style.height=parseFloat(n.height)+(d.minHeight-s.height)+"px"),a.style.backgroundPosition=oe?s.width-d.backgroundSize.width-d.backgroundPosition.right+"px "+d.backgroundPosition.top+"px":"right "+d.backgroundPosition.right+"px top "+d.backgroundPosition.top+"px",a.style.display&&(a.element.style.display=e),k.mouseHoverAnchor.dirKeys.forEach(function(e){e="padding"+e[1];a.style[e]&&(a.element.style[e]=p[e])}),["style","hoverStyle"].forEach(function(e){var t=a[e],n=i[e];ce(n)&&Object.keys(n).forEach(function(e){"string"==typeof n[e]||ue(n[e])?t[e]=n[e]:null==n[e]&&delete t[e]})}),"function"==typeof i.onSwitch&&(r=i.onSwitch),i.showEffectName&&M[i.showEffectName]&&(a.showEffectName=l=i.showEffectName),o=i.animOptions,a.elmStyle=t=a.element.style,a.mouseenter=function(e){a.hoverStyleSave=d.getStyles(t,Object.keys(a.hoverStyle)),d.setStyles(t,a.hoverStyle),a.boundTargets.forEach(function(e){et(e.props,!0,l,o)}),r&&r(e)},a.mouseleave=function(e){d.setStyles(t,a.hoverStyleSave),a.boundTargets.forEach(function(e){et(e.props,!1,l,o)}),r&&r(e)},!0},bind:function(e,t){var n,a,i,l,o;return t.props.svg?k.mouseHoverAnchor.llShow(t.props,!1,e.showEffectName):Qe(function(){k.mouseHoverAnchor.llShow(t.props,!1,e.showEffectName)}),e.enabled||(e.styleSave=k.mouseHoverAnchor.getStyles(e.elmStyle,Object.keys(e.style)),k.mouseHoverAnchor.setStyles(e.elmStyle,e.style),e.removeEventListener=(n=e.element,a=e.mouseenter,i=e.mouseleave,"onmouseenter"in n&&"onmouseleave"in n?(n.addEventListener("mouseenter",a,!1),n.addEventListener("mouseleave",i,!1),function(){n.removeEventListener("mouseenter",a,!1),n.removeEventListener("mouseleave",i,!1)}):(console.warn("mouseenter and mouseleave events polyfill is enabled."),n.addEventListener("mouseover",l=function(e){e.relatedTarget&&(e.relatedTarget===this||this.compareDocumentPosition(e.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||a.apply(this,arguments)}),n.addEventListener("mouseout",o=function(e){e.relatedTarget&&(e.relatedTarget===this||this.compareDocumentPosition(e.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||i.apply(this,arguments)}),function(){n.removeEventListener("mouseover",l,!1),n.removeEventListener("mouseout",o,!1)})),e.enabled=!0),!0},unbind:function(e,t){e.enabled&&e.boundTargets.length<=1&&(e.removeEventListener(),k.mouseHoverAnchor.setStyles(e.elmStyle,e.styleSave),e.enabled=!1),k.mouseHoverAnchor.llShow(t.props,!0,e.showEffectName)},removeOption:function(e,t){k.pointAnchor.removeOption(e,t)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){k.mouseHoverAnchor.unbind(t,e)}))},getBBoxNest:function(e,t){return Oe(e.element,t.baseWindow)},llShow:function(e,t,n){M[n||e.curStats.show_effect].stop(e,!0,t),e.aplStats.show_on=t},getStyles:function(n,e){return e.reduce(function(e,t){return e[t]=n[t],e},{})},setStyles:function(t,n){Object.keys(n).forEach(function(e){t[e]=n[e]})}},captionLabel:{type:"label",argOptions:[{optionName:"text",type:"string"}],stats:{color:{},x:{},y:{}},textStyleProps:["fontFamily","fontStyle","fontVariant","fontWeight","fontStretch","fontSize","fontSizeAdjust","kerning","letterSpacing","wordSpacing","textDecoration"],init:function(o,t){return"string"==typeof t.text&&(o.text=t.text.trim()),!!o.text&&("string"==typeof t.color&&(o.color=t.color.trim()),o.outlineColor="string"==typeof t.outlineColor?t.outlineColor.trim():"#fff",Array.isArray(t.offset)&&ue(t.offset[0])&&ue(t.offset[1])&&(o.offset={x:t.offset[0],y:t.offset[1]}),ue(t.lineOffset)&&(o.lineOffset=t.lineOffset),k.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(o[e]=t[e])}),o.updateColor=function(e){k.captionLabel.updateColor(o,e)},o.updateSocketXY=function(e){var t,n=o.curStats,a=o.aplStats,i=e.curStats,l=i.position_socketXYSE[o.socketIndex];null!=l.x&&(o.offset?(n.x=l.x+o.offset.x,n.y=l.y+o.offset.y):(t=o.height/2,e=Math.max(i.attach_plugSideLenSE[o.socketIndex]||0,i.line_strokeWidth/2),i=i.position_socketXYSE[o.socketIndex?0:1],l.socketId===A||l.socketId===x?(n.x=l.socketId===A?l.x-t-o.width:l.x+t,n.y=i.y<l.y?l.y+e+t:l.y-e-t-o.height):(n.x=i.x<l.x?l.x+e+t:l.x-e-t-o.width,n.y=l.socketId===_?l.y-t-o.height:l.y+t)),Ue(o,a,"x",t=n.x)&&(o.elmPosition.x.baseVal.getItem(0).value=t),Ue(o,a,"y",t=n.y)&&(o.elmPosition.y.baseVal.getItem(0).value=t+o.height))},o.updatePath=function(e){var t=o.curStats,n=o.aplStats,e=e.pathList.animVal||e.pathList.baseVal;e&&(e=k.captionLabel.getMidPoint(e,o.lineOffset),t.x=e.x-o.width/2,t.y=e.y-o.height/2,Ue(o,n,"x",e=t.x)&&(o.elmPosition.x.baseVal.getItem(0).value=e),Ue(o,n,"y",e=t.y)&&(o.elmPosition.y.baseVal.getItem(0).value=e+o.height))},o.updateShow=function(e){k.captionLabel.updateShow(o,e)},oe&&(o.adjustEdge=function(e,t){var n=o.curStats;null!=n.x&&k.captionLabel.adjustEdge(t,{x:n.x,y:n.y,width:o.width,height:o.height},o.strokeWidth/2)}),!0)},updateColor:function(e,t){var n=e.curStats,a=e.aplStats,t=t.curStats;n.color=t=e.color||t.line_color,Ue(e,a,"color",t)&&(e.styleFill.fill=t)},updateShow:function(e,t){t=!0===t.isShown;t!==e.isShown&&(e.styleShow.visibility=t?"":"hidden",e.isShown=t)},adjustEdge:function(e,t,n){n={x1:t.x-n,y1:t.y-n,x2:t.x+t.width+n,y2:t.y+t.height+n};n.x1<e.x1&&(e.x1=n.x1),n.y1<e.y1&&(e.y1=n.y1),n.x2>e.x2&&(e.x2=n.x2),n.y2>e.y2&&(e.y2=n.y2)},newText:function(e,t,n,a,i){var l,o,r;return(l=t.createElementNS(ne,"text")).textContent=e,[l.x,l.y].forEach(function(e){var t=n.createSVGLength();t.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),e.baseVal.initialize(t)}),"boolean"!=typeof u&&(u="paintOrder"in l.style),i&&!u?(o=t.createElementNS(ne,"defs"),l.id=a,o.appendChild(l),(r=(e=t.createElementNS(ne,"g")).appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+a,(t=e.appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+a,(r=r.style).strokeLinejoin="round",{elmPosition:l,styleText:l.style,styleFill:t.style,styleStroke:r,styleShow:e.style,elmsAppend:[o,e]}):(r=l.style,i&&(r.strokeLinejoin="round",r.paintOrder="stroke"),{elmPosition:l,styleText:r,styleFill:r,styleStroke:i?r:null,styleShow:r,elmsAppend:[l]})},getMidPoint:function(e,t){var n,a,i,l=je(e),o=l.segsLen,l=l.lenAll,r=-1;if((n=l/2+(t||0))<=0)return 2===(a=e[0]).length?Ie(a[0],a[1],0):Ne(a[0],a[1],a[2],a[3],0);if(l<=n)return 2===(a=e[e.length-1]).length?Ie(a[0],a[1],1):Ne(a[0],a[1],a[2],a[3],1);for(i=[];n>o[++r];)i.push(e[r]),n-=o[r];return 2===(a=e[r]).length?Ie(a[0],a[1],n/o[r]):Ne(a[0],a[1],a[2],a[3],Te(a[0],a[1],a[2],a[3],n))},initSvg:function(t,n){var e,a,i=k.captionLabel.newText(t.text,n.baseWindow.document,n.svg,O+"-captionLabel-"+t._id,t.outlineColor);["elmPosition","styleFill","styleShow","elmsAppend"].forEach(function(e){t[e]=i[e]}),t.isShown=!1,t.styleShow.visibility="hidden",k.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(i.styleText[e]=t[e])}),i.elmsAppend.forEach(function(e){n.svg.appendChild(e)}),e=i.elmPosition.getBBox(),t.width=e.width,t.height=e.height,t.outlineColor&&(a=10<(a=e.height/9)?10:a<2?2:a,i.styleStroke.strokeWidth=a+"px",i.styleStroke.stroke=t.outlineColor),t.strokeWidth=a||0,$e(t.aplStats,k.captionLabel.stats),t.updateColor(n),t.refSocketXY?t.updateSocketXY(n):t.updatePath(n),oe&&Ze(n,{}),t.updateShow(n)},bind:function(e,t){var n=t.props;return e.color||Pe(n,"cur_line_color",e.updateColor),(e.refSocketXY="startLabel"===t.optionName||"endLabel"===t.optionName)?(e.socketIndex="startLabel"===t.optionName?0:1,Pe(n,"apl_position",e.updateSocketXY),e.offset||(Pe(n,"cur_attach_plugSideLenSE",e.updateSocketXY),Pe(n,"cur_line_strokeWidth",e.updateSocketXY))):Pe(n,"apl_path",e.updatePath),Pe(n,"svgShow",e.updateShow),oe&&Pe(n,"new_edge4viewBox",e.adjustEdge),k.captionLabel.initSvg(e,n),!0},unbind:function(e,t){var n=t.props;e.elmsAppend&&(e.elmsAppend.forEach(function(e){n.svg.removeChild(e)}),e.elmPosition=e.styleFill=e.styleShow=e.elmsAppend=null),$e(e.curStats,k.captionLabel.stats),$e(e.aplStats,k.captionLabel.stats),e.color||De(n,"cur_line_color",e.updateColor),e.refSocketXY?(De(n,"apl_position",e.updateSocketXY),e.offset||(De(n,"cur_attach_plugSideLenSE",e.updateSocketXY),De(n,"cur_line_strokeWidth",e.updateSocketXY))):De(n,"apl_path",e.updatePath),De(n,"svgShow",e.updateShow),oe&&(De(n,"new_edge4viewBox",e.adjustEdge),Ze(n,{}))},removeOption:function(e,t){var n=t.props,a={};a[t.optionName]="",at(n,a)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){k.captionLabel.unbind(t,e)}))}},pathLabel:{type:"label",argOptions:[{optionName:"text",type:"string"}],stats:{color:{},startOffset:{},pathData:{}},init:function(o,t){return"string"==typeof t.text&&(o.text=t.text.trim()),!!o.text&&("string"==typeof t.color&&(o.color=t.color.trim()),o.outlineColor="string"==typeof t.outlineColor?t.outlineColor.trim():"#fff",ue(t.lineOffset)&&(o.lineOffset=t.lineOffset),k.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(o[e]=t[e])}),o.updateColor=function(e){k.captionLabel.updateColor(o,e)},o.updatePath=function(e){var t=o.curStats,n=o.aplStats,a=e.curStats,i=e.pathList.animVal||e.pathList.baseVal;i&&(t.pathData=a=k.pathLabel.getOffsetPathData(i,a.line_strokeWidth/2+o.strokeWidth/2+o.height/4,1.25*o.height),Fe(a,n.pathData)&&(o.elmPath.setPathData(a),n.pathData=a,o.bBox=o.elmPosition.getBBox(),o.updateStartOffset(e)))},o.updateStartOffset=function(e){var t,i,n=o.curStats,a=o.aplStats,l=e.curStats;n.pathData&&(2!==o.semIndex||o.lineOffset)&&(t=n.pathData.reduce(function(e,t){var n,a=t.values;switch(t.type){case"M":i={x:a[0],y:a[1]};break;case"L":n={x:a[0],y:a[1]},i&&(e+=Ae(i,n)),i=n;break;case"C":n={x:a[4],y:a[5]},i&&(e+=Le(i,{x:a[0],y:a[1]},{x:a[2],y:a[3]},n)),i=n}return e},0),e=0===o.semIndex?0:1===o.semIndex?t:t/2,2!==o.semIndex&&(l=Math.max(l.attach_plugBackLenSE[o.semIndex]||0,l.line_strokeWidth/2)+o.strokeWidth/2+o.height/4,e=(e+=0===o.semIndex?l:-l)<0?0:t<e?t:e),o.lineOffset&&(e=(e+=o.lineOffset)<0?0:t<e?t:e),n.startOffset=e,Ue(o,a,"startOffset",e)&&(o.elmOffset.startOffset.baseVal.value=e))},o.updateShow=function(e){k.captionLabel.updateShow(o,e)},oe&&(o.adjustEdge=function(e,t){o.bBox&&k.captionLabel.adjustEdge(t,o.bBox,o.strokeWidth/2)}),!0)},getOffsetPathData:function(e,p,n){var h,a,f=[];function m(e,t){return Math.abs(e.x-t.x)<3&&Math.abs(e.y-t.y)<3}return e.forEach(function(e){var t,n,a,i,l,o,r,s,c,u,d;2===e.length?(s=e[0],c=e[1],u=p,d=Math.atan2(s.y-c.y,c.x-s.x)+.5*Math.PI,t=[{x:s.x+Math.cos(d)*u,y:s.y+Math.sin(d)*u*-1},{x:c.x+Math.cos(d)*u,y:c.y+Math.sin(d)*u*-1}],h?(a=h.points,0<=(r=Math.atan2(a[1].y-a[0].y,a[0].x-a[1].x)-Math.atan2(e[0].y-e[1].y,e[1].x-e[0].x))&&r<=Math.PI?n={type:"line",points:t,inside:!0}:(l=Ve(a[0],a[1],p),i=Ve(t[1],t[0],p),o=a[0],s=l.x-o.x,c=l.y-o.y,u=(d=t[1]).x-i.x,r=d.y-i.y,d=(-c*(o.x-i.x)+s*(o.y-i.y))/(-u*c+s*r),r=(u*(o.y-i.y)-r*(o.x-i.x))/(-u*c+s*r),n=(c=0<=d&&d<=1&&0<=r&&r<=1?{x:o.x+r*s,y:o.y+r*c}:null)?{type:"line",points:[a[1]=c,t[1]]}:(a[1]=m(i,l)?i:l,{type:"line",points:[i,t[1]]}),h.len=Ae(a[0],a[1]))):n={type:"line",points:t},n.len=Ae(n.points[0],n.points[1]),f.push(h=n)):(f.push({type:"cubic",points:function(e,t,n,a,i){for(var l,o,r=Le(e,t,n,a)/16,s=1/(16<i?i/16*r:r),c=[],u=0;o=(90-(l=Ne(e,t,n,a,u)).angle)*(Math.PI/180),c.push({x:l.x+Math.cos(o)*i,y:l.y+Math.sin(o)*i*-1}),!(1<=u);)1<(u+=s)&&(u=1);return c}(e[0],e[1],e[2],e[3],p)}),h=null)}),h=null,f.forEach(function(e){var t;h="line"===e.type?(e.inside&&(h.len>p?((t=h.points)[1]=Ve(t[0],t[1],-p),h.len=Ae(t[0],t[1])):(h.points=null,h.len=0),e.len>p+n?((t=e.points)[0]=Ve(t[1],t[0],-(p+n)),e.len=Ae(t[0],t[1])):(e.points=null,e.len=0)),e):null}),f.reduce(function(t,e){var n=e.points;return n&&(a&&m(n[0],a)||t.push({type:"M",values:[n[0].x,n[0].y]}),"line"===e.type?t.push({type:"L",values:[n[1].x,n[1].y]}):(n.shift(),n.forEach(function(e){t.push({type:"L",values:[e.x,e.y]})})),a=n[n.length-1]),t},[])},newText:function(e,t,n,a){var i,l,o,r,s,c;return(o=(l=t.createElementNS(ne,"defs")).appendChild(t.createElementNS(ne,"path"))).id=i=n+"-path",(s=(r=t.createElementNS(ne,"text")).appendChild(t.createElementNS(ne,"textPath"))).href.baseVal="#"+i,s.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),s.textContent=e,"boolean"!=typeof u&&(u="paintOrder"in r.style),a&&!u?(r.id=e=n+"-text",l.appendChild(r),(c=(n=t.createElementNS(ne,"g")).appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+e,(t=n.appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+e,(c=c.style).strokeLinejoin="round",{elmPosition:r,elmPath:o,elmOffset:s,styleText:r.style,styleFill:t.style,styleStroke:c,styleShow:n.style,elmsAppend:[l,n]}):(c=r.style,a&&(c.strokeLinejoin="round",c.paintOrder="stroke"),{elmPosition:r,elmPath:o,elmOffset:s,styleText:c,styleFill:c,styleStroke:a?c:null,styleShow:c,elmsAppend:[l,r]})},initSvg:function(t,n){var e,a,i=k.pathLabel.newText(t.text,n.baseWindow.document,O+"-pathLabel-"+t._id,t.outlineColor);["elmPosition","elmPath","elmOffset","styleFill","styleShow","elmsAppend"].forEach(function(e){t[e]=i[e]}),t.isShown=!1,t.styleShow.visibility="hidden",k.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(i.styleText[e]=t[e])}),i.elmsAppend.forEach(function(e){n.svg.appendChild(e)}),i.elmPath.setPathData([{type:"M",values:[0,100]},{type:"h",values:[100]}]),e=i.elmPosition.getBBox(),i.styleText.textAnchor=["start","end","middle"][t.semIndex],2!==t.semIndex||t.lineOffset||i.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,50),t.height=e.height,t.outlineColor&&(a=10<(a=e.height/9)?10:a<2?2:a,i.styleStroke.strokeWidth=a+"px",i.styleStroke.stroke=t.outlineColor),t.strokeWidth=a||0,$e(t.aplStats,k.pathLabel.stats),t.updateColor(n),t.updatePath(n),t.updateStartOffset(n),oe&&Ze(n,{}),t.updateShow(n)},bind:function(e,t){var n=t.props;return e.color||Pe(n,"cur_line_color",e.updateColor),Pe(n,"cur_line_strokeWidth",e.updatePath),Pe(n,"apl_path",e.updatePath),e.semIndex="startLabel"===t.optionName?0:"endLabel"===t.optionName?1:2,2===e.semIndex&&!e.lineOffset||Pe(n,"cur_attach_plugBackLenSE",e.updateStartOffset),Pe(n,"svgShow",e.updateShow),oe&&Pe(n,"new_edge4viewBox",e.adjustEdge),k.pathLabel.initSvg(e,n),!0},unbind:function(e,t){var n=t.props;e.elmsAppend&&(e.elmsAppend.forEach(function(e){n.svg.removeChild(e)}),e.elmPosition=e.elmPath=e.elmOffset=e.styleFill=e.styleShow=e.elmsAppend=null),$e(e.curStats,k.pathLabel.stats),$e(e.aplStats,k.pathLabel.stats),e.color||De(n,"cur_line_color",e.updateColor),De(n,"cur_line_strokeWidth",e.updatePath),De(n,"apl_path",e.updatePath),2===e.semIndex&&!e.lineOffset||De(n,"cur_attach_plugBackLenSE",e.updateStartOffset),De(n,"svgShow",e.updateShow),oe&&(De(n,"new_edge4viewBox",e.adjustEdge),Ze(n,{}))},removeOption:function(e,t){var n=t.props,a={};a[t.optionName]="",at(n,a)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){k.pathLabel.unbind(t,e)}))}}},Object.keys(k).forEach(function(e){it[e]=function(){return new C(k[e],Array.prototype.slice.call(arguments))}}),it.positionByWindowResize=!0,window.addEventListener("resize",w.add(function(){it.positionByWindowResize&&Object.keys(ye).forEach(function(e){Ze(ye[e],{position:!0})})}),!1),it;function lt(e,t){var n,a={conf:e,curStats:{},aplStats:{},boundTargets:[]},i={};e.argOptions.every(function(e){return!(!t.length||("string"==typeof e.type?typeof t[0]!==e.type:"function"!=typeof e.type||!e.type(t[0]))||(i[e.optionName]=t.shift(),0))}),n=t.length&&ce(t[0])?Ee(t[0]):{},Object.keys(i).forEach(function(e){n[e]=i[e]}),e.stats&&($e(a.curStats,e.stats),$e(a.aplStats,e.stats)),Object.defineProperty(this,"_id",{value:++Se}),Object.defineProperty(this,"isRemoved",{get:function(){return!ge[this._id]}}),a._id=this._id,e.init&&!e.init(a,n)||(ge[this._id]=a)}function ot(n){return function(e){var t={};t[n]=e,this.setOptions(t)}}}();function getCaretPosition(e){return $(e).caret()}function setCaretPosition(e,t){$(e).caret(t)}!function(a){"use strict";function i(e,t){this.$element=a(e),this.options=a.extend({},a.fn.typeahead.defaults,t),this.matcher=this.options.matcher||this.matcher,this.sorter=this.options.sorter||this.sorter,this.highlighter=this.options.highlighter||this.highlighter,this.updater=this.options.updater||this.updater,this.blur=this.options.blur||this.blur,this.source=this.options.source,this.$menu=a(this.options.menu),this.shown=!1,this.listen()}i.prototype={constructor:i,select:function(){var e=this.$menu.find(".active").attr("data-value");return this.$element.val(this.updater(e)).text(this.updater(e)).change(),this.hide()},updater:function(e){return e},show:function(){var e=a.extend({},this.$element.position(),{height:this.$element[0].offsetHeight});return this.$menu.insertAfter(this.$element).css({top:e.top+e.height,left:e.left}).show(),this.shown=!0,this},hide:function(){return this.$menu.hide(),this.shown=!1,this},lookup:function(e){var t;return this.query=this.$element.is("input")?this.$element.val():this.$element.html(),!this.query||this.query.length<this.options.minLength?this.shown?this.hide():this:(t=a.isFunction(this.source)?this.source(this.query,a.proxy(this.process,this)):this.source)?this.process(t):this},process:function(e){var t=this;return e=a.grep(e,function(e){return t.matcher(e)}),(e=this.sorter(e)).length?this.render(e.slice(0,this.options.items)).show():this.shown?this.hide():this},matcher:function(e){return~e.toLowerCase().indexOf(this.query.toLowerCase())},sorter:function(e){for(var t,n=[],a=[],i=[];t=e.shift();)(t.toLowerCase().indexOf(this.query.toLowerCase())?~t.indexOf(this.query)?a:i:n).push(t);return n.concat(a,i)},highlighter:function(e){var t=this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");return e.replace(new RegExp("("+t+")","ig"),function(e,t){return"<strong>"+t+"</strong>"})},render:function(e){var n=this;return(e=a(e).map(function(e,t){return(e=a(n.options.item).attr("data-value",t)).find("a").html(n.highlighter(t)),e[0]})).first().addClass("active"),this.$menu.html(e),this},next:function(e){var t=this.$menu.find(".active").removeClass("active").next();(t=!t.length?a(this.$menu.find("li")[0]):t).addClass("active")},prev:function(e){var t=this.$menu.find(".active").removeClass("active").prev();(t=!t.length?this.$menu.find("li").last():t).addClass("active")},listen:function(){this.$element.on("focus",a.proxy(this.focus,this)).on("blur",a.proxy(this.blur,this)).on("keypress",a.proxy(this.keypress,this)).on("keyup",a.proxy(this.keyup,this)),this.eventSupported("keydown")&&this.$element.on("keydown",a.proxy(this.keydown,this)),this.$menu.on("click",a.proxy(this.click,this)).on("mouseenter","li",a.proxy(this.mouseenter,this)).on("mouseleave","li",a.proxy(this.mouseleave,this))},eventSupported:function(e){var t=e in this.$element;return t||(this.$element.setAttribute(e,"return;"),t="function"==typeof this.$element[e]),t},move:function(e){if(this.shown){switch(e.keyCode){case 9:case 13:case 27:e.preventDefault();break;case 38:e.preventDefault(),this.prev();break;case 40:e.preventDefault(),this.next()}e.stopPropagation()}},keydown:function(e){this.suppressKeyPressRepeat=~a.inArray(e.keyCode,[40,38,9,13,27]),this.move(e)},keypress:function(e){this.suppressKeyPressRepeat||this.move(e)},keyup:function(e){switch(e.keyCode){case 40:case 38:case 16:case 17:case 18:break;case 9:case 13:if(!this.shown)return;this.select();break;case 27:if(!this.shown)return;this.hide();break;default:this.lookup()}},focus:function(e){this.focused=!0},blur:function(e){this.focused=!1,!this.mousedover&&this.shown&&this.hide()},click:function(e){e.stopPropagation(),e.preventDefault(),this.select(),this.$element.focus()},mouseenter:function(e){this.mousedover=!0,this.$menu.find(".active").removeClass("active"),a(e.currentTarget).addClass("active")},mouseleave:function(e){this.mousedover=!1,!this.focused&&this.shown&&this.hide()}};var e=a.fn.typeahead;a.fn.typeahead=function(n){return this.each(function(){var e=a(this),t=e.data("typeahead");t||e.data("typeahead",t=new i(this,"object"==typeof n&&n)),"string"==typeof n&&t[n]()})},a.fn.typeahead.defaults={source:[],items:8,menu:'<ul class="typeahead dropdown-menu"></ul>',item:'<li><a href="#"></a></li>',minLength:1},a.fn.typeahead.Constructor=i,a.fn.typeahead.noConflict=function(){return a.fn.typeahead=e,this},a(document).on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(e){var t=a(this);t.data("typeahead")||t.typeahead(t.data())})}(window.jQuery),function(a){"use strict";function i(e,t){a.fn.typeahead.Constructor.call(this,e,t),this.after=this.options.after||this.after,this.show=this.options.show||this.show}i.prototype=a.extend({},a.fn.typeahead.Constructor.prototype,{constructor:i,select:function(){let e=this.$menu.find(".active").attr("data-value");var t=e.length-this.length_of_query,n=getCaretPosition(this.$element[0])+t;let a=this.$element.text();return a=a.slice(0,n-t-this.length_of_query)+e.substring(0,e.length)+this.suffix+a.substring(n-t,a.length),this.$element.text(a),this.$element.change(),this.after(),setCaretPosition(this.$element[0],n+this.suffix.length),this.hide()},after:function(){},hide:function(){return this.$menu.hide(),this.shown=!1,this},show:function(){this.$element.position(),this.$element.height();var e=this.$element.width();return this.$menu.show().css({position:"absolute",margin:"auto",marginTop:-40,left:0,right:0,width:e,zIndex:100}),this.$element.after(this.$menu),this.shown=!0,this},extractor:function(){var e=this.query,t=getCaretPosition(this.$element[0]),e=e.substring(0,t),e=new RegExp("(^|\\s)(\\"+this.options.tag+"[\\w-]*)$").exec(e);return e&&e[2]?e[2].trim().toLowerCase().substr(this.options.tag.length):""},updater:function(e){return e+" "},matcher:function(e){var t=this.extractor();return!!t&&(this.length_of_query=t.length,this.suffix=this.options.suffix,~e.toLowerCase().indexOf(t))},highlighter:function(e){var t=this.extractor().replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");return e.replace(new RegExp("("+t+")","ig"),function(e,t){return"<strong>"+t+"</strong>"})}});var e=a.fn.tagautocomplete;a.fn.tagautocomplete=function(n){return this.each(function(){var e=a(this),t=e.data("tagautocomplete");t||e.data("tagautocomplete",t=new i(this,"object"==typeof n&&n)),"string"==typeof n&&t[n]()})},a.fn.tagautocomplete.Constructor=i,a.fn.tagautocomplete.defaults=a.extend(a.fn.typeahead.defaults,{tag:"@",suffix:""}),a.fn.tagautocomplete.noConflict=function(){return a.fn.tagautocomplete=e,this}}(window.jQuery),function(){function l(e){document.activeElement&&document.activeElement===e||e.focus()}jQuery.fn.caret=function(n){var a=this[0],t=a&&"true"===a.contentEditable;if(0!==arguments.length){if(a){if(-1===n&&(n=this[t?"text":"val"]().length),window.getSelection)if(t){if(l(a),0<=n){let e=window.getSelection(),t=function e(t,n,a){a||((a=document.createRange()).selectNode(t),a.setStart(t,0));if(0===n.count)a.setEnd(t,n.count);else if(t&&0<n.count)if(t.nodeType===Node.TEXT_NODE)t.textContent.length<n.count?n.count-=t.textContent.length:(a.setEnd(t,n.count),n.count=0);else for(var i=0;i<t.childNodes.length&&(a=e(t.childNodes[i],n,a),0!==n.count);i++);return a}(a,{count:n});t&&(t.collapse(!1),e.removeAllRanges(),e.addRange(t))}}else a.setSelectionRange(n,n);t||l(a)}return this}if(a){if(window.getSelection){if(t){l(a);let e=window.getSelection();if(!e.rangeCount)return 0;var i=e.getRangeAt(0),t=i.cloneRange();return t.selectNodeContents(a),t.setEnd(i.endContainer,i.endOffset),t.toString().length}return a.selectionStart}if(a.selectionStart)return a.selectionStart}}}();