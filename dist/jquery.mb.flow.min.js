...
import{FlowApp}from"../Classes/FlowApp.js";import{Util}from"../Classes/Util.js";import{UI}from"../Classes/UI.js";import{ContextualMenu,Menu}from"../Classes/Menu.js";import{KeyboardListener}from"../Classes/KeyboardListener.js";import{Events,EventType}from"../Classes/Events.js";import{Type}from"../Classes/Node.js";import{Connection}from"../Classes/Connection.js";import{ActorsDrawer}from"../Classes/ActorsDrawer.js";import{AvatarDrawer}from"../Classes/AvatarDrawer.js";!function(r){r(()=>{r.flow.init()}),r.flow={metaKeys:[],draggable:[],areaSize:{},selectedNodes:[],latMousePosition:{},contextualMenu:{boardListElement:e=>{let t=[{name:"Rename",fn:function(e){e=r(e).parent().data("board-id");r.flow.editBoardName(e)}},{name:"Duplicate",fn:function(e){e=r(e).parent().data("board-id");r.flow.duplicateBoard(e)}},{name:"Export",fn:function(e){var t=r(e).parent().data("board-id");r(e).parent().find(".name").text();console.debug("Export board ",t)}}],a=r(e).parent().data("board-id"),i=flowApp.flow.getBoardById(a),n=flowApp.flow.getBoardsGroupsList();return 1<n.length&&(t.push({}),t.push({name:"Move to: ",className:"listTitle"})),n.forEach(n=>{var e;n!==i._group&&(e={name:n,className:"listElement",fn:function(e){r.flow.moveBoardToGroup(a,n);var t=flowApp.flow.selectedBoardGroup;flowApp.drawer.drawBoardList(),r.flow.showBoardsByGroup(t)}},t.push(e))}),t.push({}),t.push({name:"Delete",className:"alert",fn:function(e){var t=r(e).parent().data("board-id");r.flow.deleteBoard(t,e)}}),t},flows:[{name:"Rename",fn:function(e){var t=r(e).parent().data("flow-id");console.debug(e,t),r.flow.editFlowName(t)}},{name:"Duplicate",fn:function(e){console.log("Duplicate",r(e).parent().data("flow-id"))}},{},{name:"Options",fn:function(e){var t=r(e).parent().data("flow-id"),e=r(e).parent().find(".name").text();console.debug("Export "+t+"  -  "+e)}},{name:"Export",fn:function(e){var t=r(e).parent().data("flow-id"),e=r(e).parent().find(".name").text();console.debug("Export "+t+"  -  "+e)}},{},{name:"New",className:"highlight",fn:function(e){r.flow.addFlow()}},{},{name:"Delete",className:"alert",fn:function(e){var t=r(e).parent().data("flow-id");r.flow.deleteFlow(t,e)}}],boardsGroups:()=>{let n=[];n.push({name:"Show All",fn:function(e){flowApp.flow.selectedBoardGroup="all",r.flow.showBoardsByGroup("all")}}),n.push({});let e=flowApp.flow.getBoardsGroupsList();e.forEach(t=>{var e={name:t,className:"listElement",fn:function(e){flowApp.flow.selectedBoardGroup=t,r.flow.showBoardsByGroup(t)}};n.push(e)}),n.push({});var t={name:"Rename Group",fn:function(e){let t=r(e).parent().find(".name");t.attr({contentEditable:!0}),t.focus();let n=t.text();Util.selectElementContents(t.get(0)),t.one("blur",()=>{flowApp.flow.updateGroupName(n,t.text()),t.attr({contentEditable:!1})})}};return"all"!==flowApp.flow.selectedBoardGroup&&n.push(t),n.push({name:"New Group",className:"highlight",fn:function(e){var t={title:"Add a new Group for <br><b>"+flowApp.flow._name+"</b>",text:null,inputId:"groupName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:e=>{flowApp.flow.addGroup(e),r.flow.showBoardsByGroup(e)},className:"alert"};UI.dialogue(t)}}),n},nodeMenu:e=>{let n=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let i=n.getNodeById(e),t=[{name:"Add Line",fn:function(e){e=r(e).parents(".node").data("node-id"),e=n.getNodeById(e);Events.register(EventType.addNodeElement,e)}},{},{name:"Clone",fn:function(e){e=r(e).parents(".node").data("node-id"),n.getNodeById(e);console.debug("Clone")}},{name:"Delete",className:"alert",fn:function(t,e){t=r(t).parents(".node").data("node-id");if(null!=t){let e=r.flow.selectedBoard();e.deleteNodeById(t)}}}];if(i._connections.length&&(t.push({}),t.push({name:"Remove Connections",className:"listTitle"})),null!=e){let e=0;i._connections.forEach(a=>{t.push({name:"Connection "+ ++e,className:"alert",fn:function(e,t){a._connectionLine.remove(),i._connections.delete(a),n._connections.delete(a),Events.register(EventType.updateBoard,n)},hoverFn:function(e,t){a._connectionLine.setOptions({color:"red"})},outFn:function(e,t){var n=a._type||0,n=flowApp.drawer.getConnectionColorByConnectionType(n);a._connectionLine.setOptions({color:n})}})})}return t},cycleMenu:[{name:"List",icon:"icon-list-ol",fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType="List",r(e).attr("class","icon icon-list-ol"),Events.register(EventType.updateBoard,t)}},{name:"Repeat",icon:"icon-repeat",fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType="Repeat",r(e).attr("class","icon icon-repeat"),Events.register(EventType.updateBoard,t)}},{name:"Random",icon:"icon-random",fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType="Random",r(e).attr("class","icon icon-random"),Events.register(EventType.updateBoard,t)}}],actorMenu:e=>{let t=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let n=t.getNodeById(e),a=[];return a.push({name:"Actors",className:"listTitle"}),a.push({}),flowApp.flow._actors.forEach(t=>{a.push({name:t._name,fn:function(e){n._actorId=t._id,flowApp.drawer.drawBoard()}})}),a},board:[{name:"New Text Node",icon:"icon-commenting",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.text,{_x:t.clientX,_y:t.clientY})}},{name:"New Choice Node",icon:"icon-th-list",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.choices,{_x:t.clientX,_y:t.clientY})}},{name:"New Conditional Node",icon:"icon-sitemap",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.condition,{_x:t.clientX,_y:t.clientY})}},{name:"New Note node",icon:"icon-thumb-tack",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.note,{_x:t.clientX,_y:t.clientY})}},{name:"New Random Node",icon:"icon-random",fn:function(e,t){let n=r.flow.selectedBoard();n.addNode(Type.random,{_x:t.clientX,_y:t.clientY})}}],node:e=>{let t=[{name:"Clone",fn:function(e){console.debug("Clone")}},{name:"Delete",className:"alert",fn:function(t,e){t=r(t).parents(".node").data("node-id");if(null!=t){let e=r.flow.selectedBoard();e.deleteNodeById(t)}}}];e=r(e).parents(".node").data("node-id");let a=r.flow.selectedBoard(),i=a.getNodeById(e);if(i._connections.length&&(t.push({}),t.push({name:"Remove Connections",className:"listTitle"})),null!=e){let e=0;i._connections.forEach(n=>{t.push({name:"Connection "+ ++e,className:"alert",fn:function(e,t){console.debug(n),n._connectionLine.remove(),i._connections.delete(n),a._connections.delete(n),Events.register(EventType.updateBoard,a)},hoverFn:function(e,t){n._connectionLine.setOptions({color:"red"})},outFn:function(e,t){n._connectionLine.setOptions({color:"gray"})}})})}return t},nodeElement:e=>{let a=r(e).is(".node-text")?r(e):r(e).find(".node-text"),i=a.caret();return[{name:"Add variables",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n=" <span id='variable_"+Util.setUID()+"' class='variables' contenteditable='false'>{"+t+"}</span> ";a.caret(i),function(e){var t,n;if(window.getSelection&&(t=window.getSelection()).getRangeAt&&t.rangeCount){(n=t.getRangeAt(0)).deleteContents();var a=document.createElement("div");a.innerHTML=e;for(var i,l,o=document.createDocumentFragment();i=a.firstChild;)l=o.appendChild(i);n.insertNode(o),l&&((n=n.cloneRange()).setStartAfter(l),n.collapse(!0),t.removeAllRanges(),t.addRange(n))}}(n),Util.addVariables("{"+t+"}")},className:null};UI.dialogue(n)}},{},{name:"Delete Line",icon:"icon-remove",className:"alert",fn:function(e,t){let n=r(e).is(".node-content-line")?r(e):r(e).parents(".node-content-line");var a=n.data("node-id"),e=n.data("node-element-id");console.debug(n,a,e),Events.register(EventType.deletetNodeElement,{nodeId:a,nodeElementId:e})}}]},variablesMenu:e=>{let a=r(e),i=r(e).parents(".node-text"),t=[];return e._variables=flowApp.flow._variables,t.push({name:"Edit variables",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:a.text().replace(/{/g,"").replace(/}/g,""),okLabel:"Update",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n="{"+t+"}";Util.addVariables(n),i.find("#"+a.attr("id")).html(n),i.focus()},className:null};UI.dialogue(n)}}),t.push({name:"Delete variables",icon:"icon-remove",className:"alert",fn:function(e,t){i.find("#"+a.attr("id")).remove()}}),t}},flowApp:()=>flowApp,selectedBoard:()=>flowApp.flow.getBoardById(flowApp.flow._selectedBoardId),init:()=>{window.Avataaars=Avataaars,window.KeyListener=new KeyboardListener,window.flowApp=new FlowApp;var e=r.mbStorage.get("lastFlow");null!=e?flowApp.load(e):r.flow.addFlow(),window.flows_menu=new Menu(".flows-menu",r.flow.contextualMenu.flows,!0),window.board_list_element_menu=new Menu(".board-list-element-menu",r.flow.contextualMenu.boardListElement,!0),window.boards_groups=new Menu(".boards-group-menu",r.flow.contextualMenu.boardsGroups,!0),window.node_menu=new Menu('[data-menu="node"]',r.flow.contextualMenu.nodeMenu,!0),window.cycle_menu=new Menu('[data-menu="cycle"]',r.flow.contextualMenu.cycleMenu,!0),window.actor_menu=new Menu('[data-menu="actor"]',r.flow.contextualMenu.actorMenu,!0),window.board_contextual_menu=new ContextualMenu(flowApp.ui.placeholders.drawingArea,r.flow.contextualMenu.board,!0),window.node_contextual_menu=new ContextualMenu(".node",r.flow.contextualMenu.node,!1),window.variables_contextual_menu=new ContextualMenu(".variables",r.flow.contextualMenu.variablesMenu,!0),window.nodeElement_contextual_menu=new ContextualMenu(".node-content-line",r.flow.contextualMenu.nodeElement,!0),r(document).on("keypress","[contenteditable]",e=>{var t=r(e.target).parents(".node");switch(0<t.length&&(r.flow.autoShiftNodes(t),r.flow.updateConnections(),r(e.target)[0].caretPos=r(e.target).caret()),e.key){case"Enter":if(0<t.length)return r.flow.autoShiftNodes(t),r.flow.updateConnections(),void(0<=r.flow.metaKeys.indexOf("Shift")&&(e.preventDefault(),r(e.target).blur()));break;case"Backspace":if(0<r(e.target).parents(".node").length)return r.flow.autoShiftNodes(t),void r.flow.updateConnections();break;default:if(0<=r.flow.metaKeys.indexOf("Meta"))return console.debug(e.key),e.preventDefault(),!1}}),r("[contenteditable]").on("paste",function(e){e.preventDefault();e=(e.originalEvent||e).clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,e)}),r(document).on("keydown",n=>{if(0<=r.flow.metaKeys.indexOf("Meta")){r(".node").draggable("disable");let t=r.flow.selectedBoard();switch(n.stopPropagation(),n.key){case"0":case"-":case"+":n.preventDefault();break;case"Backspace":n.preventDefault(),r.flow.selectedNodes.forEach(e=>{t.deleteNodeById(e)}),r.flow.selectedNodes=[]}}if(0<=r.flow.metaKeys.indexOf("Control")){let e=r.flow.selectedBoard();n.stopPropagation(),"n"===n.key&&(n.preventDefault(),e.addNode(Type.text,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y}))}}),r(document).on("keyup",()=>{r(".node").draggable("enable")});let a=r(flowApp.ui.placeholders.board);a[0].style.zoom=1;let i={};r(document).on("mousedown.drag",e=>{r(e.target).parents(".node").length||(0<=r.flow.metaKeys.indexOf("Meta")?(r("body").css("cursor","grab"),i={left:a.position().left,top:a.position().top,x:e.clientX,y:e.clientY}):0<=r.flow.metaKeys.indexOf("Shift")&&flowApp.drawer.drawSelection(e),r(document).on("mousemove.drag",e=>{var t,n;r.flow.latMousePosition={x:e.clientX,y:e.clientY},r(e.target).parents(".node").length||(0<=r.flow.metaKeys.indexOf("Meta")?(r("body").css("cursor","grabbing"),t=e.clientX-i.x,n=e.clientY-i.y,a.css({left:i.left+t,top:i.top+n}),r.flow.updateConnections()):0<=r.flow.metaKeys.indexOf("Shift")&&flowApp.drawer.drawSelection(e))}).one("mouseup.drag",t=>{if(flowApp.drawer.drawSelection(t),0<=r.flow.metaKeys.indexOf("Meta")){var n=parseFloat(a.css("left")),t=parseFloat(a.css("top"));a.css({left:n+n%30,top:t+t%30}),r.flow.updateConnections(),r("body").css("cursor","default");let e=r.flow.getSelectedBoard();e._x=parseFloat(a.css("left")),e._y=parseFloat(a.css("top")),Events.register(EventType.updateBoard,e)}r(document).off("mousemove.drag")}))})},addFlow:()=>{var e={title:"Add a new Flow",text:null,inputId:"flowName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.addFlow(e),r.mbStorage.set("lastFlow",flowApp.flow.id);e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:null};UI.dialogue(e)},openFlow:()=>{},editFlowName:()=>{let e=r(flowApp.ui.placeholders.flowName).find("h1");e.attr({contentEditable:!0}),e.focus(),Util.selectElementContents(e.get(0)),e.one("blur",()=>{flowApp.flow.updateName(e.text()),e.attr({contentEditable:!1})})},deleteFlow:(t,e)=>{e={title:"Delete Flow",text:"Are you sure you want to delete<br><b>"+r(e).parent().find(".name").text()+"</b>?",inputId:null,inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.deleteFlow(t);var e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:"alert"};UI.dialogue(e)},getSelectedBoard:()=>flowApp.flow.getBoardById(flowApp.flow.selectedBoardId),addBoard:()=>{var e={title:"Add a new Board",text:null,inputId:"boardName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.flow.addBoard(e,flowApp.flow.selectedBoardGroup)},className:null};UI.dialogue(e)},duplicateBoard:e=>{flowApp.flow.duplicateBoard(e)},moveBoardToGroup:(e,t)=>{flowApp.flow.moveBoardToGroup(e,t);t=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,t)},editBoardName:t=>{let n=r(flowApp.ui.placeholders.boardList).find("#board_"+t+" .name");n.attr({contentEditable:!0}),n.focus(),Util.selectElementContents(n.get(0)),n.one("blur",()=>{let e=flowApp.flow.getBoardById(t);e._name=n.text(),flowApp.drawer.drawBoardList()})},deleteBoard:(e,t)=>{t={title:"Delete Board",text:"Are you sure you want to delete<br><b>"+r(t).parent().find(".name").text()+"</b>?",inputId:"boardName",inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.flow.deleteBoard(e),flowApp.drawer.drawBoardList()},className:"alert"};UI.dialogue(t)},showBoardsByGroup:e=>{r(flowApp.ui.placeholders.boardList).find("li").hide(),("all"!==e?r(flowApp.ui.placeholders.boardList).find('[data-board-group="'+e+'"]'):r(flowApp.ui.placeholders.boardList).find("li")).show(),r(flowApp.ui.placeholders.boardGroupName).html("all"!==e?e:"All Boards")},makeNodeDraggableAndLinkable:e=>{let n=r("#node_"+e),a=n.get(0),i=r.flow.getSelectedBoard(),l=i.getNodeById(e);n.draggable({handle:n.find(".menu").length?".menu":null,cursor:"grabbing",opacity:.7,snap:".vline, .hline",zIndex:100,start:()=>{a.startX=n.position().left,a.startY=n.position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=r("#node_"+n),t=e.get(0);t.startX=parseFloat(e.css("left")),t.startY=parseFloat(e.css("top"))}})},drag:()=>{a.distanceX=n.position().left-a.startX,a.distanceY=n.position().top-a.startY,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(t=>{if(t!==e){let e=r("#node_"+t);e[0].style.left=e[0].startX+a.distanceX+"px",e[0].style.top=e[0].startY+a.distanceY+"px"}}),r.flow.updateConnections()},stop:()=>{l._x=r(a).position().left,l._y=r(a).position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=i.getNodeById(n),t=r("#node_"+n);e._x=t.position().left,e._y=t.position().top}}),Events.register(EventType.updateNode,l)}});let t=n.is(".anchorOut")?n:n.find(".anchorOut");t.each(function(){r(this).on("mousedown",function(e){if(0<=r.flow.metaKeys.indexOf("Meta")){e.stopPropagation();let t=r(flowApp.ui.placeholders.board),a=n.is(".anchorOut")?n:r(this);0<=r.flow.metaKeys.indexOf("Alt")&&l._type===Type.condition&&(a=n);let i=r("<div id='fakeEl'>").css({position:"absolute",width:10,height:10,background:"transparent",zIndex:-100,left:e.clientX-t.position().left,top:e.clientY-t.position().top});i.appendTo(flowApp.ui.placeholders.board);e=0<=r.flow.metaKeys.indexOf("Alt")&&l._type===Type.condition?"red":"orange";r(this).get(0).line=r.flow.LeaderLine(a.is(".anchorOut")||0<=r.flow.metaKeys.indexOf("Alt")&&l._type===Type.condition?a:a.find(".anchor"),i,{color:e,size:3}),r(document).on("mousemove.line",e=>{i.css({left:e.clientX-t.position().left,top:e.clientY-t.position().top}),r(this).get(0).line.position()}).one("mouseup",e=>{let t=0;switch(l._type){case Type.choices:t=1;break;case Type.condition:t=null!=a.data("node-element-id")?2:3;break;case Type.random:t=4}r(document).off("mousemove.line"),i.remove(),r(this).get(0).line.remove();let n=r(e.target).parents(".node");e=new Connection(null,a.data("node-id"),a.data("node-element-id"),n.data("node-id"),t);Events.register(EventType.addConnection,e)})}})})},LeaderLine:(e,t,n)=>new LeaderLine(e.get(0),t.get(0),n),updateConnections:()=>{let n=r.flow.getSelectedBoard()._connections;n.forEach(e=>{let t=e._connectionLine;t?"function"==typeof t.position&&t.position():n.delete(e)})},autoShiftNodes:i=>{let e=r.flow.getSelectedBoard()._nodes,l=parseFloat(i.css("left")),o=parseFloat(i.css("top"));i.get(0).h&&i.height()===i.get(0).h||(e.forEach(e=>{let t=r(flowApp.ui.placeholders.board).find("#node_"+e._id);var n=parseFloat(t.css("left")),a=parseFloat(t.css("top"));n>=l&&n<l+i.width()&&a>o&&(n=i.height()-i.get(0).h,t.css({top:a+n}),e._x=t.position().left,e._y=t.position().top)}),i.get(0).h=i.height())},getNodeById:e=>{let t=r.flow.getSelectedBoard();return t.getNodeById(e)},addToSelectedNodes:function(e,t=!1){t?r.flow.selectedNodes.indexOf(e)<0&&r.flow.selectedNodes.unshift(e):(r.flow.selectedNodes=[],r.flow.selectedNodes.unshift(e)),Events.register(EventType.selectNode,{selectedNodeId:e})},removeFromSelectedNodes:function(e=null){e?r.flow.selectedNodes.delete(e):r.flow.selectedNodes=[]},drawActorsWindow:()=>{ActorsDrawer.openWindow()},drawAvatarWindow:e=>{AvatarDrawer.openWindow(e)}},Array.prototype.delete=function(t){for(let e=0;e<this.length;e++)this[e]===t&&(this.splice(e,1),e--)}}(jQuery,document);const Avataaars={defaultOptions:{style:"circle"},create(e){return this._createAvataaar({...this.defaultOptions,...e})},setDefaultAvatar(e){this.defaultOptions=e},getEditableTypes(){return Object.keys(this.paths).filter(e=>1<Object.keys(this.paths[e]).length)},_getChildOrDefault(e,t,n){return void 0!==e[t][n]?e[t][n]:["facialHair","accessories"].includes(t)&&null==n?()=>"":e[t].default||e[t][Object.keys(e[t])[0]]},_getShape(e,t){return this._getChildOrDefault(this.paths,e,t)},_getColor(e,t){return this._getChildOrDefault(this.colors,e,t)},_createAvataaar(e){let t=this.paths.nose.default,n=this.paths.skin.default;var a=this._getColor("skin",e.skin);let[i,,l]=this._getTopType(e.top),o=this._getShape("facialHair",e.facialHair);var r=this._getColor("hair",e.facialHairColor);let s=this._getShape("clothing",e.clothing),c=this._getShape("clothingGraphic",e.clothingGraphic);var u=this._getColor("palette",e.clothingColor);let d=this._getShape("eyes",e.eyes),p=this._getShape("eyebrows",e.eyebrows),h=this._getShape("mouth",e.mouth),f=this._getShape("accessories",e.accessories);var m=this._getColor("palette",e.accessoriesColor),y=this._getColor("palette",e.hatColor),v=this._getColor("hair",e.hairColor),g=(e,t,n)=>0<e.length?`<g transform="translate(${t}, ${n})">${e}</g>`:"",v=g(i(y,v),7,0);let S=`
      ${g(n(a),40,36)}
      ${g(s(u,c()),8,170)}
      ${g(h(),86,134)}
      ${g(t(),112,122)}
