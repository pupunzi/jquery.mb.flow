...
import{FlowApp}from"./Classes/FlowApp.js";import{Util}from"./Classes/Util.js";import{UI}from"./Classes/UI.js";import{ClassName,ContextualMenu,Menu}from"./Classes/Menu.js";import{KeyboardListener,KeyType}from"./Classes/KeyboardListener.js";import{Events,EventType}from"./Classes/Events.js";import{CycleType,Type}from"./Classes/Node.js";import{Connection}from"./Classes/Connection.js";import{ActorsDrawer}from"./Classes/ActorsDrawer.js";import{AvatarDrawer}from"./Classes/AvatarDrawer.js";import{Drawer}from"./Classes/Drawer.js";import{PreviewDrawer}from"./Classes/PreviewDrawer.js";!function(r,s,c){function i(e){var t,n;if(c.getSelection&&(t=c.getSelection()).getRangeAt&&t.rangeCount){(n=t.getRangeAt(0)).deleteContents();var a=s.createElement("div");a.innerHTML=e;for(var l,i,o=s.createDocumentFragment();l=a.firstChild;)i=o.appendChild(l);n.insertNode(o),i&&((n=n.cloneRange()).setStartAfter(i),n.collapse(!0),t.removeAllRanges(),t.addRange(n))}}r(()=>{r.flow.init()}),r.flow={metaKeys:[],draggable:[],areaSize:{},selectedNodes:[],latMousePosition:{},vars:{},flowApp:()=>flowApp,selectedBoard:()=>{if(flowApp.flow)return flowApp.flow.getBoardById(flowApp.flow._selectedBoardId)},menu:{boardListElementMenu:e=>{let t=[{name:"Rename",fn:function(e){e=r(e).parent().data("board-id");r.flow.editBoardName(e)}},{name:"Duplicate",fn:function(e){e=r(e).parent().data("board-id");r.flow.duplicateBoard(e)}},{name:"Export",fn:function(e){flowApp.exportToFile()}}],a=r(e).parent().data("board-id"),l=flowApp.flow.getBoardById(a),n=flowApp.flow.getBoardsByGroup();return 1<n.length&&(t.push({}),t.push({name:"Move to: ",className:ClassName.listTitle})),n.forEach(n=>{var e;n!==l._group&&(e={name:n,className:"listElement",fn:function(e){r.flow.moveBoardToGroup(a,n);var t=flowApp.flow.selectedBoardGroup;flowApp.drawer.drawBoardList(),r.flow.showBoardsByGroup(t)}},t.push(e))}),t.push({}),t.push({name:"Delete",className:ClassName.alert,fn:function(e){var t=r(e).parent().data("board-id");r.flow.deleteBoard(t,e)}}),t},flowsMenu:e=>{let t=r(e).parent().data("flow-id");return[{name:"Rename",fn:function(e){console.debug(e,t),r.flow.editFlowName(t)}},{name:"Duplicate",fn:function(e){console.log("Duplicate",r(e).parent().data("flow-id"))}},{name:"New",fn:function(e){r.flow.addFlow()}},{},{name:"Options",icon:"icon-cog",fn:function(e){}},{name:"Flows List",icon:"icon-list-ul",fn:function(e){}},{},{name:"Export",className:ClassName.highlight,icon:"icon-download",fn:function(e){flowApp.exportToFile()}},{name:"Import",icon:"icon-upload",className:ClassName.highlight,fn:function(e){FlowApp.ImportFromFile()}},{},{name:"Delete",className:ClassName.alert,fn:function(e){r.flow.deleteFlow(t,e)}}]},boardsGroupsMenu:e=>{let n=[];n.push({name:"Show All",fn:function(e){flowApp.flow.selectedBoardGroup="all",r.flow.showBoardsByGroup("all")}}),n.push({});let t=flowApp.flow.getBoardsByGroup();t.forEach(t=>{var e={name:t,className:ClassName.listElement,fn:function(e){flowApp.flow.selectedBoardGroup=t,r.flow.showBoardsByGroup(t)}};n.push(e)}),n.push({});var a={name:"Rename Group",fn:function(e){let t=r(e).parent().find(".name");t.attr({contentEditable:!0}),t.focus();let n=t.text();Util.selectElementContents(t.get(0)),t.one("blur",()=>{flowApp.flow.updateGroupName(n,t.text()),t.attr({contentEditable:!1})})}};"all"!==flowApp.flow.selectedBoardGroup&&n.push(a);a={name:"New Group",className:ClassName.highlight,fn:function(e){var t={title:"Add a new Group for <br><b>"+flowApp.flow._name+"</b>",text:null,inputId:"groupName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:e=>{flowApp.flow.addGroup(e),r.flow.showBoardsByGroup(e)},className:""};UI.dialogue(t)}};return n.push(a),n},nodeMenu:e=>{let n=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let l=n.getNodeById(e),t=[];if(l._type!==Type.variables&&(t.push({name:"Add Line",fn:function(e){e=r(e).parents(".node").data("node-id"),e=n.getNodeById(e);Events.register(EventType.addNodeElement,e)}}),t.push({})),t.push({name:"Clone",fn:function(e){e=r(e).parents(".node").data("node-id"),n.getNodeById(e);console.debug("Clone")}}),t.push({name:"Delete",className:ClassName.alert,fn:function(t,e){t=r(t).parents(".node").data("node-id");if(null!=t){let e=r.flow.selectedBoard();e.deleteNodeById(t)}}}),l._connections.length&&(t.push({}),t.push({name:"Remove Connections",className:ClassName.listTitle})),null!=e){let e=0;l._connections.forEach(a=>{t.push({name:"Connection "+ ++e,className:ClassName.alert,fn:function(e,t){a._connectionLine.remove(),l._connections.delete(a),n._connections.delete(a),flowApp.drawer.drawBoard(),Events.register(EventType.updateBoard,n)},hoverFn:function(e,t){a._connectionLine.setOptions({color:"red"}),r(".contextual-menu").css({opacity:.5})},outFn:function(e,t){var n=a._type||0,n=Drawer.getConnectionColorByConnectionType(n);a._connectionLine.setOptions({color:n}),r(".contextual-menu").css({opacity:1})}})})}return t},cycleMenu:e=>{let t=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let n=t.getNodeById(e);return[{name:"List",icon:"icon-list-ol",className:"List"===n._cycleType?ClassName.highlight:null,fn:function(e){n._cycleType=CycleType.list,r(e).attr("class","icon icon-list-ol"),Events.register(EventType.updateBoard,t)}},{name:"Loop",icon:"icon-repeat",className:"Repeat"===n._cycleType?ClassName.highlight:null,fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType=CycleType.loop,r(e).attr("class","icon icon-repeat"),Events.register(EventType.updateBoard,t)}},{name:"Random",icon:"icon-random",className:"Random"===n._cycleType?ClassName.highlight:null,fn:function(e){let t=r.flow.selectedBoard();var n=r(e).parents(".node").data("node-id");let a=t.getNodeById(n);a._cycleType=CycleType.random,r(e).attr("class","icon icon-random"),Events.register(EventType.updateBoard,t)}}]},actorMenu:e=>{let t=r.flow.selectedBoard();e=r(e).parents(".node").data("node-id");let n=t.getNodeById(e),a=[];return a.push({name:"Actors",className:ClassName.listTitle}),a.push({}),flowApp.flow._actors.forEach(t=>{a.push({name:t._name,className:t._id===n._actorId?ClassName.highlight:null,fn:function(e){n._actorId=t._id,flowApp.drawer.drawBoard()}})}),a},boardMenu:e=>{let n=r.flow.selectedBoard();return[{name:"New Text Node",icon:"icon-commenting",fn:function(e,t){n.addNode(Type.text,{_x:t.clientX,_y:t.clientY})}},{name:"New Choice Node",icon:"icon-th-list",fn:function(e,t){n.addNode(Type.choices,{_x:t.clientX,_y:t.clientY})}},{name:"New Conditional Node",icon:"icon-sitemap",fn:function(e,t){n.addNode(Type.condition,{_x:t.clientX,_y:t.clientY})}},{name:"New Sequence Node",icon:"icon-tasks",fn:function(e,t){n.addNode(Type.sequence,{_x:t.clientX,_y:t.clientY})}},{name:"New Note node",icon:"icon-thumb-tack",fn:function(e,t){n.addNode(Type.note,{_x:t.clientX,_y:t.clientY})}},{name:"New Variables node",icon:"icon-code",fn:function(e,t){n.addNode(Type.variables,{_x:t.clientX,_y:t.clientY})}},{name:"New Random Node",icon:"icon-random",fn:function(e,t){n.addNode(Type.random,{_x:t.clientX,_y:t.clientY})}},{name:"New JumpTo Node",icon:"icon-arrow-circle-right",fn:function(e,t){n.addNode(Type.jumpToNode,{_x:t.clientX,_y:t.clientY})}}]},nodeElementMenu:e=>{let a=r(e).is(".node-text")?r(e):r(e).find(".node-text"),l=a.caret(),t=[{name:"Delete Line",icon:"icon-remove",className:ClassName.alert,fn:function(e,t){let n=r(e).is(".node-content-line")?r(e):r(e).parents(".node-content-line");var a=n.data("node-id"),e=n.data("node-element-id");Events.register(EventType.deletetNodeElement,{nodeId:a,nodeElementId:e})}}];if(a.is("[contenteditable]")&&(t.push({}),t.push({name:"enter a calculation",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n=" <span id='variable_"+Util.setUID()+"' class='variables' contenteditable='false'>{"+t+"}</span><br>";a.caret(l),i(n),Util.parseVariables("{"+r(n).text()+"}"),flowApp.save(flowApp.flow._id)},className:null};UI.dialogue(n)}}),0<Object.keys(flowApp.flow._variables).length)){t.push({name:"Insert variable:",className:ClassName.listTitle});for(const n in flowApp.flow._variables)t.push({name:n,icon:"icon-code",fn:function(e,t){a.caret(l),i("<span class='eval-variable' contenteditable='false'>"+n+" </span>"),flowApp.save(flowApp.flow._id)}})}return t},variablesMenu:e=>{let l=r(e).is(".variables")?r(e):r(e).parents(".variables"),i=r(e).parents(".node-text"),t=[];return e._variables=flowApp.flow._variables,t.push({name:"Edit variable",icon:"icon-code",fn:function(e,t){var n={title:"Variables",text:null,inputId:"vars",inputValue:l.text().replace(/{/g,"").replace(/}/g,""),okLabel:"Update",cancelLabel:"Cancel",action:t=>{let e=Util.findVariables(t);e.forEach(e=>{t=t.replace(e,"<i>"+e+"</i>")});var n="{"+t+"}";let a=i.find("#"+l.attr("id"));a.html(n),Util.parseVariables(a.text()),flowApp.save(flowApp.flow._id),i.focus()},className:null};UI.dialogue(n)}}),t}},init:()=>{c.Avataaars=Avataaars,c.KeyListener=new KeyboardListener,c.flowApp=new FlowApp;var e=r.mbStorage.get("selectedFlow");null!=e?flowApp.load(e):r.flow.addFlow(),c.flows_menu=new Menu(".flows-menu",r.flow.menu.flowsMenu,!0),c.board_list_element_menu=new Menu(".board-list-element-menu",r.flow.menu.boardListElementMenu,!0),c.boards_groups=new Menu(".boards-group-menu",r.flow.menu.boardsGroupsMenu,!0),c.node_menu=new Menu('[data-menu="node"]',r.flow.menu.nodeMenu,!0),c.cycle_menu=new Menu('[data-menu="cycle"]',r.flow.menu.cycleMenu,!0),c.actor_menu=new Menu('[data-menu="actor"]',r.flow.menu.actorMenu,!0),c.board_contextual_menu=new ContextualMenu(flowApp.ui.placeholders.drawingArea,r.flow.menu.boardMenu,!0),c.node_contextual_menu=new ContextualMenu(".node",r.flow.menu.nodeMenu,!1),c.variables_contextual_menu=new ContextualMenu(".variables",r.flow.menu.variablesMenu,!0),c.nodeElement_contextual_menu=new ContextualMenu(".node-content-line",r.flow.menu.nodeElementMenu,!0),r(s).on("paste","[contenteditable]",e=>{e.preventDefault();e=(e.originalEvent||e).clipboardData.getData("text/plain");s.execCommand("insertHTML",!1,e)}),r(s).on("keypress","[contenteditable]",e=>{var t=r(e.target).parents(".node");switch(0<t.length&&(r(e.target)[0].caretPos=r(e.target).caret()),e.key){case KeyType.enter:if(0<t.length)return void(0<=r.flow.metaKeys.indexOf(KeyType.shift)&&(e.preventDefault(),r(e.target).blur()));e.preventDefault(),r(e.target).blur();break;case KeyType.backspace:if(0<r(e.target).parents(".node").length)return;break;default:if(0<=r.flow.metaKeys.indexOf(KeyType.meta))return e.preventDefault(),!1}}),r(s).on("keyup","[contenteditable]",e=>{e=r(e.target).parents(".node");0<e.length&&(r.flow.autoShiftNodes(e),r.flow.updateConnections())}),r(s).on("click","[contenteditable]",e=>(e.preventDefault(),e.stopPropagation(),!1)),r(s).on("keydown",e=>{console.debug(e.key);let t=r.flow.selectedBoard();if(0<=r.flow.metaKeys.indexOf(KeyType.meta)||0<=r.flow.metaKeys.indexOf(KeyType.alt)||0<=r.flow.metaKeys.indexOf(KeyType.space))switch(r(".node").draggable("disable"),e.stopPropagation(),e.key){case" ":r(e.target).is("[contenteditable=true]")||e.preventDefault();break;case"0":case"-":case"+":e.preventDefault();break;case"Backspace":0<=r.flow.metaKeys.indexOf(KeyType.meta)&&(e.preventDefault(),r.flow.selectedNodes.forEach(e=>{t.deleteNodeById(e)}),r.flow.selectedNodes=[])}if(0<=r.flow.metaKeys.indexOf(KeyType.control))switch(e.stopPropagation(),e.key){case"t":e.preventDefault(),t.addNode(Type.text,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"n":e.preventDefault(),t.addNode(Type.note,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"c":e.preventDefault(),t.addNode(Type.choices,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"v":e.preventDefault(),t.addNode(Type.variables,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"r":e.preventDefault(),t.addNode(Type.random,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"s":e.preventDefault(),t.addNode(Type.sequence,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y});break;case"x":e.preventDefault(),t.addNode(Type.condition,{_x:r.flow.latMousePosition.x,_y:r.flow.latMousePosition.y})}}),r(s).on("keyup",()=>{r(".node").draggable("enable")}),r(c).on("resize",()=>{flowApp.drawer.drawGrid()}),r(c).on("blur",()=>{r(".node").draggable("enable")});let a=r(flowApp.ui.placeholders.board);a[0].style.zoom=1;let l={};r(s).on("mousedown.drag",e=>{0<=r.flow.metaKeys.indexOf(KeyType.space)?(e.preventDefault(),r("body").css("cursor","grab"),l={left:a.offset().left,top:a.offset().top,x:e.pageX,y:e.pageY,hasMove:!0}):0<=r.flow.metaKeys.indexOf(KeyType.shift)&&flowApp.drawer.drawSelection(e),r(s).on("mousemove.drag",e=>{var t,n;r.flow.latMousePosition={x:e.clientX,y:e.clientY},0<=r.flow.metaKeys.indexOf(KeyType.space)?(e.preventDefault(),r("body").css("cursor","grabbing"),l.hasMove&&(t=l.left+Math.round((e.pageX-l.x)/flowApp._grid)*flowApp._grid,n=l.top+Math.round((e.pageY-l.y)/flowApp._grid)*flowApp._grid,a.css({left:t,top:n})),r.flow.updateConnections()):0<=r.flow.metaKeys.indexOf(KeyType.shift)&&flowApp.drawer.drawSelection(e)}).one("mouseup.drag",e=>{if(flowApp.drawer.drawSelection(e),l.hasMove=!1,r(s).off("mousemove.drag"),r("body").css("cursor","default"),0<=r.flow.metaKeys.indexOf(KeyType.space)){r.flow.updateConnections();let e=r.flow.getSelectedBoard();e._x=parseFloat(a.css("left")),e._y=parseFloat(a.css("top")),Events.register(EventType.updateBoard,e)}})})},makeNodeDraggableAndLinkable:e=>{let l=r("#node_"+e),n=l.get(0),a=r.flow.getSelectedBoard(),i=a.getNodeById(e);l.draggable({handle:l.find(".menu").length?".menu":null,cursor:"grabbing",opacity:.7,snap:".vline, .hline",zIndex:100,start:()=>{n.startX=l.position().left,n.startY=l.position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=r("#node_"+n),t=e.get(0);t.startX=parseFloat(e.css("left")),t.startY=parseFloat(e.css("top"))}})},drag:()=>{n.distanceX=l.position().left-n.startX,n.distanceY=l.position().top-n.startY,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(t=>{if(t!==e){let e=r("#node_"+t);e[0].style.left=e[0].startX+n.distanceX+"px",e[0].style.top=e[0].startY+n.distanceY+"px"}}),r.flow.updateConnections()},stop:()=>{i._x=r(n).position().left,i._y=r(n).position().top,1<r.flow.selectedNodes.length&&r.flow.selectedNodes.forEach(n=>{if(n!==e){let e=a.getNodeById(n),t=r("#node_"+n);e._x=t.position().left,e._y=t.position().top}}),Events.register(EventType.updateNode,i)}});let t=l.is(".anchorOut")?l:l.find(".anchorOut");t.each(function(){r(this).on("mousedown",function(e){if(0<=r.flow.metaKeys.indexOf(KeyType.meta)){e.stopPropagation(),e.preventDefault();let t=r(flowApp.ui.placeholders.board),n=l.is(".anchorOut")?l:r(this);0<=r.flow.metaKeys.indexOf(KeyType.alt)&&i._type===Type.condition&&(n=l);let a=r("<div id='fakeEl'>").css({position:"absolute",width:10,height:10,background:"transparent",zIndex:-100,left:e.clientX-t.position().left,top:e.clientY-t.position().top});a.appendTo(flowApp.ui.placeholders.board);e=0<=r.flow.metaKeys.indexOf(KeyType.alt)&&i._type===Type.condition?"red":"orange";r(this).get(0).line=r.flow.LeaderLine(n.is(".anchorOut")||0<=r.flow.metaKeys.indexOf(KeyType.alt)&&i._type===Type.condition?n:n.find(".anchor"),a,{color:e,size:3}),r(s).on("mousemove.line",e=>{a.css({left:e.clientX-t.position().left,top:e.clientY-t.position().top}),r(this).get(0).line.position()}).one("mouseup.line",e=>{r(s).off("mousemove.line"),a.remove(),r(this).get(0).line.remove();let t=r(e.target).parents(".node");t.length&&t.data("node-id")!==n.data("node-id")&&t.data("node-id")!==n.parents(".node").data("node-id")&&(e=r.flow.getConnectionTypeByNodeType(i,n),e=new Connection(null,n.data("node-id"),n.data("node-element-id"),t.data("node-id"),e),Events.register(EventType.addConnection,e))})}})})},getConnectionTypeByNodeType(e,t=null){let n=0;switch(e._type){case Type.choices:n=1;break;case Type.condition:n=t&&null!=t.data("node-element-id")?2:3;break;case Type.random:n=4;break;case Type.start:n=5;break;case Type.sequence:n=6}return n},addFlow:()=>{var e={title:"Add a new Flow",text:null,inputId:"flowName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.addFlow(e),r.mbStorage.set("selectedFlow",flowApp.flow.id);e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:null};UI.dialogue(e)},openFlow:()=>{},editFlowName:()=>{let e=r(flowApp.ui.placeholders.flowName).find("h1");e.attr({contentEditable:!0}),e.focus(),Util.selectElementContents(e.get(0)),e.one("blur",()=>{flowApp.flow.updateName(e.text()),e.attr({contentEditable:!1})})},deleteFlow:(t,e)=>{e={title:"Delete Flow",text:"Are you sure you want to delete<br><b>"+r(e).parent().find(".name").text()+"</b>?",inputId:null,inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.deleteFlow(t);var e=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,e)},className:"alert"};UI.dialogue(e)},getSelectedBoard:()=>flowApp.flow.getBoardById(flowApp.flow.selectedBoardId),addBoard:()=>{var e={title:"Add a new Board",text:null,inputId:"boardName",inputValue:null,okLabel:"Add",cancelLabel:"Cancel",action:function(e){flowApp.flow.addBoard(e,flowApp.flow.selectedBoardGroup)},className:null};UI.dialogue(e)},duplicateBoard:e=>{flowApp.flow.duplicateBoard(e)},moveBoardToGroup:(e,t)=>{flowApp.flow.moveBoardToGroup(e,t);t=r.flow.getSelectedBoard();Events.register(EventType.updateBoard,t)},editBoardName:t=>{let n=r(flowApp.ui.placeholders.boardList).find("#board_"+t+" .name");n.attr({contentEditable:!0}),n.focus(),Util.selectElementContents(n.get(0)),n.one("blur",()=>{let e=flowApp.flow.getBoardById(t);e._name=n.text(),flowApp.drawer.drawBoardList()})},deleteBoard:(e,t)=>{t={title:"Delete Board",text:"Are you sure you want to delete<br><b>"+r(t).parent().find(".name").text()+"</b>?",inputId:null,inputValue:null,okLabel:"Yes",cancelLabel:"Cancel",action:()=>{flowApp.flow.deleteBoard(e),flowApp.drawer.drawBoardList()},className:"alert"};UI.dialogue(t)},showBoardsByGroup:e=>{r(flowApp.ui.placeholders.boardList).find("li").hide(),("all"!==e?r(flowApp.ui.placeholders.boardList).find('[data-board-group="'+e+'"]'):r(flowApp.ui.placeholders.boardList).find("li")).show(),r(flowApp.ui.placeholders.boardGroupName).html("all"!==e?e:"All Boards")},LeaderLine:(e,t,n)=>new LeaderLine(e.get(0),t.get(0),n),updateConnections:()=>{let n=r.flow.getSelectedBoard()._connections;n.forEach(e=>{let t=e._connectionLine;t?"function"==typeof t.position&&t.position():n.delete(e)})},autoShiftNodes:l=>{let e=r.flow.getSelectedBoard()._nodes,i=parseFloat(l.css("left")),o=parseFloat(l.css("top"));l.get(0).h&&l.height()===l.get(0).h||(e.forEach(e=>{let t=r(flowApp.ui.placeholders.board).find("#node_"+e._id);var n=parseFloat(t.css("left")),a=parseFloat(t.css("top"));n>=i&&n<i+l.width()&&a>o&&(n=l.height()-l.get(0).h,t.css({top:a+n}),e._x=t.position().left,e._y=t.position().top)}),l.get(0).h=l.height())},getNodeById:e=>{let t=r.flow.getSelectedBoard();return t.getNodeById(e)},addToSelectedNodes:(e,t=!1)=>{0<=r.flow.selectedNodes.indexOf(e)||(t?r.flow.selectedNodes.indexOf(e)<0&&r.flow.selectedNodes.unshift(e):(r.flow.selectedNodes=[],r.flow.selectedNodes.unshift(e)),Events.register(EventType.selectNode,{selectedNodeId:e}))},removeFromSelectedNodes:(e=null)=>{e?r.flow.selectedNodes.delete(e):r.flow.selectedNodes=[]},drawActorsWindow:()=>{ActorsDrawer.openWindow()},drawAvatarWindow:e=>{AvatarDrawer.openWindow(e)},openPreview:()=>{PreviewDrawer.OpenWindow(flowApp.flow,r.flow.getSelectedBoard())}},Array.prototype.delete=function(t){for(let e=0;e<this.length;e++)this[e]===t&&(this.splice(e,1),e--)},Number.prototype.module=function(e){return(this%e+e)%e}}(jQuery,document,window),$.flow=$.flow||{},$.flow.parser={},$.flowParser=$.flow.parser,window.previewDrawer=PreviewDrawer,$.flowParser={source:null,boards:[],vars:{},selectedBoardId:null,selectedNodeId:null,load:(e=null,t=null)=>{if("object"==typeof e){$.flowParser.source=Object.assign({},e),$.flowParser.selectedBoardId=t._id;for(var[n,a]of Object.entries($.flowParser.source._variables))$.flowParser.vars[a._key]=a._value}},board:{getSelected:()=>{let t=null;return $.flowParser.source._boards.forEach(e=>{e._id===$.flowParser.selectedBoardId&&(t=e)}),t}},node:{start:(e=null)=>{let t=null;null===e&&(t=$.flowParser.node.getByType(Type.start)[0],$.flowParser.selectedNodeId=t._id,t._selected=!0,$.flowParser.node.next())},get:t=>{let e=$.flowParser.board.getSelected(),n=null;return e._nodes.forEach(e=>{e._id===t&&(n=e)}),n},getByType:t=>{let n=[],e=$.flowParser.board.getSelected();return e._nodes.forEach(e=>{e._type===t&&n.push(e)}),n},getNext:(e=0)=>{},getPrev:()=>{},goTo:e=>{},next:(e=null)=>{var t=$.flowParser.node.get($.flowParser.selectedNodeId);let n=$.flowParser.nodeElement.get(t._id,e),a=$.flowParser.connection.getAvailable(e);if(t._type===Type.choices){let e=$("<div class='temp-element'>").css({display:"none"}).html($.flowParser.node.getText(n)),t=e.find("span.variables");t.each(function(){var e=$(this).text().trim();$.flowParser.parseVariables(e);$(this).remove()})}if(!a||!a._to)return!1;if(a._connectionLine){let e=a._connectionLine.color;a._connectionLine.setOptions({color:"red"}),setTimeout(()=>{a._connectionLine.setOptions({color:e})},3e3)}$.flowParser.selectedNodeId=a._to;let l=$.flowParser.node.get($.flowParser.selectedNodeId);return l._previousNodeId=t._id,n&&(n._selected=!0),l._type!==Type.note&&l._type!==Type.sequence&&l._type!==Type.random&&l._type!==Type.variables&&l._type!==Type.condition||$.flowParser.node.next(),a},getAvailableElement:(e=null)=>{e=e||$.flowParser.selectedNodeId;let t=$.flowParser.node.get(e);var n=t._cycleType;let a=null,l=t._elements.filter(e=>!e._selected);switch(t._type){case Type.text:switch(n){case CycleType.list:a=l.length?l[0]:t._elements[t._elements.length-1],a._selected=!0;break;case CycleType.random:l=l.length?l:t._elements;var i=1<l.length?Math.floor(Math.random()*l.length):0;a=l[i],a._selected=!0;break;case CycleType.loop:l=l.length?l:t._elements,a=l[0]}break;case Type.choices:}return a},getText:(e=null)=>{e=e||$.flowParser.node.getAvailableElement();return console.debug(e),window.flowApp.getContent(e,window.flowApp.flow._locale)._text},getParsedText:(e=null)=>{var t=e?e._nodeId:$.flowParser.selectedNodeId;let n=$.flowParser.node.get(t);e=$.flowParser.node.getText(e);let a=$("<div class='temp-element'>").css({display:"none"}).html(e),l=a.find("span.variables");l.each(function(){var e=$(this).text().trim();n._type===Type.text&&$.flowParser.parseVariables(e),$(this).remove()});let i=a.find("span.eval-variable");return i.each(function(){var e=$(this).text().trim(),e=$.flowParser.vars[e];$(this).replaceWith("<span>"+e+"</span>")}),a.html()}},nodeElement:{get:(e,t)=>{let n=$.flowParser.node.get(e);return n._elements.filter(e=>e._id===t)[0]}},connection:{getAvailable:(lineId=null)=>{let node=$.flowParser.node.get($.flowParser.selectedNodeId),availableConnection=null;switch(node._type){case Type.start:case Type.text:case Type.note:availableConnection=node._connections[0];break;case Type.choices:availableConnection=$.flowParser.connection.getByLineId(node,lineId);break;case Type.condition:node._elements.forEach(element=>{let content=window.flowApp.getText(element),result=$.flowParser.parseVariables(content);console.debug(content,result),eval(result.toString())&&!availableConnection&&(availableConnection=$.flowParser.connection.getByLineId(node,element._id))}),availableConnection=availableConnection||$.flowParser.connection.getFail(node);break;case Type.variables:node._elements.forEach(e=>{e=window.flowApp.getText(e),$.flowParser.parseVariables(e)}),availableConnection=node._connections[0];break;case Type.random:let rnd=Math.floor(Math.random()*node._connections.length);availableConnection=node._connections[rnd];break;case Type.sequence:let possibleElement=node._elements.filter(e=>!e._selected)[0];possibleElement?(possibleElement._selected=!0,availableConnection=$.flowParser.connection.getByLineId(node,possibleElement._id)):node._elements.forEach(e=>{e._selected=!1,availableConnection=$.flowParser.connection.getByLineId(node,node._elements[0]._id)});break;case Type.jumpToNode:availableConnection=null}return availableConnection},getByLineId(e,t){let n=null;return e._connections.forEach(e=>{e._nodeElementId===t&&(n=e)}),n},getFail:e=>{let t=null;return e._connections.forEach(e=>{3===e._type&&(t=e)}),t}},actor:{get:t=>{let n=null;return $.flowParser.source._actors.forEach(e=>{e._id===t&&(n=e)}),n}},parseVariables:content=>{let str=$("<div>").html(content).text(),regExp=/[^{\{]+(?=})/gi,variableBlocks=str.match(regExp);return variableBlocks?(variableBlocks.forEach(e=>{let t=$.flowParser.findVariables(e);t&&t.forEach(e=>{str=str.replace(e,"$.flowParser.vars."+e.replace("$","")),e=e.replace("$",""),$.flowParser.vars[e]||($.flowParser.vars[e]=null)})}),eval(str),str):null},findVariables:e=>{return e.match(/\$([\w]+)/gi)}};const Avataaars={defaultOptions:{style:"circle"},create(e){return this._createAvataaar({...this.defaultOptions,...e})},setDefaultAvatar(e){this.defaultOptions=e},getEditableTypes(){return Object.keys(this.paths).filter(e=>1<Object.keys(this.paths[e]).length)},_getChildOrDefault(e,t,n){return void 0!==e[t][n]?e[t][n]:["facialHair","accessories"].includes(t)&&null==n?()=>"":e[t].default||e[t][Object.keys(e[t])[0]]},_getShape(e,t){return this._getChildOrDefault(this.paths,e,t)},_getColor(e,t){return this._getChildOrDefault(this.colors,e,t)},_createAvataaar(e){let t=this.paths.nose.default,n=this.paths.skin.default;var a=this._getColor("skin",e.skin);let[l,,i]=this._getTopType(e.top),o=this._getShape("facialHair",e.facialHair);var r=this._getColor("hair",e.facialHairColor);let s=this._getShape("clothing",e.clothing),c=this._getShape("clothingGraphic",e.clothingGraphic);var u=this._getColor("palette",e.clothingColor);let d=this._getShape("eyes",e.eyes),p=this._getShape("eyebrows",e.eyebrows),h=this._getShape("mouth",e.mouth),f=this._getShape("accessories",e.accessories);var m=this._getColor("palette",e.accessoriesColor),y=this._getColor("palette",e.hatColor),v=this._getColor("hair",e.hairColor),g=(e,t,n)=>0<e.length?`<g transform="translate(${t}, ${n})">${e}</g>`:"",v=g(l(y,v),7,0);let w=`
      ${g(n(a),40,36)}
      ${g(s(u,c()),8,170)}
      ${g(h(),86,134)}
      ${g(t(),112,122)}
      ...
      ${f?g(f(m),69,85):""}
      ${2===i?v:""}
    `;return"circle"===e.style?(m=Math.random().toString(36).substring(7),w=`
        ${e.svgBackground?`<path fill="${1==e.svgBackground?"#fff":e.svgBackground}" d="M0 0h280v280H0z"/>`:""}
        <path d="M260 160c0 66.274-53.726 120-120 120S20 226.274 20 160 73.726 40 140 40s120 53.726 120 120z" fill="${null!==(v=e.background)&&void 0!==v?v:this.colors.palette.blue01}"/>
        <mask id="${m}" maskUnits="userSpaceOnUse" x="8" y="0" width="264" height="280">
      ...
      `):e.svgBackground&&(w=`
      <path fill="${1==e.svgBackground?"#fff":e.svgBackground}" d="M0 0h280v280H0z"/>
      ${w}
    `),e.background=void 0,`
    <svg ${e.width?`width="${e.width}"`:""} ${e.height?`height="${e.height}"`:""} viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ${w}
    </svg>
  `},_getTopType(e){switch(e){case"bigHair":return[this.paths.top.bigHair,!1,0];case"bob":return[this.paths.top.bob,!1,0];case"bun":return[this.paths.top.bun,!1,1];case"curly":return[this.paths.top.curly,!1,0];case"curvy":return[this.paths.top.curvy,!1,0];case"dreads":return[this.paths.top.dreads,!1,0];case"frida":return[this.paths.top.frida,!1,0];case"fro":return[this.paths.top.fro,!1,0];case"froAndBand":return[this.paths.top.froAndBand,!1,0];case"miaWallace":return[this.paths.top.miaWallace,!1,0];case"longButNotTooLong":return[this.paths.top.longButNotTooLong,!1,0];case"shavedSides":return[this.paths.top.shavedSides,!1,0];case"straight01":return[this.paths.top.straight01,!1,0];case"straight02":return[this.paths.top.straight02,!1,0];case"straightAndStrand":return[this.paths.top.straightAndStrand,!1,0];case"dreads01":return[this.paths.top.dreads01,!1,1];case"dreads02":return[this.paths.top.dreads02,!1,1];case"frizzle":return[this.paths.top.frizzle,!1,1];case"shaggy":return[this.paths.top.shaggy,!1,2];case"shaggyMullet":return[this.paths.top.shaggyMullet,!1,0];case"shortCurly":return[this.paths.top.shortCurly,!1,1];case"shortFlat":return[this.paths.top.shortFlat,!1,1];case"shortRound":return[this.paths.top.shortRound,!1,1];case"shortWaved":return[this.paths.top.shortWaved,!1,1];case"sides":return[this.paths.top.sides,!1,1];case"theCaesar":return[this.paths.top.theCaesar,!1,1];case"theCaesarAndSidePart":return[this.paths.top.theCaesarAndSidePart,!1,1];case"hat":return[this.paths.top.hat,!0,0];case"winterHat01":return[this.paths.top.winterHat01,!0,2];case"winterHat02":return[this.paths.top.winterHat02,!0,2];case"winterHat03":return[this.paths.top.winterHat03,!0,2];case"winterHat04":return[this.paths.top.winterHat04,!0,2];case"hijab":return[this.paths.top.hijab,!0,1];case"turban":return[this.paths.top.turban,!0,1];case"eyepatch":return[this.paths.top.eyepatch,!1,1];default:return[this.paths.top.shortWaved,!1,1]}},colors:{hair:{auburn:"#A55728",black:"#2C1B18",blonde:"#B58143",blondeGolden:"#D6B370",brown:"#724133",brownDark:"#4A312C",pastelPink:"#F59797",platinum:"#ECDCBF",red:"#C93305",silverGray:"#E8E1E1"},palette:{black:"#262E33",blue01:"#65C9FF",blue02:"#5199E4",blue03:"#25557C",gray01:"#E5E5E5",gray02:"#929598",heather:"#3C4F5C",pastelBlue:"#B1E2FF",pastelGreen:"#A7FFC4",pastelOrange:"#FFDEB5",pastelRed:"#FFAFB9",pastelYellow:"#FFFFB1",pink:"#FF488E",red:"#FF5C5C",white:"#FFFFFF"},skin:{tanned:"#FD9841",yellow:"#F9D562",pale:"#FFDBB4",light:"#EDB98A",brown:"#D08B5B",darkBrown:"#AE5D29",black:"#614335"}},paths:{accessories:{none:e=>"",kurt:e=>`
      ...
      `,round:e=>`
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M40 51c-13.255 0-24-10.745-24-24 0-2.435.363-4.785 1.037-7H10.5a2.5 2.5 0 010-5h8c.229 0 .45.03.66.088C23.297 7.866 31.08 3 40 3c9.352 0 17.455 5.35 21.416 13.155C63.493 13.039 66.949 11 70.862 11c4.013 0 7.545 2.144 9.603 5.394C84.38 8.46 92.553 3 102 3c8.92 0 16.703 4.866 20.84 12.088a2.52 2.52 0 01.66-.088h8a2.5 2.5 0 110 5h-6.537A24.006 24.006 0 01126 27c0 13.255-10.745 24-24 24S78 40.255 78 27c0-1.422.124-2.815.36-4.169C78.277 18.455 74.915 15 70.863 15c-3.736 0-6.887 2.94-7.42 6.83.365 1.665.558 3.395.558 5.17 0 13.255-10.745 24-24 24zm0-4c11.046 0 20-8.954 20-20S51.046 7 40 7s-20 8.954-20 20 8.954 20 20 20zm82-20c0 11.046-8.954 20-20 20s-20-8.954-20-20 8.954-20 20-20 20 8.954 20 20z" fill="${e}"/>
      `,sunglasses:e=>`
      ...
      `},clothing:{blazerAndShirt:e=>`
        ...
        <path d="M100.778 29.122c.072-.378.145-.752.222-1.122-2.959.054-6 1-6 1l-.42.662C59.267 34.276 32 64.48 32 101.052V110h74s-10.7-51.555-5.238-80.793l.023-.085h-.007zM158 110s11-53 5-82c2.959.054 6 1 6 1l.419.662C204.733 34.276 232 64.48 232 101.052V110h-74z" fill="${e}"/>
      ...
      `,graphicShirt:(e,t)=>`
        <path d="M132.5 54c18.502 0 33.5-9.626 33.5-21.5a14.08 14.08 0 00-.376-3.232C202.76 32.138 232 63.18 232 101.052V110H32v-8.948c0-38.217 29.775-69.48 67.393-71.855A14.108 14.108 0 0099 32.5C99 44.374 113.998 54 132.5 54z" fill="${e}"/>
        <g transform="translate(77, 60)">${t}</g>
      `,hoodie:e=>`
        <path d="M108 14.694C92.484 18.38 80.895 25.529 77.228 34.142 50.72 44.765 32 70.696 32 101v9h200v-9.001c0-30.303-18.721-56.234-45.228-66.858-3.667-8.613-15.256-15.761-30.772-19.447V32c0 13.255-10.745 24-24 24s-24-10.745-24-24V14.694z" fill="${e}"/>
      ...
      `,overall:e=>`
        <path d="M196 38.632V110H68V38.632a71.525 71.525 0 0126-8.944V74h76V29.688a71.523 71.523 0 0126 8.944z" fill="${e}"/>
        <path d="M86 83a5 5 0 11-10 0 5 5 0 0110 0zm102 0a5 5 0 11-10 0 5 5 0 0110 0z" fill="#F4F4F4"/>
      `,shirtCrewNeck:e=>`
        <path d="M132.5 51.828c18.502 0 33.5-9.617 33.5-21.48 0-.353-.013-.704-.04-1.053 36.976 3.03 66.04 34 66.04 71.757V110H32v-8.948c0-38.1 29.592-69.287 67.045-71.833-.03.374-.045.75-.045 1.129 0 11.863 14.998 21.48 33.5 21.48z" fill="${e}"/>
      ...
      `,shirtScoopNeck:e=>`
        <path d="M132.5 65.828c27.338 0 49.5-13.199 49.5-29.48 0-1.363-.155-2.704-.456-4.017C210.784 41.487 232 68.791 232 101.052V110H32v-8.948c0-32.655 21.739-60.232 51.534-69.05A18.001 18.001 0 0083 36.348c0 16.281 22.162 29.48 49.5 29.48z" fill="${e}"/>
      `,shirtVNeck:e=>`
        <path d="M92.68 29.936C58.295 35.366 32 65.138 32 101.052V110h200v-8.948c0-35.914-26.294-65.686-60.681-71.116a23.874 23.874 0 01-7.555 13.603l-29.085 26.229a4 4 0 01-5.358 0l-29.085-26.229a23.871 23.871 0 01-7.555-13.603z" fill="${e}"/>
      ...
      `,winterHat01:(e,t)=>`
        ...
        <path d="M63 64c0-24.3 19.7-44 44-44h52c24.301 0 44 19.7 44 44v104.607c0 9.053-7.34 16.393-16.393 16.393a3.607 3.607 0 01-3.607-3.607V74H83v94.607C83 177.66 75.66 185 66.607 185A3.607 3.607 0 0163 181.393V64z" fill="${e}"/>
      ...
      `,winterHat02:(e,t)=>`
        ...
        <path d="M93.449 77.535h79.102c6.084 0 9.816 2.925 9.816 9v79.454c0 30.458 22.633 30.416 22.633 10.921v-73.865C205 68.803 187.773 21 133 21c-54.773 0-72 47.803-72 82.045v73.865c0 19.495 22.633 19.537 22.633-10.921V86.535c0-6.075 3.732-9 9.816-9z" fill="${e}"/>
      ...
      `,winterHat03:(e,t)=>`
        <circle cx="133" cy="20" r="20" fill="#F4F4F4"/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M67 78c0-36.45 29.55-66 66-66 36.451 0 66 29.55 66 66v5H67v-5z" fill="${e}"/>
      ...
      `,shavedSides:(e,t)=>`
        ...
        <path d="M92.537 53.286C82.913 63.342 77 76.98 77 92v6.166a11.968 11.968 0 00-6.485 3.349l.702-17.372c.56-13.884 7.234-26.125 17.363-34.173-2.207-3.843-1.455-10.333 7.802-13.093 5.065-1.51 7.572-5.087 10.234-8.884 3.503-4.995 7.272-10.371 17.487-11.92 9.866-1.494 13.227-.88 17.043-.184 3.138.572 6.584 1.201 14.205.762 9.852-.57 16.862-3.993 21.424-6.221 3.262-1.593 5.272-2.575 6.176-1.467 15.42 18.903 6.968 33.79-6.198 41.953C186.692 59.354 193 71.94 193 86v13.605a11.921 11.921 0 00-4-1.44V92c0-15.256-6.101-29.087-15.995-39.187-7.77 2.744-50.391 16.543-80.468.473zM223.61 226.052c3.059 5.601 4.049 11.122 3.499 16.377C216.051 216.878 190.613 199 161 199h-4v-18.389c17.531-8.328 30.048-25.496 31.791-45.744a11.918 11.918 0 004.209-1.472v20.714c0 20.759 11.475 39.779 22.146 57.465 2.972 4.926 5.882 9.749 8.464 14.478zM68.697 146.504l.661-16.359a11.993 11.993 0 007.85 4.722c1.744 20.248 14.261 37.416 31.792 45.744V199h-4c-11.197 0-21.798 2.556-31.25 7.116-2.986-18.284-4.297-38.673-5.053-59.612z" fill="${t}"/>
      ...
      `,straight01:(e,t)=>`
        <path d="M67 113c10.859-22.702 34.67-31.597 55.44-39.355 13.32-4.976 25.389-9.485 31.99-16.868 2.233 2.027 4.762 4.058 7.424 6.194C172.063 71.166 184.212 80.917 189 98v.165a12.01 12.01 0 019.815 9.726v-21.85a46.41 46.41 0 00-.158-3.838C203.2 65.198 195.565 44.415 186 35c-9.481-8.818-22.302-12.319-30.953-8.478C143.442 8.982 109.905 13.241 90 28c-13.22 9.808-24.787 25.721-27.845 45.751A46.18 46.18 0 0061 84.046v88.495c-.192 31.515-7.394 82.497-21 90.459 62.358 16.798 71.93-38.145 69-82v-.389c-17.53-8.328-30.048-25.496-31.791-45.744C71.43 134.003 67 129.019 67 123v-10zm90 67.611c17.531-8.328 30.048-25.496 31.791-45.744a12.007 12.007 0 0010.024-9.759v1.363c0 15.828 3.758 31.43 10.963 45.523l26.949 52.707c7.225 14.132 4.676 29.741-3.937 40.761C229.962 228.285 198.901 199 161 199h-4v-18.389z" fill="${t}"/>
      ...
      `,straight02:(e,t)=>`
        <path d="M157 180.611V199h4c17.491 0 33.525 6.237 46 16.608V92c0-40.87-33.131-74-74-74-40.87 0-74 33.13-74 74v183.716c13.57-1.94 24-13.61 24-27.716v-45.577A71.952 71.952 0 01105 199h4v-18.389a56.236 56.236 0 01-26-25.365v-61.98c9.147-2.975 18.778-7.249 28.342-12.77 15.403-8.894 28.089-19.555 36.724-30.099a86.935 86.935 0 007.044 15.488c8.768 15.185 21.114 26.349 33.89 32.032v.249c.4.067.794.154 1.18.26.774.323 1.55.626 2.326.91A11.998 11.998 0 01199 110v13c0 6.019-4.431 11.002-10.209 11.867-1.743 20.248-14.26 37.416-31.791 45.744z" fill="${t}"/>
      ...
      `,shaggy:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M88.183 37.856c5.141-3.832 11.219-7.116 17.559-8.378 6.447-1.282 10.359-1.593 16.705-.073 1.633.392 2.184.78 3.621-.148 1.211-.783 9.662-9.49 35.42-4.657 26.035 4.885 33.769 44.075 43.427 45.566 3.48.537 7.782-.384 7.916-2.527 3.964 6.034 5.008 14.007 3.327 21.074-1.446 6.086-4.496 11.804-9.989 15.137-4.725 2.867-11.259 4.116-16.721 3.587-2.485-.24-4.745-.763-7.031-1.766-2.759-1.209-4.957-3.391-7.665-4.543a53.896 53.896 0 009.176 6.418c1.64.907 3.304 1.532 5.113 2.024 1.236.336 3.762 1.481 4.956 1.182-7.807 1.396-15.16.18-22.319-3.163-3.231-1.508-6.339-3.332-9.191-5.476-2.833-2.13-6.094-4.307-8.311-7.11.931 1.204-.697-.586-.912-.805a67.764 67.764 0 01-1.787-1.895 74.075 74.075 0 01-2.931-3.391c-1.993-2.486-3.851-5.082-5.507-7.803-1.677-2.756-8.358-13.873-10.375-16.49 1.905 5.708 3.98 11.418 6.407 16.925-4.713-1.47-9.283-5.544-12.295-9.34-3.392-4.276-5.4-9.268-6.108-14.666-3.825 10.416-12.785 18.63-22.032 24.295 2.003-3.73 5.056-6.885 7.052-10.678-9.19 9.329-24.568 13.893-28.595 27.574-1.032-4.758-4.353-8.58-5.347-13.433-1.105-5.389-1.897-11.11-1.722-16.616.398-12.242 8.632-23.723 18.16-30.824z" fill="${t}"/>
      `,shortCurly:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M193.765 70.766c-.264-3.317-.732-6.614-1.518-9.855-.625-2.576-1.478-5.034-2.487-7.491-.609-1.485-2.032-3.524-2.2-5.126-.165-1.577 1.067-3.325 1.329-5.162a15.975 15.975 0 00-.155-5.438c-.833-4.023-3.594-7.764-7.857-8.813-.952-.234-2.964.055-3.636-.5-.771-.635-1.308-2.8-2.006-3.669-1.991-2.476-5.095-4.07-8.369-3.514-2.411.409-1.027.907-2.834-.512-1.005-.788-1.756-1.993-2.732-2.847-1.467-1.283-3.15-2.38-4.892-3.282-4.557-2.358-9.754-4.072-14.844-4.908-9.285-1.524-19.195-.195-28.195 2.22-4.479 1.201-8.987 2.726-13.147 4.743-1.783.864-2.813 1.582-4.672 1.808-2.93.357-5.41.339-8.184 1.581-8.536 3.822-12.381 12.689-9.06 21.174a14.637 14.637 0 002.82 4.584c1.521 1.68 2.072 1.35.762 3.282a52.785 52.785 0 00-4.955 9.172c-3.529 8.402-4.12 17.864-3.89 26.824.081 3.137.216 6.313.71 9.42.214 1.344.274 3.872 1.282 4.87.512.506 1.241.788 1.969.587 1.71-.474 1.121-1.735 1.161-2.906.2-5.884-.07-11.089 1.33-16.901 1.033-4.295 2.755-8.195 4.988-12.036 2.838-4.884 5.903-9.173 9.806-13.355.918-.984 1.119-1.4 2.35-1.472.931-.054 2.295.584 3.2.805 1.999.487 4 .968 6.034 1.296 3.74.603 7.444.644 11.217.525 7.426-.232 14.885-.753 22.085-2.623 4.782-1.242 9.022-3.47 13.602-5.105.082-.029 1.23-.847 1.431-.814.281.047 1.977 1.826 2.263 2.05 2.226 1.746 4.667 2.479 7.07 3.83 2.964 1.667.094-.718 1.728 1.359.477.605.721 1.726 1.103 2.411a18.086 18.086 0 004.931 5.624c1.955 1.47 4.893 2.18 5.89 4.095.769 1.477 1.028 3.484 1.648 5.06 1.628 4.136 3.777 7.992 5.926 11.887 1.732 3.14 3.625 5.881 3.818 9.468.067 1.248-1.121 8.737 1.773 6.46.429-.338 1.353-4.156 1.543-4.804.772-2.633 1.046-5.381 1.395-8.086.694-5.38.923-10.498.469-15.916z" fill="${t}"/>
      `,shortFlat:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M180.15 39.92c-2.76-2.82-5.964-5.213-9.081-7.613-.687-.53-1.386-1.046-2.058-1.595-.153-.125-1.719-1.246-1.906-1.659-.451-.993-.19-.22-.128-1.404.079-1.498 3.134-5.73.854-6.7-1.003-.427-2.791.709-3.753 1.084a59.558 59.558 0 01-5.731 1.9c.932-1.857 2.708-5.573-.631-4.579-2.602.775-5.026 2.768-7.64 3.705.865-1.418 4.324-5.811 1.198-6.057-.972-.076-3.803 1.748-4.85 2.138-3.137 1.165-6.341 1.92-9.634 2.513-11.198 2.018-24.293 1.442-34.653 6.54-7.987 3.93-15.874 10.029-20.489 17.794-4.447 7.486-6.11 15.677-7.041 24.254-.683 6.295-.739 12.802-.42 19.119.105 2.07.338 11.611 3.345 8.721 1.498-1.44 1.487-7.253 1.864-9.22.751-3.916 1.474-7.848 2.726-11.638 2.206-6.68 4.809-13.793 10.305-18.393 3.527-2.952 6.004-6.941 9.379-9.919 1.516-1.337.359-1.198 2.797-1.022 1.638.117 3.282.162 4.923.205 3.796.099 7.598.074 11.395.087 7.647.028 15.258.136 22.898-.265 3.395-.177 6.799-.274 10.185-.588 1.891-.175 5.247-1.387 6.804-.461 1.425.847 2.905 3.615 3.928 4.748 2.418 2.679 5.3 4.724 8.126 6.92 5.895 4.58 8.87 10.332 10.661 17.488 1.783 7.13 1.283 13.745 3.49 20.762.389 1.234 1.416 3.36 2.682 1.454.235-.354.175-2.3.175-3.42 0-4.52 1.144-7.91 1.13-12.46-.056-13.832-.504-31.868-10.85-42.439z" fill="${t}"/>
      `,shortRound:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M167.309 35.006c-20.188-11.7-40.18-9.784-55.272-5.976-15.092 3.808-24.02 14.621-31.68 30.618-3.761 7.855-5.991 17.143-6.334 25.833-.135 3.412.325 6.934 1.245 10.22.337 1.205 2.155 5.386 2.654 2.008.166-1.125-.442-2.676-.5-3.871-.078-1.569.005-3.157.112-4.723.2-2.928.722-5.8 1.65-8.59 1.328-3.988 3.017-8.312 5.603-11.677 6.401-8.328 17.482-8.802 26.279-13.384-.763 1.405-3.706 3.68-2.687 5.263.705 1.094 3.37.762 4.643.727 3.349-.092 6.713-.674 10.021-1.147 5.213-.745 10.098-2.255 15.004-4.089 4.016-1.502 8.603-2.892 11.622-6.078 4.871 5.048 11.141 9.794 17.401 13.003 5.618 2.88 14.679 4.318 18.113 10.158 4.065 6.914 2.195 15.406 3.436 22.9.472 2.85 1.545 2.786 2.132.237.997-4.33 1.468-8.828 1.151-13.279-.718-10.048-4.405-36.453-24.593-48.153z" fill="${t}"/>
      `,sides:(e,t)=>`
        <path d="M70 97c0 3.994.924 5.071 6 5 3.255-.051 3.443-6.005 3.652-12.589.139-4.374.286-9.027 1.348-12.411.619-4.432-1.824-3.17-3-1-3.96 4.778-8 15.344-8 21zm126 0c0 3.994-.924 5.071-6 5-3.255-.051-3.443-6.005-3.652-12.589-.139-4.374-.286-9.027-1.348-12.411-.619-4.432 1.824-3.17 3-1 3.959 4.778 8 15.344 8 21z" fill="${t}"/>
      `,shortWaved:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M183.68 38.949c5.406-4.95 6.707-14.987 3.638-21.5-3.769-7.995-11.417-8.997-18.746-5.48-6.908 3.315-13.057 4.419-20.622 2.813-7.258-1.541-14.144-4.26-21.647-4.706-12.325-.733-24.3 3.839-32.7 13.053-1.603 1.758-2.894 3.768-4.115 5.805-.977 1.63-2.078 3.38-2.493 5.258-.198.894.17 3.098-.275 3.83-.48.79-2.296 1.515-3.069 2.102-1.567 1.188-2.924 2.53-4.18 4.047-2.666 3.222-4.133 6.587-5.368 10.572-4.102 13.245-4.45 28.998.854 42.004.707 1.734 2.898 5.352 4.186 1.638.255-.734-.334-3.194-.333-3.935.005-2.72 1.506-20.729 8.047-30.817 2.13-3.284 11.973-15.58 13.984-15.68 1.065 1.693 11.88 12.51 39.942 11.242 12.662-.572 22.4-6.26 24.738-8.727 1.028 5.533 12.992 13.816 14.815 17.224 5.267 9.846 6.435 30.304 8.445 30.265 2.01-.038 3.453-5.237 3.867-6.23 3.072-7.375 3.595-16.632 3.267-24.559-.427-10.202-4.638-21.226-12.235-28.22z" fill="${t}"/>
      `,theCaesarAndSidePart:(e,t)=>`
        <path d="M78 98c-.327 1.223-1.653 1.488-2 0-.719-10.298 0-62.274 57-63 57-.726 57.719 52.702 57 63-.347 1.488-1.673 1.223-2 0 .463-1.554-3.296-28.752-13-36-1.759-1.224-7.247-2.39-14.641-3.261L164 50l-6.982 8.379c-7.032-.694-15.361-1.127-23.705-1.133C114.008 57.232 94.618 59.483 91 62c-9.704 7.248-13.463 34.446-13 36z" fill="${t}"/>
      `,theCaesar:(e,t)=>`
        <path fill-rule="evenodd" clip-rule="evenodd" d="M76 98c.347 1.488 1.673 1.223 2 0-.463-1.554 3.296-28.752 13-36 3.618-2.517 23.008-4.768 42.313-4.754C152.409 57.259 171.421 59.51 175 62c9.704 7.248 13.463 34.446 13 36 .327 1.223 1.653 1.488 2 0 .719-10.298 0-63.726-57-63-57 .726-57.719 52.702-57 63z" fill="${t}"/>
      `}}};var nAgt=navigator.userAgent;function isTouchSupported(){var e=nAgt.msMaxTouchPoints,t="ontouchstart"in document.createElement("div");return!(!e&&!t)}jQuery.browser=jQuery.browser||{},jQuery.browser.mozilla=!1,jQuery.browser.webkit=!1,jQuery.browser.opera=!1,jQuery.browser.safari=!1,jQuery.browser.chrome=!1,jQuery.browser.androidStock=!1,jQuery.browser.msie=!1,jQuery.browser.edge=!1,jQuery.browser.ua=nAgt;var getOS=function(){var e={version:"Unknown version",name:"Unknown OS"};return-1!=navigator.appVersion.indexOf("Win")&&(e.name="Windows"),-1!=navigator.appVersion.indexOf("Mac")&&navigator.appVersion.indexOf("Mobile")<0&&(e.name="Mac"),-1!=navigator.appVersion.indexOf("Linux")&&(e.name="Linux"),/Mac OS X/.test(nAgt)&&!/Mobile/.test(nAgt)&&(e.version=/Mac OS X ([\._\d]+)/.exec(nAgt)[1],e.version=e.version.replace(/_/g,".").substring(0,5)),/Windows/.test(nAgt)&&(e.version="Unknown.Unknown"),/Windows NT 5.1/.test(nAgt)&&(e.version="5.1"),/Windows NT 6.0/.test(nAgt)&&(e.version="6.0"),/Windows NT 6.1/.test(nAgt)&&(e.version="6.1"),/Windows NT 6.2/.test(nAgt)&&(e.version="6.2"),/Windows NT 10.0/.test(nAgt)&&(e.version="10.0"),/Linux/.test(nAgt)&&/Linux/.test(nAgt)&&(e.version="Unknown.Unknown"),e.name=e.name.toLowerCase(),e.major_version="Unknown",e.minor_version="Unknown","Unknown.Unknown"!=e.version&&(e.major_version=parseFloat(e.version.split(".")[0]),e.minor_version=parseFloat(e.version.split(".")[1])),e},nameOffset,verOffset,ix,start,end;function uncamel(e){return e.replace(/([A-Z])/g,function(e){return"-"+e.toLowerCase()})}function setUnit(e,t){return"string"!=typeof e||e.match(/^[\-0-9\.]+jQuery/)?""+e+t:e}function setFilter(e,t,n){var a=uncamel(t),l=jQuery.mbBrowser.mozilla?"":jQuery.CSS.sfx;e[l+"filter"]=e[l+"filter"]||"",n=setUnit(n>jQuery.CSS.filters[t].max?jQuery.CSS.filters[t].max:n,jQuery.CSS.filters[t].unit),e[l+"filter"]+=a+"("+n+") ",delete e[t]}jQuery.browser.os=getOS(),jQuery.browser.hasTouch=isTouchSupported(),jQuery.browser.name=navigator.appName,jQuery.browser.fullVersion=""+parseFloat(navigator.appVersion),jQuery.browser.majorVersion=parseInt(navigator.appVersion,10),-1!=(verOffset=nAgt.indexOf("Opera"))?(jQuery.browser.opera=!0,jQuery.browser.name="Opera",jQuery.browser.fullVersion=nAgt.substring(verOffset+6),-1!=(verOffset=nAgt.indexOf("Version"))&&(jQuery.browser.fullVersion=nAgt.substring(verOffset+8))):-1!=(verOffset=nAgt.indexOf("OPR"))?(jQuery.browser.opera=!0,jQuery.browser.name="Opera",jQuery.browser.fullVersion=nAgt.substring(verOffset+4)):-1!=(verOffset=nAgt.indexOf("MSIE"))?(jQuery.browser.msie=!0,jQuery.browser.name="Microsoft Internet Explorer",jQuery.browser.fullVersion=nAgt.substring(verOffset+5)):-1!=nAgt.indexOf("Trident")?(jQuery.browser.msie=!0,jQuery.browser.name="Microsoft Internet Explorer",start=nAgt.indexOf("rv:")+3,end=start+4,jQuery.browser.fullVersion=nAgt.substring(start,end)):-1!=(verOffset=nAgt.indexOf("Edge"))?(jQuery.browser.edge=!0,jQuery.browser.name="Microsoft Edge",jQuery.browser.fullVersion=nAgt.substring(verOffset+5)):-1!=(verOffset=nAgt.indexOf("Chrome"))?(jQuery.browser.webkit=!0,jQuery.browser.chrome=!0,jQuery.browser.name="Chrome",jQuery.browser.fullVersion=nAgt.substring(verOffset+7)):-1<nAgt.indexOf("mozilla/5.0")&&-1<nAgt.indexOf("android ")&&-1<nAgt.indexOf("applewebkit")&&!(-1<nAgt.indexOf("chrome"))?(verOffset=nAgt.indexOf("Chrome"),jQuery.browser.webkit=!0,jQuery.browser.androidStock=!0,jQuery.browser.name="androidStock",jQuery.browser.fullVersion=nAgt.substring(verOffset+7)):-1!=(verOffset=nAgt.indexOf("Safari"))||-1!=(verOffset=nAgt.indexOf("AppleWebkit"))?(jQuery.browser.webkit=!0,jQuery.browser.safari=!0,jQuery.browser.name="Safari",jQuery.browser.fullVersion=nAgt.substring(verOffset+7),-1!=(verOffset=nAgt.indexOf("Version"))&&(jQuery.browser.fullVersion=nAgt.substring(verOffset+8))):-1!=(verOffset=nAgt.indexOf("Firefox"))?(jQuery.browser.mozilla=!0,jQuery.browser.name="Firefox",jQuery.browser.fullVersion=nAgt.substring(verOffset+8)):(nameOffset=nAgt.lastIndexOf(" ")+1)<(verOffset=nAgt.lastIndexOf("/"))&&(jQuery.browser.name=nAgt.substring(nameOffset,verOffset),jQuery.browser.fullVersion=nAgt.substring(verOffset+1),jQuery.browser.name.toLowerCase()==jQuery.browser.name.toUpperCase()&&(jQuery.browser.name=navigator.appName)),-1!=(ix=jQuery.browser.fullVersion.indexOf(";"))&&(jQuery.browser.fullVersion=jQuery.browser.fullVersion.substring(0,ix)),-1!=(ix=jQuery.browser.fullVersion.indexOf(" "))&&(jQuery.browser.fullVersion=jQuery.browser.fullVersion.substring(0,ix)),jQuery.browser.majorVersion=parseInt(""+jQuery.browser.fullVersion,10),isNaN(jQuery.browser.majorVersion)&&(jQuery.browser.fullVersion=""+parseFloat(navigator.appVersion),jQuery.browser.majorVersion=parseInt(navigator.appVersion,10)),jQuery.browser.version=jQuery.browser.majorVersion,jQuery.browser.android=/Android/i.test(nAgt),jQuery.browser.blackberry=/BlackBerry|BB|PlayBook/i.test(nAgt),jQuery.browser.ios=/iPhone|iPad|iPod|webOS/i.test(nAgt),jQuery.browser.operaMobile=/Opera Mini/i.test(nAgt),jQuery.browser.windowsMobile=/IEMobile|Windows Phone/i.test(nAgt),jQuery.browser.kindle=/Kindle|Silk/i.test(nAgt),jQuery.browser.mobile=jQuery.browser.android||jQuery.browser.blackberry||jQuery.browser.ios||jQuery.browser.windowsMobile||jQuery.browser.operaMobile||jQuery.browser.kindle,jQuery.isMobile=jQuery.browser.mobile,jQuery.isTablet=jQuery.browser.mobile&&765<jQuery(window).width(),jQuery.isAndroidDefault=jQuery.browser.android&&!/chrome/i.test(nAgt),jQuery.mbBrowser=jQuery.browser,jQuery.browser.versionCompare=function(e,t){if("stringstring"!=typeof e+typeof t)return!1;for(var n=e.split("."),a=t.split("."),l=0,i=Math.max(n.length,a.length);l<i;l++){if(n[l]&&!a[l]&&0<parseInt(n[l])||parseInt(n[l])>parseInt(a[l]))return 1;if(a[l]&&!n[l]&&0<parseInt(a[l])||parseInt(n[l])<parseInt(a[l]))return-1}return 0},jQuery.support.CSStransition=function(){var e=(document.body||document.documentElement).style;return void 0!==e.transition||void 0!==e.WebkitTransition||void 0!==e.MozTransition||void 0!==e.MsTransition||void 0!==e.OTransition}(),jQuery.CSS={name:"mb.CSSAnimate",author:"Matteo Bicocchi",version:"2.0.0",transitionEnd:"transitionEnd",sfx:"",filters:{blur:{min:0,max:100,unit:"px"},brightness:{min:0,max:400,unit:"%"},contrast:{min:0,max:400,unit:"%"},grayscale:{min:0,max:100,unit:"%"},hueRotate:{min:0,max:360,unit:"deg"},invert:{min:0,max:100,unit:"%"},saturate:{min:0,max:400,unit:"%"},sepia:{min:0,max:100,unit:"%"}},normalizeCss:function(e){var t,n,a=jQuery.extend(!0,{},e);for(t in jQuery.mbBrowser.webkit||jQuery.mbBrowser.opera?jQuery.CSS.sfx="-webkit-":jQuery.mbBrowser.mozilla?jQuery.CSS.sfx="-moz-":jQuery.mbBrowser.msie&&(jQuery.CSS.sfx="-ms-"),jQuery.CSS.sfx="",a)"transform"===t&&(a[jQuery.CSS.sfx+"transform"]=a[t],delete a[t]),"transform-origin"===t&&(a[jQuery.CSS.sfx+"transform-origin"]=e[t],delete a[t]),"filter"!==t||jQuery.mbBrowser.mozilla||(a[jQuery.CSS.sfx+"filter"]=e[t],delete a[t]),"blur"===t&&setFilter(a,"blur",e[t]),"brightness"===t&&setFilter(a,"brightness",e[t]),"contrast"===t&&setFilter(a,"contrast",e[t]),"grayscale"===t&&setFilter(a,"grayscale",e[t]),"hueRotate"===t&&setFilter(a,"hueRotate",e[t]),"invert"===t&&setFilter(a,"invert",e[t]),"saturate"===t&&setFilter(a,"saturate",e[t]),"sepia"===t&&setFilter(a,"sepia",e[t]),"x"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateX("+setUnit(e[t],"px")+")",delete a[t]),"y"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateY("+setUnit(e[t],"px")+")",delete a[t]),"z"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" translateZ("+setUnit(e[t],"px")+")",delete a[t]),"rotate"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotate("+setUnit(e[t],"deg")+")",delete a[t]),"rotateX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateX("+setUnit(e[t],"deg")+")",delete a[t]),"rotateY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateY("+setUnit(e[t],"deg")+")",delete a[t]),"rotateZ"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" rotateZ("+setUnit(e[t],"deg")+")",delete a[t]),"scale"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scale("+setUnit(e[t],"")+")",delete a[t]),"scaleX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleX("+setUnit(e[t],"")+")",delete a[t]),"scaleY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleY("+setUnit(e[t],"")+")",delete a[t]),"scaleZ"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" scaleZ("+setUnit(e[t],"")+")",delete a[t]),"skew"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skew("+setUnit(e[t],"deg")+")",delete a[t]),"skewX"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skewX("+setUnit(e[t],"deg")+")",delete a[t]),"skewY"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" skewY("+setUnit(e[t],"deg")+")",delete a[t]),"perspective"===t&&(a[n=jQuery.CSS.sfx+"transform"]=a[n]||"",a[n]+=" perspective("+setUnit(e[t],"px")+")",delete a[t]);return a},getProp:function(e){var t,n=[];for(t in e)n.indexOf(t)<0&&n.push(uncamel(t));return n.join(",")},animate:function(r,s,c,u,d){return this.each(function(){function e(){t.called=!0,t.CSSAIsRunning=!1,n.off(jQuery.CSS.transitionEnd+"."+t.id),clearTimeout(t.timeout),n.css(jQuery.CSS.sfx+"transition",""),"function"==typeof d&&d.apply(t),"function"==typeof t.CSSqueue&&(t.CSSqueue(),t.CSSqueue=null)}var t=this,n=jQuery(this);t.id=t.id||"CSSA_"+(new Date).getTime();var a=a||{type:"noEvent"};if(t.CSSAIsRunning&&t.eventType==a.type&&!jQuery.mbBrowser.msie&&jQuery.mbBrowser.version<=9)t.CSSqueue=function(){n.CSSAnimate(r,s,c,u,d)};else if(t.CSSqueue=null,t.eventType=a.type,0!==n.length&&r){if(r=jQuery.normalizeCss(r),t.CSSAIsRunning=!0,"function"==typeof s&&(d=s,s=jQuery.fx.speeds._default),"function"==typeof c&&(u=c,c=0),"string"==typeof c&&(d=c,c=0),"function"==typeof u&&(d=u,u="cubic-bezier(0.65,0.03,0.36,0.72)"),"string"==typeof s)for(var l in jQuery.fx.speeds){if(s==l){s=jQuery.fx.speeds[l];break}s=jQuery.fx.speeds._default}if(s=s||jQuery.fx.speeds._default,"string"==typeof d&&(u=d,d=null),jQuery.support.CSStransition){(i={default:"ease",in:"ease-in",out:"ease-out","in-out":"ease-in-out",snap:"cubic-bezier(0,1,.5,1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"})[u]&&(u=i[u]),n.off(jQuery.CSS.transitionEnd+"."+t.id);var i=jQuery.CSS.getProp(r),o={};jQuery.extend(o,r),o[jQuery.CSS.sfx+"transition-property"]=i,o[jQuery.CSS.sfx+"transition-duration"]=s+"ms",o[jQuery.CSS.sfx+"transition-delay"]=c+"ms",o[jQuery.CSS.sfx+"transition-timing-function"]=u,setTimeout(function(){n.one(jQuery.CSS.transitionEnd+"."+t.id,e),n.css(o)},1),t.timeout=setTimeout(function(){t.called||!d?(t.called=!1,t.CSSAIsRunning=!1):(n.css(jQuery.CSS.sfx+"transition",""),d.apply(t),t.CSSAIsRunning=!1,"function"==typeof t.CSSqueue&&(t.CSSqueue(),t.CSSqueue=null))},s+c+10)}else{for(i in r)"transform"===i&&delete r[i],"filter"===i&&delete r[i],"transform-origin"===i&&delete r[i],"auto"===r[i]&&delete r[i],"x"===i&&(a=r[i],l="left",r[l]=a,delete r[i]),"y"===i&&(a=r[i],l="top",r[l]=a,delete r[i]),"-ms-transform"!==i&&"-ms-filter"!==i||delete r[i];n.delay(c).animate(r,s,d)}}})}},jQuery.fn.CSSAnimate=jQuery.CSS.animate,jQuery.normalizeCss=jQuery.CSS.normalizeCss,jQuery.fn.css3=function(n){return this.each(function(){var e=jQuery(this),t=jQuery.normalizeCss(n);e.css(t)})},function(l){l.simpleSlider={defaults:{initialval:0,maxval:100,orientation:"h",readonly:!1,callback:!1},events:{start:l.browser.mobile?"touchstart":"mousedown",end:l.browser.mobile?"touchend":"mouseup",move:l.browser.mobile?"touchmove":"mousemove"},init:function(a){return this.each(function(){var t=this,n=l(t);n.addClass("simpleSlider"),t.opt={},l.extend(t.opt,l.simpleSlider.defaults,a),l.extend(t.opt,n.data());var e="h"===t.opt.orientation?"horizontal":"vertical",e=l("<div/>").addClass("level").addClass(e);n.prepend(e),t.level=e,n.css({cursor:"default"}),"auto"==t.opt.maxval&&(t.opt.maxval=l(t).outerWidth()),n.updateSliderVal(),t.opt.readonly||(n.on(l.simpleSlider.events.start,function(e){l.browser.mobile&&(e=e.changedTouches[0]),t.canSlide=!0,n.updateSliderVal(e),"h"===t.opt.orientation?n.css({cursor:"col-resize"}):n.css({cursor:"row-resize"}),t.lastVal=t.val,l.browser.mobile||(e.preventDefault(),e.stopPropagation())}),l(document).on(l.simpleSlider.events.move,function(e){l.browser.mobile&&(e=e.changedTouches[0]),t.canSlide&&(l(document).css({cursor:"default"}),n.updateSliderVal(e),l.browser.mobile||(e.preventDefault(),e.stopPropagation()))}).on(l.simpleSlider.events.end,function(){l(document).css({cursor:"auto"}),t.canSlide=!1,n.css({cursor:"auto"})}))})},updateSliderVal:function(e){var t,n,a=this.get(0);a.opt&&(a.opt.initialval="number"==typeof a.opt.initialval?a.opt.initialval:a.opt.initialval(a),t=l(a).outerWidth(),n=l(a).outerHeight(),a.x="object"==typeof e?e.clientX+document.body.scrollLeft-this.offset().left:"number"==typeof e?e*t/a.opt.maxval:a.opt.initialval*t/a.opt.maxval,a.y="object"==typeof e?e.clientY+document.body.scrollTop-this.offset().top:"number"==typeof e?(a.opt.maxval-a.opt.initialval-e)*n/a.opt.maxval:a.opt.initialval*n/a.opt.maxval,a.y=this.outerHeight()-a.y,a.scaleX=a.x*a.opt.maxval/t,a.scaleY=a.y*a.opt.maxval/n,a.outOfRangeX=a.scaleX>a.opt.maxval?a.scaleX-a.opt.maxval:a.scaleX<0?a.scaleX:0,a.outOfRangeY=a.scaleY>a.opt.maxval?a.scaleY-a.opt.maxval:a.scaleY<0?a.scaleY:0,a.outOfRange="h"===a.opt.orientation?a.outOfRangeX:a.outOfRangeY,a.value=void 0!==e?"h"===a.opt.orientation?a.x>=this.outerWidth()?a.opt.maxval:a.x<=0?0:a.scaleX:a.y>=this.outerHeight()?a.opt.maxval:a.y<=0?0:a.scaleY:"h"===a.opt.orientation?a.scaleX:a.scaleY,"h"===a.opt.orientation?a.level.width(Math.floor(100*a.x/t)+"%"):a.level.height(Math.floor(100*a.y/n)),a.lastVal===a.value&&("h"===a.opt.orientation&&(a.x>=this.outerWidth()||a.x<=0)||"h"!==a.opt.orientation&&(a.y>=this.outerHeight()||a.y<=0))||("function"==typeof a.opt.callback&&a.opt.callback(a),a.lastVal=a.value))}},l.fn.simpleSlider=l.simpleSlider.init,l.fn.updateSliderVal=l.simpleSlider.updateSliderVal}(jQuery),function(t){t.mbCookie={set:function(e,t,n,a){"object"==typeof t&&(t=JSON.stringify(t)),a=a?"; domain="+a:"";var l=new Date,i="";0<n&&(l.setTime(l.getTime()+864e5*n),i="; expires="+l.toGMTString()),document.cookie=e+"="+t+i+"; path=/"+a},get:function(t){t+="=";for(var e=document.cookie.split(";"),n=0;n<e.length;n++){for(var a=e[n];" "==a.charAt(0);)a=a.substring(1,a.length);if(0==a.indexOf(t))try{return JSON.parse(a.substring(t.length,a.length))}catch(e){return a.substring(t.length,a.length)}}return null},remove:function(e){t.mbCookie.set(e,"",-1)}},t.mbStorage={set:function(e,t){"object"==typeof t&&(t=JSON.stringify(t)),localStorage.setItem(e,t)},get:function(t){if(!localStorage[t])return null;try{return JSON.parse(localStorage[t])}catch(e){return localStorage[t]}},remove:function(e){e?localStorage.removeItem(e):localStorage.clear()}}}(jQuery);var LeaderLine=function(){"use strict";var G,k,C,M,z,i,t,s,u,c,n,a,l,o,r,e,v,g,d,p,h,w,S,O="leader-line",_=1,x=2,E=3,A=4,I={top:_,right:x,bottom:E,left:A},V=1,N=2,T=3,L=4,P=5,B={straight:V,arc:N,fluid:T,magnet:L,grid:P},U="behind",f=O+"-defs",m='<svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="leader-line-defs"><style><![CDATA[.leader-line{position:absolute;overflow:visible!important;pointer-events:none!important;font-size:16px}#leader-line-defs{width:0;height:0;position:absolute;left:0;top:0}.leader-line-line-path{fill:none}.leader-line-mask-bg-rect{fill:#fff}.leader-line-caps-mask-anchor,.leader-line-caps-mask-marker-shape{fill:#000}.leader-line-caps-mask-anchor{stroke:#000}.leader-line-caps-mask-line,.leader-line-plugs-face{stroke:transparent}.leader-line-line-mask-shape{stroke:#fff}.leader-line-line-outline-mask-shape{stroke:#000}.leader-line-plug-mask-shape{fill:#fff;stroke:#000}.leader-line-plug-outline-mask-shape{fill:#000;stroke:#fff}.leader-line-areaAnchor{position:absolute;overflow:visible!important}]]></style><defs><circle id="leader-line-disc" cx="0" cy="0" r="5"/><rect id="leader-line-square" x="-5" y="-5" width="10" height="10"/><polygon id="leader-line-arrow1" points="-8,-8 8,0 -8,8 -5,0"/><polygon id="leader-line-arrow2" points="-4,-8 4,0 -4,8 -7,5 -2,0 -7,-5"/><polygon id="leader-line-arrow3" points="-4,-5 8,0 -4,5"/><g id="leader-line-hand"><path style="fill: #fcfcfc" d="M9.19 11.14h4.75c1.38 0 2.49-1.11 2.49-2.49 0-.51-.15-.98-.41-1.37h1.3c1.38 0 2.49-1.11 2.49-2.49s-1.11-2.53-2.49-2.53h1.02c1.38 0 2.49-1.11 2.49-2.49s-1.11-2.49-2.49-2.49h14.96c1.37 0 2.49-1.11 2.49-2.49s-1.11-2.49-2.49-2.49H16.58C16-9.86 14.28-11.14 9.7-11.14c-4.79 0-6.55 3.42-7.87 4.73H-2.14v13.23h3.68C3.29 9.97 5.47 11.14 9.19 11.14L9.19 11.14Z"/><path style="fill: black" d="M13.95 12c1.85 0 3.35-1.5 3.35-3.35 0-.17-.02-.34-.04-.51h.07c1.85 0 3.35-1.5 3.35-3.35 0-.79-.27-1.51-.72-2.08 1.03-.57 1.74-1.67 1.74-2.93 0-.59-.16-1.15-.43-1.63h12.04c1.85 0 3.35-1.5 3.35-3.35 0-1.85-1.5-3.35-3.35-3.35H17.2C16.26-10.93 13.91-12 9.7-12 5.36-12 3.22-9.4 1.94-7.84c0 0-.29.33-.5.57-.63 0-3.58 0-3.58 0C-2.61-7.27-3-6.88-3-6.41v13.23c0 .47.39.86.86.86 0 0 2.48 0 3.2 0C2.9 10.73 5.29 12 9.19 12L13.95 12ZM9.19 10.28c-3.46 0-5.33-1.05-6.9-3.87-.15-.27-.44-.44-.75-.44 0 0-1.81 0-2.82 0V-5.55c1.06 0 3.11 0 3.11 0 .25 0 .44-.06.61-.25l.83-.95c1.23-1.49 2.91-3.53 6.43-3.53 3.45 0 4.9.74 5.57 1.72h-4.3c-.48 0-.86.38-.86.86s.39.86.86.86h22.34c.9 0 1.63.73 1.63 1.63 0 .9-.73 1.63-1.63 1.63H15.83c-.48 0-.86.38-.86.86 0 .47.39.86.86.86h2.52c.9 0 1.63.73 1.63 1.63s-.73 1.63-1.63 1.63h-3.12c-.48 0-.86.38-.86.86 0 .47.39.86.86.86h2.11c.88 0 1.63.76 1.63 1.67 0 .9-.73 1.63-1.63 1.63h-3.2c-.48 0-.86.39-.86.86 0 .47.39.86.86.86h1.36c.05.16.09.34.09.51 0 .9-.73 1.63-1.63 1.63C13.95 10.28 9.19 10.28 9.19 10.28Z"/></g><g id="leader-line-crosshair"><path d="M0-78.97c-43.54 0-78.97 35.43-78.97 78.97 0 43.54 35.43 78.97 78.97 78.97s78.97-35.43 78.97-78.97C78.97-43.54 43.55-78.97 0-78.97ZM76.51-1.21h-9.91v-9.11h-2.43v9.11h-11.45c-.64-28.12-23.38-50.86-51.5-51.5V-64.17h9.11V-66.6h-9.11v-9.91C42.46-75.86 75.86-42.45 76.51-1.21ZM-1.21-30.76h-9.11v2.43h9.11V-4.2c-1.44.42-2.57 1.54-2.98 2.98H-28.33v-9.11h-2.43v9.11H-50.29C-49.65-28-27.99-49.65-1.21-50.29V-30.76ZM-30.76 1.21v9.11h2.43v-9.11H-4.2c.42 1.44 1.54 2.57 2.98 2.98v24.13h-9.11v2.43h9.11v19.53C-27.99 49.65-49.65 28-50.29 1.21H-30.76ZM1.22 30.75h9.11v-2.43h-9.11V4.2c1.44-.42 2.56-1.54 2.98-2.98h24.13v9.11h2.43v-9.11h19.53C49.65 28 28 49.65 1.22 50.29V30.75ZM30.76-1.21v-9.11h-2.43v9.11H4.2c-.42-1.44-1.54-2.56-2.98-2.98V-28.33h9.11v-2.43h-9.11V-50.29C28-49.65 49.65-28 50.29-1.21H30.76ZM-1.21-76.51v9.91h-9.11v2.43h9.11v11.45c-28.12.64-50.86 23.38-51.5 51.5H-64.17v-9.11H-66.6v9.11h-9.91C-75.86-42.45-42.45-75.86-1.21-76.51ZM-76.51 1.21h9.91v9.11h2.43v-9.11h11.45c.64 28.12 23.38 50.86 51.5 51.5v11.45h-9.11v2.43h9.11v9.91C-42.45 75.86-75.86 42.45-76.51 1.21ZM1.22 76.51v-9.91h9.11v-2.43h-9.11v-11.45c28.12-.64 50.86-23.38 51.5-51.5h11.45v9.11h2.43v-9.11h9.91C75.86 42.45 42.45 75.86 1.22 76.51Z"/><path d="M0 83.58-7.1 96 7.1 96Z"/><path d="M0-83.58 7.1-96-7.1-96"/><path d="M83.58 0 96 7.1 96-7.1Z"/><path d="M-83.58 0-96-7.1-96 7.1Z"/></g></defs></svg>',Y={disc:{elmId:"leader-line-disc",noRotate:!0,bBox:{left:-5,top:-5,width:10,height:10,right:5,bottom:5},widthR:2.5,heightR:2.5,bCircle:5,sideLen:5,backLen:5,overhead:0,outlineBase:1,outlineMax:4},square:{elmId:"leader-line-square",noRotate:!0,bBox:{left:-5,top:-5,width:10,height:10,right:5,bottom:5},widthR:2.5,heightR:2.5,bCircle:5,sideLen:5,backLen:5,overhead:0,outlineBase:1,outlineMax:4},arrow1:{elmId:"leader-line-arrow1",bBox:{left:-8,top:-8,width:16,height:16,right:8,bottom:8},widthR:4,heightR:4,bCircle:8,sideLen:8,backLen:8,overhead:8,outlineBase:2,outlineMax:1.5},arrow2:{elmId:"leader-line-arrow2",bBox:{left:-7,top:-8,width:11,height:16,right:4,bottom:8},widthR:2.75,heightR:4,bCircle:8,sideLen:8,backLen:7,overhead:4,outlineBase:1,outlineMax:1.75},arrow3:{elmId:"leader-line-arrow3",bBox:{left:-4,top:-5,width:12,height:10,right:8,bottom:5},widthR:3,heightR:2.5,bCircle:8,sideLen:5,backLen:4,overhead:8,outlineBase:1,outlineMax:2.5},hand:{elmId:"leader-line-hand",bBox:{left:-3,top:-12,width:40,height:24,right:37,bottom:12},widthR:10,heightR:6,bCircle:37,sideLen:12,backLen:3,overhead:37},crosshair:{elmId:"leader-line-crosshair",noRotate:!0,bBox:{left:-96,top:-96,width:192,height:192,right:96,bottom:96},widthR:48,heightR:48,bCircle:96,sideLen:96,backLen:96,overhead:0}},j={behind:U,disc:"disc",square:"square",arrow1:"arrow1",arrow2:"arrow2",arrow3:"arrow3",hand:"hand",crosshair:"crosshair"},X={disc:"disc",square:"square",arrow1:"arrow1",arrow2:"arrow2",arrow3:"arrow3",hand:"hand",crosshair:"crosshair"},F=[_,x,E,A],$="auto",q={x:"left",y:"top",width:"width",height:"height"},D=80,W=4,Q=5,R=120,H=8,K=3.75,Z=10,J=30,ee=.5522847,te=.25*Math.PI,y=/^\s*(\-?[\d\.]+)\s*(\%)?\s*$/,ne="http://www.w3.org/2000/svg",b="-ms-scroll-limit"in document.documentElement.style&&"-ms-ime-align"in document.documentElement.style&&!window.navigator.msPointerEnabled,ae=!b&&!!document.uniqueID,le="MozAppearance"in document.documentElement.style,ie=!(b||le||!window.chrome||!window.CSS),oe=!b&&!ae&&!le&&!ie&&!window.chrome&&"WebkitAppearance"in document.documentElement.style,re=ae||b?.2:.1,se={path:T,lineColor:"coral",lineSize:4,plugSE:[U,"arrow1"],plugSizeSE:[1,1],lineOutlineEnabled:!1,lineOutlineColor:"indianred",lineOutlineSize:.25,plugOutlineEnabledSE:[!1,!1],plugOutlineSizeSE:[1,1]},ce=(n={}.toString,a={}.hasOwnProperty.toString,l=a.call(Object),function(e){return e&&"[object Object]"===n.call(e)&&(!(e=Object.getPrototypeOf(e))||(e=e.hasOwnProperty("constructor")&&e.constructor)&&"function"==typeof e&&a.call(e)===l)}),ue=Number.isFinite||function(e){return"number"==typeof e&&window.isFinite(e)},de=(v={ease:[.25,.1,.25,1],linear:[0,0,1,1],"ease-in":[.42,0,1,1],"ease-out":[0,0,.58,1],"ease-in-out":[.42,0,.58,1]},g=1e3/60/2,d=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||function(e){setTimeout(e,g)},p=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.msCancelAnimationFrame||function(e){clearTimeout(e)},h=Number.isFinite||function(e){return"number"==typeof e&&window.isFinite(e)},w=[],S=0,{add:function(n,e,t,a,l,i,o){var r,s,c,u,d,p,h,f,m=++S;function y(e,t){return{value:n(t),timeRatio:e,outputRatio:t}}if("string"==typeof l&&(l=v[l]),n=n||function(){},t<g)r=[y(0,0),y(1,1)];else{if(s=g/t,r=[y(0,0)],0===l[0]&&0===l[1]&&1===l[2]&&1===l[3])for(u=s;u<=1;u+=s)r.push(y(u,u));else for(d=c=(u=s)/10;d<=1;d+=c)p=(f=d*d)*d,f=3*(h=1-d)*f,u<=(p={x:(h=h*h*3*d)*l[0]+f*l[2]+p,y:h*l[1]+f*l[3]+p}).x&&(r.push(y(p.x,p.y)),u+=s);r.push(y(1,1))}return w.push(i={animId:m,frameCallback:e,duration:t,count:a,frames:r,reverse:!!i}),!1!==o&&_e(i,o),m},remove:function(n){var a;w.some(function(e,t){return e.animId===n&&(a=t,!(e.framesStart=null))})&&w.splice(a,1)},start:function(t,n,a){w.some(function(e){return e.animId===t&&(e.reverse=!!n,_e(e,a),!0)})},stop:function(t,n){var a;return w.some(function(e){return e.animId===t&&(n?null!=e.lastFrame&&(a=e.frames[e.lastFrame].timeRatio):(a=(Date.now()-e.framesStart)/e.duration,(a=e.reverse?1-a:a)<0?a=0:1<a&&(a=1)),!(e.framesStart=null))}),a},validTiming:function(t){return"string"==typeof t?v[t]:Array.isArray(t)&&[0,1,2,3].every(function(e){return h(t[e])&&0<=t[e]&&t[e]<=1})?[t[0],t[1],t[2],t[3]]:null}}),pe=function(e){e.SVGPathElement.prototype.getPathData&&e.SVGPathElement.prototype.setPathData||function(){function l(e){this._string=e,this._currentIndex=0,this._endIndex=this._string.length,this._prevCommand=null,this._skipOptionalSpaces()}var a={Z:"Z",M:"M",L:"L",C:"C",Q:"Q",A:"A",H:"H",V:"V",S:"S",T:"T",z:"Z",m:"m",l:"l",c:"c",q:"q",a:"a",h:"h",v:"v",s:"s",t:"t"},i=-1!==e.navigator.userAgent.indexOf("MSIE ");l.prototype={parseSegment:function(){var e=this._string[this._currentIndex],t=a[e]||null;if(null===t){if(null===this._prevCommand)return null;if(null===(t=("+"===e||"-"===e||"."===e||"0"<=e&&e<="9")&&"Z"!==this._prevCommand?"M"===this._prevCommand?"L":"m"===this._prevCommand?"l":this._prevCommand:null))return null}else this._currentIndex+=1;var n=null,e=(this._prevCommand=t).toUpperCase();return"H"===e||"V"===e?n=[this._parseNumber()]:"M"===e||"L"===e||"T"===e?n=[this._parseNumber(),this._parseNumber()]:"S"===e||"Q"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:"C"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:"A"===e?n=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseArcFlag(),this._parseArcFlag(),this._parseNumber(),this._parseNumber()]:"Z"===e&&(this._skipOptionalSpaces(),n=[]),null===n||0<=n.indexOf(null)?null:{type:t,values:n}},hasMoreData:function(){return this._currentIndex<this._endIndex},peekSegmentType:function(){var e=this._string[this._currentIndex];return a[e]||null},initialCommandIsMoveTo:function(){if(!this.hasMoreData())return!0;var e=this.peekSegmentType();return"M"===e||"m"===e},_isCurrentSpace:function(){var e=this._string[this._currentIndex];return e<=" "&&(" "===e||"\n"===e||"\t"===e||"\r"===e||"\f"===e)},_skipOptionalSpaces:function(){for(;this._currentIndex<this._endIndex&&this._isCurrentSpace();)this._currentIndex+=1;return this._currentIndex<this._endIndex},_skipOptionalSpacesOrDelimiter:function(){return!(this._currentIndex<this._endIndex&&!this._isCurrentSpace()&&","!==this._string[this._currentIndex])&&(this._skipOptionalSpaces()&&this._currentIndex<this._endIndex&&","===this._string[this._currentIndex]&&(this._currentIndex+=1,this._skipOptionalSpaces()),this._currentIndex<this._endIndex)},_parseNumber:function(){var e=0,t=0,n=1,a=0,l=1,i=1,o=this._currentIndex;if(this._skipOptionalSpaces(),this._currentIndex<this._endIndex&&"+"===this._string[this._currentIndex]?this._currentIndex+=1:this._currentIndex<this._endIndex&&"-"===this._string[this._currentIndex]&&(this._currentIndex+=1,l=-1),this._currentIndex===this._endIndex||(this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])&&"."!==this._string[this._currentIndex])return null;for(var r=this._currentIndex;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)this._currentIndex+=1;if(this._currentIndex!==r)for(var s=this._currentIndex-1,c=1;r<=s;)t+=c*(this._string[s]-"0"),--s,c*=10;if(this._currentIndex<this._endIndex&&"."===this._string[this._currentIndex]){if(this._currentIndex+=1,this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])return null;for(;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)n*=10,a+=(this._string.charAt(this._currentIndex)-"0")/n,this._currentIndex+=1}if(this._currentIndex!==o&&this._currentIndex+1<this._endIndex&&("e"===this._string[this._currentIndex]||"E"===this._string[this._currentIndex])&&"x"!==this._string[this._currentIndex+1]&&"m"!==this._string[this._currentIndex+1]){if(this._currentIndex+=1,"+"===this._string[this._currentIndex]?this._currentIndex+=1:"-"===this._string[this._currentIndex]&&(this._currentIndex+=1,i=-1),this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||"9"<this._string[this._currentIndex])return null;for(;this._currentIndex<this._endIndex&&"0"<=this._string[this._currentIndex]&&this._string[this._currentIndex]<="9";)e*=10,e+=this._string[this._currentIndex]-"0",this._currentIndex+=1}var u=t+a;return u*=l,e&&(u*=Math.pow(10,i*e)),o===this._currentIndex?null:(this._skipOptionalSpacesOrDelimiter(),u)},_parseArcFlag:function(){if(this._currentIndex>=this._endIndex)return null;var e=null,t=this._string[this._currentIndex];if(this._currentIndex+=1,"0"===t)e=0;else{if("1"!==t)return null;e=1}return this._skipOptionalSpacesOrDelimiter(),e}};function n(e){if(!e||0===e.length)return[];var t=new l(e),n=[];if(t.initialCommandIsMoveTo())for(;t.hasMoreData();){var a=t.parseSegment();if(null===a)break;n.push(a)}return n}function o(e){return e.map(function(e){return{type:e.type,values:Array.prototype.slice.call(e.values)}})}function r(e){var c=[],u=null,d=null,p=null,h=null,f=null,m=null,y=null;return e.forEach(function(e){var t,n,a,l,i,o,r,s;"M"===e.type?(n=e.values[0],a=e.values[1],c.push({type:"M",values:[n,a]}),h=m=n,f=y=a):"C"===e.type?(r=e.values[0],s=e.values[1],t=e.values[2],l=e.values[3],n=e.values[4],a=e.values[5],c.push({type:"C",values:[r,s,t,l,n,a]}),d=t,p=l,h=n,f=a):"L"===e.type?(n=e.values[0],a=e.values[1],c.push({type:"L",values:[n,a]}),h=n,f=a):"H"===e.type?(n=e.values[0],c.push({type:"L",values:[n,f]}),h=n):"V"===e.type?(a=e.values[0],c.push({type:"L",values:[h,a]}),f=a):"S"===e.type?(t=e.values[0],l=e.values[1],n=e.values[2],a=e.values[3],o="C"===u||"S"===u?(i=h+(h-d),f+(f-p)):(i=h,f),c.push({type:"C",values:[i,o,t,l,n,a]}),d=t,p=l,h=n,f=a):"T"===e.type?(n=e.values[0],a=e.values[1],s="Q"===u||"T"===u?(r=h+(h-d),f+(f-p)):(r=h,f),c.push({type:"C",values:[i=h+2*(r-h)/3,o=f+2*(s-f)/3,n+2*(r-n)/3,a+2*(s-a)/3,n,a]}),d=r,p=s,h=n,f=a):"Q"===e.type?(r=e.values[0],s=e.values[1],n=e.values[2],a=e.values[3],c.push({type:"C",values:[i=h+2*(r-h)/3,o=f+2*(s-f)/3,n+2*(r-n)/3,a+2*(s-a)/3,n,a]}),d=r,p=s,h=n,f=a):"A"===e.type?(l=e.values[0],i=e.values[1],o=e.values[2],r=e.values[3],s=e.values[4],n=e.values[5],a=e.values[6],0===l||0===i?(c.push({type:"C",values:[h,f,n,a,n,a]}),h=n,f=a):h===n&&f===a||x(h,f,n,a,l,i,o,r,s).forEach(function(e){c.push({type:"C",values:e}),h=n,f=a})):"Z"===e.type&&(c.push(e),h=m,f=y),u=e.type}),c}var s=e.SVGPathElement.prototype.setAttribute,c=e.SVGPathElement.prototype.removeAttribute,h=e.Symbol?e.Symbol():"__cachedPathData",f=e.Symbol?e.Symbol():"__cachedNormalizedPathData",x=function(e,t,n,a,l,i,o,r,s,c){function u(e,t,n){return{x:e*Math.cos(n)-t*Math.sin(n),y:e*Math.sin(n)+t*Math.cos(n)}}var d=Math.PI*o/180,p=[];c?(w=c[0],S=c[1],v=c[2],g=c[3]):(e=(y=u(e,t,-d)).x,t=y.y,1<(y=(m=(e-(n=(f=u(n,a,-d)).x))/2)*m/(l*l)+(h=(t-(a=f.y))/2)*h/(i*i))&&(l*=y=Math.sqrt(y),i*=y),f=l*l,y=i*i,v=(f=(r===s?-1:1)*Math.sqrt(Math.abs((f*y-f*h*h-y*m*m)/(f*h*h+y*m*m))))*l*h/i+(e+n)/2,g=f*-i*m/l+(t+a)/2,w=Math.asin(parseFloat(((t-g)/i).toFixed(9))),S=Math.asin(parseFloat(((a-g)/i).toFixed(9))),e<v&&(w=Math.PI-w),n<v&&(S=Math.PI-S),w<0&&(w=2*Math.PI+w),S<0&&(S=2*Math.PI+S),s&&S<w&&(w-=2*Math.PI),!s&&w<S&&(S-=2*Math.PI));var h,f,m,y=S-w;Math.abs(y)>120*Math.PI/180&&(h=S,f=n,m=a,S=s&&w<S?w+120*Math.PI/180*1:w+120*Math.PI/180*-1,n=v+l*Math.cos(S),a=g+i*Math.sin(S),p=x(n,a,f,m,l,i,o,0,s,[S,h,v,g]));var y=S-w,v=Math.cos(w),g=Math.sin(w),w=Math.cos(S),S=Math.sin(S),y=Math.tan(y/4),l=4/3*l*y,i=4/3*i*y,y=[e,t],v=[e+l*g,t-i*v],w=[n+l*S,a-i*w],a=[n,a];if(v[0]=2*y[0]-v[0],v[1]=2*y[1]-v[1],c)return[v,w,a].concat(p);var p=[v,w,a].concat(p).join().split(","),b=[],_=[];return p.forEach(function(e,t){t%2?_.push(u(p[t-1],p[t],d).y):_.push(u(p[t],p[t+1],d).x),6===_.length&&(b.push(_),_=[])}),b};e.SVGPathElement.prototype.setAttribute=function(e,t){"d"===e&&(this[h]=null,this[f]=null),s.call(this,e,t)},e.SVGPathElement.prototype.removeAttribute=function(e,t){"d"===e&&(this[h]=null,this[f]=null),c.call(this,e)},e.SVGPathElement.prototype.getPathData=function(e){if(e&&e.normalize){if(this[f])return o(this[f]);this[h]?t=o(this[h]):(t=n(this.getAttribute("d")||""),this[h]=o(t));e=r((s=[],p=d=u=c=null,t.forEach(function(e){var t,n,a,l,i,o,r=e.type;"M"===r?(i=e.values[0],o=e.values[1],s.push({type:"M",values:[i,o]}),c=d=i,u=p=o):"m"===r?(i=c+e.values[0],o=u+e.values[1],s.push({type:"M",values:[i,o]}),c=d=i,u=p=o):"L"===r?(i=e.values[0],o=e.values[1],s.push({type:"L",values:[i,o]}),c=i,u=o):"l"===r?(i=c+e.values[0],o=u+e.values[1],s.push({type:"L",values:[i,o]}),c=i,u=o):"C"===r?(t=e.values[0],n=e.values[1],a=e.values[2],l=e.values[3],i=e.values[4],o=e.values[5],s.push({type:"C",values:[t,n,a,l,i,o]}),c=i,u=o):"c"===r?(t=c+e.values[0],n=u+e.values[1],a=c+e.values[2],l=u+e.values[3],i=c+e.values[4],o=u+e.values[5],s.push({type:"C",values:[t,n,a,l,i,o]}),c=i,u=o):"Q"===r?(t=e.values[0],n=e.values[1],i=e.values[2],o=e.values[3],s.push({type:"Q",values:[t,n,i,o]}),c=i,u=o):"q"===r?(t=c+e.values[0],n=u+e.values[1],i=c+e.values[2],o=u+e.values[3],s.push({type:"Q",values:[t,n,i,o]}),c=i,u=o):"A"===r?(i=e.values[5],o=e.values[6],s.push({type:"A",values:[e.values[0],e.values[1],e.values[2],e.values[3],e.values[4],i,o]}),c=i,u=o):"a"===r?(i=c+e.values[5],o=u+e.values[6],s.push({type:"A",values:[e.values[0],e.values[1],e.values[2],e.values[3],e.values[4],i,o]}),c=i,u=o):"H"===r?(i=e.values[0],s.push({type:"H",values:[i]}),c=i):"h"===r?(i=c+e.values[0],s.push({type:"H",values:[i]}),c=i):"V"===r?(o=e.values[0],s.push({type:"V",values:[o]}),u=o):"v"===r?(o=u+e.values[0],s.push({type:"V",values:[o]}),u=o):"S"===r?(a=e.values[0],l=e.values[1],i=e.values[2],o=e.values[3],s.push({type:"S",values:[a,l,i,o]}),c=i,u=o):"s"===r?(a=c+e.values[0],l=u+e.values[1],i=c+e.values[2],o=u+e.values[3],s.push({type:"S",values:[a,l,i,o]}),c=i,u=o):"T"===r?(i=e.values[0],o=e.values[1],s.push({type:"T",values:[i,o]}),c=i,u=o):"t"===r?(i=c+e.values[0],o=u+e.values[1],s.push({type:"T",values:[i,o]}),c=i,u=o):"Z"!==r&&"z"!==r||(s.push({type:"Z",values:[]}),c=d,u=p)}),s));return this[f]=o(e),e}if(this[h])return o(this[h]);var s,c,u,d,p,t=n(this.getAttribute("d")||"");return this[h]=o(t),t},e.SVGPathElement.prototype.setPathData=function(e){if(0===e.length)i?this.setAttribute("d",""):this.removeAttribute("d");else{for(var t="",n=0,a=e.length;n<a;n+=1){var l=e[n];0<n&&(t+=" "),t+=l.type,l.values&&0<l.values.length&&(t+=" "+l.values.join(" "))}this.setAttribute("d",t)}},e.SVGRectElement.prototype.getPathData=function(e){var t=this.x.baseVal.value,n=this.y.baseVal.value,a=this.width.baseVal.value,l=this.height.baseVal.value,i=(this.hasAttribute("rx")?this.rx:this.ry).baseVal.value,o=(this.hasAttribute("ry")?this.ry:this.rx).baseVal.value,n=(n=[{type:"M",values:[t+(i=a/2<i?a/2:i),n]},{type:"H",values:[t+a-i]},{type:"A",values:[i,o=l/2<o?l/2:o,0,0,1,t+a,n+o]},{type:"V",values:[n+l-o]},{type:"A",values:[i,o,0,0,1,t+a-i,n+l]},{type:"H",values:[t+i]},{type:"A",values:[i,o,0,0,1,t,n+l-o]},{type:"V",values:[n+o]},{type:"A",values:[i,o,0,0,1,t+i,n]},{type:"Z",values:[]}]).filter(function(e){return"A"!==e.type||0!==e.values[0]&&0!==e.values[1]});return n=e&&!0===e.normalize?r(n):n},e.SVGCircleElement.prototype.getPathData=function(e){var t=this.cx.baseVal.value,n=this.cy.baseVal.value,a=this.r.baseVal.value,n=[{type:"M",values:[t+a,n]},{type:"A",values:[a,a,0,0,1,t,n+a]},{type:"A",values:[a,a,0,0,1,t-a,n]},{type:"A",values:[a,a,0,0,1,t,n-a]},{type:"A",values:[a,a,0,0,1,t+a,n]},{type:"Z",values:[]}];return n=e&&!0===e.normalize?r(n):n},e.SVGEllipseElement.prototype.getPathData=function(e){var t=this.cx.baseVal.value,n=this.cy.baseVal.value,a=this.rx.baseVal.value,l=this.ry.baseVal.value,n=[{type:"M",values:[t+a,n]},{type:"A",values:[a,l,0,0,1,t,n+l]},{type:"A",values:[a,l,0,0,1,t-a,n]},{type:"A",values:[a,l,0,0,1,t,n-l]},{type:"A",values:[a,l,0,0,1,t+a,n]},{type:"Z",values:[]}];return n=e&&!0===e.normalize?r(n):n},e.SVGLineElement.prototype.getPathData=function(){return[{type:"M",values:[this.x1.baseVal.value,this.y1.baseVal.value]},{type:"L",values:[this.x2.baseVal.value,this.y2.baseVal.value]}]},e.SVGPolylineElement.prototype.getPathData=function(){for(var e=[],t=0;t<this.points.numberOfItems;t+=1){var n=this.points.getItem(t);e.push({type:0===t?"M":"L",values:[n.x,n.y]})}return e},e.SVGPolygonElement.prototype.getPathData=function(){for(var e=[],t=0;t<this.points.numberOfItems;t+=1){var n=this.points.getItem(t);e.push({type:0===t?"M":"L",values:[n.x,n.y]})}return e.push({type:"Z",values:[]}),e}}()},b=(r={},Se.m=o=[function(e,t,n){n.r(t);var a=500,l=[],i=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||function(e){return setTimeout(e,1e3/60)},o=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.msCancelAnimationFrame||function(e){return clearTimeout(e)},r=void 0,s=Date.now();function c(){var t=void 0,e=void 0;r&&(o.call(window,r),r=null),l.forEach(function(e){e.event&&(e.listener(e.event),e.event=null,t=!0)}),t?(s=Date.now(),e=!0):Date.now()-s<a&&(e=!0),e&&(r=i.call(window,c))}function u(n){var a=-1;return l.some(function(e,t){return e.listener===n&&(a=t,!0)}),a}t.default={add:function(e){var t=void 0;return-1===u(e)?(l.push(t={listener:e}),function(e){t.event=e,r||c()}):null},remove:function(e){-1<(e=u(e))&&(l.splice(e,1),!l.length&&r&&(o.call(window,r),r=null))}}}],Se.c=r,Se.d=function(e,t,n){Se.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:n})},Se.r=function(e){Object.defineProperty(e,"__esModule",{value:!0})},Se.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return Se.d(t,"a",t),t},Se.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},Se.p="",Se(Se.s=0).default),he={line_altColor:{iniValue:!1},line_color:{},line_colorTra:{iniValue:!1},line_strokeWidth:{},plug_enabled:{iniValue:!1},plug_enabledSE:{hasSE:!0,iniValue:!1},plug_plugSE:{hasSE:!0,iniValue:U},plug_colorSE:{hasSE:!0},plug_colorTraSE:{hasSE:!0,iniValue:!1},plug_markerWidthSE:{hasSE:!0},plug_markerHeightSE:{hasSE:!0},lineOutline_enabled:{iniValue:!1},lineOutline_color:{},lineOutline_colorTra:{iniValue:!1},lineOutline_strokeWidth:{},lineOutline_inStrokeWidth:{},plugOutline_enabledSE:{hasSE:!0,iniValue:!1},plugOutline_plugSE:{hasSE:!0,iniValue:U},plugOutline_colorSE:{hasSE:!0},plugOutline_colorTraSE:{hasSE:!0,iniValue:!1},plugOutline_strokeWidthSE:{hasSE:!0},plugOutline_inStrokeWidthSE:{hasSE:!0},position_socketXYSE:{hasSE:!0,hasProps:!0},position_plugOverheadSE:{hasSE:!0},position_path:{},position_lineStrokeWidth:{},position_socketGravitySE:{hasSE:!0},path_pathData:{},path_edge:{hasProps:!0},viewBox_bBox:{hasProps:!0},viewBox_plugBCircleSE:{hasSE:!0},lineMask_enabled:{iniValue:!1},lineMask_outlineMode:{iniValue:!1},lineMask_x:{},lineMask_y:{},lineOutlineMask_x:{},lineOutlineMask_y:{},maskBGRect_x:{},maskBGRect_y:{},capsMaskAnchor_enabledSE:{hasSE:!0,iniValue:!1},capsMaskAnchor_pathDataSE:{hasSE:!0},capsMaskAnchor_strokeWidthSE:{hasSE:!0},capsMaskMarker_enabled:{iniValue:!1},capsMaskMarker_enabledSE:{hasSE:!0,iniValue:!1},capsMaskMarker_plugSE:{hasSE:!0,iniValue:U},capsMaskMarker_markerWidthSE:{hasSE:!0},capsMaskMarker_markerHeightSE:{hasSE:!0},caps_enabled:{iniValue:!1},attach_plugSideLenSE:{hasSE:!0},attach_plugBackLenSE:{hasSE:!0}},fe={show_on:{},show_effect:{},show_animOptions:{},show_animId:{},show_inAnim:{}},me=[],ye={},ve=0,ge={},we=0;function Se(e){if(r[e])return r[e].exports;var t=r[e]={i:e,l:!1,exports:{}};return o[e].call(t.exports,t,t.exports,Se),t.l=!0,t.exports}function be(){var l=Date.now(),i=!1;e&&(p.call(window,e),e=null),w.forEach(function(e){var t,n,a;if(e.framesStart){if((t=l-e.framesStart)>=e.duration&&e.count&&e.loopsLeft<=1)return a=e.frames[e.lastFrame=e.reverse?0:e.frames.length-1],e.frameCallback(a.value,!0,a.timeRatio,a.outputRatio),void(e.framesStart=null);if(t>e.duration){if(n=Math.floor(t/e.duration),e.count){if(n>=e.loopsLeft)return a=e.frames[e.lastFrame=e.reverse?0:e.frames.length-1],e.frameCallback(a.value,!0,a.timeRatio,a.outputRatio),void(e.framesStart=null);e.loopsLeft-=n}e.framesStart+=e.duration*n,t=l-e.framesStart}e.reverse&&(t=e.duration-t),a=e.frames[e.lastFrame=Math.round(t/g)],!1!==e.frameCallback(a.value,!1,a.timeRatio,a.outputRatio)?i=!0:e.framesStart=null}}),i&&(e=d.call(window,be))}function _e(e,t){e.framesStart=Date.now(),null!=t&&(e.framesStart-=e.duration*(e.reverse?1-t:t)),e.loopsLeft=e.count,e.lastFrame=null,be()}function xe(t,n){var e,a;return typeof t!=typeof n||(e=ce(t)?"obj":Array.isArray(t)?"array":"")!=(ce(n)?"obj":Array.isArray(n)?"array":"")||("obj"===e?xe(a=Object.keys(t).sort(),Object.keys(n).sort())||a.some(function(e){return xe(t[e],n[e])}):"array"===e?t.length!==n.length||t.some(function(e,t){return xe(e,n[t])}):t!==n)}function Ee(n){return n&&(ce(n)?Object.keys(n).reduce(function(e,t){return e[t]=Ee(n[t]),e},{}):Array.isArray(n)?n.map(Ee):n)}function ke(e){var t,n,a,l=1,i=e=(e+"").trim();function o(e){var t=1,e=y.exec(e);return e&&(t=parseFloat(e[1]),e[2]?t=0<=t&&t<=100?t/100:1:(t<0||1<t)&&(t=1)),t}return(t=/^(rgba|hsla|hwb|gray|device\-cmyk)\s*\(([\s\S]+)\)$/i.exec(e))?(n=t[1].toLowerCase(),a=t[2].trim().split(/\s*,\s*/),"rgba"===n&&4===a.length?(l=o(a[3]),i="rgb("+a.slice(0,3).join(", ")+")"):"hsla"===n&&4===a.length?(l=o(a[3]),i="hsl("+a.slice(0,3).join(", ")+")"):"hwb"===n&&4===a.length?(l=o(a[3]),i="hwb("+a.slice(0,3).join(", ")+")"):"gray"===n&&2===a.length?(l=o(a[1]),i="gray("+a[0]+")"):"device-cmyk"===n&&5<=a.length&&(l=o(a[4]),i="device-cmyk("+a.slice(0,4).join(", ")+")")):(t=/^\#(?:([\da-f]{6})([\da-f]{2})|([\da-f]{3})([\da-f]))$/i.exec(e))?i=t[1]?(l=parseInt(t[2],16)/255,"#"+t[1]):(l=parseInt(t[4]+t[4],16)/255,"#"+t[3]):"transparent"===e.toLocaleLowerCase()&&(l=0),[l,i]}function Ce(e){return!(!e||e.nodeType!==Node.ELEMENT_NODE||"function"!=typeof e.getBoundingClientRect)}function Me(e,t){var n,a,l,i={};if(!(l=e.ownerDocument))return console.error("Cannot get document that contains the element."),null;if(e.compareDocumentPosition(l)&Node.DOCUMENT_POSITION_DISCONNECTED)return console.error("A disconnected element was passed."),null;for(a in n=e.getBoundingClientRect())i[a]=n[a];if(!t){if(!(l=l.defaultView))return console.error("Cannot get window that contains the element."),null;i.left+=l.pageXOffset,i.right+=l.pageXOffset,i.top+=l.pageYOffset,i.bottom+=l.pageYOffset}return i}function ze(e,t){var n,a=[],l=e;for(t=t||window;;){if(!(n=l.ownerDocument))return console.error("Cannot get document that contains the element."),null;if(!(n=n.defaultView))return console.error("Cannot get window that contains the element."),null;if(n===t)break;if(!(l=n.frameElement))return console.error("`baseWindow` was not found."),null;a.unshift(l)}return a}function Oe(e,t){var a=0,l=0;return(t=ze(e,t=t||window))?t.length?(t.forEach(function(e,t){var n=Me(e,0<t);a+=n.left,l+=n.top,e=(t=e).ownerDocument.defaultView.getComputedStyle(t,""),n={left:t.clientLeft+parseFloat(e.paddingLeft),top:t.clientTop+parseFloat(e.paddingTop)},a+=n.left,l+=n.top}),(t=Me(e,!0)).left+=a,t.right+=a,t.top+=l,t.bottom+=l,t):Me(e):null}function Ae(e,t){var n=e.x-t.x,t=e.y-t.y;return Math.sqrt(n*n+t*t)}function Ie(e,t,n){var a=t.x-e.x,t=t.y-e.y;return{x:e.x+a*n,y:e.y+t*n,angle:Math.atan2(t,a)/(Math.PI/180)}}function Ve(e,t,n){e=Math.atan2(e.y-t.y,t.x-e.x);return{x:t.x+Math.cos(e)*n,y:t.y+Math.sin(e)*n*-1}}function Ne(e,t,n,a,l){var i=l*l,o=i*l,r=1-l,s=r*r,c=s*r,u=c*e.x+3*s*l*t.x+3*r*i*n.x+o*a.x,d=c*e.y+3*s*l*t.y+3*r*i*n.y+o*a.y,p=e.x+2*l*(t.x-e.x)+i*(n.x-2*t.x+e.x),c=e.y+2*l*(t.y-e.y)+i*(n.y-2*t.y+e.y),s=t.x+2*l*(n.x-t.x)+i*(a.x-2*n.x+t.x),o=t.y+2*l*(n.y-t.y)+i*(a.y-2*n.y+t.y),i=r*e.x+l*t.x,e=r*e.y+l*t.y,t=r*n.x+l*a.x,l=r*n.y+l*a.y,a=90-180*Math.atan2(p-s,c-o)/Math.PI;return{x:u,y:d,fromP2:{x:p,y:c},toP1:{x:s,y:o},fromP1:{x:i,y:e},toP2:{x:t,y:l},angle:a+=180<a?-180:180}}function Te(n,a,l,i,e){function o(e,t,n,a,l){return e*(e*(-3*t+9*n-9*a+3*l)+6*t-12*n+6*a)-3*t+3*n}var r,s,c=[.2491,.2491,.2335,.2335,.2032,.2032,.1601,.1601,.1069,.1069,.0472,.0472],u=0,d=(e=null==e||1<e?1:e<0?0:e)/2;return[-.1252,.1252,-.3678,.3678,-.5873,.5873,-.7699,.7699,-.9041,.9041,-.9816,.9816].forEach(function(e,t){r=o(s=d*e+d,n.x,a.x,l.x,i.x),s=o(s,n.y,a.y,l.y,i.y),s=r*r+s*s,u+=c[t]*Math.sqrt(s)}),d*u}function Le(e,t,n,a,l){for(var i,o,r=1-(o=.5);i=Te(e,t,n,a,r),!(Math.abs(i-l)<=.01);)r+=(i<l?1:-1)*(o/=2);return r}function Pe(e,t){var n;return e.forEach(function(e){e=t?e.map(function(e){e={x:e.x,y:e.y};return t(e),e}):e;(n=n||[{type:"M",values:[e[0].x,e[0].y]}]).push(e.length?2===e.length?{type:"L",values:[e[1].x,e[1].y]}:{type:"C",values:[e[1].x,e[1].y,e[2].x,e[2].y,e[3].x,e[3].y]}:{type:"Z",values:[]})}),n}function Be(e){var t=[],n=0;return e.forEach(function(e){e=(2===e.length?Ae:Te).apply(null,e);t.push(e),n+=e}),{segsLen:t,lenAll:n}}function je(e,a){return null==e||null==a||e.length!==a.length||e.some(function(e,t){var n=a[t];return e.type!==n.type||e.values.some(function(e,t){return e!==n.values[t]})})}function Fe(e,t,n){e.events[t]?e.events[t].indexOf(n)<0&&e.events[t].push(n):e.events[t]=[n]}function $e(e,t,n){var a;e.events[t]&&-1<(a=e.events[t].indexOf(n))&&e.events[t].splice(a,1)}function De(e){t&&clearTimeout(t),me.push(e),t=setTimeout(function(){me.forEach(function(e){e()}),me=[]},0)}function We(e,t){e.reflowTargets.indexOf(t)<0&&e.reflowTargets.push(t)}function Qe(e){e.reflowTargets.forEach(function(e){var n=e;setTimeout(function(){var e=n.parentNode,t=n.nextSibling;e.insertBefore(e.removeChild(n),t)},0)}),e.reflowTargets=[]}function Re(e,t,n,a,l,i,o){var r;"auto-start-reverse"===n?("boolean"!=typeof s&&(t.setAttribute("orient","auto-start-reverse"),s=t.orientType.baseVal===SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN),s?t.setAttribute("orient",n):((r=l.createSVGTransform()).setRotate(180,0,0),i.transform.baseVal.appendItem(r),t.setAttribute("orient","auto"),r=!0)):(t.setAttribute("orient",n),!1===s&&i.transform.baseVal.clear()),t=t.viewBox.baseVal,r?(t.x=-a.right,t.y=-a.bottom):(t.x=a.left,t.y=a.top),t.width=a.width,t.height=a.height,ae&&We(e,o)}function He(e,t){return{prop:e?"markerEnd":"markerStart",orient:t?t.noRotate?"0":e?"auto":"auto-start-reverse":null}}function Ge(n,a){Object.keys(a).forEach(function(e){var t=a[e];n[e]=null!=t.iniValue?t.hasSE?[t.iniValue,t.iniValue]:t.iniValue:t.hasSE?t.hasProps?[{},{}]:[]:t.hasProps?{}:null})}function Ue(t,e,n,a,l){return a!==e[n]&&(e[n]=a,l&&l.forEach(function(e){e(t,a,n)}),!0)}function Ye(e){function t(e,t){return e+parseFloat(t)}var n=e.document,a=e.getComputedStyle(n.documentElement,""),e=e.getComputedStyle(n.body,""),n={x:0,y:0};return"static"!==e.position?(n.x-=[a.marginLeft,a.borderLeftWidth,a.paddingLeft,e.marginLeft,e.borderLeftWidth].reduce(t,0),n.y-=[a.marginTop,a.borderTopWidth,a.paddingTop,e.marginTop,e.borderTopWidth].reduce(t,0)):"static"!==a.position&&(n.x-=[a.marginLeft,a.borderLeftWidth].reduce(t,0),n.y-=[a.marginTop,a.borderTopWidth].reduce(t,0)),n}function Xe(e){var t,n=e.document;n.getElementById(f)||(t=(new e.DOMParser).parseFromString(m,"image/svg+xml"),n.body.appendChild(t.documentElement),pe(e))}function qe(i){var g,p,w,e,n,a,l,h,o,r,s,t,c,u,d=i.options,f=i.curStats,m=i.aplStats,S=f.position_socketXYSE,y=!1;function v(e,t){e=t===_?{x:e.left+e.width/2,y:e.top}:t===x?{x:e.right,y:e.top+e.height/2}:t===E?{x:e.left+e.width/2,y:e.bottom}:{x:e.left,y:e.top+e.height/2};return e.socketId=t,e}function b(e){return{x:e.x,y:e.y}}if(f.position_path=d.path,f.position_lineStrokeWidth=f.line_strokeWidth,f.position_socketGravitySE=g=Ee(d.socketGravitySE),p=[0,1].map(function(e){var t=d.anchorSE[e],n=i.optionIsAttach.anchorSE[e],a=!1!==n?ge[t._id]:null,l=!1!==n&&a.conf.getStrokeWidth?a.conf.getStrokeWidth(a,i):0,t=!1!==n&&a.conf.getBBoxNest?a.conf.getBBoxNest(a,i,l):Oe(t,i.baseWindow);return f.capsMaskAnchor_pathDataSE[e]=!1!==n&&a.conf.getPathData?a.conf.getPathData(a,i,l):(n=null!=t.right?t.right:t.left+t.width,a=null!=t.bottom?t.bottom:t.top+t.height,[{type:"M",values:[t.left,t.top]},{type:"L",values:[n,t.top]},{type:"L",values:[n,a]},{type:"L",values:[t.left,a]},{type:"Z",values:[]}]),f.capsMaskAnchor_strokeWidthSE[e]=l,t}),l=-1,d.socketSE[0]&&d.socketSE[1]?(S[0]=v(p[0],d.socketSE[0]),S[1]=v(p[1],d.socketSE[1])):(d.socketSE[0]||d.socketSE[1]?(a=d.socketSE[0]?(n=0,1):(n=1,0),S[n]=v(p[n],d.socketSE[n]),(e=F.map(function(e){return v(p[a],e)})).forEach(function(e){var t=Ae(e,S[n]);(t<l||-1===l)&&(S[a]=e,l=t)})):(e=F.map(function(e){return v(p[1],e)}),F.map(function(e){return v(p[0],e)}).forEach(function(n){e.forEach(function(e){var t=Ae(n,e);(t<l||-1===l)&&(S[0]=n,S[1]=e,l=t)})})),[0,1].forEach(function(e){var t,n;d.socketSE[e]||(p[e].width||p[e].height?p[e].width||S[e].socketId!==A&&S[e].socketId!==x?p[e].height||S[e].socketId!==_&&S[e].socketId!==E||(S[e].socketId=0<=S[e?0:1].y-p[e].top?E:_):S[e].socketId=0<=S[e?0:1].x-p[e].left?x:A:(t=S[e?0:1].x-p[e].left,n=S[e?0:1].y-p[e].top,S[e].socketId=Math.abs(t)>=Math.abs(n)?0<=t?x:A:0<=n?E:_))})),f.position_path!==m.position_path||f.position_lineStrokeWidth!==m.position_lineStrokeWidth||[0,1].some(function(e){return f.position_plugOverheadSE[e]!==m.position_plugOverheadSE[e]||(t=S[e],n=m.position_socketXYSE[e],t.x!==n.x||t.y!==n.y||t.socketId!==n.socketId)||(t=g[e],n=m.position_socketGravitySE[e],(e=null==t?"auto":Array.isArray(t)?"array":"number")!=(null==n?"auto":Array.isArray(n)?"array":"number")||("array"==e?t[0]!==n[0]||t[1]!==n[1]:t!==n));var t,n})){switch(i.pathList.baseVal=w=[],i.pathList.animVal=null,f.position_path){case V:w.push([b(S[0]),b(S[1])]);break;case N:c="number"==typeof g[0]&&0<g[0]||"number"==typeof g[1]&&0<g[1],c=(u=te*(c?-1:1))-(t=Math.atan2(S[1].y-S[0].y,S[1].x-S[0].x)),t=Math.PI-t-u,u=Ae(S[0],S[1])/Math.sqrt(2)*ee,c={x:S[0].x+Math.cos(c)*u,y:S[0].y+Math.sin(c)*u*-1},u={x:S[1].x+Math.cos(t)*u,y:S[1].y+Math.sin(t)*u*-1},w.push([b(S[0]),c,u,b(S[1])]);break;case T:case L:o=[g[0],f.position_path===L?0:g[1]],r=[],s=[],S.forEach(function(e,t){var n,a=o[t],l=Array.isArray(a)?{x:a[0],y:a[1]}:"number"==typeof a?e.socketId===_?{x:0,y:-a}:e.socketId===x?{x:a,y:0}:e.socketId===E?{x:0,y:a}:{x:-a,y:0}:(n=S[t?0:1],a=0<(a=f.position_plugOverheadSE[t])?R+(H<a?(a-H)*K:0):D+(f.position_lineStrokeWidth>W?(f.position_lineStrokeWidth-W)*Q:0),e.socketId===_?{x:0,y:-(l=(l=(e.y-n.y)/2)<a?a:l)}:e.socketId===x?{x:l=(l=(n.x-e.x)/2)<a?a:l,y:0}:e.socketId===E?{x:0,y:l=(l=(n.y-e.y)/2)<a?a:l}:{x:-(l=(l=(e.x-n.x)/2)<a?a:l),y:0});r[t]=e.x+l.x,s[t]=e.y+l.y}),w.push([b(S[0]),{x:r[0],y:s[0]},{x:r[1],y:s[1]},b(S[1])]);break;case P:!function(){var n,l=1,o=2,r=3,i=4,s=[[],[]],c=[];function u(e){return e===l?r:e===o?i:e===r?l:o}function d(e){return e===o||e===i?"x":"y"}function p(e,t,n){var a={x:e.x,y:e.y};if(n){if(n===u(e.dirId))throw new Error("Invalid dirId: "+n);a.dirId=n}else a.dirId=e.dirId;return a.dirId===l?a.y-=t:a.dirId===o?a.x+=t:a.dirId===r?a.y+=t:a.x-=t,a}function h(e,t){return t.dirId===l?e.y<=t.y:t.dirId===o?e.x>=t.x:t.dirId===r?e.y>=t.y:e.x<=t.x}function f(e,t){return t.dirId===l||t.dirId===r?e.x===t.x:e.y===t.y}function m(e){return e[0]?{contain:0,notContain:1}:{contain:1,notContain:0}}function y(e,t,n){return Math.abs(t[n]-e[n])}function v(e,t,n){return"x"===n?e.x<t.x?o:i:e.y<t.y?r:l}for(S.forEach(function(e,t){var n=b(e),a=g[t],e=Array.isArray(a)?a[0]<0?[i,-a[0]]:0<a[0]?[o,a[0]]:a[1]<0?[l,-a[1]]:0<a[1]?[r,a[1]]:[e.socketId,0]:"number"!=typeof a?[e.socketId,J]:0<=a?[e.socketId,a]:[u(e.socketId),-a];n.dirId=e[0],a=e[1],s[t].push(n),c[t]=p(n,a)});function(){var e,t,a,l,n=[h(c[1],c[0]),h(c[0],c[1])],i=[d(c[0].dirId),d(c[1].dirId)];if(i[0]===i[1]){if(n[0]&&n[1])return f(c[1],c[0])||(c[0][i[0]]===c[1][i[1]]?(s[0].push(c[0]),s[1].push(c[1])):(e=c[0][i[0]]+(c[1][i[1]]-c[0][i[0]])/2,s[0].push(p(c[0],Math.abs(e-c[0][i[0]]))),s[1].push(p(c[1],Math.abs(e-c[1][i[1]]))))),0;n[0]!==n[1]?(t=m(n),(a=y(c[t.notContain],c[t.contain],i[t.notContain]))<J&&(c[t.notContain]=p(c[t.notContain],J-a)),s[t.notContain].push(c[t.notContain]),c[t.notContain]=p(c[t.notContain],J,f(c[t.contain],c[t.notContain])?"x"===i[t.notContain]?r:o:v(c[t.notContain],c[t.contain],"x"===i[t.notContain]?"y":"x"))):(a=y(c[0],c[1],"x"===i[0]?"y":"x"),s.forEach(function(e,t){var n=0===t?1:0;e.push(c[t]),c[t]=p(c[t],J,2*J<=a?v(c[t],c[n],"x"===i[t]?"y":"x"):"x"===i[t]?r:o)}))}else{if(n[0]&&n[1])return f(c[1],c[0])?s[1].push(c[1]):f(c[0],c[1])?s[0].push(c[0]):s[0].push("x"===i[0]?{x:c[1].x,y:c[0].y}:{x:c[0].x,y:c[1].y}),0;n[0]!==n[1]?(t=m(n),s[t.notContain].push(c[t.notContain]),c[t.notContain]=p(c[t.notContain],J,y(c[t.notContain],c[t.contain],i[t.contain])>=J?v(c[t.notContain],c[t.contain],i[t.contain]):c[t.contain].dirId)):(l=[{x:c[0].x,y:c[0].y},{x:c[1].x,y:c[1].y}],s.forEach(function(e,t){var n=0===t?1:0,a=y(l[t],l[n],i[t]);a<J&&(c[t]=p(c[t],J-a)),e.push(c[t]),c[t]=p(c[t],J,v(c[t],c[n],i[n]))}))}return 1}(););s[1].reverse(),s[0].concat(s[1]).forEach(function(e,t){e={x:e.x,y:e.y};0<t&&w.push([n,e]),n=e})}()}h=[],f.position_plugOverheadSE.forEach(function(e,t){var n,a,l,i,o,r,s,c,u,d=!t;0<e?2===(n=w[a=d?0:w.length-1]).length?(h[a]=h[a]||Ae.apply(null,n),h[a]>Z&&(h[a]-e<Z&&(e=h[a]-Z),s=Ie(n[0],n[1],(d?e:h[a]-e)/h[a]),w[a]=d?[s,n[1]]:[n[0],s],h[a]-=e)):(h[a]=h[a]||Te.apply(null,n),h[a]>Z&&(h[a]-e<Z&&(e=h[a]-Z),s=Ne(n[0],n[1],n[2],n[3],Le(n[0],n[1],n[2],n[3],d?e:h[a]-e)),i=d?(l=n[0],s.toP1):(l=n[3],s.fromP2),o=Math.atan2(l.y-s.y,s.x-l.x),r=Ae(s,i),s.x=l.x+Math.cos(o)*e,s.y=l.y+Math.sin(o)*e*-1,i.x=s.x+Math.cos(o)*r,i.y=s.y+Math.sin(o)*r*-1,w[a]=d?[s,s.toP1,s.toP2,n[3]]:[n[0],s.fromP1,s.fromP2,s],h[a]=null)):e<0&&(n=w[a=d?0:w.length-1],s=S[t].socketId,e<(t=-p[t]["x"==(c=s===A||s===x?"x":"y")?"width":"height"])&&(e=t),u=e*(s===A||s===_?-1:1),2===n.length?n[d?0:n.length-1][c]+=u:(d?[0,1]:[n.length-2,n.length-1]).forEach(function(e){n[e][c]+=u}),h[a]=null)}),m.position_socketXYSE=Ee(S),m.position_plugOverheadSE=Ee(f.position_plugOverheadSE),m.position_path=f.position_path,m.position_lineStrokeWidth=f.position_lineStrokeWidth,m.position_socketGravitySE=Ee(g),y=!0,i.events.apl_position&&i.events.apl_position.forEach(function(e){e(i,w)})}return y}function Ke(t,n){n!==t.isShown&&(!!n!=!!t.isShown&&(t.svg.style.visibility=n?"":"hidden"),t.isShown=n,t.events&&t.events.svgShow&&t.events.svgShow.forEach(function(e){e(t,n)}))}function Ze(e,t){var n,a,u,d,p,h,f,l,i,o,r,s,c,m,y,v,g,w,S,b,_,x,E,k,C,M,z,O,A,I,V,N,T,L,P,B,j,F,$,D,W,Q,R,H={};t.line&&(H.line=(l=(n=e).options,a=n.curStats,i=n.events,o=!1,o=Ue(n,a,"line_color",l.lineColor,i.cur_line_color)||o,o=Ue(n,a,"line_colorTra",ke(a.line_color)[0]<1)||o,o=Ue(n,a,"line_strokeWidth",l.lineSize,i.cur_line_strokeWidth)||o)),(t.plug||H.line)&&(H.plug=(d=(u=e).options,p=u.curStats,h=u.events,f=!1,[0,1].forEach(function(e){var t,n,a,l,i,o,r,s,c=d.plugSE[e];f=Ue(u,p.plug_enabledSE,e,c!==U)||f,f=Ue(u,p.plug_plugSE,e,c)||f,f=Ue(u,p.plug_colorSE,e,s=d.plugColorSE[e]||p.line_color,h.cur_plug_colorSE)||f,f=Ue(u,p.plug_colorTraSE,e,ke(s)[0]<1)||f,c!==U&&(l=n=(t=Y[X[c]]).widthR*d.plugSizeSE[e],i=a=t.heightR*d.plugSizeSE[e],oe&&(l*=p.line_strokeWidth,i*=p.line_strokeWidth),f=Ue(u,p.plug_markerWidthSE,e,l)||f,f=Ue(u,p.plug_markerHeightSE,e,i)||f,p.capsMaskMarker_markerWidthSE[e]=n,p.capsMaskMarker_markerHeightSE[e]=a),p.plugOutline_plugSE[e]=p.capsMaskMarker_plugSE[e]=c,p.plug_enabledSE[e]?(s=p.line_strokeWidth/se.lineSize*d.plugSizeSE[e],p.position_plugOverheadSE[e]=t.overhead*s,p.viewBox_plugBCircleSE[e]=t.bCircle*s,o=t.sideLen*s,r=t.backLen*s):(p.position_plugOverheadSE[e]=-p.line_strokeWidth/2,p.viewBox_plugBCircleSE[e]=o=r=0),Ue(u,p.attach_plugSideLenSE,e,o,h.cur_attach_plugSideLenSE),Ue(u,p.attach_plugBackLenSE,e,r,h.cur_attach_plugBackLenSE),p.capsMaskAnchor_enabledSE[e]=!p.plug_enabledSE[e]}),f=Ue(u,p,"plug_enabled",p.plug_enabledSE[0]||p.plug_enabledSE[1])||f)),(t.lineOutline||H.line)&&(H.lineOutline=(i=(l=e).options,E=!1,E=Ue(l,o=l.curStats,"lineOutline_enabled",i.lineOutlineEnabled)||E,E=Ue(l,o,"lineOutline_color",i.lineOutlineColor)||E,E=Ue(l,o,"lineOutline_colorTra",ke(o.lineOutline_color)[0]<1)||E,i=o.line_strokeWidth*i.lineOutlineSize,E=Ue(l,o,"lineOutline_strokeWidth",o.line_strokeWidth-2*i)||E,E=Ue(l,o,"lineOutline_inStrokeWidth",o.lineOutline_colorTra?o.lineOutline_strokeWidth+2*re:o.line_strokeWidth-i)||E)),(t.plugOutline||H.line||H.plug||H.lineOutline)&&(H.plugOutline=(s=(r=e).options,c=r.curStats,m=!1,[0,1].forEach(function(e){var t=c.plugOutline_plugSE[e],n=t!==U?Y[X[t]]:null;m=Ue(r,c.plugOutline_enabledSE,e,s.plugOutlineEnabledSE[e]&&c.plug_enabled&&c.plug_enabledSE[e]&&!!n&&!!n.outlineBase)||m,m=Ue(r,c.plugOutline_colorSE,e,t=s.plugOutlineColorSE[e]||c.lineOutline_color)||m,m=Ue(r,c.plugOutline_colorTraSE,e,ke(t)[0]<1)||m,n&&n.outlineBase&&((t=s.plugOutlineSizeSE[e])>n.outlineMax&&(t=n.outlineMax),t*=2*n.outlineBase,m=Ue(r,c.plugOutline_strokeWidthSE,e,t)||m,m=Ue(r,c.plugOutline_inStrokeWidthSE,e,c.plugOutline_colorTraSE[e]?t-re/(c.line_strokeWidth/se.lineSize)/s.plugSizeSE[e]*2:t/2)||m)}),m)),(t.faces||H.line||H.plug||H.lineOutline||H.plugOutline)&&(H.faces=(g=(y=e).curStats,w=y.aplStats,S=y.events,b=!1,!g.line_altColor&&Ue(y,w,"line_color",v=g.line_color,S.apl_line_color)&&(y.lineFace.style.stroke=v,b=!0),Ue(y,w,"line_strokeWidth",v=g.line_strokeWidth,S.apl_line_strokeWidth)&&(y.lineShape.style.strokeWidth=v+"px",b=!0,(le||ae)&&(We(y,y.lineShape),ae&&(We(y,y.lineFace),We(y,y.lineMaskCaps)))),Ue(y,w,"lineOutline_enabled",v=g.lineOutline_enabled,S.apl_lineOutline_enabled)&&(y.lineOutlineFace.style.display=v?"inline":"none",b=!0),g.lineOutline_enabled&&(Ue(y,w,"lineOutline_color",v=g.lineOutline_color,S.apl_lineOutline_color)&&(y.lineOutlineFace.style.stroke=v,b=!0),Ue(y,w,"lineOutline_strokeWidth",v=g.lineOutline_strokeWidth,S.apl_lineOutline_strokeWidth)&&(y.lineOutlineMaskShape.style.strokeWidth=v+"px",b=!0,ae&&(We(y,y.lineOutlineMaskCaps),We(y,y.lineOutlineFace))),Ue(y,w,"lineOutline_inStrokeWidth",v=g.lineOutline_inStrokeWidth,S.apl_lineOutline_inStrokeWidth)&&(y.lineMaskShape.style.strokeWidth=v+"px",b=!0,ae&&(We(y,y.lineOutlineMaskCaps),We(y,y.lineOutlineFace)))),Ue(y,w,"plug_enabled",v=g.plug_enabled,S.apl_plug_enabled)&&(y.plugsFace.style.display=v?"inline":"none",b=!0),g.plug_enabled&&[0,1].forEach(function(n){var e=g.plug_plugSE[n],t=e!==U?Y[X[e]]:null,a=He(n,t);Ue(y,w.plug_enabledSE,n,v=g.plug_enabledSE[n],S.apl_plug_enabledSE)&&(y.plugsFace.style[a.prop]=v?"url(#"+y.plugMarkerIdSE[n]+")":"none",b=!0),g.plug_enabledSE[n]&&(Ue(y,w.plug_plugSE,n,e,S.apl_plug_plugSE)&&(y.plugFaceSE[n].href.baseVal="#"+t.elmId,Re(y,y.plugMarkerSE[n],a.orient,t.bBox,y.svg,y.plugMarkerShapeSE[n],y.plugsFace),b=!0,le&&We(y,y.plugsFace)),Ue(y,w.plug_colorSE,n,v=g.plug_colorSE[n],S.apl_plug_colorSE)&&(y.plugFaceSE[n].style.fill=v,b=!0,(ie||oe||ae)&&!g.line_colorTra&&We(y,ae?y.lineMaskCaps:y.capsMaskLine)),["markerWidth","markerHeight"].forEach(function(e){var t="plug_"+e+"SE";Ue(y,w[t],n,v=g[t][n],S["apl_"+t])&&(y.plugMarkerSE[n][e].baseVal.value=v,b=!0)}),Ue(y,w.plugOutline_enabledSE,n,v=g.plugOutline_enabledSE[n],S.apl_plugOutline_enabledSE)&&(v?(y.plugFaceSE[n].style.mask="url(#"+y.plugMaskIdSE[n]+")",y.plugOutlineFaceSE[n].style.display="inline"):(y.plugFaceSE[n].style.mask="none",y.plugOutlineFaceSE[n].style.display="none"),b=!0),g.plugOutline_enabledSE[n]&&(Ue(y,w.plugOutline_plugSE,n,e,S.apl_plugOutline_plugSE)&&(y.plugOutlineFaceSE[n].href.baseVal=y.plugMaskShapeSE[n].href.baseVal=y.plugOutlineMaskShapeSE[n].href.baseVal="#"+t.elmId,[y.plugMaskSE[n],y.plugOutlineMaskSE[n]].forEach(function(e){e.x.baseVal.value=t.bBox.left,e.y.baseVal.value=t.bBox.top,e.width.baseVal.value=t.bBox.width,e.height.baseVal.value=t.bBox.height}),b=!0),Ue(y,w.plugOutline_colorSE,n,v=g.plugOutline_colorSE[n],S.apl_plugOutline_colorSE)&&(y.plugOutlineFaceSE[n].style.fill=v,b=!0,ae&&(We(y,y.lineMaskCaps),We(y,y.lineOutlineMaskCaps))),Ue(y,w.plugOutline_strokeWidthSE,n,v=g.plugOutline_strokeWidthSE[n],S.apl_plugOutline_strokeWidthSE)&&(y.plugOutlineMaskShapeSE[n].style.strokeWidth=v+"px",b=!0),Ue(y,w.plugOutline_inStrokeWidthSE,n,v=g.plugOutline_inStrokeWidthSE[n],S.apl_plugOutline_inStrokeWidthSE)&&(y.plugMaskShapeSE[n].style.strokeWidth=v+"px",b=!0)))}),b)),(t.position||H.line||H.plug)&&(H.position=qe(e)),(t.path||H.position)&&(H.path=(E=(_=e).curStats,O=_.aplStats,z=_.pathList.animVal||_.pathList.baseVal,k=E.path_edge,A=!1,z&&(k.x1=k.x2=z[0][0].x,k.y1=k.y2=z[0][0].y,E.path_pathData=x=Pe(z,function(e){e.x<k.x1&&(k.x1=e.x),e.y<k.y1&&(k.y1=e.y),e.x>k.x2&&(k.x2=e.x),e.y>k.y2&&(k.y2=e.y)}),je(x,O.path_pathData)&&(_.linePath.setPathData(x),O.path_pathData=x,A=!0,ae?(We(_,_.plugsFace),We(_,_.lineMaskCaps)):le&&We(_,_.linePath),_.events.apl_path&&_.events.apl_path.forEach(function(e){e(_,x)}))),A)),H.viewBox=(z=(C=e).curStats,O=C.aplStats,A=z.path_edge,I=z.viewBox_bBox,V=O.viewBox_bBox,N=C.svg.viewBox.baseVal,T=C.svg.style,L=!1,O=Math.max(z.line_strokeWidth/2,z.viewBox_plugBCircleSE[0]||0,z.viewBox_plugBCircleSE[1]||0),M={x1:A.x1-O,y1:A.y1-O,x2:A.x2+O,y2:A.y2+O},C.events.new_edge4viewBox&&C.events.new_edge4viewBox.forEach(function(e){e(C,M)}),I.x=z.lineMask_x=z.lineOutlineMask_x=z.maskBGRect_x=M.x1,I.y=z.lineMask_y=z.lineOutlineMask_y=z.maskBGRect_y=M.y1,I.width=M.x2-M.x1,I.height=M.y2-M.y1,["x","y","width","height"].forEach(function(e){var t;(t=I[e])!==V[e]&&(N[e]=V[e]=t,T[q[e]]=t+("x"===e||"y"===e?C.bodyOffset[e]:0)+"px",L=!0)}),L),H.mask=(j=(P=e).curStats,F=P.aplStats,$=!1,j.plug_enabled?[0,1].forEach(function(e){j.capsMaskMarker_enabledSE[e]=j.plug_enabledSE[e]&&j.plug_colorTraSE[e]||j.plugOutline_enabledSE[e]&&j.plugOutline_colorTraSE[e]}):j.capsMaskMarker_enabledSE[0]=j.capsMaskMarker_enabledSE[1]=!1,j.capsMaskMarker_enabled=j.capsMaskMarker_enabledSE[0]||j.capsMaskMarker_enabledSE[1],j.lineMask_outlineMode=j.lineOutline_enabled,j.caps_enabled=j.capsMaskMarker_enabled||j.capsMaskAnchor_enabledSE[0]||j.capsMaskAnchor_enabledSE[1],j.lineMask_enabled=j.caps_enabled||j.lineMask_outlineMode,(j.lineMask_enabled&&!j.lineMask_outlineMode||j.lineOutline_enabled)&&["x","y"].forEach(function(e){var t="maskBGRect_"+e;Ue(P,F,t,B=j[t])&&(P.maskBGRect[e].baseVal.value=B,$=!0)}),Ue(P,F,"lineMask_enabled",B=j.lineMask_enabled)&&(P.lineFace.style.mask=B?"url(#"+P.lineMaskId+")":"none",$=!0,oe&&We(P,P.lineMask)),j.lineMask_enabled&&(Ue(P,F,"lineMask_outlineMode",B=j.lineMask_outlineMode)&&(B?(P.lineMaskBG.style.display="none",P.lineMaskShape.style.display="inline"):(P.lineMaskBG.style.display="inline",P.lineMaskShape.style.display="none"),$=!0),["x","y"].forEach(function(e){var t="lineMask_"+e;Ue(P,F,t,B=j[t])&&(P.lineMask[e].baseVal.value=B,$=!0)}),Ue(P,F,"caps_enabled",B=j.caps_enabled)&&(P.lineMaskCaps.style.display=P.lineOutlineMaskCaps.style.display=B?"inline":"none",$=!0,oe&&We(P,P.capsMaskLine)),j.caps_enabled&&([0,1].forEach(function(e){var t;Ue(P,F.capsMaskAnchor_enabledSE,e,B=j.capsMaskAnchor_enabledSE[e])&&(P.capsMaskAnchorSE[e].style.display=B?"inline":"none",$=!0,oe&&We(P,P.lineMask)),j.capsMaskAnchor_enabledSE[e]&&(je(t=j.capsMaskAnchor_pathDataSE[e],F.capsMaskAnchor_pathDataSE[e])&&(P.capsMaskAnchorSE[e].setPathData(t),F.capsMaskAnchor_pathDataSE[e]=t,$=!0),Ue(P,F.capsMaskAnchor_strokeWidthSE,e,B=j.capsMaskAnchor_strokeWidthSE[e])&&(P.capsMaskAnchorSE[e].style.strokeWidth=B+"px",$=!0))}),Ue(P,F,"capsMaskMarker_enabled",B=j.capsMaskMarker_enabled)&&(P.capsMaskLine.style.display=B?"inline":"none",$=!0),j.capsMaskMarker_enabled&&[0,1].forEach(function(n){var e=j.capsMaskMarker_plugSE[n],t=e!==U?Y[X[e]]:null,a=He(n,t);Ue(P,F.capsMaskMarker_enabledSE,n,B=j.capsMaskMarker_enabledSE[n])&&(P.capsMaskLine.style[a.prop]=B?"url(#"+P.lineMaskMarkerIdSE[n]+")":"none",$=!0),j.capsMaskMarker_enabledSE[n]&&(Ue(P,F.capsMaskMarker_plugSE,n,e)&&(P.capsMaskMarkerShapeSE[n].href.baseVal="#"+t.elmId,Re(P,P.capsMaskMarkerSE[n],a.orient,t.bBox,P.svg,P.capsMaskMarkerShapeSE[n],P.capsMaskLine),$=!0,le&&(We(P,P.capsMaskLine),We(P,P.lineFace))),["markerWidth","markerHeight"].forEach(function(e){var t="capsMaskMarker_"+e+"SE";Ue(P,F[t],n,B=j[t][n])&&(P.capsMaskMarkerSE[n][e].baseVal.value=B,$=!0)}))}))),j.lineOutline_enabled&&["x","y"].forEach(function(e){var t="lineOutlineMask_"+e;Ue(P,F,t,B=j[t])&&(P.lineOutlineMask[e].baseVal.value=B,$=!0)}),$),t.effect&&(Q=(D=e).curStats,R=D.aplStats,Object.keys(G).forEach(function(e){var t=G[e],n=e+"_enabled",a=e+"_options",e=Q[a];Ue(D,R,n,W=Q[n])?(W&&(R[a]=Ee(e)),t[W?"init":"remove"](D)):W&&xe(e,R[a])&&(t.remove(D),R[n]=!0,R[a]=Ee(e),t.init(D))})),(ie||oe)&&H.line&&!H.path&&We(e,e.lineShape),ie&&H.plug&&!H.line&&We(e,e.plugsFace),Qe(e)}function Je(e,t){return{duration:(ue(e.duration)&&0<e.duration?e:t).duration,timing:de.validTiming(e.timing)?e.timing:Ee(t.timing)}}function et(e,t,n,a){var l=e.curStats,i=e.aplStats,o={};function r(){["show_on","show_effect","show_animOptions"].forEach(function(e){i[e]=l[e]})}l.show_on=t,n&&k[n]&&(l.show_effect=n,l.show_animOptions=Je(ce(a)?a:{},k[n].defaultAnimOptions)),o.show_on=l.show_on!==i.show_on,o.show_effect=l.show_effect!==i.show_effect,o.show_animOptions=xe(l.show_animOptions,i.show_animOptions),o.show_effect||o.show_animOptions?l.show_inAnim?(n=o.show_effect?k[i.show_effect].stop(e,!0,!0):k[i.show_effect].stop(e),r(),k[i.show_effect].init(e,n)):o.show_on&&(i.show_effect&&o.show_effect&&k[i.show_effect].stop(e,!0,!0),r(),k[i.show_effect].init(e)):o.show_on&&(r(),k[i.show_effect].start(e))}function tt(e,t,n){n={props:e,optionName:n};return e.attachments.indexOf(t)<0&&(!t.conf.bind||t.conf.bind(t,n))&&(e.attachments.push(t),t.boundTargets.push(n),1)}function nt(n,a,e){var l=n.attachments.indexOf(a);-1<l&&n.attachments.splice(l,1),a.boundTargets.some(function(e,t){return e.props===n&&(a.conf.unbind&&a.conf.unbind(a,e),l=t,!0)})&&(a.boundTargets.splice(l,1),e||De(function(){a.boundTargets.length||i(a)}))}function at(s,c){var l,n,e,t,a,i,o,r,u,d,p,h,f,m,y,v=s.options,g={};function w(e,t,n,a,l){var i={};return n?null!=a?(i.container=e[n],i.key=a):(i.container=e,i.key=n):(i.container=e,i.key=t),i.default=l,i.acceptsAuto=null==i.default,i}function S(e,t,n,a,l,i,o){var r,s,c,o=w(e,n,l,i,o);return null!=t[n]&&(s=(t[n]+"").toLowerCase())&&(o.acceptsAuto&&s===$||(c=a[s]))&&c!==o.container[o.key]&&(o.container[o.key]=c,r=!0),null!=o.container[o.key]||o.acceptsAuto||(o.container[o.key]=o.default,r=!0),r}function b(e,t,n,a,l,i,o,r,s){var c,u,o=w(e,n,l,i,o);if(!a){if(null==o.default)throw new Error("Invalid `type`: "+n);a=typeof o.default}return null!=t[n]&&(o.acceptsAuto&&(t[n]+"").toLowerCase()===$||(t=u=t[n],("number"===(n=a)?ue(t):typeof t===n)&&(u=s&&"string"===a&&u?u.trim():u,1)&&(!r||r(u))))&&u!==o.container[o.key]&&(o.container[o.key]=u,c=!0),null!=o.container[o.key]||o.acceptsAuto||(o.container[o.key]=o.default,c=!0),c}if(c=c||{},["start","end"].forEach(function(e,t){var n=c[e],a=!1;if(n&&(Ce(n)||(a=z(n,"anchor")))&&n!==v.anchorSE[t]){if(!1!==s.optionIsAttach.anchorSE[t]&&nt(s,ge[v.anchorSE[t]._id]),a&&!tt(s,ge[n._id],e))throw new Error("Can't bind attachment");v.anchorSE[t]=n,s.optionIsAttach.anchorSE[t]=a,l=g.position=!0}}),!v.anchorSE[0]||!v.anchorSE[1]||v.anchorSE[0]===v.anchorSE[1])throw new Error("`start` and `end` are required.");function _(e){var t=a.appendChild(m.createElementNS(ne,"mask"));return t.id=e,t.maskUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,[t.x,t.y,t.width,t.height].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0)}),t}function x(e){var t=a.appendChild(m.createElementNS(ne,"marker"));return t.id=e,t.markerUnits.baseVal=SVGMarkerElement.SVG_MARKERUNITS_STROKEWIDTH,t.viewBox.baseVal||t.setAttribute("viewBox","0 0 0 0"),t}function E(e){return[e.width,e.height].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100)}),e}l&&(p=function(e,t){var n,a;if(!(e=ze(e))||!(n=ze(t)))throw new Error("Cannot get frames.");return e.length&&n.length&&(e.reverse(),n.reverse(),e.some(function(t){return n.some(function(e){return e===t&&(a=e.contentWindow,!0)})})),a||window}(!1!==s.optionIsAttach.anchorSE[0]?ge[v.anchorSE[0]._id].element:v.anchorSE[0],!1!==s.optionIsAttach.anchorSE[1]?ge[v.anchorSE[1]._id].element:v.anchorSE[1]))!==s.baseWindow&&(e=p,f=(n=s).aplStats,m=e.document,y=O+"-"+n._id,n.pathList={},Ge(f,he),Object.keys(G).forEach(function(e){var t=e+"_enabled";f[t]&&(G[e].remove(n),f[t]=!1)}),n.baseWindow&&n.svg&&n.baseWindow.document.body.removeChild(n.svg),Xe(n.baseWindow=e),n.bodyOffset=Ye(e),n.svg=t=m.createElementNS(ne,"svg"),t.className.baseVal=O,t.viewBox.baseVal||t.setAttribute("viewBox","0 0 0 0"),n.defs=a=t.appendChild(m.createElementNS(ne,"defs")),n.linePath=o=a.appendChild(m.createElementNS(ne,"path")),o.id=r=y+"-line-path",o.className.baseVal=O+"-line-path",oe&&(o.style.fill="none"),n.lineShape=o=a.appendChild(m.createElementNS(ne,"use")),o.id=u=y+"-line-shape",o.href.baseVal="#"+r,(i=a.appendChild(m.createElementNS(ne,"g"))).id=d=y+"-caps",n.capsMaskAnchorSE=[0,1].map(function(){var e=i.appendChild(m.createElementNS(ne,"path"));return e.className.baseVal=O+"-caps-mask-anchor",e}),n.lineMaskMarkerIdSE=[y+"-caps-mask-marker-0",y+"-caps-mask-marker-1"],n.capsMaskMarkerSE=[0,1].map(function(e){return x(n.lineMaskMarkerIdSE[e])}),n.capsMaskMarkerShapeSE=[0,1].map(function(e){e=n.capsMaskMarkerSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-caps-mask-marker-shape",e}),n.capsMaskLine=o=i.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-caps-mask-line",o.href.baseVal="#"+u,n.maskBGRect=o=E(a.appendChild(m.createElementNS(ne,"rect"))),o.id=p=y+"-mask-bg-rect",o.className.baseVal=O+"-mask-bg-rect",oe&&(o.style.fill="white"),n.lineMask=E(_(n.lineMaskId=y+"-line-mask")),n.lineMaskBG=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+p,n.lineMaskShape=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-line-mask-shape",o.href.baseVal="#"+r,o.style.display="none",n.lineMaskCaps=o=n.lineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+d,n.lineOutlineMask=E(_(e=y+"-line-outline-mask")),(o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use"))).href.baseVal="#"+p,n.lineOutlineMaskShape=o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-line-outline-mask-shape",o.href.baseVal="#"+r,n.lineOutlineMaskCaps=o=n.lineOutlineMask.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+d,n.face=t.appendChild(m.createElementNS(ne,"g")),n.lineFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+u,n.lineOutlineFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.href.baseVal="#"+u,o.style.mask="url(#"+e+")",o.style.display="none",n.plugMaskIdSE=[y+"-plug-mask-0",y+"-plug-mask-1"],n.plugMaskSE=[0,1].map(function(e){return _(n.plugMaskIdSE[e])}),n.plugMaskShapeSE=[0,1].map(function(e){e=n.plugMaskSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-plug-mask-shape",e}),h=[],n.plugOutlineMaskSE=[0,1].map(function(e){return _(h[e]=y+"-plug-outline-mask-"+e)}),n.plugOutlineMaskShapeSE=[0,1].map(function(e){e=n.plugOutlineMaskSE[e].appendChild(m.createElementNS(ne,"use"));return e.className.baseVal=O+"-plug-outline-mask-shape",e}),n.plugMarkerIdSE=[y+"-plug-marker-0",y+"-plug-marker-1"],n.plugMarkerSE=[0,1].map(function(e){e=x(n.plugMarkerIdSE[e]);return oe&&(e.markerUnits.baseVal=SVGMarkerElement.SVG_MARKERUNITS_USERSPACEONUSE),e}),n.plugMarkerShapeSE=[0,1].map(function(e){return n.plugMarkerSE[e].appendChild(m.createElementNS(ne,"g"))}),n.plugFaceSE=[0,1].map(function(e){return n.plugMarkerShapeSE[e].appendChild(m.createElementNS(ne,"use"))}),n.plugOutlineFaceSE=[0,1].map(function(e){var t=n.plugMarkerShapeSE[e].appendChild(m.createElementNS(ne,"use"));return t.style.mask="url(#"+h[e]+")",t.style.display="none",t}),n.plugsFace=o=n.face.appendChild(m.createElementNS(ne,"use")),o.className.baseVal=O+"-plugs-face",o.href.baseVal="#"+u,o.style.display="none",n.curStats.show_inAnim?(n.isShown=1,k[f.show_effect].stop(n,!0)):n.isShown||(t.style.visibility="hidden"),m.body.appendChild(t),[0,1,2].forEach(function(e){var t,e=n.options.labelSEM[e];e&&z(e,"label")&&(t=ge[e._id]).conf.initSvg&&t.conf.initSvg(t,n)}),g.line=g.plug=g.lineOutline=g.plugOutline=g.faces=g.effect=!0),g.position=S(v,c,"path",B,null,null,se.path)||g.position,g.position=S(v,c,"startSocket",I,"socketSE",0)||g.position,g.position=S(v,c,"endSocket",I,"socketSE",1)||g.position,[c.startSocketGravity,c.endSocketGravity].forEach(function(e,t){var n,a=!1;null!=e&&(Array.isArray(e)?ue(e[0])&&ue(e[1])&&(a=[e[0],e[1]],Array.isArray(v.socketGravitySE[t])&&(n=v.socketGravitySE[t],a.length===n.length&&a.every(function(e,t){return e===n[t]}))&&(a=!1)):((e+"").toLowerCase()===$?a=null:ue(e)&&0<=e&&(a=e),a===v.socketGravitySE[t]&&(a=!1)),!1!==a&&(v.socketGravitySE[t]=a,g.position=!0))}),g.line=b(v,c,"color",null,"lineColor",null,se.lineColor,null,!0)||g.line,g.line=b(v,c,"size",null,"lineSize",null,se.lineSize,function(e){return 0<e})||g.line,["startPlug","endPlug"].forEach(function(e,t){g.plug=S(v,c,e,j,"plugSE",t,se.plugSE[t])||g.plug,g.plug=b(v,c,e+"Color","string","plugColorSE",t,null,null,!0)||g.plug,g.plug=b(v,c,e+"Size",null,"plugSizeSE",t,se.plugSizeSE[t],function(e){return 0<e})||g.plug}),g.lineOutline=b(v,c,"outline",null,"lineOutlineEnabled",null,se.lineOutlineEnabled)||g.lineOutline,g.lineOutline=b(v,c,"outlineColor",null,"lineOutlineColor",null,se.lineOutlineColor,null,!0)||g.lineOutline,g.lineOutline=b(v,c,"outlineSize",null,"lineOutlineSize",null,se.lineOutlineSize,function(e){return 0<e&&e<=.48})||g.lineOutline,["startPlugOutline","endPlugOutline"].forEach(function(e,t){g.plugOutline=b(v,c,e,null,"plugOutlineEnabledSE",t,se.plugOutlineEnabledSE[t])||g.plugOutline,g.plugOutline=b(v,c,e+"Color","string","plugOutlineColorSE",t,null,null,!0)||g.plugOutline,g.plugOutline=b(v,c,e+"Size",null,"plugOutlineSizeSE",t,se.plugOutlineSizeSE[t],function(e){return 1<=e})||g.plugOutline}),["startLabel","endLabel","middleLabel"].forEach(function(e,t){var n,a,l,i=c[e],o=v.labelSEM[t]&&!s.optionIsAttach.labelSEM[t]?ge[v.labelSEM[t]._id].text:v.labelSEM[t],r=!1;if((n="string"==typeof i)&&(i=i.trim()),(n||i&&(r=z(i,"label")))&&i!==o){if(v.labelSEM[t]&&(nt(s,ge[v.labelSEM[t]._id]),v.labelSEM[t]=""),i){if(r?(a=ge[(l=i)._id]).boundTargets.slice().forEach(function(e){a.conf.removeOption(a,e)}):l=new M(C.captionLabel,[i]),!tt(s,ge[l._id],e))throw new Error("Can't bind attachment");v.labelSEM[t]=l}s.optionIsAttach.labelSEM[t]=r}}),Object.keys(G).forEach(function(a){var e,t,i=G[a],n=a+"_enabled",l=a+"_options";function o(a){var l={};return i.optionsConf.forEach(function(e){var t=e[0],n=e[3];null==e[4]||l[n]||(l[n]=[]),("function"==typeof t?t:"id"===t?S:b).apply(null,[l,a].concat(e.slice(1)))}),l}function r(e){var t,n=a+"_animOptions";return e.hasOwnProperty("animation")?ce(e.animation)?t=s.curStats[n]=Je(e.animation,i.defaultAnimOptions):(t=!!e.animation,s.curStats[n]=t?Je({},i.defaultAnimOptions):null):(t=!!i.defaultEnabled,s.curStats[n]=t?Je({},i.defaultAnimOptions):null),t}c.hasOwnProperty(a)&&(e=c[a],ce(e)?(s.curStats[n]=!0,t=s.curStats[l]=o(e),i.anim&&(s.curStats[l].animation=r(e))):(t=s.curStats[n]=!!e)&&(s.curStats[l]=o({}),i.anim&&(s.curStats[l].animation=r({}))),xe(t,v[a])&&(v[a]=t,g.effect=!0))}),Ze(s,g)}function lt(e,t,n){var a={options:{anchorSE:[],socketSE:[],socketGravitySE:[],plugSE:[],plugColorSE:[],plugSizeSE:[],plugOutlineEnabledSE:[],plugOutlineColorSE:[],plugOutlineSizeSE:[],labelSEM:["","",""]},optionIsAttach:{anchorSE:[!1,!1],labelSEM:[!1,!1,!1]},curStats:{},aplStats:{},attachments:[],events:{},reflowTargets:[]};Ge(a.curStats,he),Ge(a.aplStats,he),Object.keys(G).forEach(function(e){var t=G[e].stats;Ge(a.curStats,t),Ge(a.aplStats,t),a.options[e]=!1}),Ge(a.curStats,fe),Ge(a.aplStats,fe),a.curStats.show_effect="fade",a.curStats.show_animOptions=Ee(k.fade.defaultAnimOptions),Object.defineProperty(this,"_id",{value:++ve}),a._id=this._id,ye[this._id]=a,1===arguments.length&&(n=e,e=null),n=n||{},(e||t)&&(n=Ee(n),e&&(n.start=e),t&&(n.end=t)),a.isShown=a.aplStats.show_on=!n.hide,this.setOptions(n)}return G={dash:{stats:{dash_len:{},dash_gap:{},dash_maxOffset:{}},anim:!0,defaultAnimOptions:{duration:1e3,timing:"linear"},optionsConf:[["type","len","number",null,null,null,function(e){return 0<e}],["type","gap","number",null,null,null,function(e){return 0<e}]],init:function(e){Fe(e,"apl_line_strokeWidth",G.dash.update),e.lineFace.style.strokeDashoffset=0,G.dash.update(e)},remove:function(e){var t=e.curStats;$e(e,"apl_line_strokeWidth",G.dash.update),t.dash_animId&&(de.remove(t.dash_animId),t.dash_animId=null),e.lineFace.style.strokeDasharray="none",e.lineFace.style.strokeDashoffset=0,Ge(e.aplStats,G.dash.stats)},update:function(t){var e,n=t.curStats,a=t.aplStats,l=a.dash_options,i=!1;n.dash_len=l.len||2*a.line_strokeWidth,n.dash_gap=l.gap||a.line_strokeWidth,n.dash_maxOffset=n.dash_len+n.dash_gap,i=Ue(t,a,"dash_len",n.dash_len)||i,(i=Ue(t,a,"dash_gap",n.dash_gap)||i)&&(t.lineFace.style.strokeDasharray=a.dash_len+","+a.dash_gap),n.dash_animOptions?(i=Ue(t,a,"dash_maxOffset",n.dash_maxOffset),a.dash_animOptions&&(i||xe(n.dash_animOptions,a.dash_animOptions))&&(n.dash_animId&&(e=de.stop(n.dash_animId),de.remove(n.dash_animId)),a.dash_animOptions=null),a.dash_animOptions||(n.dash_animId=de.add(function(e){return(1-e)*a.dash_maxOffset+"px"},function(e){t.lineFace.style.strokeDashoffset=e},n.dash_animOptions.duration,0,n.dash_animOptions.timing,!1,e),a.dash_animOptions=Ee(n.dash_animOptions))):a.dash_animOptions&&(n.dash_animId&&(de.remove(n.dash_animId),n.dash_animId=null),t.lineFace.style.strokeDashoffset=0,a.dash_animOptions=null)}},gradient:{stats:{gradient_colorSE:{hasSE:!0},gradient_pointSE:{hasSE:!0,hasProps:!0}},optionsConf:[["type","startColor","string","colorSE",0,null,null,!0],["type","endColor","string","colorSE",1,null,null,!0]],init:function(e){var a=e.baseWindow.document,t=e.defs,n=O+"-"+e._id+"-gradient";e.efc_gradient_gradient=t=t.appendChild(a.createElementNS(ne,"linearGradient")),t.id=n,t.gradientUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,[t.x1,t.y1,t.x2,t.y2].forEach(function(e){e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0)}),e.efc_gradient_stopSE=[0,1].map(function(t){var n=e.efc_gradient_gradient.appendChild(a.createElementNS(ne,"stop"));try{n.offset.baseVal=t}catch(e){if(e.code!==DOMException.NO_MODIFICATION_ALLOWED_ERR)throw e;n.setAttribute("offset",t)}return n}),Fe(e,"cur_plug_colorSE",G.gradient.update),Fe(e,"apl_path",G.gradient.update),e.curStats.line_altColor=!0,e.lineFace.style.stroke="url(#"+n+")",G.gradient.update(e)},remove:function(e){e.efc_gradient_gradient&&(e.defs.removeChild(e.efc_gradient_gradient),e.efc_gradient_gradient=e.efc_gradient_stopSE=null),$e(e,"cur_plug_colorSE",G.gradient.update),$e(e,"apl_path",G.gradient.update),e.curStats.line_altColor=!1,e.lineFace.style.stroke=e.curStats.line_color,Ge(e.aplStats,G.gradient.stats)},update:function(a){var e,l=a.curStats,i=a.aplStats,t=i.gradient_options,n=a.pathList.animVal||a.pathList.baseVal;[0,1].forEach(function(e){l.gradient_colorSE[e]=t.colorSE[e]||l.plug_colorSE[e]}),e=n[0][0],l.gradient_pointSE[0]={x:e.x,y:e.y},e=(n=n[n.length-1])[n.length-1],l.gradient_pointSE[1]={x:e.x,y:e.y},[0,1].forEach(function(t){var n;Ue(a,i.gradient_colorSE,t,n=l.gradient_colorSE[t])&&(oe?(n=ke(n),a.efc_gradient_stopSE[t].style.stopColor=n[1],a.efc_gradient_stopSE[t].style.stopOpacity=n[0]):a.efc_gradient_stopSE[t].style.stopColor=n),["x","y"].forEach(function(e){(n=l.gradient_pointSE[t][e])!==i.gradient_pointSE[t][e]&&(a.efc_gradient_gradient[e+(t+1)].baseVal.value=i.gradient_pointSE[t][e]=n)})})}},dropShadow:{stats:{dropShadow_dx:{},dropShadow_dy:{},dropShadow_blur:{},dropShadow_color:{},dropShadow_opacity:{},dropShadow_x:{},dropShadow_y:{}},optionsConf:[["type","dx",null,null,null,2],["type","dy",null,null,null,4],["type","blur",null,null,null,3,function(e){return 0<=e}],["type","color",null,null,null,"#000",null,!0],["type","opacity",null,null,null,.8,function(e){return 0<=e&&e<=1}]],init:function(t){var e,n,a,l,i=t.baseWindow.document,o=t.defs,r=O+"-"+t._id+"-dropShadow",s=(e=i,n=r,l={},"boolean"!=typeof c&&(c=!!window.SVGFEDropShadowElement&&!oe),l.elmsAppend=[l.elmFilter=i=e.createElementNS(ne,"filter")],i.filterUnits.baseVal=SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE,i.x.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),i.y.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),i.width.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100),i.height.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,100),i.id=n,c?(l.elmOffset=l.elmBlur=a=i.appendChild(e.createElementNS(ne,"feDropShadow")),l.styleFlood=a.style):(l.elmBlur=i.appendChild(e.createElementNS(ne,"feGaussianBlur")),l.elmOffset=a=i.appendChild(e.createElementNS(ne,"feOffset")),a.result.baseVal="offsetblur",a=i.appendChild(e.createElementNS(ne,"feFlood")),l.styleFlood=a.style,(a=i.appendChild(e.createElementNS(ne,"feComposite"))).in2.baseVal="offsetblur",a.operator.baseVal=SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN,(a=i.appendChild(e.createElementNS(ne,"feMerge"))).appendChild(e.createElementNS(ne,"feMergeNode")),a.appendChild(e.createElementNS(ne,"feMergeNode")).in1.baseVal="SourceGraphic"),l);["elmFilter","elmOffset","elmBlur","styleFlood","elmsAppend"].forEach(function(e){t["efc_dropShadow_"+e]=s[e]}),s.elmsAppend.forEach(function(e){o.appendChild(e)}),t.face.setAttribute("filter","url(#"+r+")"),Fe(t,"new_edge4viewBox",G.dropShadow.adjustEdge),G.dropShadow.update(t)},remove:function(e){var t=e.defs;e.efc_dropShadow_elmsAppend&&(e.efc_dropShadow_elmsAppend.forEach(function(e){t.removeChild(e)}),e.efc_dropShadow_elmFilter=e.efc_dropShadow_elmOffset=e.efc_dropShadow_elmBlur=e.efc_dropShadow_styleFlood=e.efc_dropShadow_elmsAppend=null),$e(e,"new_edge4viewBox",G.dropShadow.adjustEdge),Ze(e,{}),e.face.removeAttribute("filter"),Ge(e.aplStats,G.dropShadow.stats)},update:function(e){var t,n,a=e.curStats,l=e.aplStats,i=l.dropShadow_options;a.dropShadow_dx=t=i.dx,Ue(e,l,"dropShadow_dx",t)&&(e.efc_dropShadow_elmOffset.dx.baseVal=t,n=!0),a.dropShadow_dy=t=i.dy,Ue(e,l,"dropShadow_dy",t)&&(e.efc_dropShadow_elmOffset.dy.baseVal=t,n=!0),a.dropShadow_blur=t=i.blur,Ue(e,l,"dropShadow_blur",t)&&(e.efc_dropShadow_elmBlur.setStdDeviation(t,t),n=!0),n&&Ze(e,{}),a.dropShadow_color=t=i.color,Ue(e,l,"dropShadow_color",t)&&(e.efc_dropShadow_styleFlood.floodColor=t),a.dropShadow_opacity=t=i.opacity,Ue(e,l,"dropShadow_opacity",t)&&(e.efc_dropShadow_styleFlood.floodOpacity=t)},adjustEdge:function(a,l){var e,i=a.curStats,o=a.aplStats;null!=i.dropShadow_dx&&(e=3*i.dropShadow_blur,(e={x1:l.x1-e+i.dropShadow_dx,y1:l.y1-e+i.dropShadow_dy,x2:l.x2+e+i.dropShadow_dx,y2:l.y2+e+i.dropShadow_dy}).x1<l.x1&&(l.x1=e.x1),e.y1<l.y1&&(l.y1=e.y1),e.x2>l.x2&&(l.x2=e.x2),e.y2>l.y2&&(l.y2=e.y2),["x","y"].forEach(function(e){var t,n="dropShadow_"+e;i[n]=t=l[e+"1"],Ue(a,o,n,t)&&(a.efc_dropShadow_elmFilter[e].baseVal.value=t)}))}}},Object.keys(G).forEach(function(e){var t=G[e],n=t.stats;n[e+"_enabled"]={iniValue:!1},n[e+"_options"]={hasProps:!0},t.anim&&(n[e+"_animOptions"]={},n[e+"_animId"]={})}),k={none:{defaultAnimOptions:{},init:function(e,t){var n=e.curStats;n.show_animId&&(de.remove(n.show_animId),n.show_animId=null),k.none.start(e,t)},start:function(e,t){k.none.stop(e,!0)},stop:function(e,t,n){var a=e.curStats;return n=null!=n?n:e.aplStats.show_on,a.show_inAnim=!1,t&&Ke(e,n),n?1:0}},fade:{defaultAnimOptions:{duration:300,timing:"linear"},init:function(n,e){var t=n.curStats,a=n.aplStats;t.show_animId&&de.remove(t.show_animId),t.show_animId=de.add(function(e){return e},function(e,t){t?k.fade.stop(n,!0):(n.svg.style.opacity=e+"",ae&&(We(n,n.svg),Qe(n)))},a.show_animOptions.duration,1,a.show_animOptions.timing,null,!1),k.fade.start(n,e)},start:function(e,t){var n,a=e.curStats;a.show_inAnim&&(n=de.stop(a.show_animId)),Ke(e,1),a.show_inAnim=!0,de.start(a.show_animId,!e.aplStats.show_on,null!=t?t:n)},stop:function(e,t,n){var a,l=e.curStats;return n=null!=n?n:e.aplStats.show_on,a=l.show_inAnim?de.stop(l.show_animId):n?1:0,l.show_inAnim=!1,t&&(e.svg.style.opacity=n?"":"0",Ke(e,n)),a}},draw:{defaultAnimOptions:{duration:500,timing:[.58,0,.42,1]},init:function(n,e){var t=n.curStats,a=n.aplStats,i=n.pathList.baseVal,l=Be(i),o=l.segsLen,r=l.lenAll;t.show_animId&&de.remove(t.show_animId),t.show_animId=de.add(function(e){var t,n,a,l=-1;if(0===e)n=[[i[0][0],i[0][0]]];else if(1===e)n=i;else{for(t=r*e,n=[];t>=o[++l];)n.push(i[l]),t-=o[l];t&&(2===(a=i[l]).length?n.push([a[0],Ie(a[0],a[1],t/o[l])]):(e=Ne(a[0],a[1],a[2],a[3],Le(a[0],a[1],a[2],a[3],t)),n.push([a[0],e.fromP1,e.fromP2,e])))}return n},function(e,t){t?k.draw.stop(n,!0):(n.pathList.animVal=e,Ze(n,{path:!0}))},a.show_animOptions.duration,1,a.show_animOptions.timing,null,!1),k.draw.start(n,e)},start:function(e,t){var n,a=e.curStats;a.show_inAnim&&(n=de.stop(a.show_animId)),Ke(e,1),a.show_inAnim=!0,Fe(e,"apl_position",k.draw.update),de.start(a.show_animId,!e.aplStats.show_on,null!=t?t:n)},stop:function(e,t,n){var a,l=e.curStats;return n=null!=n?n:e.aplStats.show_on,a=l.show_inAnim?de.stop(l.show_animId):n?1:0,l.show_inAnim=!1,t&&(e.pathList.animVal=n?null:[[e.pathList.baseVal[0][0],e.pathList.baseVal[0][0]]],Ze(e,{path:!0}),Ke(e,n)),a},update:function(e){$e(e,"apl_position",k.draw.update),e.curStats.show_inAnim?k.draw.init(e,k.draw.stop(e)):e.aplStats.show_animOptions={}}}},[["start","anchorSE",0],["end","anchorSE",1],["color","lineColor"],["size","lineSize"],["startSocketGravity","socketGravitySE",0],["endSocketGravity","socketGravitySE",1],["startPlugColor","plugColorSE",0],["endPlugColor","plugColorSE",1],["startPlugSize","plugSizeSE",0],["endPlugSize","plugSizeSE",1],["outline","lineOutlineEnabled"],["outlineColor","lineOutlineColor"],["outlineSize","lineOutlineSize"],["startPlugOutline","plugOutlineEnabledSE",0],["endPlugOutline","plugOutlineEnabledSE",1],["startPlugOutlineColor","plugOutlineColorSE",0],["endPlugOutlineColor","plugOutlineColorSE",1],["startPlugOutlineSize","plugOutlineSizeSE",0],["endPlugOutlineSize","plugOutlineSizeSE",1]].forEach(function(e){var t=e[0],n=e[1],a=e[2];Object.defineProperty(lt.prototype,t,{get:function(){var e=null!=a?ye[this._id].options[n][a]:n?ye[this._id].options[n]:ye[this._id].options[t];return null==e?$:Ee(e)},set:ot(t),enumerable:!0})}),[["path",B],["startSocket",I,"socketSE",0],["endSocket",I,"socketSE",1],["startPlug",j,"plugSE",0],["endPlug",j,"plugSE",1]].forEach(function(e){var a=e[0],l=e[1],i=e[2],o=e[3];Object.defineProperty(lt.prototype,a,{get:function(){var t,n=null!=o?ye[this._id].options[i][o]:i?ye[this._id].options[i]:ye[this._id].options[a];return n?Object.keys(l).some(function(e){return l[e]===n&&(t=e,!0)})?t:new Error("It's broken"):$},set:ot(a),enumerable:!0})}),Object.keys(G).forEach(function(n){var a=G[n];Object.defineProperty(lt.prototype,n,{get:function(){var s,e,t=ye[this._id].options[n];return ce(t)?(s=t,e=a.optionsConf.reduce(function(e,t){var n,a=t[0],l=t[1],i=t[2],o=t[3],t=t[4],r=null!=t?s[o][t]:o?s[o]:s[l];return e[l]="id"===a?r?Object.keys(i).some(function(e){return i[e]===r&&(n=e,!0)})?n:new Error("It's broken"):$:null==r?$:Ee(r),e},{}),a.anim&&(e.animation=Ee(s.animation)),e):t},set:ot(n),enumerable:!0})}),["startLabel","endLabel","middleLabel"].forEach(function(e,n){Object.defineProperty(lt.prototype,e,{get:function(){var e=ye[this._id],t=e.options;return t.labelSEM[n]&&!e.optionIsAttach.labelSEM[n]?ge[t.labelSEM[n]._id].text:t.labelSEM[n]||""},set:ot(e),enumerable:!0})}),lt.prototype.setOptions=function(e){return at(ye[this._id],e),this},lt.prototype.position=function(){return Ze(ye[this._id],{position:!0}),this},lt.prototype.remove=function(){var t=ye[this._id],n=t.curStats;Object.keys(G).forEach(function(e){e+="_animId";n[e]&&de.remove(n[e])}),n.show_animId&&de.remove(n.show_animId),t.attachments.slice().forEach(function(e){nt(t,e)}),t.baseWindow&&t.svg&&t.baseWindow.document.body.removeChild(t.svg),delete ye[this._id]},lt.prototype.show=function(e,t){return et(ye[this._id],!0,e,t),this},lt.prototype.hide=function(e,t){return et(ye[this._id],!1,e,t),this},i=function(t){t&&ge[t._id]&&(t.boundTargets.slice().forEach(function(e){nt(e.props,t,!0)}),t.conf.remove&&t.conf.remove(t),delete ge[t._id])},it.prototype.remove=function(){var t=this,n=ge[t._id];n&&(n.boundTargets.slice().forEach(function(e){n.conf.removeOption(n,e)}),De(function(){var e=ge[t._id];e&&(console.error("LeaderLineAttachment was not removed by removeOption"),i(e))}))},M=it,window.LeaderLineAttachment=M,z=function(e,t){return e instanceof M&&(!(e.isRemoved||t&&ge[e._id].conf.type!==t)||null)},C={pointAnchor:{type:"anchor",argOptions:[{optionName:"element",type:Ce}],init:function(e,t){return e.element=C.pointAnchor.checkElement(t.element),e.x=C.pointAnchor.parsePercent(t.x,!0)||[.5,!0],e.y=C.pointAnchor.parsePercent(t.y,!0)||[.5,!0],!0},removeOption:function(e,t){var n=t.props,a={},l=e.element,e=n.options.anchorSE["start"===t.optionName?1:0];l===e&&(l=e===document.body?new M(C.pointAnchor,[l]):document.body),a[t.optionName]=l,at(n,a)},getBBoxNest:function(e,t){var n=Oe(e.element,t.baseWindow),a=n.width,t=n.height;return n.width=n.height=0,n.left=n.right=n.left+e.x[0]*(e.x[1]?a:1),n.top=n.bottom=n.top+e.y[0]*(e.y[1]?t:1),n},parsePercent:function(e,t){var n,a,l=!1;return ue(e)?a=e:"string"==typeof e&&(n=y.exec(e))&&n[2]&&(l=0!=(a=parseFloat(n[1])/100)),null!=a&&(t||0<=a)?[a,l]:null},checkElement:function(e){if(null==e)e=document.body;else if(!Ce(e))throw new Error("`element` must be Element");return e}},areaAnchor:{type:"anchor",argOptions:[{optionName:"element",type:Ce},{optionName:"shape",type:"string"}],stats:{color:{},strokeWidth:{},elementWidth:{},elementHeight:{},elementLeft:{},elementTop:{},pathListRel:{},bBoxRel:{},pathData:{},viewBoxBBox:{hasProps:!0},dashLen:{},dashGap:{}},init:function(a,e){var t,n=[];return a.element=C.pointAnchor.checkElement(e.element),"string"==typeof e.color&&(a.color=e.color.trim()),"string"==typeof e.fillColor&&(a.fill=e.fillColor.trim()),ue(e.size)&&0<=e.size&&(a.size=e.size),e.dash&&(a.dash=!0,ue(e.dash.len)&&0<e.dash.len&&(a.dashLen=e.dash.len),ue(e.dash.gap)&&0<e.dash.gap&&(a.dashGap=e.dash.gap)),"circle"===e.shape?a.shape=e.shape:"polygon"===e.shape&&Array.isArray(e.points)&&3<=e.points.length&&e.points.every(function(e){var t={};return!(!(t.x=C.pointAnchor.parsePercent(e[0],!0))||!(t.y=C.pointAnchor.parsePercent(e[1],!0))||(n.push(t),(t.x[1]||t.y[1])&&(a.hasRatio=!0),0))})?(a.shape=e.shape,a.points=n):(a.shape="rect",a.radius=ue(e.radius)&&0<=e.radius?e.radius:0),"rect"!==a.shape&&"circle"!==a.shape||(a.x=C.pointAnchor.parsePercent(e.x,!0)||[-.05,!0],a.y=C.pointAnchor.parsePercent(e.y,!0)||[-.05,!0],a.width=C.pointAnchor.parsePercent(e.width)||[1.1,!0],a.height=C.pointAnchor.parsePercent(e.height)||[1.1,!0],(a.x[1]||a.y[1]||a.width[1]||a.height[1])&&(a.hasRatio=!0)),t=a.element.ownerDocument,a.svg=e=t.createElementNS(ne,"svg"),e.className.baseVal=O+"-areaAnchor",e.viewBox.baseVal||e.setAttribute("viewBox","0 0 0 0"),a.path=e.appendChild(t.createElementNS(ne,"path")),a.path.style.fill=a.fill||"none",a.isShown=!1,e.style.visibility="hidden",t.body.appendChild(e),Xe(t=t.defaultView),a.bodyOffset=Ye(t),a.updateColor=function(){var e=a.curStats,t=a.aplStats,n=a.boundTargets.length?a.boundTargets[0].props.curStats:null;e.color=n=a.color||(n?n.line_color:se.lineColor),Ue(a,t,"color",n)&&(a.path.style.stroke=n)},a.updateShow=function(){Ke(a,a.boundTargets.some(function(e){return!0===e.props.isShown}))},!0},bind:function(e,t){t=t.props;return e.color||Fe(t,"cur_line_color",e.updateColor),Fe(t,"svgShow",e.updateShow),De(function(){e.updateColor(),e.updateShow()}),!0},unbind:function(e,t){t=t.props;e.color||$e(t,"cur_line_color",e.updateColor),$e(t,"svgShow",e.updateShow),1<e.boundTargets.length&&De(function(){e.updateColor(),e.updateShow(),C.areaAnchor.update(e)&&e.boundTargets.forEach(function(e){Ze(e.props,{position:!0})})})},removeOption:function(e,t){C.pointAnchor.removeOption(e,t)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){C.areaAnchor.unbind(t,e)})),t.svg.parentNode.removeChild(t.svg)},getStrokeWidth:function(e,t){return C.areaAnchor.update(e)&&1<e.boundTargets.length&&De(function(){e.boundTargets.forEach(function(e){e.props!==t&&Ze(e.props,{position:!0})})}),e.curStats.strokeWidth},getPathData:function(e,t){var n=Oe(e.element,t.baseWindow);return Pe(e.curStats.pathListRel,function(e){e.x+=n.left,e.y+=n.top})},getBBoxNest:function(e,t){t=Oe(e.element,t.baseWindow),e=e.curStats.bBoxRel;return{left:e.left+t.left,top:e.top+t.top,right:e.right+t.left,bottom:e.bottom+t.top,width:e.width,height:e.height}},update:function(t){var n,a,l,i,e,o,r,s,c,u,d,p,h,f,m,y,v=t.curStats,g=t.aplStats,w=t.boundTargets.length?t.boundTargets[0].props.curStats:null,S={};if(S.strokeWidth=Ue(t,v,"strokeWidth",null!=t.size?t.size:w?w.line_strokeWidth:se.lineSize),n=Me(t.element),S.elementWidth=Ue(t,v,"elementWidth",n.width),S.elementHeight=Ue(t,v,"elementHeight",n.height),S.elementLeft=Ue(t,v,"elementLeft",n.left),S.elementTop=Ue(t,v,"elementTop",n.top),S.strokeWidth||t.hasRatio&&(S.elementWidth||S.elementHeight)){switch(t.shape){case"rect":(o={left:t.x[0]*(t.x[1]?n.width:1),top:t.y[0]*(t.y[1]?n.height:1),width:t.width[0]*(t.width[1]?n.width:1),height:t.height[0]*(t.height[1]?n.height:1)}).right=o.left+o.width,o.bottom=o.top+o.height,s=v.strokeWidth/2,r=(r=Math.min(o.width,o.height))?r/2*Math.SQRT2+s:0,d=(r=t.radius?t.radius<=r?t.radius:r:0)?(u=r-(c=(r-s)/Math.SQRT2),d=[{x:o.left-u,y:o.top+c},{x:o.left+c,y:o.top-u},{x:o.right-c,y:o.top-u},{x:o.right+u,y:o.top+c},{x:o.right+u,y:o.bottom-c},{x:o.right-c,y:o.bottom+u},{x:o.left+c,y:o.bottom+u},{x:o.left-u,y:o.bottom-c}],v.pathListRel=[[d[0],{x:d[0].x,y:d[0].y-(p=r*ee)},{x:d[1].x-p,y:d[1].y},d[1]]],d[1].x!==d[2].x&&v.pathListRel.push([d[1],d[2]]),v.pathListRel.push([d[2],{x:d[2].x+p,y:d[2].y},{x:d[3].x,y:d[3].y-p},d[3]]),d[3].y!==d[4].y&&v.pathListRel.push([d[3],d[4]]),v.pathListRel.push([d[4],{x:d[4].x,y:d[4].y+p},{x:d[5].x+p,y:d[5].y},d[5]]),d[5].x!==d[6].x&&v.pathListRel.push([d[5],d[6]]),v.pathListRel.push([d[6],{x:d[6].x-p,y:d[6].y},{x:d[7].x,y:d[7].y+p},d[7]]),d[7].y!==d[0].y&&v.pathListRel.push([d[7],d[0]]),v.pathListRel.push([]),u=r-c+v.strokeWidth/2,[{x:o.left-u,y:o.top-u},{x:o.right+u,y:o.bottom+u}]):(u=v.strokeWidth/2,d=[{x:o.left-u,y:o.top-u},{x:o.right+u,y:o.bottom+u}],v.pathListRel=[[d[0],{x:d[1].x,y:d[0].y}],[{x:d[1].x,y:d[0].y},d[1]],[d[1],{x:d[0].x,y:d[1].y}],[]],[{x:o.left-v.strokeWidth,y:o.top-v.strokeWidth},{x:o.right+v.strokeWidth,y:o.bottom+v.strokeWidth}]),v.bBoxRel={left:d[0].x,top:d[0].y,right:d[1].x,bottom:d[1].y,width:d[1].x-d[0].x,height:d[1].y-d[0].y};break;case"circle":(s={left:t.x[0]*(t.x[1]?n.width:1),top:t.y[0]*(t.y[1]?n.height:1),width:t.width[0]*(t.width[1]?n.width:1),height:t.height[0]*(t.height[1]?n.height:1)}).width||s.height||(s.width=s.height=10),s.width||(s.width=s.height),s.height||(s.height=s.width),s.right=s.left+s.width,s.bottom=s.top+s.height,p=s.left+s.width/2,r=s.top+s.height/2,e=v.strokeWidth/2,c=s.width/2,u=s.height/2,o=c*Math.SQRT2+e,d=u*Math.SQRT2+e,v.pathListRel=[[(e=[{x:p-o,y:r},{x:p,y:r-d},{x:p+o,y:r},{x:p,y:r+d}])[0],{x:e[0].x,y:e[0].y-(p=d*ee)},{x:e[1].x-(r=o*ee),y:e[1].y},e[1]],[e[1],{x:e[1].x+r,y:e[1].y},{x:e[2].x,y:e[2].y-p},e[2]],[e[2],{x:e[2].x,y:e[2].y+p},{x:e[3].x+r,y:e[3].y},e[3]],[e[3],{x:e[3].x-r,y:e[3].y},{x:e[0].x,y:e[0].y+p},e[0]],[]],c=o-c+v.strokeWidth/2,u=d-u+v.strokeWidth/2,e=[{x:s.left-c,y:s.top-u},{x:s.right+c,y:s.bottom+u}],v.bBoxRel={left:e[0].x,top:e[0].y,right:e[1].x,bottom:e[1].y,width:e[1].x-e[0].x,height:e[1].y-e[0].y};break;case"polygon":t.points.forEach(function(e){var t=e.x[0]*(e.x[1]?n.width:1),e=e.y[0]*(e.y[1]?n.height:1);l?(t<l.left&&(l.left=t),t>l.right&&(l.right=t),e<l.top&&(l.top=e),e>l.bottom&&(l.bottom=e)):l={left:t,right:t,top:e,bottom:e},i?v.pathListRel.push([i,{x:t,y:e}]):v.pathListRel=[],i={x:t,y:e}}),v.pathListRel.push([]),e=v.strokeWidth/2,e=[{x:l.left-e,y:l.top-e},{x:l.right+e,y:l.bottom+e}],v.bBoxRel={left:e[0].x,top:e[0].y,right:e[1].x,bottom:e[1].y,width:e[1].x-e[0].x,height:e[1].y-e[0].y}}S.pathListRel=S.bBoxRel=!0}return(S.pathListRel||S.elementLeft||S.elementTop)&&(v.pathData=Pe(v.pathListRel,function(e){e.x+=n.left,e.y+=n.top})),Ue(t,g,"strokeWidth",a=v.strokeWidth)&&(t.path.style.strokeWidth=a+"px"),je(a=v.pathData,g.pathData)&&(t.path.setPathData(a),g.pathData=a,S.pathData=!0),t.dash&&(!S.pathData&&(!S.strokeWidth||t.dashLen&&t.dashGap)||(v.dashLen=t.dashLen||2*v.strokeWidth,v.dashGap=t.dashGap||v.strokeWidth),S.dash=Ue(t,g,"dashLen",v.dashLen)||S.dash,S.dash=Ue(t,g,"dashGap",v.dashGap)||S.dash,S.dash&&(t.path.style.strokeDasharray=g.dashLen+","+g.dashGap)),h=v.viewBoxBBox,f=g.viewBoxBBox,m=t.svg.viewBox.baseVal,y=t.svg.style,h.x=v.bBoxRel.left+n.left,h.y=v.bBoxRel.top+n.top,h.width=v.bBoxRel.width,h.height=v.bBoxRel.height,["x","y","width","height"].forEach(function(e){(a=h[e])!==f[e]&&(m[e]=f[e]=a,y[q[e]]=a+("x"===e||"y"===e?t.bodyOffset[e]:0)+"px")}),S.strokeWidth||S.pathListRel||S.bBoxRel}},mouseHoverAnchor:{type:"anchor",argOptions:[{optionName:"element",type:Ce},{optionName:"showEffectName",type:"string"}],style:{backgroundImage:"url('data:image/svg+xml;charset=utf-8;base64,PHN2ZyB2ZXJzaW9uPSIxLjEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgd2lkdGg9IjI0IiBoZWlnaHQ9IjI0Ij48cG9seWdvbiBwb2ludHM9IjI0LDAgMCw4IDgsMTEgMCwxOSA1LDI0IDEzLDE2IDE2LDI0IiBmaWxsPSJjb3JhbCIvPjwvc3ZnPg==')",backgroundSize:"",backgroundRepeat:"no-loop",backgroundColor:"#f8f881",cursor:"default"},hoverStyle:{backgroundImage:"none",backgroundColor:"#fadf8f"},padding:{top:1,right:15,bottom:1,left:2},minHeight:15,backgroundPosition:{right:2,top:2},backgroundSize:{width:12,height:12},dirKeys:[["top","Top"],["right","Right"],["bottom","Bottom"],["left","Left"]],init:function(a,l){var n,t,e,i,o,r,s,c,u,d=C.mouseHoverAnchor,p={};if(a.element=C.pointAnchor.checkElement(l.element),!((c=(s=a.element).ownerDocument)&&(u=c.defaultView)&&u.HTMLElement&&s instanceof u.HTMLElement))throw new Error("`element` must be HTML element");return d.style.backgroundSize=d.backgroundSize.width+"px "+d.backgroundSize.height+"px",["style","hoverStyle"].forEach(function(e){var n=d[e];a[e]=Object.keys(n).reduce(function(e,t){return e[t]=n[t],e},{})}),"inline"===(n=a.element.ownerDocument.defaultView.getComputedStyle(a.element,"")).display?a.style.display="inline-block":"none"===n.display&&(a.style.display="block"),C.mouseHoverAnchor.dirKeys.forEach(function(e){var t=e[0],e="padding"+e[1];parseFloat(n[e])<d.padding[t]&&(a.style[e]=d.padding[t]+"px")}),a.style.display&&(e=a.element.style.display,a.element.style.display=a.style.display),C.mouseHoverAnchor.dirKeys.forEach(function(e){e="padding"+e[1];a.style[e]&&(p[e]=a.element.style[e],a.element.style[e]=a.style[e])}),(s=a.element.getBoundingClientRect()).height<d.minHeight&&(ae?(u=d.minHeight,"content-box"===n.boxSizing?u-=parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth)+parseFloat(n.paddingTop)+parseFloat(n.paddingBottom):"padding-box"===n.boxSizing&&(u-=parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth)),a.style.height=u+"px"):a.style.height=parseFloat(n.height)+(d.minHeight-s.height)+"px"),a.style.backgroundPosition=oe?s.width-d.backgroundSize.width-d.backgroundPosition.right+"px "+d.backgroundPosition.top+"px":"right "+d.backgroundPosition.right+"px top "+d.backgroundPosition.top+"px",a.style.display&&(a.element.style.display=e),C.mouseHoverAnchor.dirKeys.forEach(function(e){e="padding"+e[1];a.style[e]&&(a.element.style[e]=p[e])}),["style","hoverStyle"].forEach(function(e){var t=a[e],n=l[e];ce(n)&&Object.keys(n).forEach(function(e){"string"==typeof n[e]||ue(n[e])?t[e]=n[e]:null==n[e]&&delete t[e]})}),"function"==typeof l.onSwitch&&(r=l.onSwitch),l.showEffectName&&k[l.showEffectName]&&(a.showEffectName=i=l.showEffectName),o=l.animOptions,a.elmStyle=t=a.element.style,a.mouseenter=function(e){a.hoverStyleSave=d.getStyles(t,Object.keys(a.hoverStyle)),d.setStyles(t,a.hoverStyle),a.boundTargets.forEach(function(e){et(e.props,!0,i,o)}),r&&r(e)},a.mouseleave=function(e){d.setStyles(t,a.hoverStyleSave),a.boundTargets.forEach(function(e){et(e.props,!1,i,o)}),r&&r(e)},!0},bind:function(e,t){var n,a,l,i,o;return t.props.svg?C.mouseHoverAnchor.llShow(t.props,!1,e.showEffectName):De(function(){C.mouseHoverAnchor.llShow(t.props,!1,e.showEffectName)}),e.enabled||(e.styleSave=C.mouseHoverAnchor.getStyles(e.elmStyle,Object.keys(e.style)),C.mouseHoverAnchor.setStyles(e.elmStyle,e.style),e.removeEventListener=(n=e.element,a=e.mouseenter,l=e.mouseleave,"onmouseenter"in n&&"onmouseleave"in n?(n.addEventListener("mouseenter",a,!1),n.addEventListener("mouseleave",l,!1),function(){n.removeEventListener("mouseenter",a,!1),n.removeEventListener("mouseleave",l,!1)}):(console.warn("mouseenter and mouseleave events polyfill is enabled."),n.addEventListener("mouseover",i=function(e){e.relatedTarget&&(e.relatedTarget===this||this.compareDocumentPosition(e.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||a.apply(this,arguments)}),n.addEventListener("mouseout",o=function(e){e.relatedTarget&&(e.relatedTarget===this||this.compareDocumentPosition(e.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||l.apply(this,arguments)}),function(){n.removeEventListener("mouseover",i,!1),n.removeEventListener("mouseout",o,!1)})),e.enabled=!0),!0},unbind:function(e,t){e.enabled&&e.boundTargets.length<=1&&(e.removeEventListener(),C.mouseHoverAnchor.setStyles(e.elmStyle,e.styleSave),e.enabled=!1),C.mouseHoverAnchor.llShow(t.props,!0,e.showEffectName)},removeOption:function(e,t){C.pointAnchor.removeOption(e,t)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){C.mouseHoverAnchor.unbind(t,e)}))},getBBoxNest:function(e,t){return Oe(e.element,t.baseWindow)},llShow:function(e,t,n){k[n||e.curStats.show_effect].stop(e,!0,t),e.aplStats.show_on=t},getStyles:function(n,e){return e.reduce(function(e,t){return e[t]=n[t],e},{})},setStyles:function(t,n){Object.keys(n).forEach(function(e){t[e]=n[e]})}},captionLabel:{type:"label",argOptions:[{optionName:"text",type:"string"}],stats:{color:{},x:{},y:{}},textStyleProps:["fontFamily","fontStyle","fontVariant","fontWeight","fontStretch","fontSize","fontSizeAdjust","kerning","letterSpacing","wordSpacing","textDecoration"],init:function(o,t){return"string"==typeof t.text&&(o.text=t.text.trim()),!!o.text&&("string"==typeof t.color&&(o.color=t.color.trim()),o.outlineColor="string"==typeof t.outlineColor?t.outlineColor.trim():"#fff",Array.isArray(t.offset)&&ue(t.offset[0])&&ue(t.offset[1])&&(o.offset={x:t.offset[0],y:t.offset[1]}),ue(t.lineOffset)&&(o.lineOffset=t.lineOffset),C.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(o[e]=t[e])}),o.updateColor=function(e){C.captionLabel.updateColor(o,e)},o.updateSocketXY=function(e){var t,n=o.curStats,a=o.aplStats,l=e.curStats,i=l.position_socketXYSE[o.socketIndex];null!=i.x&&(o.offset?(n.x=i.x+o.offset.x,n.y=i.y+o.offset.y):(t=o.height/2,e=Math.max(l.attach_plugSideLenSE[o.socketIndex]||0,l.line_strokeWidth/2),l=l.position_socketXYSE[o.socketIndex?0:1],i.socketId===A||i.socketId===x?(n.x=i.socketId===A?i.x-t-o.width:i.x+t,n.y=l.y<i.y?i.y+e+t:i.y-e-t-o.height):(n.x=l.x<i.x?i.x+e+t:i.x-e-t-o.width,n.y=i.socketId===_?i.y-t-o.height:i.y+t)),Ue(o,a,"x",t=n.x)&&(o.elmPosition.x.baseVal.getItem(0).value=t),Ue(o,a,"y",t=n.y)&&(o.elmPosition.y.baseVal.getItem(0).value=t+o.height))},o.updatePath=function(e){var t=o.curStats,n=o.aplStats,e=e.pathList.animVal||e.pathList.baseVal;e&&(e=C.captionLabel.getMidPoint(e,o.lineOffset),t.x=e.x-o.width/2,t.y=e.y-o.height/2,Ue(o,n,"x",e=t.x)&&(o.elmPosition.x.baseVal.getItem(0).value=e),Ue(o,n,"y",e=t.y)&&(o.elmPosition.y.baseVal.getItem(0).value=e+o.height))},o.updateShow=function(e){C.captionLabel.updateShow(o,e)},oe&&(o.adjustEdge=function(e,t){var n=o.curStats;null!=n.x&&C.captionLabel.adjustEdge(t,{x:n.x,y:n.y,width:o.width,height:o.height},o.strokeWidth/2)}),!0)},updateColor:function(e,t){var n=e.curStats,a=e.aplStats,t=t.curStats;n.color=t=e.color||t.line_color,Ue(e,a,"color",t)&&(e.styleFill.fill=t)},updateShow:function(e,t){t=!0===t.isShown;t!==e.isShown&&(e.styleShow.visibility=t?"":"hidden",e.isShown=t)},adjustEdge:function(e,t,n){n={x1:t.x-n,y1:t.y-n,x2:t.x+t.width+n,y2:t.y+t.height+n};n.x1<e.x1&&(e.x1=n.x1),n.y1<e.y1&&(e.y1=n.y1),n.x2>e.x2&&(e.x2=n.x2),n.y2>e.y2&&(e.y2=n.y2)},newText:function(e,t,n,a,l){var i,o,r;return(i=t.createElementNS(ne,"text")).textContent=e,[i.x,i.y].forEach(function(e){var t=n.createSVGLength();t.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),e.baseVal.initialize(t)}),"boolean"!=typeof u&&(u="paintOrder"in i.style),l&&!u?(o=t.createElementNS(ne,"defs"),i.id=a,o.appendChild(i),(r=(e=t.createElementNS(ne,"g")).appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+a,(t=e.appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+a,(r=r.style).strokeLinejoin="round",{elmPosition:i,styleText:i.style,styleFill:t.style,styleStroke:r,styleShow:e.style,elmsAppend:[o,e]}):(r=i.style,l&&(r.strokeLinejoin="round",r.paintOrder="stroke"),{elmPosition:i,styleText:r,styleFill:r,styleStroke:l?r:null,styleShow:r,elmsAppend:[i]})},getMidPoint:function(e,t){var n,a,l,i=Be(e),o=i.segsLen,i=i.lenAll,r=-1;if((n=i/2+(t||0))<=0)return 2===(a=e[0]).length?Ie(a[0],a[1],0):Ne(a[0],a[1],a[2],a[3],0);if(i<=n)return 2===(a=e[e.length-1]).length?Ie(a[0],a[1],1):Ne(a[0],a[1],a[2],a[3],1);for(l=[];n>o[++r];)l.push(e[r]),n-=o[r];return 2===(a=e[r]).length?Ie(a[0],a[1],n/o[r]):Ne(a[0],a[1],a[2],a[3],Le(a[0],a[1],a[2],a[3],n))},initSvg:function(t,n){var e,a,l=C.captionLabel.newText(t.text,n.baseWindow.document,n.svg,O+"-captionLabel-"+t._id,t.outlineColor);["elmPosition","styleFill","styleShow","elmsAppend"].forEach(function(e){t[e]=l[e]}),t.isShown=!1,t.styleShow.visibility="hidden",C.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(l.styleText[e]=t[e])}),l.elmsAppend.forEach(function(e){n.svg.appendChild(e)}),e=l.elmPosition.getBBox(),t.width=e.width,t.height=e.height,t.outlineColor&&(a=10<(a=e.height/9)?10:a<2?2:a,l.styleStroke.strokeWidth=a+"px",l.styleStroke.stroke=t.outlineColor),t.strokeWidth=a||0,Ge(t.aplStats,C.captionLabel.stats),t.updateColor(n),t.refSocketXY?t.updateSocketXY(n):t.updatePath(n),oe&&Ze(n,{}),t.updateShow(n)},bind:function(e,t){var n=t.props;return e.color||Fe(n,"cur_line_color",e.updateColor),(e.refSocketXY="startLabel"===t.optionName||"endLabel"===t.optionName)?(e.socketIndex="startLabel"===t.optionName?0:1,Fe(n,"apl_position",e.updateSocketXY),e.offset||(Fe(n,"cur_attach_plugSideLenSE",e.updateSocketXY),Fe(n,"cur_line_strokeWidth",e.updateSocketXY))):Fe(n,"apl_path",e.updatePath),Fe(n,"svgShow",e.updateShow),oe&&Fe(n,"new_edge4viewBox",e.adjustEdge),C.captionLabel.initSvg(e,n),!0},unbind:function(e,t){var n=t.props;e.elmsAppend&&(e.elmsAppend.forEach(function(e){n.svg.removeChild(e)}),e.elmPosition=e.styleFill=e.styleShow=e.elmsAppend=null),Ge(e.curStats,C.captionLabel.stats),Ge(e.aplStats,C.captionLabel.stats),e.color||$e(n,"cur_line_color",e.updateColor),e.refSocketXY?($e(n,"apl_position",e.updateSocketXY),e.offset||($e(n,"cur_attach_plugSideLenSE",e.updateSocketXY),$e(n,"cur_line_strokeWidth",e.updateSocketXY))):$e(n,"apl_path",e.updatePath),$e(n,"svgShow",e.updateShow),oe&&($e(n,"new_edge4viewBox",e.adjustEdge),Ze(n,{}))},removeOption:function(e,t){var n=t.props,a={};a[t.optionName]="",at(n,a)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){C.captionLabel.unbind(t,e)}))}},pathLabel:{type:"label",argOptions:[{optionName:"text",type:"string"}],stats:{color:{},startOffset:{},pathData:{}},init:function(o,t){return"string"==typeof t.text&&(o.text=t.text.trim()),!!o.text&&("string"==typeof t.color&&(o.color=t.color.trim()),o.outlineColor="string"==typeof t.outlineColor?t.outlineColor.trim():"#fff",ue(t.lineOffset)&&(o.lineOffset=t.lineOffset),C.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(o[e]=t[e])}),o.updateColor=function(e){C.captionLabel.updateColor(o,e)},o.updatePath=function(e){var t=o.curStats,n=o.aplStats,a=e.curStats,l=e.pathList.animVal||e.pathList.baseVal;l&&(t.pathData=a=C.pathLabel.getOffsetPathData(l,a.line_strokeWidth/2+o.strokeWidth/2+o.height/4,1.25*o.height),je(a,n.pathData)&&(o.elmPath.setPathData(a),n.pathData=a,o.bBox=o.elmPosition.getBBox(),o.updateStartOffset(e)))},o.updateStartOffset=function(e){var t,l,n=o.curStats,a=o.aplStats,i=e.curStats;n.pathData&&(2!==o.semIndex||o.lineOffset)&&(t=n.pathData.reduce(function(e,t){var n,a=t.values;switch(t.type){case"M":l={x:a[0],y:a[1]};break;case"L":n={x:a[0],y:a[1]},l&&(e+=Ae(l,n)),l=n;break;case"C":n={x:a[4],y:a[5]},l&&(e+=Te(l,{x:a[0],y:a[1]},{x:a[2],y:a[3]},n)),l=n}return e},0),e=0===o.semIndex?0:1===o.semIndex?t:t/2,2!==o.semIndex&&(i=Math.max(i.attach_plugBackLenSE[o.semIndex]||0,i.line_strokeWidth/2)+o.strokeWidth/2+o.height/4,e=(e+=0===o.semIndex?i:-i)<0?0:t<e?t:e),o.lineOffset&&(e=(e+=o.lineOffset)<0?0:t<e?t:e),n.startOffset=e,Ue(o,a,"startOffset",e)&&(o.elmOffset.startOffset.baseVal.value=e))},o.updateShow=function(e){C.captionLabel.updateShow(o,e)},oe&&(o.adjustEdge=function(e,t){o.bBox&&C.captionLabel.adjustEdge(t,o.bBox,o.strokeWidth/2)}),!0)},getOffsetPathData:function(e,p,n){var h,a,f=[];function m(e,t){return Math.abs(e.x-t.x)<3&&Math.abs(e.y-t.y)<3}return e.forEach(function(e){var t,n,a,l,i,o,r,s,c,u,d;2===e.length?(s=e[0],c=e[1],u=p,d=Math.atan2(s.y-c.y,c.x-s.x)+.5*Math.PI,t=[{x:s.x+Math.cos(d)*u,y:s.y+Math.sin(d)*u*-1},{x:c.x+Math.cos(d)*u,y:c.y+Math.sin(d)*u*-1}],h?(a=h.points,0<=(r=Math.atan2(a[1].y-a[0].y,a[0].x-a[1].x)-Math.atan2(e[0].y-e[1].y,e[1].x-e[0].x))&&r<=Math.PI?n={type:"line",points:t,inside:!0}:(i=Ve(a[0],a[1],p),l=Ve(t[1],t[0],p),o=a[0],s=i.x-o.x,c=i.y-o.y,u=(d=t[1]).x-l.x,r=d.y-l.y,d=(-c*(o.x-l.x)+s*(o.y-l.y))/(-u*c+s*r),r=(u*(o.y-l.y)-r*(o.x-l.x))/(-u*c+s*r),n=(c=0<=d&&d<=1&&0<=r&&r<=1?{x:o.x+r*s,y:o.y+r*c}:null)?{type:"line",points:[a[1]=c,t[1]]}:(a[1]=m(l,i)?l:i,{type:"line",points:[l,t[1]]}),h.len=Ae(a[0],a[1]))):n={type:"line",points:t},n.len=Ae(n.points[0],n.points[1]),f.push(h=n)):(f.push({type:"cubic",points:function(e,t,n,a,l){for(var i,o,r=Te(e,t,n,a)/16,s=1/(16<l?l/16*r:r),c=[],u=0;o=(90-(i=Ne(e,t,n,a,u)).angle)*(Math.PI/180),c.push({x:i.x+Math.cos(o)*l,y:i.y+Math.sin(o)*l*-1}),!(1<=u);)1<(u+=s)&&(u=1);return c}(e[0],e[1],e[2],e[3],p)}),h=null)}),h=null,f.forEach(function(e){var t;h="line"===e.type?(e.inside&&(h.len>p?((t=h.points)[1]=Ve(t[0],t[1],-p),h.len=Ae(t[0],t[1])):(h.points=null,h.len=0),e.len>p+n?((t=e.points)[0]=Ve(t[1],t[0],-(p+n)),e.len=Ae(t[0],t[1])):(e.points=null,e.len=0)),e):null}),f.reduce(function(t,e){var n=e.points;return n&&(a&&m(n[0],a)||t.push({type:"M",values:[n[0].x,n[0].y]}),"line"===e.type?t.push({type:"L",values:[n[1].x,n[1].y]}):(n.shift(),n.forEach(function(e){t.push({type:"L",values:[e.x,e.y]})})),a=n[n.length-1]),t},[])},newText:function(e,t,n,a){var l,i,o,r,s,c;return(o=(i=t.createElementNS(ne,"defs")).appendChild(t.createElementNS(ne,"path"))).id=l=n+"-path",(s=(r=t.createElementNS(ne,"text")).appendChild(t.createElementNS(ne,"textPath"))).href.baseVal="#"+l,s.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX,0),s.textContent=e,"boolean"!=typeof u&&(u="paintOrder"in r.style),a&&!u?(r.id=e=n+"-text",i.appendChild(r),(c=(n=t.createElementNS(ne,"g")).appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+e,(t=n.appendChild(t.createElementNS(ne,"use"))).href.baseVal="#"+e,(c=c.style).strokeLinejoin="round",{elmPosition:r,elmPath:o,elmOffset:s,styleText:r.style,styleFill:t.style,styleStroke:c,styleShow:n.style,elmsAppend:[i,n]}):(c=r.style,a&&(c.strokeLinejoin="round",c.paintOrder="stroke"),{elmPosition:r,elmPath:o,elmOffset:s,styleText:c,styleFill:c,styleStroke:a?c:null,styleShow:c,elmsAppend:[i,r]})},initSvg:function(t,n){var e,a,l=C.pathLabel.newText(t.text,n.baseWindow.document,O+"-pathLabel-"+t._id,t.outlineColor);["elmPosition","elmPath","elmOffset","styleFill","styleShow","elmsAppend"].forEach(function(e){t[e]=l[e]}),t.isShown=!1,t.styleShow.visibility="hidden",C.captionLabel.textStyleProps.forEach(function(e){null!=t[e]&&(l.styleText[e]=t[e])}),l.elmsAppend.forEach(function(e){n.svg.appendChild(e)}),l.elmPath.setPathData([{type:"M",values:[0,100]},{type:"h",values:[100]}]),e=l.elmPosition.getBBox(),l.styleText.textAnchor=["start","end","middle"][t.semIndex],2!==t.semIndex||t.lineOffset||l.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE,50),t.height=e.height,t.outlineColor&&(a=10<(a=e.height/9)?10:a<2?2:a,l.styleStroke.strokeWidth=a+"px",l.styleStroke.stroke=t.outlineColor),t.strokeWidth=a||0,Ge(t.aplStats,C.pathLabel.stats),t.updateColor(n),t.updatePath(n),t.updateStartOffset(n),oe&&Ze(n,{}),t.updateShow(n)},bind:function(e,t){var n=t.props;return e.color||Fe(n,"cur_line_color",e.updateColor),Fe(n,"cur_line_strokeWidth",e.updatePath),Fe(n,"apl_path",e.updatePath),e.semIndex="startLabel"===t.optionName?0:"endLabel"===t.optionName?1:2,2===e.semIndex&&!e.lineOffset||Fe(n,"cur_attach_plugBackLenSE",e.updateStartOffset),Fe(n,"svgShow",e.updateShow),oe&&Fe(n,"new_edge4viewBox",e.adjustEdge),C.pathLabel.initSvg(e,n),!0},unbind:function(e,t){var n=t.props;e.elmsAppend&&(e.elmsAppend.forEach(function(e){n.svg.removeChild(e)}),e.elmPosition=e.elmPath=e.elmOffset=e.styleFill=e.styleShow=e.elmsAppend=null),Ge(e.curStats,C.pathLabel.stats),Ge(e.aplStats,C.pathLabel.stats),e.color||$e(n,"cur_line_color",e.updateColor),$e(n,"cur_line_strokeWidth",e.updatePath),$e(n,"apl_path",e.updatePath),2===e.semIndex&&!e.lineOffset||$e(n,"cur_attach_plugBackLenSE",e.updateStartOffset),$e(n,"svgShow",e.updateShow),oe&&($e(n,"new_edge4viewBox",e.adjustEdge),Ze(n,{}))},removeOption:function(e,t){var n=t.props,a={};a[t.optionName]="",at(n,a)},remove:function(t){t.boundTargets.length&&(console.error("LeaderLineAttachment was not unbound by remove"),t.boundTargets.forEach(function(e){C.pathLabel.unbind(t,e)}))}}},Object.keys(C).forEach(function(e){lt[e]=function(){return new M(C[e],Array.prototype.slice.call(arguments))}}),lt.positionByWindowResize=!0,window.addEventListener("resize",b.add(function(){lt.positionByWindowResize&&Object.keys(ye).forEach(function(e){Ze(ye[e],{position:!0})})}),!1),lt;function it(e,t){var n,a={conf:e,curStats:{},aplStats:{},boundTargets:[]},l={};e.argOptions.every(function(e){return!(!t.length||("string"==typeof e.type?typeof t[0]!==e.type:"function"!=typeof e.type||!e.type(t[0]))||(l[e.optionName]=t.shift(),0))}),n=t.length&&ce(t[0])?Ee(t[0]):{},Object.keys(l).forEach(function(e){n[e]=l[e]}),e.stats&&(Ge(a.curStats,e.stats),Ge(a.aplStats,e.stats)),Object.defineProperty(this,"_id",{value:++we}),Object.defineProperty(this,"isRemoved",{get:function(){return!ge[this._id]}}),a._id=this._id,e.init&&!e.init(a,n)||(ge[this._id]=a)}function ot(n){return function(e){var t={};t[n]=e,this.setOptions(t)}}}();function getCaretPosition(e){return $(e).caret()}function setCaretPosition(e,t){$(e).caret(t)}!function(a){"use strict";function l(e,t){this.$element=a(e),this.options=a.extend({},a.fn.typeahead.defaults,t),this.matcher=this.options.matcher||this.matcher,this.sorter=this.options.sorter||this.sorter,this.highlighter=this.options.highlighter||this.highlighter,this.updater=this.options.updater||this.updater,this.blur=this.options.blur||this.blur,this.source=this.options.source,this.$menu=a(this.options.menu),this.shown=!1,this.listen()}l.prototype={constructor:l,select:function(){var e=this.$menu.find(".active").attr("data-value");return this.$element.val(this.updater(e)).text(this.updater(e)).change(),this.hide()},updater:function(e){return e},show:function(){var e=a.extend({},this.$element.position(),{height:this.$element[0].offsetHeight});return this.$menu.insertAfter(this.$element).css({top:e.top+e.height,left:e.left}).show(),this.shown=!0,this},hide:function(){return this.$menu.hide(),this.shown=!1,this},lookup:function(e){var t;return this.query=this.$element.is("input")?this.$element.val():this.$element.html(),!this.query||this.query.length<this.options.minLength?this.shown?this.hide():this:(t=a.isFunction(this.source)?this.source(this.query,a.proxy(this.process,this)):this.source)?this.process(t):this},process:function(e){var t=this;return e=a.grep(e,function(e){return t.matcher(e)}),(e=this.sorter(e)).length?this.render(e.slice(0,this.options.items)).show():this.shown?this.hide():this},matcher:function(e){return~e.toLowerCase().indexOf(this.query.toLowerCase())},sorter:function(e){for(var t,n=[],a=[],l=[];t=e.shift();)(t.toLowerCase().indexOf(this.query.toLowerCase())?~t.indexOf(this.query)?a:l:n).push(t);return n.concat(a,l)},highlighter:function(e){var t=this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");return e.replace(new RegExp("("+t+")","ig"),function(e,t){return"<strong>"+t+"</strong>"})},render:function(e){var n=this;return(e=a(e).map(function(e,t){return(e=a(n.options.item).attr("data-value",t)).find("a").html(n.highlighter(t)),e[0]})).first().addClass("active"),this.$menu.html(e),this},next:function(e){var t=this.$menu.find(".active").removeClass("active").next();(t=!t.length?a(this.$menu.find("li")[0]):t).addClass("active")},prev:function(e){var t=this.$menu.find(".active").removeClass("active").prev();(t=!t.length?this.$menu.find("li").last():t).addClass("active")},listen:function(){this.$element.on("focus",a.proxy(this.focus,this)).on("blur",a.proxy(this.blur,this)).on("keypress",a.proxy(this.keypress,this)).on("keyup",a.proxy(this.keyup,this)),this.eventSupported("keydown")&&this.$element.on("keydown",a.proxy(this.keydown,this)),this.$menu.on("click",a.proxy(this.click,this)).on("mouseenter","li",a.proxy(this.mouseenter,this)).on("mouseleave","li",a.proxy(this.mouseleave,this))},eventSupported:function(e){var t=e in this.$element;return t||(this.$element.setAttribute(e,"return;"),t="function"==typeof this.$element[e]),t},move:function(e){if(this.shown){switch(e.keyCode){case 9:case 13:case 27:e.preventDefault();break;case 38:e.preventDefault(),this.prev();break;case 40:e.preventDefault(),this.next()}e.stopPropagation()}},keydown:function(e){this.suppressKeyPressRepeat=~a.inArray(e.keyCode,[40,38,9,13,27]),this.move(e)},keypress:function(e){this.suppressKeyPressRepeat||this.move(e)},keyup:function(e){switch(e.keyCode){case 40:case 38:case 16:case 17:case 18:break;case 9:case 13:if(!this.shown)return;this.select();break;case 27:if(!this.shown)return;this.hide();break;default:this.lookup()}},focus:function(e){this.focused=!0},blur:function(e){this.focused=!1,!this.mousedover&&this.shown&&this.hide()},click:function(e){e.stopPropagation(),e.preventDefault(),this.select(),this.$element.focus()},mouseenter:function(e){this.mousedover=!0,this.$menu.find(".active").removeClass("active"),a(e.currentTarget).addClass("active")},mouseleave:function(e){this.mousedover=!1,!this.focused&&this.shown&&this.hide()}};var e=a.fn.typeahead;a.fn.typeahead=function(n){return this.each(function(){var e=a(this),t=e.data("typeahead");t||e.data("typeahead",t=new l(this,"object"==typeof n&&n)),"string"==typeof n&&t[n]()})},a.fn.typeahead.defaults={source:[],items:8,menu:'<ul class="typeahead dropdown-menu"></ul>',item:'<li><a href="#"></a></li>',minLength:1},a.fn.typeahead.Constructor=l,a.fn.typeahead.noConflict=function(){return a.fn.typeahead=e,this},a(document).on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(e){var t=a(this);t.data("typeahead")||t.typeahead(t.data())})}(window.jQuery),function(a){"use strict";function l(e,t){a.fn.typeahead.Constructor.call(this,e,t),this.after=this.options.after||this.after,this.show=this.options.show||this.show}l.prototype=a.extend({},a.fn.typeahead.Constructor.prototype,{constructor:l,select:function(){let e=this.$menu.find(".active").attr("data-value");var t=e.length-this.length_of_query,n=getCaretPosition(this.$element[0])+t;let a=this.$element.text();return a=a.slice(0,n-t-this.length_of_query)+e.substring(0,e.length)+this.suffix+a.substring(n-t,a.length),this.$element.text(a),this.$element.change(),this.after(),setCaretPosition(this.$element[0],n+this.suffix.length),this.hide()},after:function(){},hide:function(){return this.$menu.hide(),this.shown=!1,this},show:function(){this.$element.position(),this.$element.height();var e=this.$element.width();return this.$menu.show().css({position:"absolute",margin:"auto",marginTop:-40,left:0,right:0,width:e,zIndex:100}),this.$element.after(this.$menu),this.shown=!0,this},extractor:function(){var e=this.query,t=getCaretPosition(this.$element[0]),e=e.substring(0,t),e=new RegExp("(^|\\s)(\\"+this.options.tag+"[\\w-]*)$").exec(e);return e&&e[2]?e[2].trim().toLowerCase().substr(this.options.tag.length):""},updater:function(e){return e+" "},matcher:function(e){var t=this.extractor();return!!t&&(this.length_of_query=t.length,this.suffix=this.options.suffix,~e.toLowerCase().indexOf(t))},highlighter:function(e){var t=this.extractor().replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&");return e.replace(new RegExp("("+t+")","ig"),function(e,t){return"<strong>"+t+"</strong>"})}});var e=a.fn.tagautocomplete;a.fn.tagautocomplete=function(n){return this.each(function(){var e=a(this),t=e.data("tagautocomplete");t||e.data("tagautocomplete",t=new l(this,"object"==typeof n&&n)),"string"==typeof n&&t[n]()})},a.fn.tagautocomplete.Constructor=l,a.fn.tagautocomplete.defaults=a.extend(a.fn.typeahead.defaults,{tag:"@",suffix:""}),a.fn.tagautocomplete.noConflict=function(){return a.fn.tagautocomplete=e,this}}(window.jQuery),function(){function i(e){document.activeElement&&document.activeElement===e||e.focus()}jQuery.fn.caret=function(n){var a=this[0],t=a&&"true"===a.contentEditable;if(0!==arguments.length){if(a){if(-1===n&&(n=this[t?"text":"val"]().length),window.getSelection)if(t){if(i(a),0<=n){let e=window.getSelection(),t=function e(t,n,a){a||((a=document.createRange()).selectNode(t),a.setStart(t,0));if(0===n.count)a.setEnd(t,n.count);else if(t&&0<n.count)if(t.nodeType===Node.TEXT_NODE)t.textContent.length<n.count?n.count-=t.textContent.length:(a.setEnd(t,n.count),n.count=0);else for(var l=0;l<t.childNodes.length&&(a=e(t.childNodes[l],n,a),0!==n.count);l++);return a}(a,{count:n});t&&(t.collapse(!1),e.removeAllRanges(),e.addRange(t))}}else a.setSelectionRange(n,n);t||i(a)}return this}if(a){if(window.getSelection){if(t){i(a);let e=window.getSelection();if(!e.rangeCount)return 0;var l=e.getRangeAt(0),t=l.cloneRange();return t.selectNodeContents(a),t.setEnd(l.endContainer,l.endOffset),t.toString().length}return a.selectionStart}if(a.selectionStart)return a.selectionStart}}}();